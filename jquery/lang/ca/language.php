...
"Cookies must be allowed to vote" => "Les galetes haurien de tenir dret al vot",
...
"Puts a link to an anchor in a wiki page. Use in conjunction with the ANAME plugin, which sets the location and name of the anchor" => "Posa un enllaç a una àncora en una pàgina wiki. Per ser emprada en conjunció amb el plugin ANAME, que especifica el lloc i nom de l'ancora",
"linktext" => "text d'enllaç",
"Puts an anchor into a wiki page. Use in conjunction with the ALINK plugin, which makes links to the anchor" => "Posa una àncora en una pàgina wiki. Per ser emprada en conjunció amb el plugin ALINK, que especifica l'enllaç a l'ancora",
...
"Can participate to rating of wiki pages" => "Pot participar a la valoració de pàgines wiki",
