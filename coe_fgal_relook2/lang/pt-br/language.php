...
// "Logon to cclite server %0 failed for %1" => "Logon to cclite server %0 failed for %1",
...
// "Currently a choice between PayPal, and Cclite (in development)" => "Currently a choice between PayPal, and Cclite (in development)",
...
// "Cclite Registry" => "Cclite Registry",
// "Enable payments through Cclite" => "Enable payments through Cclite",
// "Registry name in Cclite" => "Registry name in Cclite",
...
// "Use ReCaptcha instead of default CAPTCHA" => "Use ReCaptcha instead of default CAPTCHA",
// "Pubkey" => "Pubkey",
// "Privkey" => "Privkey",
...
// "0|1, copy the contents of the code box to the clipboard" => "0|1, copy the contents of the code box to the clipboard",
// "colorbox" => "colorbox",
...
// "File link" => "File link",
// "Integer identifying a file in the file galleries" => "Integer identifying a file in the file galleries",
// "Text showing on the link" => "Text showing on the link",
// "Displays a link to download a file from a file gallery" => "Displays a link to download a file from a file gallery",
...
// "user can register this site with socialnetworks" => "user can register this site with socialnetworks",
...
// "(regenerate anti-bot code)" => "(regenerate anti-bot code)",
...
// "You can only use one payment system per Tiki, so only enter info into one section or another" => "You can only use one payment system per Tiki, so only enter info into one section or another",
// "Only PayPal is working at the moment. See PayPal.com" => "Only PayPal is working at the moment. See PayPal.com",
...
// "To use Twitter integration, you must register this site as an application at <a href=\"http://twitter.com/oauth_clients/\">http://twitter.com/oauth_clients/</a> and allow write access for the application" => "To use Twitter integration, you must register this site as an application at <a href=\"http://twitter.com/oauth_clients/\">http://twitter.com/oauth_clients/</a> and allow write access for the application",
...
// "Batch subscribe from wiki page" => "Batch subscribe from wiki page",
...
// "Subscribe wiki page" => "Subscribe wiki page",
// "Wiki page which will be added at each newsletter sending, one e-mail per line" => "Wiki page which will be added at each newsletter sending, one e-mail per line",
...
// "Tiki Wiki CMSGroupware Project" => "Tiki Wiki CMSGroupware Project",
// "Powered by Tiki" => "Powered by Tiki",
...
// "Transfer currency now" => "Transfer currency now",
