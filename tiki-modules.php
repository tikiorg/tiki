...
foreach(array('left_modules', 'right_modules') as $these_modules_name) {
	...
	for ($mod_counter = 0; $mod_counter < $temp_max; $mod_counter++) {
		...
		if (isset($prefs['user_flip_modules']) && $prefs['user_flip_modules'] != 'module') $module_params['flip'] = $prefs['user_flip_modules'];
		elseif (!isset($module_params['flip'])) $module_params['flip'] = 'n';
