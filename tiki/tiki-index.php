...
// $Header: /cvsroot/tikiwiki/tiki/tiki-index.php,v 1.58 2003-08-07 04:33:57 rossta Exp $
...
if (($tiki_p_admin_wiki == 'y') || ($user and ($tiki_p_lock == 'y') and ($feature_wiki_usrlock == 'y'))) {
...
if (isset($_REQUEST["undo"])) {
	if ($tiki_p_admin_wiki
		== 'y' || ($info["flag"] != 'L' && (($tiki_p_edit == 'y' && $info["user"] == $user) || ($tiki_p_remove == 'y')))) {
