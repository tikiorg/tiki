<?php
// $Header: /cvsroot/tikiwiki/tiki/tiki-blogs_rss.php,v 1.18 2003-10-11 09:42:58 ohertel Exp $
...
foreach ($changes["data"] as $chg) {
	...
	print ('  <title>'.rawurlencode($chg["blogtitle"].': '.$tikilib -> date_format($tikilib -> get_short_datetime_format(), $chg["created"])).'</title>'."\n");
