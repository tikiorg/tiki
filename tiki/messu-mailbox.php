...
// $Header: /cvsroot/tikiwiki/tiki/messu-mailbox.php,v 1.20 2007-02-03 20:47:13 nyloth Exp $
...
if ($mess_archiveAfter>0) {
	...
	$mess_archiveLast = $messulib->get_user_preference($user, 'mess_archiveLast', gmdate("U")-600);
	// only run auto-archive job every 10 minutes:
	if (gmdate("U")-$mess_archiveLast>=600) {
		$messulib->set_user_preference($user, 'mess_archiveLast', gmdate("U"));
