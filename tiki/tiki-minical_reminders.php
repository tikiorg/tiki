...
// $Header: /cvsroot/tikiwiki/tiki/tiki-minical_reminders.php,v 1.13 2007-02-03 20:47:14 nyloth Exp $
...
foreach ($evs as $ev) {
	$command = "<script type='text/javascript'>alert('event " . $ev['title'] . " will start at " . gmdate(
		"h:i", $ev['start']). "');</script>";
