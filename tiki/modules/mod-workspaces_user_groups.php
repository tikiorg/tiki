...
if ($tiki_p_admin != 'y' && $tiki_p_admin_workspaces!='y' && !$userlib->object_has_permission($user, $workspace["workspaceId"], 'workspace', "tiki_p_admin_workspace")) {
...
if (!$exit_module){
	...
	if (isset ($module_params["addGroupActiveName"])) {
		if ($userlib->group_exists($module_params["addGroupName"])) {
