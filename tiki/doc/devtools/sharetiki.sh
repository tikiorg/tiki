...
# $Header: /cvsroot/tikiwiki/tiki/doc/devtools/sharetiki.sh,v 1.2 2004-04-11 23:38:07 mose Exp $
...
RTMPDIR="/tmp"
ARCHDIR="/usr/local/tiki18/dupli"
OLDIR=`pwd`

eval `cat $RTIKI/db/local.php | sed -e '/[\?#]/d' -e "s/\$\([-_a-z]*\)[[:space:]]*=[[:space:]]*\([-_a-zA-Z0-9\"'\.]*\);/\\1=\\2/"`
