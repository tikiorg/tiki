...
{/if}
<tr id='show_pubdate' {if $types.$type.show_pubdate eq 'y'}style="display:;"{else}style="display:none;"{/if} class="formcolor"><td>{tr}Publish Date{/tr}</td><td>
...
<tr id='show_expdate' {if $types.$type.show_expdate eq 'y'}style="display:;"{else}style="display:none;"{/if} class="formcolor"><td>{tr}Expiration Date{/tr}</td><td>
