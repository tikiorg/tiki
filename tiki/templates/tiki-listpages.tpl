{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-listpages.tpl,v 1.53.2.1 2007-10-17 20:36:10 niclone Exp $ *}
...
<input type="hidden" name="maxRecords" value="{$prefs.maxRecords|escape}" />
</form>
