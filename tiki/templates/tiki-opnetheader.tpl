...
<script type="text/javascript" src="lib/opinion_network/javascript/range.js"></script>
<script type="text/javascript" src="lib/opinion_network/javascript/timer.js"></script>
<script type="text/javascript" src="lib/opinion_network/javascript/slider.js"></script> 
...
<link rel="StyleSheet"  href="styles/{$style}" type="text/css" />
<link type="text/css" rel="StyleSheet" href="lib/opinion_network/javascript/winclassic.css" /> 
{$trl}

</head>

<body
{if $user_dbl eq 'y' and $feature_wiki_dblclickedit eq 'whole_page' and $tiki_p_edit eq 'y'}ondblclick="location.href='tiki-editpage.php?page={$page|escape:"url"}';"{/if}
