...
<form action="tiki-admin.php#gal" method="post">
    ...
    <tr><td class="form">{tr}Library to use for processing images{/tr}:</td><td><input type="radio" name="gal_use_lib" value="gd" {if $gal_use_lib eq 'gd'}checked="checked"{/if}/>GD</td></tr>
