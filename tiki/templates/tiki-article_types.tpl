{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-article_types.tpl,v 1.1 2003-10-28 03:58:29 dheltzel Exp $ *}
...
<a class="link" href="tiki-article_types.php?type={$types[user].type}">{tr}Edit{/tr}</a>
</td>
</tr>
{sectionelse}
<tr>
