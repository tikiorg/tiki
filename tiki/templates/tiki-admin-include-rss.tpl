...
<div class="cbox-data">
        ...
        <tr><td class="form">{tr}Feed for upcoming calendar events{/tr}:</td><td><input type="checkbox" name="rss_calendar" {if $rss_calendar eq 'y'}checked="checked"{/if}/></td><td><input type="text" name="max_rss_calendar" size="5" value="{$max_rss_calendar|escape}" /></td><td><input type='text' name='title_rss_calendar' size='20' maxlength='255' value='{$title_rss_calendar|escape}' /></td><td><textarea name='desc_rss_calendar' cols='20'>{$desc_rss_calendar|escape}</textarea></td></tr>
