<a class="pagetitle" href="tiki-edit_question_options.php?questionId={$questionId}">Edit question options</a><br/><br/>
...
<h2>{tr}Create/edit options for question: <a class="pagetitle" href="tiki-edit_quiz_questions.php?quizId={$question_info.quizId}&amp;questionId={$question_info.questionId}">{$question_info.question}</a>{/tr}</h2>
<form action="tiki-edit_question_options.php" method="post">
<input type="hidden" name="optionId" value="{$optionId}" />
<input type="hidden" name="questionId" value="{$questionId}" />
<table class="normal">
<tr><td class="formcolor">{tr}Option{/tr}:</td><td class="formcolor"><textarea name="optionText" rows="5" cols="40">{$optionText}</textarea></td></tr>
<tr><td class="formcolor">{tr}Points{/tr}:</td><td class="formcolor"><input type="text" name="points" value="{$points}" /></td></tr>
