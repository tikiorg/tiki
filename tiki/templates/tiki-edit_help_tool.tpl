...
{/if}
<a title="{tr}external link{/tr}" class="link" href="javascript:insertAt('{$area_name}','[http://example.com|text]');"><img src='images/ed_link.gif' alt='{tr}external link{/tr}' title='{tr}external link{/tr}' border='0' /></a>
