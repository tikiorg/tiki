{* $Header: /cvsroot/tikiwiki/tiki/templates/modules/mod-last_actions.tpl,v 1.2 2005-01-22 22:56:27 mose Exp $ *}
...
{/if}
{tikimodule title=$tpl_module_title name="last_actions"}
