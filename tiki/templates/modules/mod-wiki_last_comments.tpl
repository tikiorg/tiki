{* $Header: /cvsroot/tikiwiki/tiki/templates/modules/mod-wiki_last_comments.tpl,v 1.6 2005-03-12 16:51:00 mose Exp $ *}
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    {section name=ix loop=$comments}
      <tr>
        ...
        <td class="module">
          <a class="linkmodule" href="tiki-index.php?page={$comments[ix].page|escape:"url"}&amp;comzone=show#comments" title="{$comments[ix].commentDate|tiki_short_datetime}, {tr}by{/tr} {$comments[ix].user}{if $moretooltips eq 'y'} on page {$comments[ix].page}{/if}">
