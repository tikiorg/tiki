{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-hw_student_last_changes.tpl,v 1.1 2004-02-18 04:06:37 ggeller Exp $ *}
{* Copyright (c) 2004 George G. Geller *}
{* Adapted from tiki-lastchanges.tpl *}

<h1>
  <a href="tiki-hw_student_last_changes.php?" class="pagetitle">{tr}Last Changes{/tr}</a>
</h1>
...
<div align="left">
  <table class="normal">
    <tr>
      <td class="heading" bgcolor="#bbbbbb"><a class="tableheading" href="tiki-hw_student_last_changes.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'lastModif_desc'}lastModif_asc{else}lastModif_desc{/if}">{tr}Last Modified{/tr}</a></td>
      <td class="heading" bgcolor="#bbbbbb"><a class="tableheading" href="tiki-hw_student_last_changes.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'Assignment_desc'}Assignment_asc{else}Assignment_desc{/if}">{tr}Assignment{/tr}</a></td>
      <td class="heading" bgcolor="#bbbbbb"><a class="tableheading" href="tiki-hw_last_changes.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'pageName_desc'}pageName_asc{else}pageName_desc{/if}">{tr}Due Date{/tr}</a></td>
