...
<div align="center"></div></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td id="page28" width="10" border="0" cellspacing="0" cellpadding="0" height="100%"><img src="styles/bluemetal/page_0.gif" width="10" height="1" alt="" border="0" /></td>
...
<div align="left"><img src="img/tiki/tikibutton2.png" border="0" /></div></td>
                ...
                <tr> 
                  ...
                  <td width="18" height="22" align="right" id="page18"> <div align="right"><img src="styles/bluemetal/page_0.gif" width="18" height="22" alt="" /></div></td>
                </tr>
              </table>
...
<table border="0" cellspacing="0" cellpadding="0" height="100%">
                      <tr> 
                        <td id="page7"><img src="styles/bluemetal/page_0.gif" width="30" height="5"></td>
                        <td id="page6" width="4" height="0"><img src="styles/bluemetal/page_0.gif" width="4" height="5" alt="" border="0" /></td>
                      </tr>
                      <tr> 
                        <td id="page8"><img src="styles/bluemetal/nav_m.gif" width="23" height="11" align="ABSMIDDLE" border="0"><img src="styles/bluemetal/page_0.gif" width="1" height="19" align="top" border="0"/></td>
                      ...
                      <tr>
                        <td id="page8" height="100%"><img src="styles/bluemetal/page_0.gif" width="1" height="19" align="top" border="0"/></td>
