...
<hr/><small><a href="tiki-admin_html_pages.php?pageName={$pageName|escape:"url"}">edit</a>
{if $type eq 'd'}
<a href="tiki-admin_html_page_content.php?pageName={$pageName|escape:"url"}">content</a>
{/if}
</small>
{/if}
