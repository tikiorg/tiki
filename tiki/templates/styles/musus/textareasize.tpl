...
<a href="javascript:textareasize('{$area_name}', +10, 0, '{$formId}')" title="{tr}Enlarge area height{/tr}"><img src="img/icons2/enlargeH.gif" border="0" alt="{tr}Enlarge textarea height{/tr}" /></a>
<a href="javascript:textareasize('{$area_name}', -10, 0, '{$formId}')" title="{tr}Reduce area height{/tr}"><img src="img/icons2/reduceH.gif" border="0" alt="{tr}Reduce textarea height{/tr}" /></a>
