...
<table>
<tr><td><label>{tr}Cookie{/tr}:</label></td><td><input type="text" maxlength="255" size="40" name="cookie" value="{$cookie|escape}" /></td></tr>
...
<table>
<tr><td><label>{tr}Upload from disk:{/tr}</label></td><td>
