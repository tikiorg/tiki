...
<td class="button2"><a href="tiki-admin_trackers.php?trackerId={$trackerId}" class="linkbut" title="{tr}Click here to edit this menu{/tr}"><img border="0" alt="{tr}Edit{/tr}" src="img/icons/edit.gif" /></a></td>
{if $user}
