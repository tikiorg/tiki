    ...
    <div class="simplebox">{tr}Forum listing configuration{/tr}
      <form method="post" action="tiki-admin.php?page=forums">
        <table><tr>
          ...
          <td><input type="checkbox" name="forum_list_topics" id="" {if $forum_list_topics eq 'y'}checked="checked"{/if} /></td>
        </tr><tr>
          <td><label>{tr}Posts{/tr}</label></td>
          <td><input type="checkbox" name="forum_list_posts" id="" {if $forum_list_posts eq 'y'}checked="checked"{/if} /></td>
        </tr><tr>
          ...
          <td><input type="checkbox" name="forum_list_lastpost" id="" {if $forum_list_lastpost eq 'y'}checked="checked"{/if} /></td>
        </tr><tr>
          <td><label>{tr}Visits{/tr}</label></td>
          <td><input type="checkbox" name="forum_list_visits" id="" {if $forum_list_visits eq 'y'}checked="checked"{/if} /></td>
        </tr><tr>
          <td><label>{tr}Description{/tr}</label></td>
          <td><input type="checkbox" name="forum_list_desc" id="" {if $forum_list_desc eq 'y'}checked="checked"{/if} /></td>
        </tr><tr>
