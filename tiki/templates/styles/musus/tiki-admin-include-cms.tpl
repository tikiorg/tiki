<div class="tiki">
  ...
  <div class="tiki-content">
    <div class="simplebox">{tr}CMS features{/tr}<br />
      <form action="tiki-admin.php?page=cms" method="post">
        <table class="admin"><tr>
          ...
          <td colspan="2" class="button"><input type="submit" name="cmsfeatures" value="{tr}Change preferences{/tr}" /></td>
        </tr></table>
      </form>
    </div>
    ...
    <div class="simplebox">
      <form method="post" action="tiki-admin.php?page=cms">
        <table class="admin"><tr>
          ...
          <td colspan="2" class="button"><input type="submit" name="cmsprefs" value="{tr}Change preferences{/tr}" /></td>
        </tr></table>
      </form>
    </div>
    <div class="simplebox">{tr}Article comments settings{/tr}
      <form method="post" action="tiki-admin.php?page=cms">
        <table class="admin"><tr>
          ...
          <td><label for="articles-commentsorder">{tr}Comments default ordering{/tr}</label></td>
          ...
          <td colspan="2" class="button"><input type="submit" name="articlecomprefs" value="{tr}Change preferences{/tr}" /></td>
        </tr></table>
      </form>
    </div>
    <div class="simplebox">{tr}Fields to display on page{/tr} <a href="tiki-list_articles.php">{tr}List articles{/tr}</a>: <br />
      <form method="post" action="tiki-admin.php?page=cms">
        <table class="admin"><tr>
          ...
          <td><label for="articles-expire">{tr}Expire Date{/tr}</label></td>
          ...
          <td><label for="articles-img">{tr}Img{/tr}</label></td>
          <td><input type="checkbox" name="art_list_img" id="articles-img" {if $art_list_img eq 'y'}checked="checked"{/if} /></td>
        </tr><tr>
          <td colspan="2" class="button"><input type="submit" name="artlist" value="{tr}Change preferences{/tr}" /></td>
        </tr></table>
      </form>    
    </div>
  </div>
