{* based on /cvsroot/tikiwiki/tiki/templates/modules/mod-top_image_galleries.tpl,v 1.13 2007/10/14 17:51:02 mose *}
...
<li>
<a class="linkmodule" href="tiki-browse_gallery.php?galleryId={$modTopGalleries[ix].galleryId}">{$modTopGalleries[ix].name}</a>
</li>
{/section}
{if $nonums != 'y'}</ol>{else}</ul>{/if}
{/tikimodule}
