{* based on /cvsroot/tikiwiki/tiki/templates/tiki-top_bar.tpl,v 1.41.2.6 2007/12/23 17:11:21 mose *}
{*{if $prefs.feature_tell_a_friend eq 'y' && $tiki_p_tell_a_friend eq 'y' and (!isset($edit_page) or $edit_page ne 'y')}
<div class="tellafriend" style="width><a href="tiki-tell_a_friend.php?url={$smarty.server.REQUEST_URI|escape:'url'}">{tr}Email this page{/tr}</a></div>
{/if}*}
