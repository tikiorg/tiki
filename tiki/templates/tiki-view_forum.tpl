{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-view_forum.tpl,v 1.89 2007-07-13 08:20:23 nyloth Exp $ *}
...
<div id="forumpost" style="display:{if $comments_threadId > 0 or $warning eq 'y'}block{else}none{/if};">
