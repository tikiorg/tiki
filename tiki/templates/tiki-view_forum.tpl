{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-view_forum.tpl,v 1.65 2005-10-16 14:35:10 mose Exp $ *}
...
<tr>
  ...
  {if $tiki_p_admin_forum eq 'y' or $comments_coms[ix].userName == $user or $tiki_p_edit_comments eq 'y' }
