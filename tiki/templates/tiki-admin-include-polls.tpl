...
<div class="highlight">{tr}Tip{/tr}: {tr}to add/remove polls, look for "Polls" under "Admin" on the application menu, or{/tr} <a class="link" href="tiki-admin_polls.php">{tr}click here{/tr}</a>.</div><br />
{/if}
