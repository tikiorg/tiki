        ...
        <div class="simplebox">
          ...
          <form action="tiki-admin.php?page=features" method="post">
            <table><tr>
              ...
              <td align="center" class="form" colspan="2"><input type="submit"
                  name="layout" value="{tr}Set features{/tr}" /></td>
            </tr></table>
          </form>
          <hr>
          <form action="tiki-admin.php?page=features" method="post">
            <table><tr>
              ...
              <td class="form"><input type="checkbox" name="layout_section"
                  {if $layout_section eq 'y'}checked="checked"{/if}/></td>
              <td class="form"><input type="submit"
                  name="layout_ss" value="{tr}Set{/tr}" /></td>
            </tr></table>
          </form>
