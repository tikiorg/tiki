...
{section name=i loop=$copyrights}
  <tr><td class="formcolor">
    ...
    <table border="0">
      <tr><td class="formcolor">Title:</td><td><input size="40" class="wikitext" type="text" name="copyrightTitle" value="{$copyrights[i].title}" /></td></tr>
      <tr><td class="formcolor">Year:</td><td><input size="4" class="wikitext" type="text" name="copyrightYear" value="{$copyrights[i].year}" /></td></tr>
      <tr><td class="formcolor">Authors:</td><td><input size="40" class="wikitext" type="text" name="copyrightAuthors" value="{$copyrights[i].authors}" /></td></tr>
    </table>
