...
{if $channels[ix].type eq 's'}
  ...
  <a class='separator' href="javascript:icntoggle('userm{$channels[ix].name|regex_replace:"/[^a-zA-Z0-9]/":""}');"><img src="img/icons/fo.gif" border="0" name="userm{$channels[ix].name|regex_replace:"/[^a-zA-Z0-9]/":""}icn">&nbsp;</a>
