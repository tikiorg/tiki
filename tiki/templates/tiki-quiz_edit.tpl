{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-quiz_edit.tpl,v 1.4 2004-05-12 13:08:01 ggeller Exp $ *}
...
<a class="linkbut" href="tiki-quiz_edit.php?quizId={$quizId}?view=ini">{tr}View/Edit as text{/tr}</a>
<br />
<br />
