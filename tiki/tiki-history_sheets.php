...
// $Header: /cvsroot/tikiwiki/tiki/tiki-history_sheets.php,v 1.6 2007-02-03 20:47:14 nyloth Exp $
...
while( $row = $result->fetchRow() )
	$data[] = array( "stamp" =>$row['begin'], "string" => gmdate( "Y-m-d H:i:s", $row['begin'] ), "user" => $row['user'] );
