// $Header: /cvsroot/tikiwiki/tiki/lib/tiki-js.js,v 1.59 2005-01-22 22:55:36 mose Exp $
...
function icntoggle(foo) {
	if (document.getElementById(foo).style.display == "none") {
		show(foo, true, "menu");
		document.getElementsByName(foo + 'icn')[0].src = document.getElementsByName(foo + 'icn')[0].src.replace(/[^\\\/]*$/, "ofo.gif");
		
	} else {
		hide(foo, true, "menu");
		document.getElementsByName(foo + 'icn')[0].src = document.getElementsByName(foo + 'icn')[0].src.replace(/[^\\\/]*$/, "fo.gif");
	}
}
