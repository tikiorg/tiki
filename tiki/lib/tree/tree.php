<?php
/** \file
 * $Header: /cvsroot/tikiwiki/tiki/lib/tree/tree.php,v 1.2 2003-08-01 10:31:02 redflo Exp $
 *
  ...
  function make_tree_r($rootid, & $ar)
  {
    ...
    if (count($ar) > 0)
    {
      ...
      foreach ($cli as $i)
      {
        ...
        $flipper = '';
        if ($have_childs) $flipper = $this->node_flipper_code($i);
