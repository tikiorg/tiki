<?php
/** \file
 * $Header: /cvsroot/tikiwiki/tiki/lib/tree/categ_admin_tree.php,v 1.2 2003-08-01 10:31:01 redflo Exp $
 *
...
class CatAdminTreeMaker extends TreeMaker
{
  ...
  function node_flipper_code($nodeinfo)
  {
    ...
    return '<td width="3%"><a class="catname" title="'.tra('child categories').': '.$nodeinfo["children"].', '.tra('objects in category').': '.$nodeinfo["objects"].'" id="flipper'.$this->itemID.'" href="javascript:flipWithSign(\''.$this->itemID.'\')">[+]</a></td>';
  }
  //
