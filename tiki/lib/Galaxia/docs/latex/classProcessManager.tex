...
References Observable::notify\_\-all().\index{ProcessManager@{Process\-Manager}!deactivate_process@{deactivate\_\-process}}
...
Referenced by remove\_\-process().\index{ProcessManager@{Process\-Manager}!get_process@{get\_\-process}}
...
References get\_\-process(), Observable::notify\_\-all(), and replace\_\-process().\index{ProcessManager@{Process\-Manager}!invalidate_process@{invalidate\_\-process}}
...
Definition at line 407 of file src/Process\-Manager/Process\-Manager.php.\index{ProcessManager@{Process\-Manager}!list_processes@{list\_\-processes}}
...
Definition at line 375 of file src/Process\-Manager/Process\-Manager.php.\index{ProcessManager@{Process\-Manager}!new_process_version@{new\_\-process\_\-version}}
...
Definition at line 353 of file src/Process\-Manager/Process\-Manager.php.\index{ProcessManager@{Process\-Manager}!remove_process@{remove\_\-process}}
...
References deactivate\_\-process(), and Observable::notify\_\-all().\index{ProcessManager@{Process\-Manager}!replace_process@{replace\_\-process}}
