...
class CASClient
{
  ...
  function getCallbackURL()
	...
	/* removed by Julien Marchal - v0.4.6
	 * if ( !empty($_SERVER['PHP_AUTH_USER']) ) {
	 *   $this->_callback_url .= $_SERVER['PHP_AUTH_USER'];
	 *   $this->_callback_url .= ':';
	 *   $this->_callback_url .= $_SERVER['PHP_AUTH_PW'];
	 *   $this->_callback_url .= '@';
	 * }
	 */
...
//          $this->_callback_url .= $_SERVER['SERVER_NAME'];
  ...
  function getURL()
	...
	/* removed by Julien Marchal - v0.4.6
	if ( !empty($_SERVER['PHP_AUTH_USER']) ) {
	  $this->_url .= $_SERVER['PHP_AUTH_USER'];
	  $this->_url .= ':';
	  $this->_url .= $_SERVER['PHP_AUTH_PW'];
	  $this->_url .= '@';
	}
	*/	
	/* replaced by Julien Marchal - v0.4.6
