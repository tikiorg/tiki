<?php
// $Header: /cvsroot/tikiwiki/tiki/lib/html2pdf/css.inc.php,v 1.1.1.1 2006-02-08 11:02:37 nikchankov Exp $
...
class CSSObject {
  ...
  function apply_pseudoelement($element_type, &$root) {
    $local_css = array();
...
class CSSProperty {
  ...
  function css($value) { $this->replace($this->parse($value)); }
  ...
  function push_css($value) { $this->push_default(); $this->css($value); }
