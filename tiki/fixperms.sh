#!/bin/sh
# $Header: /cvsroot/tikiwiki/tiki/fixperms.sh,v 1.5 2005-05-18 10:58:51 mose Exp $
...
DIRS="backups db dump img/wiki img/wiki_up modules/cache temp temp/cache templates_c templates styles maps whelp"
