...
"Create user if not in Auth?" => "Criar utilizadores se não estiver no PEAR::Auth?",
...
"Users can suggest new items" => "Utilizadores podem sugerir ítens",
"Auto validate user suggestions" => "Validades automaticamente sugestões de utilizadores",
...
"Users can vote again after" => "Utilizadores podem votar novamente",
...
"Allow other user to post in this blog" => "Permitir a outros utilizadores escrever neste blog",
