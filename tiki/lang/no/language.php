...
"Last galleries" => "Nyeste gallerier",
"My Pages" => "Mine sider",
...
"The page cannot be found" => "Siden kan ikke finnes",
"Page cannot be found" => "Siden kan ikke finnes",
...
"Permission denied you cannot rollback this page" => "Du har ikke rättighet att ändra tilbaka til tidigare version av denna sida",
...
"Permission denied you cannot access this gallery" => "Du har ikke rettigheter til å aksessere dette galleriet",
...
"Permission denied you cannot remove images from this gallery" => "Du har ikke rettigheter til å ta bort bilder fra dette galleriet",
...
"Permission denied you cannot create or edit blogs" => "Du har inte rättighet att skapa eller redigera blogger",
...
"Home Blog (main blog)" => "Hemblog (hovedblog)",
...
"Last Modified blogs" => "Sist endrede blogger",
"Last Created blogs" => "Nyeste blogger",
...
"Com" => "Komentar",
"Vers" => "Version",
"Create or edit content" => "Lage eller endre innhold",
"position" => "posisjon",
...
"Create/edit Forums" => "Lage/endre fora",
...
"Prevent flooding" => "Förhindre oversvømmelse",
...
"Default ordering for threads" => "Forvalgt sortering av tråder",
...
"Prune unreplied messages after" => "Slette ubesvarte meldinger etter",
"Prune old messages after" => "Slette gamle meldinger etter",
"Save" => "Lagre",
"topics" => "emner",
"coms" => "kommentarer",
"age" => "alder",
"ppd" => "rettighetsbegrensning",
"last post" => "nyeste innlegg",
"perms" => "rettigheter",
"forums" => "forum",
"Assign permissions to group" => "Tildel rettigheter til gruppe",
...
"Image galleries comments settings" => "Kommentarinnstillinger i billedgallerier",
...
"Poll comments settings" => "Kommentarinnstilling for avstemninger",
"image galleries" => "bildgallerier",//perhaps not used
"Blog settings" => "Blogg innstillinger",
"Blog comments settings" => "Kommentarinnstillinger for blogger",
"general" => "generelt",//perhaps not used
"Forums settings" => "Innstillinger for forum",
"Home Forum (main forum)" => "Hjemmeforum (hovedforum)",
"Set home forum" => "Sett hjemmeforum",
"Ordering for forums in the forum listing" => "Sortering av forum i forumliste",
"Creation Date (desc)" => "Oppretelsesdato (fallende)",
"Topics (desc)" => "Emne (fallende)",
"Threads (desc)" => "Tråder (fallende)",
"Visits (desc)" => "Besøk (fallende)",
...
"Feed for Weblogs" => "Matning til Weblogs",
...
"use poll" => "bruk avstemning",
"Dynamic content blocks" => "Dynamiske innholdsblokk",
...
"Create/edit channel" => "Lage/endre kanal",
"Active" => "Aktiv",
...
"Content for the feed" => "Innholl for mating",
"Create/edit RSS module" => "Lage/endre RSS modul",
"minute" => "minutt",
"minutes" => "minutter",
"hour" => "time",
"hours" => "timer",
...
"Home Page" => "Hjemside",
"Home Blog" => "Hjemblogg",
"Home Image Gal" => "Hjembilledgalleri",
"Home Image Gallery" => "Hjembilledgalleri",
"Home File Gal" => "Hjemfilgalleri",
"Home File Gallery" => "Hjemfilgalleri",
"User preferences" => "Bruker innstillinger",
"User prefs" => "Bruker innstillinger",
"Wiki Home" => "Wiki Hjemside",
"List image galleries" => "List billedgalleri",
"Gallery Rankings" => "Rangordning av gallerier",
"Browse a gallery" => "Bläddra i ett galleri",
"Articles home" => "Artikkelhjemside",
"All articles" => "Alle artikler",
"Submit" => "Skicka in",
"List Blogs" => "Blogg liste",
"Create blog" => "Lage blogg",
"View a forum" => "Vise ett forum",
"View a thread" => "Vise en tråd",
"Create/edit Polls" => "Lage/endre avstemning",
"current" => "aktuell",
"closed" => "stengt",
"votes" => "stemmer",
"Publish" => "Publisere",
"List polls" => "Vis avstemninger",
"Edit this poll" => "Redigere avstemning",
"Preview poll" => "Vise avstemninger",
...
"Blog Posts" => "Blogg innlegg",
"chat" => "chat",
"categories" => "kategorier",
"received pages" => "mottatte sider",
"Menus" => "Menyer",
"Admin chat" => "Administrera chat",//perhaps not used
"Admin forums" => "Administrere forum",
"Templates" => "Maler",
"Random Pages" => "Tilfeldig sider",
"Last blog posts" => "Nyeste blogg innlegg",
"Last forum topics" => "Siste emne i forum",
"Most read topics" => "Mest leste emne",
"Top topics" => "Populäraste ämnen",
"Most visited forums" => "Mest besøkte forum",
...
"Fatal error" => "Fatalt feil",
"This feature has been disabled" => "Denne funksjonen er ikke aktivert",
"No forum indicated" => "Ingen forum valgt",
...
"Generate a password" => "Generer passord",
"faqs" => "faq'er",
...
"External links" => "Eksterne linker",
...
"Games" => "Spel",
"Validate users by email" => "Validere brukere via e-post",
...
"Feed for forums" => "Matning til forum",
"Feed for individual forums" => "Matning til personlige forum",
"User Bookmarks" => "Brukerbokmerker",
...
"Use (:name:) for smileys" => "Bruk (:navn:) til smilefjes",
"Admin cookies" => "Administrere cookies",
"Create/edit cookies" => "Lage/endre cookies",
"Cookie" => "Cookie",
...
"View FAQ" => "Visa FAQ",
"Edit this FAQ" => "Redigere denne FAQ",
...
"Return to HomePage" => "Tilbake til HjemmeSiden",
...
"Average pageviews per day" => "Genomsnittligt antall sidvisningar per dag",
"Best day" => "Bedste dag",
"Worst day" => "Verste dag",
"Show chart for the last " => "Vise graf for de siste ",
...
"Average threads per topic" => "Genomsnittligt antall tråder per emne",
"Visits to forums" => "Antall besøk i forum",
"Blog Stats" => "Blogg statistikk",
"Weblogs" => "Weblogs",
...
"No pages indicated" => "Ingen side er valgt",
"You must log in to use this feature" => "Du må væra innloget for å bruke denne funksjon",
"No url indicated" => "Ingen URL er valgt",
"The thumbnail name must be" => "Indeksbildets navn må være",
"Passcode to register (not your user password)" => "Adgangskode (ikke passordet ditt)",
"Link type" => "Länk typ",
...
"size" => "størrelse",
"dls" => "dls",
"No attachments for this page" => "Ingen vedlegg tildenne sida",//perhaps not used
"attach" => "vedlegg",
...
"Count admin pageviews" => "Telle administrators sidevisninger",
...
"Creation date (desc)" => "Skapelsedato (fallende)",
"Last modification date (desc)" => "Senast endret (fallende)",
"Blog title (asc)" => "Blogg tittel (stigende)",
...
"Stats for a Quiz" => "Statistikk for en frågesport",
"list quizzes" => "Frågesportslista",
"quiz stats" => "Frågesportsstatistik",
"admin quizzes" => "admininistrere frågesporter",
"Create/edit quizzes" => "Lage/endre frågesporter",
...
"Av score" => "Medelpoäng",
"Av time" => "Medeltid",
"Stats for quiz" => "statistikk for frågesporter",
...
"Quiz result stats" => "Statistikk på frågesportsresultat",
"Time" => "Tid",
...
"Admin templates" => "Administrere maler",
"Create/edit templates" => "Lage/endre maler",
...
"Quiz Stats" => "Frågesports statistikk",
"Average questions per quiz" => "Genomsnittligt antall frågor per frågesport",
...
"List Quizzes" => "Frågesportslista",
"Last Created Quizzes" => "Nyeste quiz",
...
"Wrong passcode you need to know the passcode to register in this site" => "Feil adgangskode. Du må kjenne til anmälningskoden for å kunne registerar dig på denna hemsida",
"No quiz indicated" => "Ingen frågesport vald",
"You cannot take this quiz twice" => "Du kan ikke delta i denne frågesport to ganger",
...
"Permission denied you cannot edit images" => "Du har ikke tilgang til å redigere bilder",
...
"Use challenge/response authentication" => "Bruk challenge/response autentifikation",
"Force to use chars and nums in passwords" => "Krev at passord inneholder siffer og bokstaver",
"Minimum password length" => "Minimum passord lengde",
"Password invalid after days" => "Lösenordet ogiltigt efter dagar",
"Require HTTP Basic authentication" => "Krev HTTP grundläggande autentifikation",
"Allow secure (https) login" => "Tillat säkra (https) inlogningar",
"Require secure (https) login" => "Krev säkra (https) inlogningar",
...
"There are individual permissions set for this newsletter" => "Det finns indevuduella rättigheter for dette nyhetsbrev",
"Users can subscribe any email addresss" => "Bruker kan benytte valgfri e-postadresse for prenumerationen",
"Frequency" => "Frekvens",
"editions" => "utgaver",
"last sent" => "senast skickad",
"subscriptions" => "prenumerationer",
"Structures" => "Strukturer",
"Create new structure" => "Lag ny struktur",
"Structure" => "Struktur",
"List surveys" => "Lista undersökningar",
"survey stats" => "undersökningsstatistik",
"this survey stats" => "denne undersöknings statistikk",
"edit this survey" => "redigere denne undersökning",
"admin surveys" => "administrere undersökningar",
...
"list surveys" => "liste undersökningar",
"Create/edit surveys" => "Skapa/redigera undersökningar",
"There are individual permissions set for this survey" => "Det finns individuella rättigheter för denne undersökning",
"open" => "åpne",
"status" => "status",
"List trackers" => "Liste spårhundar",
"Admin trackers" => "Administrere spårhundar",
"Edit this tracker" => "Redigera denne spårhunden",
"View this tracker items" => "Vise denne spårhunds poster",
"Edit tracker fields" => "Redigere spårhundens poster",
"checkbox" => "kryssrute",
...
"Show creation date when listing tracker items?" => "Vise opprettelsesdato ved listning av spårhundsposter?",
...
"Upload picture" => "Legg inn bile",
"Import pages from a PHPWiki Dump" => "Importere sider fra en PHPWiki avbild",
...
"sites from the directory" => "sajter fra mappen",
"Users have searched" => "Bruker har søkt",
"times from the directory" => "gånger från mappen",
"Admin sites" => "Administrera sajter",
"Admin category relationships" => "Administrere kategoriberoenden",
"Validate links" => "Validera länkar",
"Settings" => "Innstillinger",
"Admin directory categories" => "Administrere kart kategorier",
"Parent category" => "Faderkattegori",
"Add or edit a category" => "Legg til eller redigere en kategori",
"Children type" => "Barntype",
...
"Allow sites in this category" => "Tillat sajter i denna kategori",
...
"editor" => "redaktør",
"relate" => "relatera",
"Wiki Import dump" => "Wiki Importer dump",
"phpinfo" => "phpinfo",
...
"No newsletter indicated" => "Ingen nyhetsbrev valgt",
"No survey indicated" => "Ingen undersökning valgt",
"No tracker indicated" => "Ingen spårhund valgt",
...
"Use database for translation" => "Bruk database for oversettelser",
...
"Links per page" => "Linker per side",
...
"Left Modules" => "Venstre moduler",
"Right Modules" => "Høyre moduler",
"Edit/Create user module" => "Lage/endre bruker module",
...
"Create level" => "Lag nivå",
"all permissions in level" => "alle rettigheter i nivå",
"update" => "oppdater",
...
"hist" => "treff",
"Create banner" => "Lage banner",
"edit blog" => "endre blogg",
...
"Pick avatar from the library" => "Velg avatar fra utvalg",
...
"private message" => "private meldinger",
"Tasks" => "Oppgaver",
...
"User Galleries" => "Bruker gallerier",
...
"Notes" => "Notater",
"quota" => "quota",
"Write a note" => "Skrive notat",
"Reading note:" => "Reading note:",
"List notes" => "List notater",
...
"All ephemerides" => "Alle ephemerides",
...
"extwiki" => "extwiki",
"Admin dsn" => "Admin dsn",
"Create/edit dsn" => "Lage/endre dsn",
"dsn" => "dsn",
...
"Use single spaces to indent structure levels" => "Bruk enkelt mellomrom for å indikere struktur nivå",
"tree" => "tre",
...
"Link to user information" => "Link til bruker informasjon",
...
"Accept wiki syntax" => "Godta wiki syntax",
"Forum quick jumps" => "Forum quick jumps",
"Forum listing configuration" => "Forumliste konfigurasjon",
...
"Sections" => "Seksjoner",
"Authentication method" => "Autentiserings metode",
"Just Tiki" => "Bare Tiki",
...
"Create/edit Calendars" => "Lage/endre kalender",
...
"Show description" => "Vise beskrivelse",
"Moderator user" => "Moderator",
"Moderator group" => "Moderator gruppe",
"Password protected" => "Passord beskyttet",
"Topics only" => "Topics only",
"All posts" => "All posts",
"Forum password" => "Forum passord",
...
"Added users" => "Registrert bruker",
"Rejected users" => "Avvist bruker",
"Reason" => "Reason",
"Number of displayed rows" => "Antall viste linjer",
"Workflow" => "Workflow",
"ExtWikis" => "ExtWikis",
...
"save and exit" => "lagre og avslutte",
"rotate" => "rotate",
"popup" => "popup",
...
"Edit or create banners" => "Lage/endre banner",
"List banners" => "List banner",
...
"Allow search" => "Tillate søk",
"Allow comments" => "Tillate komentarer",
"Blog heading" => "Blogg heading",
...
"List of messages" => "Liste av meldinger",
"new topic" => "new topic",
...
"Previous page" => "Previous page",
"Next page" => "Neste side",
"Last page" => "Silte side",
"create new blog" => "lage ny blogg",
...
"merge selected notes into" => "Slå sammen valgte notater til",
...
"Folders" => "Mapper",
"remove folder" => "slette mappe",
"remove bookmark" => "slett bokmerke",
"refresh cache" => "refresh cache",
"Admin folders and bookmarks" => "Admin mapper og bokmerker",
"Is email public? (uses scrambling to prevent spam)" => "Offentlig epost (bruker scrambling for å unngå spam)",
"Edit CSS" => "Endre CSS",
"No tasks entered" => "Ingen oppgaver gitt",
"Watches" => "Watches",
"RSS feed" => "RSS feed",
"Edit blog" => "Endre blog",
...
"Message will be sent to: " => "Meldingen vil bli sendt til: ",
...
"created from import" => "laget fra import",
...
"created from notepad" => "laget med notisblokk",
"Wrong registration code" => "Feil adgangs kode",
...
"Blogs last posts" => "Bloggens siste innlegg",
"Post date" => "Post date",
