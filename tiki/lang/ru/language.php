...
"Create/edit cookies" => "Создать/редактировать cookies",
"Cookie" => "Cookie",
...
Все таблицы будут заменены информацией из резервной копии",//perhaps not used
...
в вашем php.ini файле",//perhaps not used
...
"Show chart for the last " => "Показать чарт за последние ",
...
"Admin Cookies" => "Настройка Cookies",//perhaps not used
...
"Toggle display of comment zone" => "Включить отображение комментариев", //probably unused now
...
"Banned from sections" => "Закрыть доступ в разделы",
...
"lang" => "язык",
"prio" => "приор.",
"Admin chart items" => "Настроить пункты чарта",
"charts" => "чарты",
"edit chart" => "редактировать чарт",
"Chart items" => "Пункты чарта",
"No items defined yet" => "Элементы пока не определены",
...
"Subscriptions" => "Подписки",
"Destroy the structure leaving the wiki pages" => "Разрушать структуру оставляя страницы wiki",
"Destroy the structure and remove the pages" => "Разрушать структуру и удалять страницы",
"export pages" => "экспортировать странички",
"dump tree" => "дапм дерева",
"stat" => "стат.",
...
"Select Wiki Pages" => "Выберите странички Wiki",
"reset" => "сброс",
...
"Edit Style Sheet" => "Редактировать CSS стиль",
