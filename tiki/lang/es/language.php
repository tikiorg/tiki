...
"e-mail" => "correo",
"E-Mail address options: 0,1 or 2, 0 shows the address as a normal text field. 1 Does an obfuscated mailto: link when viewing item. 2 Does a normal href mailto: when viewing items." => "Opciones de dirección de correo: 0,1 o 2, 0 muesrta la dirección como campo normal de texto, 1 muestra un link mailto: ofuscado cuando se ve el ítem y 2 hace un href mailto: normal cuando se ven ítems.",
...
"Tip" => "Consejo",
"to add/remove FAQs, look for \"Admin FAQs\" under \"FAQs\" on the left menu, or" => "para añadir/borrar FAQs, busque \"Admin FAQs\" bajo \"FAQs\" en el menú izquierdo o",
...
"to configure your directory, find \"Admin directory\" under \"Directory\" on the left menu, or" => "para configurar su directorio, encuentre \"Admin directorio\" bajo \"Directorio\" en el menú de la izquierda, o",
"Tracker Items" => "Ítems de Tracker",
"v=view, b=rollback, c=compare with current, d=diff to current, s=source" => "v=ver, b=rollback, c=comparar con actual, d=dif. con actual, s=fuente",
...
"{literal}{MODULE(module=>some_module)}text{MODULE}{/literal}  can be used to insert the output of module \"some_module\" into your Wiki page. See <a href=\"http://tikiwiki.org/tiki-index.php?page=PluginModule\">PluginModule</a> for more information. " => "{literal}{MODULE(module=>algun_modulo)}text{MODULE}{/literal}  puede ser usado para insertar la salida del módulo \"algun_module\" en su página Wiki. Vea <a href=\"http://tikiwiki.org/tiki-index.php?page=PluginModule\">PluginModule</a> para mas información. ",
"Rendering Program Code" => "Muestra Código de Programa",
"{literal}{CODE()}some code{CODE} {/literal} will render \"some code\" as program code. This plugin has other options; see <a href=\"http://tikiwiki.org/tiki-index.php?page=PluginCode\">PluginCode</a>." => "{literal}{CODE()}algún código{CODE} {/literal} mostrará \"algún código\" como código de programa. Este plugin tiene otras opciones, vea <a href=\"http://tikiwiki.org/tiki-index.php?page=PluginCode\">PluginCode</a>.",
"Direction" => "Dirección",
"{literal}{maketoc}{/literal}\" prints out a table of contents for the current page based on ! headings," => "{literal}{maketoc}{/literal}\" imprime una tabla de contenido para la página actual basado en los encabezados con !,",
"Import/export trackers fields" => "Importar/exportar campos de trackers",
"Community" => "Comunidad",
"look under \"Articles\" on the left menu for links to" => "vea bajo \"Artículos\" en el menú de la izquierda para enlaces a",
...
"Warn on edit conflict" => "Advierte por conflicto en edición",
"Edit idle timeout" => "Editar límite de tiempo de espera",
...
"to add/remove blogs, go to \"Create/Edit blog\" under \"Blogs\" on the left menu, or" => "para añadir/borrar blogs, vaya a \"Crear/Editar blog\" bajo \"Blogs\" en el menú de la izquierda, o",
...
"Group Homepage" => "Página Inicial de Grupo",
...
"semester" => "semestre",
"year" => "año",
"to configure your trackers, look for \"Admin trackers\" under \"Trackers\" on the left menu, or" => "para configurar sus trackers, busque \"Admin trackers\" bajo \"Trackers\" en el menú de la izquierda, o",
...
"This page is to configure settings of RSS feeds generated/exported by Tiki. To read/import RSS feeds, look for \"RSS modules\" on the left menu, or" => "Esta página es para configurar opciones de los feeds RSS generados/exportados por Tiki. Para leer/importar. To read/import RSS feeds, busque \"RSS modules\" en el menú de la izquierda, o",
"Posted replies" => "Respuestas posteadas",
"Plain" => "Plano",
"Threaded" => "Threaded",
"Headers Only" => "Sólo Cabezales",
"Replies below your current threshold" => "Respuestas debajo su umbral actual",
...
"to add/remove file galleries, go to \"File Galleries\" on the left menu, or" => "para añadir/borrar galerías de archivos, vaya a \"Galerías de Archivos\" en el menú de la izquierda, o",
...
"to add/remove forums, look for \"Admin forums\" under \"Forums\" on the left menu, or" => "para añadir/borrar foros, busque \"Admin foros\" bajo \"Foros\" en el menú de la izquierda, o",
...
"to add/remove image galleries, go to \"Image Galleries\" on the left menu, or" => "para añadir/borrar galerías de imágenes, vaya a \"Galerías de Imágenes\" en el menú de la izquierda, o",
...
"This user is not your friend" => "Este usuario no es su amigo",
"Request friendship" => "Requerir amistad",
...
"name of wiki page" => "nombre de la página wiki",
"Help URL" => "URL de Ayuda",
"Korean" => "Koreano",
...
"A password reminder email has been sent " => "Un correo recordatorio de contraseña fue enviado ",
"A new password has been sent " => "Una nueva contraseña ha sido enviada ",
...
"author" => "autor",
"Threads can be voted" => "Los mensajes pueden ser votados",
...
"add" => "añadir",
"Delete item from category?" => "Borrar ítem de categoría?",
...
"Click here to unassign this module" => "Cliquee aquí para inhabilitar este módulo",
...
"admin featured links tpl" => "admin enlaces destacados tpl",
...
"admin hotwords" => "admin palabras clave",
"admin hotwords tpl" => "admin palabras clave tpl",
...
"private" => "privado",
"public" => "público",
"Use dbl click to edit pages" => "Use dbl clic para editar páginas",
"Change your email" => "Cambie su correo",
...
"Number of displayed rows" => "Número de filas mostradas",
"Never" => "Nunca",
"Assign Group (Active)" => "Asignar Grupo (Activo)",
"Assign Group" => "Asignar Grupo",
