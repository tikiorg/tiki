...
"Links/Commands" => "Links/Comandi",//perhaps not used
...
"create tag" => "crea tag",//perhaps not used
"Restore the wiki" => "Restore del wiki",
"restore" => "restore",
"Tag Name" => "Nome Tag",
"remove" => "elimina",
"Anonymous users can edit pages" => "Utenti anonimi possono editare pagine",//perhaps not used
...
"References" => "Riferimenti",//perhaps not used
"JoinCapitalizedWords" => "UnisciParoleConMaiuscole",//perhaps not used
"or use square brackets for an" => "o usa parentesi quadre per un",//perhaps not used
...
"Title_bar" => "Barra_titolo",//perhaps not used
"title" => "titolo",
...
"Links" => "Links",
"Size" => "Dimensione",
"printable" => "stampa",//perhaps not used
"edit" => "modifica",
"remove page" => "elimina",
"unlock" => "sblocca",
"lock" => "blocca",
...
"history" => "versioni",
"backlinks" => "backlinks",
"like pages" => "pagine simili",//perhaps not used
"History of" => "Versioni di",//perhaps not used
...
"pages" => "pagine",
"Top" => "Primi",
"All pages" => "Tutte le pagine",//perhaps not used
...
"Rollback_page" => "Rollback pagina",//perhaps not used
...
"Browse" => "Visita",
"changed" => "modificato",
"versions" => "versioni",//perhaps not used
"Current permissions for this page" => "Permessi correnti per questa pagina",
"Perm" => "Perm",//perhaps not used
"No individual permissions global permissions to all pages apply" => "Nessun permesso individuale, si applicano i permessi globali",//perhaps not used
"Assign permissions to thispage" => "Assegna permessi a questa pagina",//perhaps not used
"Cache" => "Cache",
"URL" => "URL",
...
"last changes" => "ultime modifiche",
"dump" => "dump",
"ranking" => "classifica",//perhaps not used
"list_pages" => "elenca pagine",//perhaps not used
"my galleries" => "le mie gallerie",//perhaps not used
...
"system gallery" => "galleria di sistema",//perhaps not used
...
"Blogs" => "Blogs",
"Last Modified" => "Ultima Modifica",
"Public" => "Pubblico",//perhaps not used
"Posts" => "Post",
"Visits" => "Visite",
"Activity" => "Attività",
"Post" => "Post",
...
la pagina non viene memorizzata.",//perhaps not used
...
"sandbox" => "sandbox",
"user preferences" => "preferenze utente",//perhaps not used
...
"Current version" => "Versione corrente",//perhaps not used
"Next version" => "Prossima versione",//perhaps not used
"Programmed versions" => "Versione programmata",//perhaps not used
"Old versions" => "Versioni precedenti",//perhaps not used
"Edit desc" => "Modifica desc",//perhaps not used
"Program" => "Programma",
"Wiki" => "Wiki",
...
">Block description: " => ">Descrizione del blocco: ",//perhaps not used
...
"Admin content" => "Amministrazione contenuti",//perhaps not used
...
"comments" => "commenti",
"Show comments" => "Mostra commenti",//perhaps not used
"Hide comments" => "Nascondi commenti",//perhaps not used
...
"Cannot get file from URL" => "Non posso scaricare il file dalla URL",//perhaps not used
...
"You cant download files" => "Non puoi scaricare files",//perhaps not used
"No file" => "No file",//perhaps not used
...
"Moderator" => "Moderatore",//perhaps not used
...
"There are inddividual permissions set for this gallery" => "Questa gallera ha permessi individuali definiti",//perhaps not used
...
"There are inddividual permissions set for this blog" => "Questo blog ha permessi individuali specificati",//perhaps not used
...
"Layout options" => "Opzioni di layout",//perhaps not used
...
"Name (desc)" => "Nome (disc)",
"Name (asc)" => "Nome (asc)",
"file galleries" => "gallerie di file",//perhaps not used
...
"Smileys" => "Smileys",
"There are inddividual permissions set for this file gallery" => "Questa galleria di file ha permessi individuali specificati",//perhaps not used
...
"Menus" => "Menu",
"Admin chat" => "Amministrazione chat",//perhaps not used
...
"Permission denied you cant view this section" => "Permesso negato, non puoi vedere questa sezione",//perhaps not used
...
"Img" => "Img",
"deep" => "in profondità",
"Allowed HTML:" => "HTML permesso:",//perhaps not used
"undo" => "annulla",
...
"Configure modules" => "Configura moduli",//perhaps not used
"Number of visited pages to remember" => "Pagine visitate da ricordare",
"to insert a random tagline" => "per inserire una frase casuale",//perhaps not used
...
Tutte le tabelle saranno rimpiazzate con le informazioni nel backup.",//perhaps not used
...
In questo caso è necessario aumentare il massimo tempo di esecuzione dello script in php.ini",//perhaps not used
...
"print" => "stampa",
">I forgot my password" => ">Ho dimenticato la password",//perhaps not used
...
"column" => "colonna",//perhaps not used
"Assign module" => "Assegna modulo",
"Module" => "Modulo",
"Column" => "Colonna",
...
"dispay" => "mostra",//perhaps not used
...
"user bookmarks" => "Numero totale bookmark",//perhaps not used
"stats" => "statistiche",
"games" => "giochi",
"orphan pages" => "pagine orfane",
"Backups" => "Backup",
"Admin FAQs" => "Amministrazione FAQ",
"Admin Cookies" => "Amministrazione Cookie",//perhaps not used
...
"size" => "dimensione",
"dls" => "dls",
"No attachments for this page" => "Nessun allegato a questa pagina",//perhaps not used
"attach" => "allega",
"Entire site" => "Sito completo",//perhaps not used
"Quizzes" => "Quiz",
"content templates" => "Template contenuti",//perhaps not used
"shoutbox" => "Shoutbox",//perhaps not used
"drawings" => "Disegni",//perhaps not used
"HTML pages" => "Pagine HTML",
"assigned" => "assegnato",//perhaps not used
...
"suggested" => "proposte",//perhaps not used
"underline" => "sottolinea",
"table" => "tabella",
"wiki link" => "link wiki",
"heading1" => "titolo1",
"heading2" => "titolo2",//perhaps not used
"heading3" => "titolo3",//perhaps not used
...
"Edit this HTML page" => "Modifica questa pagina HTML",//perhaps not used
...
"Export" => "Esporta",
"feat" => "cart",//perhaps not used
"file gls" => "gal file",//perhaps not used
"gral" => "gen",//perhaps not used
"Blog level comments" => "Commenti a livello di Blog",
"Post level comments" => "Commenti a livello di post",
"img gls" => "gal img",//perhaps not used
"frms" => "forum",//perhaps not used
"Trackers" => "Trackers",
...
"There are inddividual permissions set for this tracker" => "Esistono permessi individuali per questo tracker",//perhaps not used
...
"Path to where the dumped files are" => "Path ai file di dump",//perhaps not used
...
Nessuna newsletters verrà inviata prima della conferma della richiesta di abbonamento.",//perhaps not used
...
"You cant use the same password again" => "Non puoi usare di nuovo la stessa password",//perhaps not used
...
"You have to provide a name to the file" => "Devi specificare un nome per il file",//perhaps not used
...
"parent" => "padre",
"directory" => "directory",
"userfiles" => "file utente",//perhaps not used
"Directory" => "Directory",
...
"Users can save pages to notepad" => "Utenti possono saltare pagine nel blocco note",//perhaps not used
...
"Forum settings" => "Preferenze Forum",//perhaps not used
"Allow wiki markup" => "Consenti markup wiki",//perhaps not used
"Describe topics in listing" => "Descrivi topics nell'elenco",//perhaps not used
"Allow viewing HTML mails" => "Permetti la lettura di mail HTML",//perhaps not used
"Unlimited" => "Illimitato",//perhaps not used
...
"Edit drawings &amp; pictures" => "Modifica disegni e foto",//perhaps not used
...
"rotate left" => "ruota a sinistra",//perhaps not used
...
"Received Articles" => "Articoli ricevuti",
"Received pages" => "Pagine ricevute",
"wiki pages" => "pagine wiki",//perhaps not used
"Relevance" => "Rilevanza",
