...
// "your having onl view rights" => "your having onl view rights",
// "move to trash" => "move to trash",
// "reload" => "reload",
// "Histroy" => "Histroy",
// "show version" => "show version",
// "update all percents" => "update all percents",
// "move marked to trash" => "move marked to trash",
// "remove marked to trash" => "remove marked to trash",
// "complete marked" => "complete marked",
// "show:" => "show:",
// "received" => "received",
// "submitted" => "submitted",
// "shared" => "shared",
...
// "The tile must have at lease three characters!" => "The tile must have at lease three characters!",
// "The end date must be after the start date!" => "The end date must be after the start date!",
// "Sorry the task user has no right to recive tasks" => "Sorry the task user has no right to recive tasks",
// "Sorry the creator has no right to send tasks" => "Sorry the creator has no right to send tasks",
