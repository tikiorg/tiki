...
// "To include groups the feature \"Use group homepages\" must be enabled on <a href=\"tiki-admin.php?page=general\">Admin->General</a>" => "To include groups the feature \"Use group homepages\" must be enabled on <a href=\"tiki-admin.php?page=general\">Admin->General</a>",
...
// "There are currently changes that have yet to be synchronized." => "There are currently changes that have yet to be synchronized.",
...
// "There are currently changes in the staging copy that have yet to be synchronized." => "There are currently changes in the staging copy that have yet to be synchronized.",
...
"Newsletter:" => "Comunicado:",
"Bye bye from %s at %s" => "Tchau de %s às %s",
...
"Prevents wiki parsing of the enclosed data." => "Não interpreta o código que estiver entre essa tag.",
...
"Add scaled images with bounding box of square size" => "Adicionar escala para a imagem",
