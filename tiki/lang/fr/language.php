...
"Default number of rows (forum replies)" => "Nombre de lignes par défaut (réponse de forum)",
"WARNING : Old and New trackers cannot coexist. Trackers created with new library will not work with old library and conversely" => "ATTENTION : Les anciens et mes nouveaux formulaires ne peuvent pas cohabiter. Les formulaires créés avec la nouvelle librairie ne fonctionneront pas avec l'ancienne et vice-versa",
...
"But still create line breaks within paragraphs" => "Créé cependant toujours des sauts de lignes à l'intérieur des paragraphes",
...
"World writable files or directories" => "iFichiers ou répertoires modifiables par tout le monde",
"Files or directories the Webserver can write to" => "Fichierss ou répertoires dans lesquels le serveur Web peut écrire",
"Strange Inodes (not file, not link, not directory)" => "Inodes Etrancges (pas fichier, pas lien, pas répertoire)",
"Executable files" => "Files exécutables",
...
"The following pages are in categories that the structure is not in. You may wish to recategorize them in order to be consistent:" => "Les pages suivantes sont dans des catégories dans laquelle ne se trouve pas la structure. Pour assurer la consistance, vous pourriez vouloir les recatégoriser :",
