...
"Compose Message" => "Composer un message",
"compose message tpl" => "composer un tpl de message",
...
"Show Babelfish Translation Logo" => "Afficher le logo de translataion Babelfish",
...
"admin banning tpl" => "administrer le tpl des bannières",
"admin categories" => "administrer les catégories",
"admin categories tpl" => "administrer le tpl des catégories",
"admin charts tpl" => "administrer le tpl des graphiques",
"ChatAdmin" => "Administrer les discussions",
"ChatAdmin tpl" => "Administrer le tpl des discussions",
"admin content templates" => "administer les gabarits de contenu",
"admin content templates tpl" => "administer le tpl des gabarits de contenu",
"admin FortuneCookie" => "administrer les FortuneCookies",
"admin FortuneCookie tpl" => "administrer le tpl des FortuneCookies",
"admin Drawings" => "administrer les dessins",
"admin Drawings tpl" => "administrer le tpl des dessins",
"AdminDSN" => "Administrer les DSNs",
"tiki-admin_dsn tpl" => "tiki-admin_dsn tpl",
"admin ExternalWiki" => "administrer les ExternalWiki",
"tiki admin external wikis tpl" => "tiki admin external wikis tpl",
"Create/Edit External Wiki" => "Create/Edit External Wiki",
"External Wiki" => "External Wiki",//##close: External wikis=>Wikis externes
"admin forums tpl" => "admin forums tpl",
"admin hotwords" => "admin hotwords",//##close: Admin Hotwords=>Administrer les mot/liens automatiques
"admin hotwords tpl" => "admin hotwords tpl",
"aAdmin HTML page dynamic zones" => "aAdmin HTML page dynamic zones",//##close: Admin HTML page dynamic zones=>Administrer les zones dynamiques d'une page HTML
...
"dynamic collapsed" => "dynamic collapsed",//##close: dynamic colapsed=>sous-menus non vus
"admin modules" => "admin modules",//##close: Admin Modules=>Administrer les modules
...
"admin newsletters tpl" => "admin newsletters tpl",//##close: admin newsletters=>Administrer les newsletters
"EMail notifications" => "EMail notifications",//##close: Mail notifications=>Notification par courrier
"admin Email Notifications" => "admin Email Notifications",
"admin notifications tpl" => "admin notifications tpl",
"admin polls" => "admin polls",//##close: Admin Polls=>Administrer les sondages
"admin polls tpl" => "admin polls tpl",
"admin RSS modules" => "admin RSS modules",//##close: Admin RSS modules=>Administrer les canaux de syndication RSS
"admin RSSmodules tpl" => "admin RSSmodules tpl",
"admin structures tpl" => "admin structures tpl",
"admin surveys tpl" => "admin surveys tpl",//##close: admin surveys=>administrer les enquêtes
"admin topics tpl" => "admin topics tpl",
"admin Trackers tpl" => "admin Trackers tpl",
"admin groups" => "admin groups",//##close: Admin groups=>Administrer les groupes
"admin groups tpl" => "admin groups tpl",
"Add new group" => "Add new group",//##close: Add New Group=>Ajouter un nouveau groupe
"admin users" => "admin users",//##close: Admin users=>Administrer les utilisateurs
"admin users tpl" => "admin users tpl",
"Edit Article" => "Edit Article",//##close: Edit article=>Modifier un article
...
"admin directory categories tpl" => "admin directory categories tpl",//##close: Admin directory categories=>Administrer les catégories des liens
...
"Validate Sites" => "Validate Sites",//##close: Validate sites=>Sites validés
"directory validate sites tpl" => "directory validate sites tpl",
"Article image" => "Article image",
"edit blog tpl" => "edit blog tpl",
"admin quizzes tpl" => "admin quizzes tpl",//##close: admin quizzes=>administrer les QCMs
"Edit Submissions" => "Edit Submissions",//##close: Last submissions=>Dernières publications
"edit submissions tpl" => "edit submissions tpl",
"EditTemplates" => "EditTemplates",//##close: Edit Templates=>Modifier les gabarits
...
"List Articles" => "List Articles",//##close: List articles=>Liste des articles
"list articles tpl" => "list articles tpl",//##close: list articles=>liste des articles
...
"Topic image" => "Topic image",//##close: topic image=>image du sujet
"received articles tpl" => "received articles tpl",//##close: Received articles=>Articles reçus
"Received Pages" => "Received Pages",//##close: Received pages=>Pages reçues
"received pages tpl" => "received pages tpl",//##close: received pages=>pages reçues
...
"Random Image" => "Random Image",//##close: Random Pages=>Pages aléatoires
"Search Stats" => "Search Stats",//##close: Search stats=>Statistiques des recherches
"search stats tpl" => "search stats tpl",
"Send Objects" => "Send Objects",//##close: Send objects=>Envoyer des objets
...
"ThemeControl" => "ThemeControl",//##close: Theme Control=>Contrôle des thèmes
...
"Image Gallery tpl" => "Image Gallery tpl",//##close: Image Gallery=>Galerie d'images
"Image ID" => "Image ID",
"Image ID thumb" => "Image ID thumb",
"User Assigned Modules" => "User Assigned Modules",//##close: User assigned modules=>Modules utilisateur
"User Assigned Modules tpl" => "User Assigned Modules tpl",
"User Bookmarks tpl" => "User Bookmarks tpl",//##close: User Bookmarks=>Signets utilisateur
"Folder in" => "Folder in",
"UserPreferences tpl" => "UserPreferences tpl",
"User Tasks tpl" => "User Tasks tpl",
"1 Comment" => "1 Comment",//##close: 1 comment=>1 commentaire
"view faq" => "view faq",
"view faq tpl" => "view faq tpl",
"Webmail Doc" => "Webmail Doc",
"Webmail Doc tpl" => "Webmail Doc tpl",
"Contact" => "Contact",//##close: Contacts=>Contacts
"flagged" => "flagged",//##close: Flagged=>Avec drapeau
"replied" => "replied",//##close: replies=>réponses
"clip" => "clip",
