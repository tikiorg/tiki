...
"No categories defined" => "Aucunes catégories définies",
"Change your email" => "Modifier votre courriel",
"change email" => "modifier votre courriel",
"change password" => "modifier votre mot de passe",
"IRC log" => "log IRC",
"Select" => "Choisir",
"Show All" => "Show All",
"Maximum Rows" => "Maximum Rows",
"Refresh Every" => "Rafraîchir après",
"Seconds" => "Secondes",
"Search File" => "Rechercher un fichier",
"Child categories" => "Sous-catégories",
"Invalid password.  You current password is required to change your email address." => "Mot de passe invalide Votre mot de passe est requis pour modifier votre courriel.",
