...
"There is an error in the plugin data" => "Il y a une erreur dans la requête passé au module d'extension(plugin)",
...
"Categories are disabled" => "Les categories sont désactivées",
...
"List of attached files" => "Liste des ficheirs joints",
...
"Click here to view the Google cache of the page instead." => "Cliquer ici pour voir à la palce le cache Google de la page.",
"Features state" => "Etat de la fonctionalité",
"features matched" => "fonctionalités trouvées",
"Watchlist" => "Watchlist",
"Insert the full category path for each category that this wiki page belongs to" => "Insérer l'arborescence complète de la catégorie pour chaque catégorie auquelle appartient cette page",
...
"Content Features" => "Fonctionalités contenu",
"Administration Features" => "Fonctionalités administrateur",
"User Features" => "Fonctionalités utilisateur",
...
"Edit this template:" => "Modifier ce template:",
...
"Create new Featured Link" => "Créer un novueau lien vedette",
"Edit this Menu:" => "Modifier ce menu:",
