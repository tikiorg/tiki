...
"Is files from repository can be cached" => "Is files from repository can be cached", // ## CLOSE: Can files from repository be cached=>Les fichiers du répertoire peuvent-ils être mis en antémémoire
...
// "Preview Results" => "Preview Results", // ## CLOSE: View Results=>Voir les résultats
// "Rules List" => "Rules List",
// "Regex" => "Regex",
// "Case" => "Case",
// "Create a group for each user <br />(with the same\nname as the user)" => "Create a group for each user <br />(with the same\nname as the user)", // ## CLOSE: Create a group for each user <br />(with the same name as the user)=>Créerun groupe pour chaque utilisateur <br />(avec le même nom que l'utilisateur)
...
// "Create/Edit QuickTags" => "Create/Edit QuickTags", // ## CLOSE: Create/edit quizzes=>Ajouter/modifier un QCM
// "label" => "label", // ## CLOSE: Label=>Etiquette
...
// "URL cannot be accessed: wrong URL or site is offline and cannot be added to the directory" => "URL cannot be accessed: wrong URL or site is offline and cannot be added to the directory", // ## CLOSE: URL cannot be accessed wrong URL or site is offline and cannot be added to the directory=>L'adresse Webb ne peut pas être accédée : mauvaise adresse Web ou site déconnecté. L'adresse Web ne peut pas être ajoutée au répertoire
