<?php
// $Header: /cvsroot/tikiwiki/tiki/tiki-wiki_rss.php,v 1.17 2003-10-09 21:13:13 ohertel Exp $
...
// --- object independend things: (TODO: clean up not yet finished)
...
$pagename = substr($urlarray["path"], strrpos($urlarray["path"], '/') + 1); // extract pagename

$home = httpPrefix().str_replace($pagename, $tikiIndex, $urlarray["path"]);
$img = httpPrefix().str_replace($pagename, "img/tiki.jpg", $urlarray["path"]); // TODO: make logo configurable
