...
// $Header: /cvsroot/tikiwiki/tiki/tiki-admin_charts.php,v 1.18 2007-10-12 07:55:23 nyloth Exp $
...
$items = $chartlib->list_charts($offset, $prefs['maxRecords'], $sort_mode, $find, $where);
