...
// $Header: /cvsroot/tikiwiki/tiki/tiki-admin_newsletters.php,v 1.18 2007-07-01 16:59:15 tombombadilom Exp $
...
if (isset($_REQUEST["save"])) {
	...
	$sid = $nllib->replace_newsletter($_REQUEST["nlId"], $_REQUEST["name"], $_REQUEST["description"], $_REQUEST["allowUserSub"], $_REQUEST["allowAnySub"], $_REQUEST["unsubMsg"], $_REQUEST["validateAddr"],$_REQUEST["allowTxt"],$_REQUEST["author"]);
	/*
	$cat_type='newsletter';
	$cat_objid = $sid;
