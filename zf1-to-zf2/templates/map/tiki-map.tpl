			...
			<tr>
				<td align="center" valign="middle">
					<div class="table-responsive">
						<table class="table">
								...
								<td align="center">
									...
									<div id="queryWindow" style="position:absolute; top:0px; left:0px; visibility:hidden; z-Index:100">
										...
										>
											...
											<img id="queryClose" src="img/icons/close.gif" height="13" width="13" alt="{tr}Scroll Up{/tr}" style="position:absolute; top:0px; left:257px">
											<img id="queryUp" src="img/icons/up.gif" height="8" width="10" alt="{tr}Scroll Up{/tr}" style="position:absolute; top:15px; left:257px">
											<img id="queryDown" src="img/icons/down.gif" height="8" width="10" alt="{tr}Scroll Down{/tr}" style="position:absolute; top:188px; left:257px">
											<script type="text/javascript">
							...
							<tr>
								<td><div id="resultBox">{$map_querymsg}</div></td>
							</tr>
						</table>
				...
				<td valign="top">
					<table class="table">
						...
						<tr>
							<td align="center" bgcolor="FFFFFF"><img id="leg" src="{$image_leg_url}" alt="{tr}Legend{/tr}" title="{tr}Legend{/tr}"></td>
						</tr>
						<tr>
							<td>
								<div class="separator">
									...
									<div class="table-responsive">
										<table class="table">
											<tr>
												...
												<th><b>{tr}On{/tr}</b></th>
												<th>
													<img src="img/icons/edit.gif" alt="{tr}Label{/tr}" title="{tr}Label{/tr}">
												</th>
												<th>
											...
											{section name=j loop=$my_layers}
												...
												{if $my_layers[j]->group neq ""}
													{if $my_layers[j]->group eq $unique_layer_group[j]}
														<tr>
															<td class="{if $smarty.section.i.index % 2}odd{else}even{/if}" colspan="5">
																<div class="separator">
																	{if $prefs.feature_menusfolderstyle eq 'y'}
																			...
																			{section name=i loop=$my_layers}
																				{if $my_layers[i]->group neq ""}
																					{if $my_layers[i]->group == $my_layers[j]->group}
																						<tr>
																							<td class="{if $smarty.section.i.index % 2}odd{else}even{/if}">
																								{tr}{$layer_wiki[i]}{/tr}
																							</td>
																							<td class="{if $smarty.section.i.index % 2}odd{else}even{/if}" width=20px>
															...
															{if $layer_download[j] eq "T"}
																<small>
																	<a href="tiki-map_download.phtml?mapfile={$mapfile}&amp;layer={$my_layers[j]->name}">
																		<img src="img/icons/disk.png" alt="{tr}Download{/tr}" title="{tr}Download{/tr}" width="16" height="16">
																	</a>
																</small>
															{/if}
														</td>
													</tr>
												{/if} {*end of if group not empty loop*}
