 ...
 *
 */
class OpenPGP_Zend_Mail extends Zend_Mime_Message
{
    /**#@+
     * @access protected
     */
    ...
    /**
     * @var OpenPGP_Zend_Mail_Transport_Abstract
     * @static
     */
     ...
     * @param  OpenPGP_Zend_Mail_Transport_Abstract $transport
     */
    public static function setDefaultTransport(OpenPGP_Zend_Mail_Transport_Abstract $transport)
    {
     ...
     * @return OpenPGP_Zend_Mail Implements fluent interface
    ...
    */
     ...
     *
     * @param string $headerName
     * @return OpenPGP_Zend_Mail Provides fluent inter
     */
    ...
    {
        if ($transport === null) {
            if (! self::$_defaultTransport instanceof OpenPGP_Zend_Mail_Transport_Abstract) {
                $transport = new OpenPGP_Zend_Mail_Transport_Sendmail();
            } else {
