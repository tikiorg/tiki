...
<form action="tiki-admin.php?page=rss" method="post">
	...
	<fieldset>
		<legend>{tr}{$crumbs[$crumb]->title}{/tr}{help crumb=$crumbs[$crumb]}</legend>
	...
	<fieldset>
		<legend>{tr}Defaults{/tr}
			<a href="http://blogs.law.harvard.edu/tech/rss#optionalChannelElements" target="tikihelp" class="tikihelp" title="{tr}Documentation:{/tr} RDF">{icon _id=help}</a></legend>
