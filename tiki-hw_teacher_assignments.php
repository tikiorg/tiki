...
// $Header: /cvsroot/tikiwiki/tiki/tiki-hw_teacher_assignments.php,v 1.7 2004-03-19 18:09:59 ggeller Exp $
...
//     link to tiki-hw_teacher_grading_queue.php?assignmentId=n
...
for ($i = 0; $i < $listassignments["cant"]; $i++) {
  ...
  $listassignments["data"][$i]["iGradingQueue"] = $homeworklib->hw_assignment_iGradingQue($listassignments["data"][$i]["assignmentId"]);
}
...
$smarty->assign('page',"Assignments");
