...
;
define = window.Aloha.define;document.write('<script data-gg-define="characterpicker/characterpicker-plugin" src="' + ALOHA_BASE_URL + 'plugins/common/characterpicker/lib/characterpicker-plugin.js"></script>');}());
