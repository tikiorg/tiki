...
define = window.Aloha.define;document.write('<script data-gg-define="dom-to-xhtml/dom-to-xhtml-plugin" src="' + ALOHA_BASE_URL + 'plugins/common/dom-to-xhtml/lib/dom-to-xhtml-plugin.js"></script>');}());
