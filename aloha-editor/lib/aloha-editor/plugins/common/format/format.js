...
;
;
define = window.Aloha.define;document.write('<script data-gg-define="format/nls/i18n" src="' + ALOHA_BASE_URL + 'plugins/common/format/nls/i18n.js"></script>');
;
define = window.Aloha.define;document.write('<script data-gg-define="format/format-plugin" src="' + ALOHA_BASE_URL + 'plugins/common/format/lib/format-plugin.js"></script>');}());
