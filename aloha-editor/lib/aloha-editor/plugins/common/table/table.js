...
;
;
define = window.Aloha.define;document.write('<script data-gg-define="table/nls/i18n" src="' + ALOHA_BASE_URL + 'plugins/common/table/nls/i18n.js"></script>');
;
define = window.Aloha.define;document.write('<script data-gg-define="table/table-create-layer" src="' + ALOHA_BASE_URL + 'plugins/common/table/lib/table-create-layer.js"></script>');
define = window.Aloha.define;document.write('<script data-gg-define="table/table-plugin-utils" src="' + ALOHA_BASE_URL + 'plugins/common/table/lib/table-plugin-utils.js"></script>');
