...
;
;
define = window.Aloha.define;document.write('<script data-gg-define="list/nls/i18n" src="' + ALOHA_BASE_URL + 'plugins/common/list/nls/i18n.js"></script>');
;
define = window.Aloha.define;document.write('<script data-gg-define="list/list-plugin" src="' + ALOHA_BASE_URL + 'plugins/common/list/lib/list-plugin.js"></script>');}());
