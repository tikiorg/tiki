...
;
;
define = window.Aloha.define;document.write('<script data-gg-define="linkbrowser/nls/i18n" src="' + ALOHA_BASE_URL + 'plugins/extra/linkbrowser/nls/i18n.js"></script>');
define = window.Aloha.define;document.write('<script data-gg-define="linkbrowser/linkbrowser-plugin" src="' + ALOHA_BASE_URL + 'plugins/extra/linkbrowser/lib/linkbrowser-plugin.js"></script>');}());
