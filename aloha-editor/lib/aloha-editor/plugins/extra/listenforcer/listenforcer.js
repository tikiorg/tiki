...
;
;
define = window.Aloha.define;document.write('<script data-gg-define="listenforcer/listenforcer-plugin" src="' + ALOHA_BASE_URL + 'plugins/extra/listenforcer/lib/listenforcer-plugin.js"></script>');}());
