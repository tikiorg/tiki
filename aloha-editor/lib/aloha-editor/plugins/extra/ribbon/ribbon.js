...
;
;
define = window.Aloha.define;document.write('<script data-gg-define="ribbon/ribbon-plugin" src="' + ALOHA_BASE_URL + 'plugins/extra/ribbon/lib/ribbon-plugin.js"></script>');}());
