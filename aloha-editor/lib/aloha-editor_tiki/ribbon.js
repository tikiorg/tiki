Aloha.ready(function(){
    Aloha.require(["ribbon/ribbon-plugin", "ui/ui", "ui/menuButton", 'ui/dialog'], function(Ribbon, Ui, MenuButton, Dialog){
		//Ui.adopt('formatTag', MenuButton, {});

		Ui.adopt("insertTag", MenuButton, {
			text: "X",
			menu: [
				{ text: "Z",
				  menu: [ { text: "one two", click: function(){console.log("Q");}, iconUrl: 'lib/aloha-editor/plugins/extra/wai-lang/img/button.png' },
						  { text: "three four five", click: function(){console.log("W");} } ],
				  iconUrl: 'lib/aloha-editor/plugins/extra/wai-lang/img/button.png'},
