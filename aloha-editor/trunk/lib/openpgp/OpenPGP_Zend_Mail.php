 ...
 *
 * See lib/core/Zend/Mail.php for original Zend Framework class
 *
 ...
 */
require_once 'lib/core/Zend/Mime/Message.php';

/**
 * @see Zend_Mime_Part
 */
require_once 'lib/core/Zend/Mime/Part.php';
...
class OpenPGP_Zend_Mail extends Zend_Mime_Message
{
    ...
    public function setType($type)
    {
        ...
        if (!in_array($type, $allowed)) {
             ...
             */
            require_once 'lib/core/Zend/Mail/Exception.php';
    ...
    public function send($transport = null)
    {
        if ($transport === null) {
            if (! self::$_defaultTransport instanceof OpenPGP_Zend_Mail_Transport_Abstract) {
                require_once 'lib/openpgp/OpenPGP_Zend_Mail_Transport_Sendmail.php';
