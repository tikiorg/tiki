...
function helloworld($data, $params)
{
	...
	$helloworld = \TikiAddons::get('tikisample_helloworld');
	...
	// $output = \TikiLib::lib('smarty')->fetch('tikisample-helloworld.tpl');
	...
	$output = $helloworld->smarty->fetch('tikisample-helloworld.tpl');
