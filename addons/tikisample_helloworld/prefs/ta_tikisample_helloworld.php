...
function prefs_ta_tikisample_helloworld_list()
{
	return array(
		'ta_tikisample_helloworld_on' => array( // This main _on pref is mandatory
			'name' => tra('Activate Tiki Sample Hello World'),
			'description' => tra('Activate Tiki Sample Hello World Addon'),
			'type' => 'flag',
			'admin' => 'ta_tikisample_helloworld',
			'tags' => array('basic'),
			'default' => 'y',
		),
		'ta_tikisample_helloworld_boldtext' => array(
			'name' => tra('Bold Text'),
