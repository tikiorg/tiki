...
<div class="t_navbar form-group">
	{button href="tiki-edit_blog.php" _class="btn btn-default" _text="{tr}Create Blog{/tr}"}
	{button href="tiki-blog_post.php" _class="btn btn-primary" _text="{tr}New Blog Post{/tr}"}
	{button href="tiki-list_blogs.php" _class="btn btn-default" _text="{tr}List Blogs{/tr}"}
</div>
