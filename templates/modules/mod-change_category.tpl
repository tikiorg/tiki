{* 
$Header: /cvsroot/tikiwiki/tiki/templates/modules/mod-change_category.tpl,v 1.9 2007-10-14 17:51:00 mose Exp $ 
parameters : id=1
...
{if !isset($module_params.notop)} <option value="0">{tr}top{/tr}</option>{/if}
