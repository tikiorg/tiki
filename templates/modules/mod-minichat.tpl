<!-- START of {$smarty.template} -->{tikimodule error=$module_params.error title="minichat" name="minichat" flip=$module_params.flip decorations=$module_params.decorations nobox=$module_params.nobox notitle=$module_params.notitle}
