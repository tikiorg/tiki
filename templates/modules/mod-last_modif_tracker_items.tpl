{* $Header: /cvsroot/tikiwiki/tiki/templates/modules/mod-last_modif_tracker_items.tpl,v 1.5 2003-11-20 23:49:04 mose Exp $ *}

{if $feature_trackers eq 'y'}
<div class="box">
<div class="box-title">
{include file="module-title.tpl" module_title="{tr}Last Modified Items{/tr}" module_name="last_modif_tracker_items"}
</div>
<div class="box-data">
