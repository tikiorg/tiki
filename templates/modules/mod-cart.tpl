...
{if !empty($cart_content)}
	...
	<table>
		...
		<tr>
			<td></td>
			<td colspan="2" align="right"><input type="submit" class="btn btn-default btn-sm btn-sm" name="update" value="{tr}Update{/tr}"></td>
		</tr>
	</table>
	</form>
	...
	<form method="post" action="">
		<p>
			...
			<input type="submit" class="btn btn-default btn-sm btn-sm" name="checkout" value="{tr}Check-out{/tr}">
		</p>
	</form>
{else}
