...
<div class="simplebox">
  ...
  <table width="100%">
  <tr>
     <td>{tr}URL to link the banner{/tr}</td><td><input type="text" name="url" value="{$url}" /></td>
   </tr>
  <tr><td>{tr}Client{/tr}:</td>
   ...
   <tr><td valign="top">{tr}Zone{/tr}:</td>
       <td><select name="zone">
...
<div class="simplebox">
<table width="100%">
<tr><td colspan="2">{tr}Show the banner only between these dates{/tr}:</tr></tr>
