...
<form action="tiki-edit_banner.php" method="post" enctype="multipart/form-data">
	...
	<div class="simplebox">
		<table >
			<tr>
				<td colspan="2" class="form">{tr}Show the banner only between these dates:{/tr}</td>
			</tr>
			<tr>
				<td class="form">{tr}From date:{/tr}</td>
				<td class="form">
					{html_select_date time=$fromDate prefix="fromDate_" end_year="+2" field_order=$prefs.display_field_order}
				</td>
			</tr>
			<tr>
				<td class="form">{tr}To date:{/tr}</td>
				<td class="form">
	...
	<div class="simplebox">
		<table width="100%">
			<tr>
				<td colspan="2" class="form">{tr}Show the banner only in this hours:{/tr}</td>
			</tr>
			<tr>
				<td class="form">{tr}from:{/tr}</td>
				<td class="form">{html_select_time time=$fromTime display_seconds=false prefix='fromTime'}</td>
			</tr>
			<tr>
				<td class="form">{tr}to:{/tr}</td>
				<td class="form">{html_select_time time=$toTime display_seconds=false prefix='toTime'}</td>
			</tr>
		</table>
	</div>
	...
	<div class="simplebox">
		<table width="100%">
			<tr>
				<td colspan="7" class="form">{tr}Show the banner only on:{/tr}</td>
			</tr>
			<tr>
				<td class="form">
			...
			<tr>
				...
				<td class="form">
					...
					<table>
						...
						{if $hasImage eq 'y'}
							<tr>
								<td class="form">{tr}Current Image{/tr}</td>
								<td>
