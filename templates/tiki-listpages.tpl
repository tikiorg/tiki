...
<td class="heading"><a class="link" href="tiki-listpages.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'lastModif_desc'}lastModif_asc{else}lastModif_desc{/if}">{tr}Last mod{/tr}</a></td>
...
<td class="heading"><a class="link" href="tiki-listpages.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'version_desc'}version_asc{else}version_desc{/if}">{tr}Last ver{/tr}</a></td>
<td class="heading"><a class="link" href="tiki-listpages.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'comment_desc'}comment_asc{else}comment_desc{/if}">{tr}Com{/tr}</a></td>
...
<td class="heading"><a class="link" href="tiki-listpages.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'versions_desc'}versions_asc{else}versions_desc{/if}">{tr}Vers{/tr}</a></td>
...
<td class="odd">&nbsp;<a href="tiki-index.php?page={$listpages[changes].pageName}" class="wiki">{$listpages[changes].pageName|truncate:20:"(...)":true}</a>&nbsp;
{if $tiki_p_edit eq 'y'}
<br>(<a class="wiki" href="tiki-editpage?page={$listpages[changes].pageName}">edit</a>)
{/if}
</td>
...
{else}
<td class="even">&nbsp;<a href="tiki-index.php?page={$listpages[changes].pageName}" class="wiki">{$listpages[changes].pageName|truncate:20:"(...)":true}</a>&nbsp;
{if $tiki_p_edit eq 'y'}
<br>(<a class="wiki" href="tiki-editpage?page={$listpages[changes].pageName}">edit</a>)
{/if}
</td>
