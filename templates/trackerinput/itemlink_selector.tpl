...
<div class="item-link">
{object_selector _id=$field.ins_id _simplevalue=$field.value _simplename=$field.ins_id type="trackeritem" tracker_id=$field.options_map.trackerId tracker_status=$data.status}
