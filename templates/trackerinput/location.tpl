<div class="map-container" data-target-field="{$field.ins_id}" style="width: 500px; height: 400px;" data-map-controls="controls,search_location,current_location,navigation,layers"></div>
