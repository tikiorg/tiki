<nav class="navbar navbar-default" role="navigation">
	<div class="navbar-header">
		...
		<a class="navbar-brand logo-nav" href="tiki-admin.php" title="{tr}Administration{/tr}">
			{glyph name="cog"}
		</a>
	</div>
	<div class="collapse navbar-collapse" id="admin-navbar-collapse-1">	
		...
		<li>
			...
			<li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="{tr}Preference Filters{/tr}"><span class="glyphicon glyphicon-wrench"></span></a>
...
{elseif $lm_criteria}
	{remarksbox type="note" title="{tr}No results{/tr}" icon="magnifier"}
		{tr}No preferences were found for your search query.{/tr}{if $prefs.unified_engine eq 'lucene'}{tr} Not what you expected? Try {/tr}<a class="rbox-link" href="tiki-admin.php?prefrebuild">{tr}rebuild{/tr}</a> {tr}the preferences search index.{/tr}{/if}
	{/remarksbox}
{/if}