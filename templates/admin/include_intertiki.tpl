	...
	{tab name="{tr}Intertiki client{/tr}"}
		<form action="tiki-admin.php?page=intertiki" method="post" name="intertiki" class="form-horizontal">
			...
			<div class="form-group">
				<label class="col-sm-4 control-label">{tr}Tiki Unique key{/tr}</label>
				<div class="col-sm-8">
					  <input type="text" name="tiki_key" value="{$prefs.tiki_key}" size="32" class="form-control"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label">{tr}InterTiki Slave mode{/tr}</label>
				<div class="col-sm-8">
					...
					<div class="help-block">
						{tr}Warning: overrides manually registered local users{/tr}
					</div>
				</div>
			</div>
			<div id="admin-slavemode-options" style="display: {if $prefs.feature_intertiki_mymaster eq ''}none{else}block{/if}">
				<div class="form-group">
					<label class="col-sm-4 control-label" for="feature_intertiki_import_preferences">{tr}Import user preferences{/tr}</label>
					<div class="col-sm-8">
					...
					<label class="col-sm-4 control-label" for="feature_intertiki_import_groups">{tr}Import user groups{/tr}</label>
					<div class="col-sm-8">
					...
					<label class="col-sm-4 control-label" for="feature_intertiki_imported_groups">{tr}Limit group import (comma-separated list of imported groups, leave empty to avoid limitation){/tr}</label>
					<div class="col-sm-8">
			...
			<div class="form-group">
				<label class="col-sm-4 control-label" for="feature_intertiki_sharedcookie">{tr}Intertiki shared cookie for sliding auth under same domain{/tr}</label>
				<div class="col-sm-8">
					<input type="checkbox" class="form-control" id="feature_intertiki_sharedcookie" name="feature_intertiki_sharedcookie" {if $prefs.feature_intertiki_sharedcookie eq 'y'}checked="checked"{/if}>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label">{tr}Add new server{/tr}</label>
					<div class="col-sm-8 margin-bottom-sm">
						<input type="text" name="new[name]" value="" class="form-control" placeholder="Server Name"/>
					</div>
					<div class="col-sm-8 col-sm-offset-4 margin-bottom-sm">
			...
			<div class="form-group">
				<label class="col-sm-4 text-left control-label ">{tr}InterTiki Servers{/tr}</label>
