					...
					{if $edit}
						<table border="0" cellspacing="0" cellpadding="3">
							<tbody>
								<tr>
									<td>
										<input id="reminder_type_none" type="radio" name="save[reminder_type]" value="0" 
											onclick="document.getElementById('reminder_fixed_date_row').style.display = 'none'; 
											document.getElementById('reminder_time_offset_row').style.display = 'none';" 
											{if $calitem.reminder_type eq 0}
												checked="checked"
											{/if}
										 />
										<label for="reminder_type_none">
											{tr}None{/tr}
										</label>
									</td>
								</tr>
								<tr id="reminder_fixed_date_option_row">
									<td>
										<input id="reminder_type_date" type="radio" name="save[reminder_type]" 
											value="1" onclick="document.getElementById('reminder_fixed_date_row').style.display = ''; 
											document.getElementById('reminder_time_offset_row').style.display = 'none';" 
											{if $calitem.reminder_type eq 1}
												checked="checked"
											{/if}
										 />
										<label for="reminder_type_date">
											{tr}Use Date/Time{/tr}
										</label>
									</td>
								</tr>
								<tr id="reminder_fixed_date_row" style="display: 
									{if $calitem.reminder_type eq 1}
										block
									{else}
										none
								...
								;">
									<td>
										<table>
											<tr>
												<td style="border:0; padding-top:2px; vertical-align: middle;">
													{html_select_date prefix="reminder_fixed_date_" time=$calitem.reminder_fixed_date field_order=$prefs.display_field_order 
													start_year=$prefs.calendar_start_year end_year=$prefs.calendar_end_year}
												</td>
								...
								<tr id="reminder_time_offset_option_row">
									<td>
										<input id="reminder_type_offset" type="radio" name="save[reminder_type]" value="2" 
											onclick="document.getElementById('reminder_fixed_date_row').style.display = 'none'; 
											document.getElementById('reminder_time_offset_row').style.display = '';" 
								...
								<tr id="reminder_time_offset_row" style="display: 
									{if $calitem.reminder_type eq 2}
										block
									{else}
										none
								...
								;">
									<td>
										<table>
											<tr>
												<td>
													<input id="reminder_time_offset_days" type="text" size="2" name="reminder_time_offset_days" 
														value="{$reminder_time_offset_days}" style="text-align: right;"
													/>
													<label for="reminder_time_offset_days" style="padding-left: 5px; padding-right: 10px;">
														days
													</label>
													<input id="reminder_time_offset_hours" type="text" size="2" name="reminder_time_offset_hours" 
														value="{$reminder_time_offset_hours}" style="text-align: right;" 
													/>
													<label for="reminder_time_offset_hours" style="padding-left: 5px; padding-right: 10px;">
														hours
													</label>
													<input id="reminder_time_offset_minutes" type="text" size="2" name="reminder_time_offset_minutes" 
														value="{$reminder_time_offset_minutes}" style="text-align: right;" 
													/>
													<label for="reminder_time_offset_minutes" style="padding-left: 5px; padding-right: 10px;">
														minutes
													</label>
												</td>
											</tr>
											<tr>
												<td>
													<input id="reminder_when_run_B" type="radio" name="save[reminder_when_run]" value="B" 
														{if $calitem.reminder_when_run neq 'A'}
															checked="checked"
														{/if}
													  />
													<label for="reminder_when_run_B">
														Before
													</label>
													<input id="reminder_when_run_A" type="radio" name="save[reminder_when_run]" value="A" 
														{if $calitem.reminder_when_run eq 'A'}
															checked="checked"
														{/if}
													 />
													<label for="reminder_when_run_A">
														After
													</label>
												</td>
											</tr>
											<tr>
												<td>
													<input id="reminder_related_to_s" type="radio" name="save[reminder_related_to]" value="S" 
														{if $calitem.reminder_related_to neq 'E'}
															checked="checked"
														{/if}
													 />
													<label for="reminder_related_to_s">
														Start
													</label>
													<input id="reminder_related_to_e" type="radio" name="save[reminder_related_to]" value="E" 
														{if $calitem.reminder_related_to eq 'E'}
															checked="checked"
														{/if}
													 />
													<label for="reminder_related_to_e">
														End
													</label>
												</td>
											</tr>
						...
						<table border="0" cellspacing="0" cellpadding="3">
							<tbody>
								...
								{if $calitem.reminder_type eq 1}
									...
									<tr>
										<td>
											<abbr class="dtstart" title="{$calitem.reminder_fixed_date|isodate}">
												{$calitem.reminder_fixed_date|tiki_long_datetime}
											</abbr>
										</td>
									</tr>
								{/if}
								{if $calitem.reminder_type eq 2}
									...
									<tr>
										<td>
											{$reminder_time_offset_days} days {$reminder_time_offset_hours} hours {$reminder_time_offset_minutes} minutes 
											{if $calitem.reminder_when_run neq 'A'}
												before
											{else}
												after
