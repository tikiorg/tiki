	...
	<table class="formcolor">
		...
		<tr>
			<td colspan="3" style="text-align:left; vertical-align:bottom;">
				...
				<input type="submit" class="btn btn-default btn-sm" name="update_tasks" value="{tr}Go{/tr}" style="vertical-align:bottom;">
			</td>
			<td colspan="3" style="text-align:right;">
				<input type="submit" class="btn btn-default btn-sm" name="update_percentage" value="{tr}Go{/tr}" style="vertical-align:bottom;">
