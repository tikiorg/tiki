...
<tr><td class="formcolor">{tr}categorize{/tr}</td><td class="formcolor">
...
{tr}categorize this object{/tr}:<input type="checkbox" name="cat_categorize" {if $cat_categorize eq 'y'}checked="checked"{/if}/><br/>
{if $tiki_p_admin_categories eq 'y'}<a href="tiki-admin_categories.php" class="link">{tr}Admin categories{/tr}</a>{/if}
</div>
</td></tr>
{/if}