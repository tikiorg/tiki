...
<tr><td class="formcolor">{tr}CSV File{/tr}<a {popup text='name|subject,description,(start date,start time)|start,(end date,end time)|end,status,lang,categoryId,locationId,priority,url,categoryId'}><img src="img/icons/help.gif" border="0" height="16" width="16" alt='{tr}help{/tr}' /></a>
