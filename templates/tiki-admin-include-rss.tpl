...
<div class="rbox" name="tip">
  ...
  <div class="rbox-data" name="tip">{tr}Use this page to configure the RSS feeds generated by Tiki. To syndicate RSS feeds from other sites, use the <strong>Admin</strong> &gt; <strong>RSS modules</strong> menu option, or{/tr} <a class="rbox-link" href="tiki-admin_rssmodules.php" title="{tr}RSS modules{/tr}">{tr}Click Here{/tr}</a>.</div>
</div>
<br />
<div class="cbox">
...
<br />
      <table class="admin">
	    ...
	    <div class="rbox" name="tip">
	      <div class="rbox-title" name="tip">{tr}Tip{/tr}</div>  
	      <div class="rbox-data" name="tip">{tr}Enabling caching will override existing permissions - all content will be public. Enable this option <strong>only</strong> if your syndicated content should be public.{/tr}</div>
	    </div>
	  </td>
        </tr>
