...
<div class="adminoptionbox">
	{tr}Title{/tr}: <input type="text" name="title_rss_blogs" size="20" maxlength="255" style="width:95%" value='{$prefs.title_rss_blogs|escape}' /><br />{tr}Description{/tr}: <textarea name="desc_rss_blogs" style="width:95%" cols="20" rows="2">{$prefs.desc_rss_blogs|escape}</textarea><br />{tr}Maximum number of items to display{/tr}:<input type="text" name="max_rss_blogs" size="5" value="{$prefs.max_rss_blogs|escape}" /><br />{tr}Show Author{/tr}: <input type="checkbox" name="showAuthor_rss_blogs" {if $prefs.showAuthor_rss_blogs eq 'y'} checked="checked"{/if}><br /><br />{tr}Homepage URL{/tr}:<br /><input type="text" name="index_rss_blogs" size="20" style="width: 95%" value="{$prefs.index_rss_blogs|escape}" />
</div>
</div>	
	</div>
</div>
...
<div class="adminoptionbox">
	{tr}Title{/tr}: <input type="text" name="title_rss_blog" size="20" maxlength="255" style="width:95%" value='{$prefs.title_rss_blog|escape}' /><br />{tr}Description{/tr}: <textarea name="desc_rss_blog" style="width:95%" cols="20" rows="2">{$prefs.desc_rss_blog|escape}</textarea><br />{tr}Maximum number of items to display{/tr}:<input type="text" name="max_rss_blog" size="5" value="{$prefs.max_rss_blog|escape}" /><br />{tr}Show Author{/tr}: <input type="checkbox" name="showAuthor_rss_blog" {if $prefs.showAuthor_rss_blog eq 'y'} checked="checked"{/if}><br />{tr}Homepage URL{/tr}:<br /><input type="text" name="index_rss_blog" size="20" style="width: 95%" value="{$prefs.index_rss_blog|escape}" />
</div>
</div>	
	</div>
</div>
...
<div class="adminoptionbox">
	{tr}Title{/tr}: <input type="text" name="title_rss_image_galleries" size="20" maxlength="255" style="width:95%" value='{$prefs.title_rss_image_galleries|escape}' /><br />{tr}Description{/tr}: <textarea name="desc_rss_image_galleries" style="width:95%" cols="20" rows="2">{$prefs.desc_rss_image_galleries|escape}</textarea><br />{tr}Maximum number of items to display{/tr}:<input type="text" name="max_rss_image_galleries" size="5" value="{$prefs.max_rss_image_galleries|escape}" /><br />{tr}Show Author{/tr}: <input type="checkbox" name="showAuthor_rss_image_galleries" {if $prefs.showAuthor_rss_image_galleries eq 'y'} checked="checked"{/if}><br />{tr}Homepage URL{/tr}:<br /><input type="text" name="index_rss_image_galleries" size="20" style="width: 95%" value="{$prefs.index_rss_image_galleries|escape}" />
</div>
	</div>
</div>
</div>
...
<div class="adminoptionbox">
	{tr}Title{/tr}: <input type="text" name="title_rss_image_gallery" size="20" maxlength="255" style="width:95%" value='{$prefs.title_rss_image_gallery|escape}' /><br />{tr}Description{/tr}: <textarea name="desc_rss_image_gallery" style="width:95%" cols="20" rows="2">{$prefs.desc_rss_image_gallery|escape}</textarea><br />{tr}Maximum number of items to display{/tr}:<input type="text" name="max_rss_image_gallery" size="5" value="{$prefs.max_rss_image_gallery|escape}" /><br />{tr}Show Author{/tr}: <input type="checkbox" name="showAuthor_rss_image_gallery" {if $prefs.showAuthor_rss_image_gallery eq 'y'} checked="checked"{/if}><br />{tr}Homepage URL{/tr}:<br /><input type="text" name="index_rss_image_gallery" size="20" style="width: 95%" value="{$prefs.index_rss_image_gallery|escape}" />
</div>
</div>	
	</div>
</div>
...
<div class="adminoptionbox">{tr}Title{/tr}: <input type="text" name="title_rss_file_galleries" size="20" maxlength="255" style="width:95%" value='{$prefs.title_rss_file_galleries|escape}' /><br />{tr}Description{/tr}: <textarea name="desc_rss_file_galleries" style="width:95%" cols="20" rows="2">{$prefs.desc_rss_file_galleries|escape}</textarea><br />{tr}Maximum number of items to display{/tr}:<input type="text" name="max_rss_file_galleries" size="5" value="{$prefs.max_rss_file_galleries|escape}" /><br />{tr}Show Author{/tr}: <input type="checkbox" name="showAuthor_rss_file_galleries" {if $prefs.showAuthor_rss_file_galleries eq 'y'} checked="checked"{/if}><br />{tr}Homepage URL{/tr}:<br /><input type="text" name="index_rss_file_galleries" size="20" style="width: 95%" value="{$prefs.index_rss_file_galleries|escape}" /></div>
	</div>
	</div>
</div>
...
<div class="adminoptionbox">
	{tr}Title{/tr}: <input type="text" name="title_rss_file_gallery" size="20" maxlength="255" style="width:95%" value='{$prefs.title_rss_file_gallery|escape}' /><br />{tr}Description{/tr}: <textarea name="desc_rss_file_gallery" style="width:95%" cols="20" rows="2">{$prefs.desc_rss_file_gallery|escape}</textarea><br />{tr}Maximum number of items to display{/tr}:<input type="text" name="max_rss_file_gallery" size="5" value="{$prefs.max_rss_file_gallery|escape}" /><br />{tr}Show Author{/tr}: <input type="checkbox" name="showAuthor_rss_file_gallery" {if $prefs.showAuthor_rss_file_gallery eq 'y'} checked="checked"{/if}><br />{tr}Homepage URL{/tr}:<br /><input type="text" name="index_rss_file_gallery" size="20" style="width: 95%" value="{$prefs.index_rss_file_gallery|escape}" />
</div>	
</div>	
	</div>
</div>
...
<div class="adminoptionbox">
	...
	<div class="adminoptionbox">{tr}Title{/tr}: <input type="text" name="title_rss_forum" size="20" maxlength="255" style="width:95%" value='{$prefs.title_rss_forums|escape}' /><br />{tr}Description{/tr}: <textarea name="desc_rss_forums" style="width:95%" cols="20" rows="2">{$prefs.desc_rss_forums|escape}</textarea><br />{tr}Maximum number of items to display{/tr}:<input type="text" name="max_rss_forums" size="5" value="{$prefs.max_rss_forums|escape}" /><br />{tr}Show Author{/tr}: <input type="checkbox" name="showAuthor_rss_forums" {if $prefs.showAuthor_rss_forums eq 'y'} checked="checked"{/if}><br />{tr}Homepage URL{/tr}:<br /><input type="text" name="index_rss_forums" size="20" style="width: 95%" value="{$prefs.index_rss_forums|escape}" /></div>
            </div>
	</div>
</div>
...
<div class="adminoptionbox">
	...
	<div class="adminoptionlabel"><label for="rss_trackers">{tr}Trackers{/tr}</label>{if $prefs.rss_trackers eq 'y'} <a href="tiki-tracker_rss.php">{icon _id=feed}</a>{/if} {if $prefs.feature_trackers ne 'y'}&nbsp;({tr}Feature is disabled.{/tr} <a href="tiki-admin.php?page=features" title="{tr}Features{/tr}">{tr}Enable now{/tr}</a>.){/if}
            ...
            <div class="adminoptionbox">{tr}Title{/tr}: <input type="text" name="title_rss_trackers" size="20" maxlength="255" style="width:95%" value='{$prefs.title_rss_trackers|escape}' /><br />{tr}Description{/tr}: <textarea name="desc_rss_trackers" style="width:95%" cols="20" rows="2">{$prefs.desc_rss_trackers|escape}</textarea><br />{tr}Maximum number of items to display{/tr}:<input type="text" name="max_rss_trackers" size="5" value="{$prefs.max_rss_trackers|escape}" /><br />{tr}Show Author{/tr}: <input type="checkbox" name="showAuthor_rss_trackers" {if $prefs.showAuthor_rss_trackers eq 'y'} checked="checked"{/if}><br />{tr}Homepage URL{/tr}:<br /><input type="text" name="index_rss_trackers" size="20" style="width: 95%" value="{$prefs.index_rss_trackers|escape}" /></div>
            </div>	
	</div>
</div>
...
<div class="adminoptionbox">
	...
	<div id="trackerrss" class="adminoptionboxchild" style="display:{if ($prefs.rss_tracker eq 'y') and ($prefs.feature_trackers eq 'y')}block{else}none{/if};">
            <div class="adminoptionbox">{tr}Title{/tr}: <input type="text" name="title_rss_tracker" size="20" maxlength="255" style="width:95%" value='{$prefs.title_rss_tracker|escape}' /><br />{tr}Description{/tr}: <textarea name="desc_rss_tracker" style="width:95%" cols="20" rows="2">{$prefs.desc_rss_tracker|escape}</textarea><br />{tr}Maximum number of items to display{/tr}:<input type="text" name="max_rss_tracker" size="5" value="{$prefs.max_rss_tracker|escape}" /><br />{tr}Show Author{/tr}: <input type="checkbox" name="showAuthor_rss_tracker" {if $prefs.showAuthor_rss_tracker eq 'y'} checked="checked"{/if}><br />{tr}Homepage URL{/tr}:<br /><input type="text" name="index_rss_tracker" size="20" style="width: 95%" value="{$prefs.index_rss_tracker|escape}" /></div>
            </div>
	</div>
</div>
...
<div class="adminoptionbox">
	...
	<div class="adminoptionboxchild" id="mapfilesrss" style="display:{if ($prefs.rss_mapfiles eq 'y') and ($prefs.feature_maps eq 'y')}block{else}none{/if};">
            <div class="adminoptionbox">{tr}Title{/tr}: <input type="text" name="title_rss_mapfiles" size="20" maxlength="255" style="width:95%" value='{$prefs.title_rss_mapfiles|escape}' /><br />{tr}Description{/tr}: <textarea name="desc_rss_mapfiles" style="width:95%" cols="20" rows="2">{$prefs.desc_rss_mapfiles|escape}</textarea><br />{tr}Maximum number of items to display{/tr}:<input type="text" name="max_rss_mapfiles" size="5" value="{$prefs.max_rss_mapfiles|escape}" /><br />{tr}Show Author{/tr}: <input type="checkbox" name="showAuthor_rss_mapfiles" {if $prefs.showAuthor_rss_mapfiles eq 'y'} checked="checked"{/if}><br />{tr}Homepage URL{/tr}:<br /><input type="text" name="index_rss_mapfiles" size="20" style="width: 95%" value="{$prefs.index_rss_mapfiles|escape}" /></div>
            </div>
	</div>
</div>
</fieldset>
