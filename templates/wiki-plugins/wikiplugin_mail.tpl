...
{if $preview}
	...
	<input type="submit" class="btn btn-default btn-sm" name="mail_send{$ipluginmail}" value="{tr}Send Mail{/tr}">
	</form>
	<form method="post">
	<input type="submit" class="btn btn-default btn-sm" name="mail_cancel{$ipluginmail}" value="{tr}Cancel{/tr}">
	</form>
{else}
<form method="post">
<table>
	...
	<td></td>
	<td>
		<input type="submit" class="btn btn-default btn-sm" name="mail_preview{$ipluginmail}" value="{tr}Preview Mail{/tr}">
	</td>
	</tr>
</table>
</form>
