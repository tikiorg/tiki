			...
			<tfoot>
				...
				{if !empty($computedFields)}
					<tr class='compute'>
						...
						{if $tracker_info.useComments eq 'y' and ($tracker_info.showComments eq 'y' || $tracker_info.showLastComment eq 'y') and $perms.tiki_p_tracker_view_comments ne 'n'}<td></td>{/if}
