{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-hw_pagehistory.tpl,v 1.1 2004-02-06 15:51:07 ggeller Exp $ *}

<a class="pagetitle" href="tiki-pagehistory?page={$page|escape:"url"}">
  {tr}History{/tr}
</a>
{tr}of{/tr}: <a class="pagetitle" href="tiki-index.php?page={$page|escape:"url"}">{$page}</a><br /><br />
{if $preview}
