...
<form method="post" action="tiki-view_forum.php">
	...
	{if $tiki_p_admin_forum eq 'y'}
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div style="width:50%;float:left">
					...
					{/if}
					<button name="unlocksel" class="btn btn-link btn-sm tikihelp" title=":{tr}Unlock Selected Topics{/tr}">{icon name="unlock"}</button>
		...
		{if isset($smarty.request.movesel_x) and $smarty.request.movesel_x}
			<div id="moveop" class="panel panel-success">
				<div class="panel-heading">
					{tr}Move selected topics to another forum{/tr}
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label for="moveto" class="col-lg-3 control-label">{tr}Move to this forum:{/tr}</label>
						<div class="col-lg-5">
							<select class="form-control" id="moveto" name="moveto">
				...
				<div class="panel-footer">
					<input type='submit' name='movesel' class="btn btn-primary" value="{tr}Move{/tr}">
				</div>
			</div>
		{/if}
		{if isset($smarty.request.splitsel_x) and $smarty.request.splitsel_x}
			<div id="moveop" class="panel panel-success">
				<div class="panel-heading">
					{tr}Merge selected topics to another topic{/tr}
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label for="mergetopic" class="col-lg-3 control-label">{tr}Merge to this topic:{/tr}</label>
						<div class="col-lg-5">
				...
				<div class="panel-footer">
					<input type='submit' name='mergesel' class="btn btn-primary" value="{tr}Merge{/tr}">
				</div>
			</div>
		{/if}
	{/if}
