...
{*viewmodes*}
		{if $calendar_type neq "tiki_actions"}
			{if $viewmode == 'day'}{assign var='selected' value='y'}{else}{assign var='selected' value='n'}{/if}
			{if $module neq 'y'}
				{button _ajax=$ajax href="?viewmode=day" _title="{tr}Day{/tr}" _text="{tr}Day{/tr}" _selected_class="buttonon" _selected=$selected}
			{elseif empty($module_params.viewmode)}
				{button _ajax=$ajax viewmode='day' _auto_args="viewmode" _keepall='y' _title="{tr}Day{/tr}" _text="{tr}D{/tr}" _selected_class="buttonon" _selected=$selected}
			{/if}
		{/if}
		{if $module neq 'y'}
			{if $viewmode == 'week'}{assign var='selected' value='y'}{else}{assign var='selected' value='n'}{/if}
			{button _ajax=$ajax href="?viewmode=week" _title="{tr}Week{/tr}" _text="{tr}Week{/tr}" _selected_class="buttonon" _selected=$selected}
			{if $viewmode == 'month'}{assign var='selected' value='y'}{else}{assign var='selected' value='n'}{/if}
			{button _ajax=$ajax href="?viewmode=month" _title="{tr}Month{/tr}" _text="{tr}Month{/tr}" _selected_class="buttonon" _selected=$selected}
		{elseif empty($module_params.viewmode)}
			{if $viewmode == 'week'}{assign var='selected' value='y'}{else}{assign var='selected' value='n'}{/if}
			{button _ajax=$ajax viewmode='week' _auto_args="viewmode" _keepall='y' _title="{tr}Week{/tr}" _text="{tr}W{/tr}" _selected_class="buttonon" _selected=$selected}
			{if $viewmode == 'month'}{assign var='selected' value='y'}{else}{assign var='selected' value='n'}{/if}
			{button _ajax=$ajax viewmode='month' _auto_args="viewmode" _keepall='y' _title="{tr}Month{/tr}" _text="{tr}M{/tr}" _selected_class="buttonon" _selected=$selected}
		{/if}

		{if $module neq 'y'}
			{if $viewmode == 'quarter'}{assign var='selected' value='y'}{else}{assign var='selected' value='n'}{/if}
			{button _ajax=$ajax href="?viewmode=quarter" _title="{tr}Quarter{/tr}" _text="{tr}Quarter{/tr}" _selected_class="buttonon" _selected=$selected}
			{if $viewmode == 'semester'}{assign var='selected' value='y'}{else}{assign var='selected' value='n'}{/if}
			{button href="?viewmode=semester" _title="{tr}Semester{/tr}" _text="{tr}Semester{/tr}" _selected_class="buttonon" _selected=$selected}
			{if $viewmode == 'year'}{assign var='selected' value='y'}{else}{assign var='selected' value='n'}{/if}
			{button href="?viewmode=year" _ajax=$ajax viewmode=year _title="{tr}Year{/tr}" _text="{tr}Year{/tr}" _selected_class="buttonon" _selected=$selected}
		{/if}
