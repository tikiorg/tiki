...
{elseif $field_value.type eq 'f'}
	...
	{if isset($cur_field.options_array[2])}{assign var=end value=$cur_field.options_array[2]}{elseif isset($prefs.calendar_end_year)}{assign var=end value=$prefs.calendar_end_year}{else}{assign var=end value=+4}{/if}
