{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-orphan_pages.tpl,v 1.27.2.1 2007-10-17 20:36:11 niclone Exp $ *}
...
<tr><td class="findtitle">{tr}Find{/tr}</td>
   ...
   <form method="get" action="tiki-orphan_pages.php">
     ...
     {tr}Number of lines{/tr} <input type="text" name="numrows" value="{$prefs.maxRecords|escape}" size="3" />
