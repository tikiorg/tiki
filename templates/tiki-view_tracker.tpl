...
<input type="radio" name="{$field_value.ins_id}" id="{$field_value.options_array[jx]}" value="{$field_value.options_array[jx]|escape}" {if $input_err}{if $field_value.value eq $field_value.options_array[jx]}checked="checked"{/if}{elseif $defaultvalues.$fid eq $field_value.options_array[jx] or $field_value.defaultvalue eq $field_value.options_array[jx]}checked="checked"{/if} /><label for="{$field_value.options_array[jx]}">{$field_value.options_array[jx]}</label>
<br />
