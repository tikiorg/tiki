{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-view_tracker.tpl,v 1.136 2007-06-01 18:21:32 sylvieg Exp $ *}
...
{/if}
{/if}
{if (isset($tiki_p_list_trackers) && $tiki_p_list_trackers eq 'y') or $tiki_p_view_trackers eq 'y'}<span class="button2"><a href="tiki-list_trackers.php" class="linkbut">{tr}List trackers{/tr}</a></span>{/if}
{if $filtervalue}
