...
<div style="padding:5px;" align="left">{tr}Tikiwiki version{/tr}: <strong>{$tiki_version}</strong> 
...
<br />{tr}or{/tr}<br /></div>
	<div style="float:left;padding-right:10px;"><input type="checkbox" name="useUrlIndex" id="general-uri" {if $prefs.useUrlIndex eq 'y'}checked="checked" {/if}onclick="flip('tiki_home_page');" /></div>
...
<div style="padding:5px;">	  
	<div style="float:left;padding-right:10px;"><input type="checkbox" name="session_db" id="general-session_db" {if $prefs.session_db eq 'y'}checked="checked" {/if}/></div>
...
<div style="padding:5px;" align="left">{icon _id=information style="vertical-align:middle"} {tr}The "Contact Us" feature is disabled.{/tr} <a href="tiki-admin.php?page=features" title="{tr}Features{/tr}">{tr}Enable now{/tr}</a>.</div>
{/if}
<div style="padding:5px;">	  
