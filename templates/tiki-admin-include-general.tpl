...
<div id="group_homepages" style="display:{if $prefs.useGroupHome eq 'y'}block{else}none{/if};margin-left:30px;padding:.5em;">
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="limitedGoGroupHome" id="general-gogrouphome" {if $prefs.limitedGoGroupHome eq 'y'}checked="checked" {/if}/></div>
	<div align="left"><label for="general-gogrouphome">{tr}Go to group homepage only if login from default homepage{/tr}.</label></div>
</div>
</div>
<div style="padding:.5em;clear:both" align="left">
...
<br />{tr}or{/tr}<br /></div>
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="useUrlIndex" id="general-uri" {if $prefs.useUrlIndex eq 'y'}checked="checked" {/if}onclick="flip('tiki_home_page');" /></div>
...
<div style="padding:.5em;clear:both" align="left"><label for="general-os">{tr}Server OS{/tr}</label>:<select name="system_os" id="general-os">
            <option value="unix"
...
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="smarty_security" id="smarty-security"{if $prefs.smarty_security eq 'y'} checked="checked"{/if} /></div>
...
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" id="feature_pear_date" name="feature_pear_date"{if $prefs.feature_pear_date eq 'y'} checked="checked"{/if} /></div>
	<div align="left"><label for="feature_pear_date">{tr}Use PEAR::Date library{/tr}.</label></div>
</div>
<div style="padding:.5em;clear:both" align="left"><label for="general-charset">{tr}Default charset for sending mail{/tr}:</label> 
...
<div style="padding:.5em;clear:both" align="left"><label for="mail_crlf">{tr}Mail end of line{/tr}:</label> 
...
<div style="padding:.5em;clear:both" align="left">
	...
	<div style="margin-left:20px;padding:.5em;clear:both">
		<div style="float:left;padding-right:1em;"><input type="checkbox" id="error_reporting_adminonly" name="error_reporting_adminonly"{if $prefs.error_reporting_adminonly eq 'y'} checked="checked"{/if} /></div>
		<div align="left"><label for="error_reporting_adminonly">{tr}Visible to Admin only{/tr}.</label></div>
<br />
		<div style="float:left;padding-right:1em;clear:both"><input type="checkbox" id="smarty_notice_reporting" name="smarty_notice_reporting"{if $prefs.smarty_notice_reporting eq 'y'} checked="checked"{/if} /></div>
		<div align="left"><label for="smarty_notice_reporting">{tr}Include Smarty notices{/tr}</label>.</div>
	</div>
</div>
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" id="log_mail" name="log_mail"{if $prefs.log_mail eq 'y'} checked="checked"{/if} /></div>
...
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" id="log_sql" name="log_sql"{if $prefs.log_sql eq 'y'} checked="checked"{/if} onclick="flip('log_sql_queries');" /></div>
	<div align="left"><label for="log_sql">{tr}Log SQL{/tr}.</label></div>
</div>
<div id="log_sql_queries" align="left" style="margin-left:20px;padding:.5em;display:{if $prefs.log_sql eq 'y'}display{else}none{/if};">
...
<div style="padding:.5em;clear:both" align="left">{tr}Use these options to protect against cross-site request forgeries (CSRF){/tr}.</div>

<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="feature_ticketlib" id="feature_ticketlib" {if $prefs.feature_ticketlib eq 'y'}checked="checked"{/if}/></div>
	<div align="left"><label for="feature_ticketlib">{tr}Require confirmation if possible CSRF detected{/tr}.</label></div>
</div>

<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="feature_ticketlib2" id="feature_ticketlib2" {if $prefs.feature_ticketlib2 eq 'y'}checked="checked"{/if} /></div>
...
<div style="padding:.5em;clear:both">
<div style="margin:0px;float:left;padding-right:1em"><input type="checkbox" name="site_closed" id="general-access" {if $prefs.site_closed eq 'y'}checked="checked" {/if}onclick="flip('close_site_message');" /></div>
<div align="left"><label for="general-access">{tr}Close site (except for those with permission){/tr}.</label></div>
<div align="left" id="close_site_message" style="display:{if $prefs.site_closed eq 'y'}block{else}none{/if};margin-left:30px;padding:.5em;">
...
<div style="padding:.5em;clear:both">
<div style="float:left;padding-right:1em;margin:0px;"><input type="checkbox" name="use_load_threshold" id="general-load" {if $prefs.use_load_threshold eq 'y'}checked="checked" {/if}onclick="flip('close_threshold_message');" /></div>
...
<div align="left" id="close_threshold_message" style="display:{if $prefs.use_load_threshold eq 'y'}block{else}none{/if};margin-left:30px;padding:.5em;">
	<div align="left">
...
<div style="padding:.5em;clear:both">
	<div style="float:left;padding-right:1em;margin:0px;"><input type="checkbox" name="use_proxy" id="general-proxy" {if $prefs.use_proxy eq 'y'}checked="checked" {/if}onclick="flip('use_proxy_settings');" /></div>
	<div align="left"><label for="general-proxy">{tr}Use proxy{/tr}.</label></div>
	<div align="left" id="use_proxy_settings" style="display:{if $prefs.use_proxy eq 'y'}block{else}none{/if};margin-left:30px;padding:.5em;">
		<div><label for="general-proxy_host">{tr}Host{/tr}:</label><input type="text" name="proxy_host" id="general-proxy_host" value="{$prefs.proxy_host|escape}" size="40" /></div>
		<div><label for="general-proxy_port">{tr}Port{/tr}:</label><input size="5" type="text" name="proxy_port" id="general-proxy_port" value="{$prefs.proxy_port|escape}" /></div>
	</div>
</div>
...
<div style="padding:.5em;clear:both">
	<div style="float:left;padding-right:1em;"><input id="permission_denied_login_box" type="checkbox" name="permission_denied_login_box"{if $prefs.permission_denied_login_box eq 'y'} checked="checked"{/if} onclick="flip('urlonerror');" /></div>
	<div align="left"><label for="permission_denied_login_box">{tr}On permission denied, display login module (for Anonymous){/tr}.</label></div>
	<div align="left" id="urlonerror" style="display:{if $prefs.permission_denied_login_box eq 'y'}none{else}block{/if};">
	{tr}or{/tr}<br />
		<div align="left" style="margin-left:3em;"><label for="permission_denied_url">{tr}Send to URL{/tr}</label>:<br /><input type="text" name="permission_denied_url" id="permission_denied_url"  value="{$prefs.permission_denied_url|escape}" size="50" /></div>
	</div>
</div>
...
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="cachepages" id="general-cache_ext_pages" {if $prefs.cachepages eq 'y'}checked="checked" {/if}/></div>
	<div align="left"><label for="general-cache_ext_pages">{tr}Cache external pages{/tr}</label>.</div>
</div>
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="cacheimages" id="general-cache_ext_imgs" {if $prefs.cacheimages eq 'y'}checked="checked" {/if}/></div>
	<div align="left"><label for="general-cache_ext_imgs">{tr}Cache external images{/tr}</label>.</div>
</div>
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="feature_obzip" id="general-gzip" {if $prefs.feature_obzip eq 'y'}checked="checked" {/if}/></div>
...
<div style="padding:.5em;">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="session_db" id="general-session_db" {if $prefs.session_db eq 'y'}checked="checked" {/if}/></div>
	<div align="left"><label for="general-session_db">{tr}Store session data in database{/tr}.</label></div>
</div>
<div style="padding:.5em;">	  
	<div align="left"><label for="general-session_life">{tr}Session lifetime{/tr}:</label> <input size="5" type="text" name="session_lifetime" id="general-session_life" value="{$prefs.session_lifetime|escape}" /> {tr}minutes{/tr}</div>
</div>
</fieldset>
...
{/if}
<div style="padding:.5em;">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="contact_anon" id="contact_anon" {if $prefs.contact_anon eq 'y'}checked="checked" {/if}{if $prefs.feature_contact ne 'y'}disabled="disabled" {/if}/></div>
...
<fieldset><legend>{tr}Miscellaneous{/tr}</legend>
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="count_admin_pvs" id="general-pageviews" {if $prefs.count_admin_pvs eq 'y'}checked="checked" {/if}/></div>
...
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="feature_help" id="feature_help" {if $prefs.feature_help eq 'y'}checked="checked" {/if}onclick="flip('use_help_system');" /></div>
	<div align="left"><label for="feature_help">{tr}Help System{/tr}:</label>{if $prefs.feature_help eq 'y'}{help url="Documentation"}{/if}</div>
	<div align="left" id="use_help_system" style="display:{if $prefs.feature_help eq 'y'}block{else}none{/if};margin-left:30px;padding:.5em;">
...
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" name="user_show_realnames" id="user_show_realnames" {if $prefs.user_show_realnames eq 'y'}checked="checked"{/if}/></div>
...
<div style="padding:.5em;clear:both">	  
	<div align="left"><label for="user_show_realnames">{tr}Highlight group{/tr}:</label> 
...
<div style="padding:.5em;clear:both">	  
	<div style="float:left;padding-right:1em;"><input type="checkbox" id="feature_display_my_to_others"  name="feature_display_my_to_others" {if $prefs.feature_display_my_to_others eq 'y'}checked="checked"{/if} /></div>
	<div align="left"><label for="feature_display_my_to_others">{tr}Show user's contribution on the user information page{/tr}.</label>{if $prefs.feature_help eq 'y'} {help url="User+Preferences"}{/if}</div>
</div>

<div style="padding:.5em;clear:both">
	<div align="left"><label for="user_tracker_infos">{tr}Display UserTracker information on the user information page{/tr}:</label> {if $prefs.feature_help eq 'y'} {help url="User+Tracker"}{/if}
...
<div style="padding:.5em;clear:both">	  
	<div align="left"><label for="general-timezone">{tr}Default timezone{/tr}:</label><br />
...
<div style="padding:.5em;">	  
	<div align="left"><label for="general-long_date">{tr}Long date format{/tr}:</label><br /><input type="text" name="long_date_format" id="general-long_date" value="{$prefs.long_date_format|escape}" size="40" /><br /><em>{tr}Sample{/tr}: {$now|tiki_long_date}</em></div>
</div>
<div style="padding:.5em;">	  
	<div align="left"><label for="general-short_date">{tr}Short date format{/tr}:</label><br /><input type="text" name="short_date_format" id="general-short_date" value="{$prefs.short_date_format|escape}" size="40" /><br /><em>{tr}Sample{/tr}: {$now|tiki_short_date}</em></div>
</div>
<div style="padding:.5em;">	  
	<div align="left"><label for="general-long_time">{tr}Long time format{/tr}:</label><br /><input type="text" name="long_time_format" id="general-long_time" value="{$prefs.long_time_format|escape}" size="40" /><br /><em>{tr}Sample{/tr}: {$now|tiki_long_time}</em></div>
</div>
<div style="padding:.5em;">	  
	<div align="left"><label for="general-short_time">{tr}Short time format{/tr}:</label><br /><input type="text" name="short_time_format" id="general-short_time" value="{$prefs.short_time_format|escape}" size="40" /><br /><em>{tr}Sample{/tr}: {$now|tiki_short_time}</em></div>
</div>
<div style="padding:.5em;">	  
	<div align="left"><label for="general-display_fieldorder">{tr}Fields display order{/tr}:</label> 
