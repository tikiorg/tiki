...
<div class="t_navbar form-group btn-group">
	...
	{button class="btn btn-default" href="messu-compose.php" _class="btn btn-primary" _text="{tr}Compose{/tr}"}

	{if $tiki_p_broadcast eq 'y'}
		{button class="btn btn-default" href="messu-broadcast.php" _class="btn btn-info" _text="{tr}Broadcast{/tr}"}
	{/if}
