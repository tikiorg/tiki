...
<table class="normal" width="100%">
    <tr> 
      ...
      <td class="heading" width="30%"><a class="tableheading" href="tiki-workspaces_admin.php?offset={$offset}&amp;numrows={$numrows}&amp;sort_mode={if $sort_mode eq 'nombre_desc'}nombre_asc{else}nombre_desc{/if}">{tr}Name{/tr}</a></td>
...
{section name=i loop=$workspaces}
    ...
    <tr> 
      <td class="{$parImpar}"><a href="./tiki-workspaces_admin.php?viewWS={$workspaces[i].workspaceId}">{$workspaces[i].workspaceId}</a></td>
      <td class="{$parImpar}"><a href="./tiki-workspaces_admin.php?viewWS={$workspaces[i].workspaceId}">{$workspaces[i].code}</a></td>
      <td class="{$parImpar}"><a href="./tiki-workspaces_admin.php?viewWS={$workspaces[i].workspaceId}">{$workspaces[i].name}</a></td>
      <td class="{$parImpar}">{$workspaces[i].description}</td>
      <td class="{$parImpar}">{$workspaces[i].closed}</td>
      <td class="{$parImpar}"> <a class="link" href="tiki-workspaces_admin.php?viewWS={$viewWS}&edit={$workspaces[i].workspaceId}">
      ...
      <td class="{$parImpar}"><a class="link" href="tiki-workspaces_view_module.php?module=workspaces_resources&workspaceId={$workspaces[i].workspaceId}">
      	   <img src='img/icons/change.gif' border='0' alt='{tr}Resources{/tr}' title='{tr}Resources{/tr}' /></a>
      </td>
      <td class="{$parImpar}"><a class="link" href="tiki-workspaces_desktop.php?workspaceId={$workspaces[i].workspaceId}">
