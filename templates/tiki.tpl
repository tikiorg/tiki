...
<div id="tiki-main">
  ...
  <table id="tiki-midtbl" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
      {if $feature_left_column ne 'n' && $left_modules|@count > 0 && $show_columns.left_modules ne 'n'}
	...
	<div style="text-align:left;float:left;"><a class="flip" href="javascript:flip('leftcolumn','table-cell');">
      ...
      {if $feature_right_column ne 'n' && $right_modules|@count > 0 && $show_columns.right_modules ne 'n'}
