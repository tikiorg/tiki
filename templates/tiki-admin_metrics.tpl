		...
		{foreach from=$metrics_list key=i item=metric}
			<tr>
				...
				<td class="action">
					...
					<a class="tips"
					   title="{tr}Actions{/tr}"
					   href="#" {popup delay="0|2000" fullhtml="1" center=true text=$smarty.capture.metrics_actions|escape:"javascript"|escape:"html"}
		...
		{foreach from=$tabs_list key=i item=tab}
			<tr>
				...
				<td class="action">
					...
					<a class="tips"
					   title="{tr}Actions{/tr}"
					   href="#" {popup delay="0|2000" fullhtml="1" center=true text=$smarty.capture.metrics_tabs_actions|escape:"javascript"|escape:"html"}
					   style="padding:0; margin:0; border:0"
							>
						{icon name='wrench'}
					</a>
