<a class="pagetitle" href="tiki-admin_html_pages.php">{tr}Admin HTML pages{/tr}</a><br/>
{if $preview eq 'y'}
...
<tr><td class="formcolor">{tr}Content{/tr}:</td><td class="formcolor"><textarea name="content" rows="25" cols="60">{$info.content}</textarea></td></tr>
