...
{if $tiki_p_minor eq 'y'}
  <input type="submit" onmouseover="return overlib('{tr}Save the page, but do not sent notifications and do not count it as new content to be translated.{/tr}');" onmouseout="nd();" class="wikiaction" name="minor" value="{tr}Minor{/tr}" onclick="needToConfirm=false;" />
{/if}
