{* $Id$ *}
					...
					{if $prefs.pass_blacklist != 'n' && isset($prefs.pass_blacklist)}<div class="highlight"><em>{tr}Password must not be one of the 10,000 most used passwords.{/tr}</em></div>{/if}
