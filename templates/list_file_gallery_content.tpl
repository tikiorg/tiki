			...
			<tr>
				...
				{if ( $prefs.use_context_menu_icon eq 'y' or $prefs.use_context_menu_text eq 'y' )
					...
					<td style="white-space: nowrap">
						<a class="fgalname tips" title="{tr}Actions{/tr}" href="#" onclick="return false;" {popup fullhtml="1" center=true trigger="click" delay="0" text=$smarty.capture.over_actions|escape:"javascript"|escape:"html"} style="padding:0; margin:0; border:0">
