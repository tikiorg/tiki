...
<a href="tiki-admin.php?page=look" title="{tr}Customize look and feel of your Tiki{/tr}" class="link"><img border="0" src="pics/large/gnome-settings-background.png" alt="{tr}Look &amp; Feel{/tr}" /></a>
...
<a href="tiki-admin.php?page=textarea" title="{tr}Text area{/tr}" class="link"><img border="0" src="img/icons/admin_textarea.png" alt="{tr}Text area{/tr}" /></a>      

<a href="tiki-admin.php?page=module" title="{tr}Module{/tr}" class="link"><img border="0" src="pics/large/display-capplet.png" alt="{tr}Module{/tr}" /></a>   
...
<a href="tiki-admin.php?page=category" title="{tr}Category{/tr}" class="link"><img border="0" src="pics/large/categories.png" alt="{tr}Category{/tr}" /></a>
{/if}
...
<a href="tiki-admin.php?page=multimedia" title="{tr}Multimedia{/tr}" class="link"><img border="0" src="pics/large/multimedia.png" alt="{tr}Multimedia{/tr}"  width="32" height="32" /></a>
{/if}

{if $prefs.feature_copyright eq 'y'}
<a href="tiki-admin.php?page=copyright" title="{tr}Copyright{/tr}" class="link"><img border="0" src="pics/large/copyright.png" alt="{tr}Copyright{/tr}" width="32" height="32" /></a>
{/if}
...
<a href="tiki-admin.php?page=ads" title="{tr}Site Ads and Banners{/tr}" class="link"><img border="0" src="pics/large/ads.png" alt="{tr}Site Ads and Banners{/tr}" width="32" height="32" /></a>
{/if}
