...
<a href="tiki-edit_templates.php?template=tiki-packager_admin_packages.tpl" target="tikihelp" class="tikihelp" title="{tr}View template{/tr}: {tr}Packager Admin{/tr}">
