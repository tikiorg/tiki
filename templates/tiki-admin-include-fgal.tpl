{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-admin-include-fgal.tpl,v 1.26 2006-12-12 17:22:55 sylvieg Exp $ *}
      ...
      <form action="tiki-admin.php?page=fgal" method="post">
        <table class="admin"><tr class="formcolor">
          ...
          <td><input type="radio" name="fgal_use_db" value="n"
              ...
              value="{$fgal_use_dir|escape}" size="50" /><br /><i>{tr}Can be not web accessible{/tr}</i></td>
        </tr><tr class="formcolor">
