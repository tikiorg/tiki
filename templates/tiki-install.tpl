...
{if $mail_test_performed ne 'y'}
	...
	<form action="tiki-install.php#mail" method="post">
		...
		<div align="center">
			<input type="submit" class="btn btn-default btn-sm" value=" {tr}Send Test Message{/tr} ">
		</div>
{if $multi}		<input type="hidden" name="multi" value="{$multi}">{/if}
{if $lang}		<input type="hidden" name="lang" value="{$lang}">{/if}
...
{else}
	<div align="center" style="padding:1em">
		...
		<form action="tiki-install.php" method="post">
			...
			{if $multi}<input type="hidden" name="multi" value="{$multi}">{/if}
			{if $lang}<input type="hidden" name="lang" value="{$lang}">{/if}
			<input type="submit" class="btn btn-default btn-sm" value=" {tr}Use Existing Connection{/tr} ">
		</form>
		or<br>
...
{/foreach}
		...
		<div align="center" style="margin-top:1em;"><input type="submit" class="btn btn-default btn-sm" name="dbinfo" value=" {tr}Continue{/tr} "></div>
	</form>
  </div>
</div>
	  	...
	  	{remarksbox icon=error title="{tr}Encoding Issue{/tr}"}
			...
			<form method="post" action="">
				<fieldset>
					...
					<p>
						<input type="submit" class="btn btn-default btn-sm" name="convert_to_utf8" value="{tr}Convert database and tables to UTF-8{/tr}">
						<input type="hidden" name="install_step" value="4">
					</p>
				</fieldset>
			</form>
		...
		<td valign="top">
			<fieldset><legend>{tr}Install{/tr}</legend>
				...
				{/if}
					...
					{/if}
				<p align="center">
					<input type="submit" class="btn btn-default btn-sm" name="scratch" value=" {if $tikidb_created}{tr}Reinstall{/tr}{else}{tr}Install{/tr}{/if} " style="margin: 32px;">
				</p>
			</div>
			</fieldset>
		</td>
			...
			<p align="center"><input type="submit" class="btn btn-default btn-sm" name="update" value=" {tr}Upgrade{/tr} "></p>
			</fieldset>
			</td>
			{/if}
		</tr></table>
			...
			<fieldset>
				...
				{if $client_charset_in_file eq 'utf8'}
					<p>
						...
						<input type="submit" class="btn btn-default btn-sm" name="fix_double_encoding" value="{tr}Dangerous: Fix double encoding{/tr}">
						<input type="hidden" name="install_step" value="7">
					</p>
				{else}
