...
<form action="tiki-admin.php?page=calendar" method="post">
	...
	<fieldset>
		...
		<div class="adminoptionbox">
			<div class="adminoptionlabel">
				<label for="calendar_view_mode">{tr}Default view mode{/tr}:</label>
		...
		<div class="adminoptionbox">
			<div class="adminoptionlabel">
				<label for="calendar_list_begins_focus">{tr}View list begins{/tr}:</label>
		...
		<div class="adminoptionbox">
		<div class="adminoptionlabel">
			<label for="calendar_timespan">{tr}Split hours in periods of{/tr}: </label>
	...
	<div class="adminoptionbox">
		<div class="adminoption">
			<input type="checkbox" id="feature_cal_manual_time" name="feature_cal_manual_time" {if $prefs.feature_cal_manual_time eq 'y'}checked="checked"{/if}/>
		</div>
		<div class="adminoptionlabel">
			<label for="feature_cal_manual_time">{tr}Manual selection of time/date{/tr}</label>
		</div>
	</div>
	<div class="adminoptionbox">
		<div class="adminoption">
		...
		<div id="usejscalendar" style="display:{if $prefs.feature_jscalendar eq 'y'}none{else}block{/if}">
			...
			<div class="adminoptionbox">
				<div class="adminoptionlabel">
					<label for="calendar_start_year">{tr}First year in the dropdown{/tr}</label>:
					<input type="text" name="calendar_start_year" id="calendar_start_year" value="{$prefs.calendar_start_year}" />
					<br />
					<em>{tr}Enter a year or use +/- N to specify a year relative to the current year{/tr}.</em>
				</div>
			</div>
			<div class="adminoptionbox">
				<div class="adminoptionlabel">
					<label for="calendar_end_year">{tr}Last year in the dropdown{/tr}</label>:
					<input type="text" id="calendar_end_year" name="calendar_end_year" value="{$prefs.calendar_end_year}" />
					<br />
					<em>{tr}Enter a year or use +/- N to specify a year relative to the current year{/tr}.</em>
				</div>
			</div>
		...
		<div class="adminoptionbox">
			<div class="adminoption">
				<input type="checkbox" id="calendar_sticky_popup" name="calendar_sticky_popup" {if $prefs.calendar_sticky_popup eq 'y'}checked="checked" {/if}/>
			</div>
			<div class="adminoptionlabel">
				<label for="calendar_sticky_popup">{tr}Sticky popup{/tr}</label>
			</div>
		</div>
		{preference name=feature_action_calendar}
		<div class="adminoptionbox">
			<div class="adminoption">
				<input type="checkbox" id="calendar_view_tab" name="calendar_view_tab" {if $prefs.calendar_view_tab eq 'y'}checked="checked" {/if}/>
			</div>
			<div class="adminoptionlabel">
