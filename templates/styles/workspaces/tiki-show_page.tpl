{* $Header: /cvsroot/tikiwiki/tiki/templates/styles/workspaces/tiki-show_page.tpl,v 1.2 2006-10-01 14:18:28 ohertel Exp $ *}
...
{if $print_page ne 'y'}
	...
	{if $user and $feature_user_watches eq 'y'}
		{if $user_watching_page eq 'n'}
			<a href="tiki-index.php?page={$page|escape:"url"}&amp;watch_event=wiki_page_changed&amp;watch_object={$page|escape:"url"}&amp;watch_action=add"><img src='pics/icons/eye.png' border='0' alt="{tr}monitor this page{/tr}" title="{tr}monitor this page{/tr}" width='16' height='16' /></a>
		{else}
			<a href="tiki-index.php?page={$page|escape:"url"}&amp;watch_event=wiki_page_changed&amp;watch_object={$page|escape:"url"}&amp;watch_action=remove"><img src='pics/icons/no_eye.png' border='0' alt="{tr}stop monitoring this page{/tr}" title="{tr}stop monitoring this page{/tr}" width='16' height='16' /></a>
		{/if}
	{/if}
	</td>
