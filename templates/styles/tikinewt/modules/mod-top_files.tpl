{* based on /cvsroot/tikiwiki/tiki/templates/modules/mod-top_files.tpl,v 1.13 2007/10/14 17:51:02 mose *}
...
<li>
<a class="linkmodule" href="tiki-download_file.php?fileId={$modTopFiles[ix].fileId}">{$modTopFiles[ix].filename}</a>
</li>
{/section}
{if $nonums != 'y'}</ol>{else}</ul>{/if}
{/tikimodule}
