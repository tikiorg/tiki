{* based on /cvsroot/tikiwiki/tiki/templates/modules/mod-top_visited_blogs.tpl,v 1.15 2007/10/14 17:51:02 mose *}
...
{/if}
	...
	<li>
	<a class="linkmodule" href="tiki-view_blog.php?blogId={$modTopVisitedBlogs[ix].blogId}">{$modTopVisitedBlogs[ix].title}</a>
	</li>
    {/section}
	{if $nonums != 'y'}</ol>{else}</ul>{/if}
    {/tikimodule}
