...
<div class="fcol2">
	<img src="styles/strasa/info_icon.png" alt="info_icon" width="46" height="46" /><span class="titlefooter">Heading Two</span><br clear="all">
	<ul>
...
<div class="fcol3">
	<img src="styles/strasa/link_icon.png" alt="link_icon" width="46" height="46" /><span class="titlefooter">Heading Three</span><br clear="all">
	<ul>
