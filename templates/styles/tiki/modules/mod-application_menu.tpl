{* $Header: /cvsroot/tikiwiki/tiki/templates/styles/tiki/modules/mod-application_menu.tpl,v 1.21 2004-05-06 00:24:22 mose Exp $ *}
...
{/if}
  ...
  {if $feature_dump eq 'y' and $tiki_p_view eq 'y'}
    <div class="separated"><a href="dump/{if $tikidomain}{$tikidomain}/{/if}new.tar" class="linkmenu">{tr}dump{/tr}</a></div>
  {/if}
  ...
  <div id='admmnu' style="{$mnu_admmnu}">
    ...
    {if $tiki_p_admin eq 'y'}
      ...
      <div class="separated"><a href="tiki-theme_control.php" class="linkmenu">{tr}Theme control{/tr}</a></div>
			<div class="separated"><a href="tiki-admin_quicktags.php" class="linkmenu">{tr}QuickTags{/tr}</a></div>
    {/if}
    ...
    <div class="separated"><a href="tiki-admin_external_wikis.php" class="linkmenu">{tr}External wikis{/tr}</a></div>
		<div class="separated"><a href="tiki-admin_system.php" class="linkmenu">{tr}System Admin{/tr}</a></div>
    {/if}
		{/sortlinks}
  </div>
