...
{* top left wiki ck box ... each of the function option boxes here begin with  td class form *}
	<tr>
        <td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_wiki" id="" {if $feature_wiki eq 'y'}checked="checked"{/if}/></td>
{* blank cell *}
        <td>&nbsp;</td>
{* beginning of the new cell for blogs followed by a check box cell *}
				<td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_blogs" id="" {if $feature_blogs eq 'y'}checked="checked"{/if}/></td>
      </tr>
{* end of the first row *}
	<tr>
        	<td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_galleries" id="" {if $feature_galleries eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
	<td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_file_galleries" id="" {if $feature_file_galleries eq 'y'}checked="checked"{/if}/></td>
      </tr>
	<tr>
        	<td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_articles" id="" {if $feature_articles eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
				{if $feature_help eq 'y'}<a href="http://tikiwiki.org/tiki-index.php?page=Article" target="tikihelp" class="tikihelp" title="{tr}Tikiwiki.org help{/tr}: {tr}Articles{/tr}">{/if}
				{tr}Submissions{/tr}
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_submissions" id="" {if $feature_submissions eq 'y'}checked="checked"{/if}/></td>
      </tr>
	<tr>
        <td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_faqs" id="" {if $feature_faqs eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_forums" id="" {if $feature_forums eq 'y'}checked="checked"{/if}/></td>
      </tr>
	<tr>
        <td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_chat" id="" {if $feature_chat eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
				<td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_shoutbox" id="" {if $feature_shoutbox eq 'y'}checked="checked"{/if}/></td>
      </tr>
			<tr>
        <td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_directory" id="" {if $feature_directory eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
				<td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_trackers" id="" {if $feature_trackers eq 'y'}checked="checked"{/if}/></td>
      </tr>
			<tr>
        <td>
        ...
        <td><input type="checkbox" name="feature_newsreader" id="" {if $feature_newsreader eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
				<td>
        ...
        <td><input type="checkbox" name="feature_webmail" id="" {if $feature_webmail eq 'y'}checked="checked"{/if}/></td>
      </tr>
			<tr>
        <td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_polls" id="" {if $feature_polls eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
				<td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_surveys" id="" {if $feature_surveys eq 'y'}checked="checked"{/if}/></td>
      </tr>
			<tr>
        <td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_quizzes" id="" {if $feature_quizzes eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
				<td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_eph" id="" {if $feature_eph eq 'y'}checked="checked"{/if}/></td>
      </tr>
			<tr>
        <td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_featuredLinks" id="" {if $feature_featuredLinks eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
				<td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_search" id="" {if $feature_search eq 'y'}checked="checked"{/if}/></td>
      </tr>
			<tr>
        <td>
        	...
        	{if $feature_help eq 'y'}</a>{/if}
        	:</td>
        <td><input type="checkbox" name="feature_banners" id="" {if $feature_banners eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
				<td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_search_fulltext" id="" {if $feature_search_fulltext eq 'y'}checked="checked"{/if}/></td>
      </tr>
			<tr>
        <td>
	        	...
	        	{if $feature_help eq 'y'}</a>{/if}
	        	:</td>
        <td><input type="checkbox" name="feature_games" id="" {if $feature_games eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
				<td>
					...
					{if $feature_help eq 'y'}</a>{/if}
					:</td>
        <td><input type="checkbox" name="feature_search_stats" id="" {if $feature_search_stats eq 'y'}checked="checked"{/if}/></td>
      </tr>
			<tr>
        <td>
	        		...
	        		{if $feature_help eq 'y'}</a>{/if}
	        		:</td>
        <td><input type="checkbox" name="feature_newsletters" id="" {if $feature_newsletters eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
				<td>
					...
					{if $feature_help eq 'y'}</a>{/if}
					:</td>
        <td><input type="checkbox" name="feature_live_support" id="" {if $feature_live_support eq 'y'}checked="checked"{/if}/></td>
      </tr>			
			<tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_html_pages" id="" {if $feature_html_pages eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_workflow" id="" {if $feature_workflow eq 'y'}checked="checked"{/if}/></td>
      </tr><tr>
{* beginning of mini calendar function option *}
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_minical" id="" {if $feature_minical eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
{* here's the categories option *}
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_categories" id="" {if $feature_categories eq 'y'}checked="checked"{/if}/></td>
      </tr>
...
<td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_help" id="" {if $feature_help eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_maps" id="" {if $feature_maps eq 'y'}checked="checked"{/if}/></td>
      </tr>
      <tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_categorypath" id="" {if $feature_categorypath eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_babelfish" id="" {if $feature_babelfish eq 'y'}checked="checked"{/if}/></td>
      </tr>
      <tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_categoryobjects" id="" {if $feature_categoryobjects eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		:</td>
        <td><input type="checkbox" name="feature_babelfish_logo" id="" {if $feature_babelfish_logo eq 'y'}checked="checked"{/if}/></td>
      </tr>
      <tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_modulecontrols" id="" {if $feature_modulecontrols eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
					...
					{if $feature_help eq 'y'}</a>{/if}
					:</td>
	<td><input type="checkbox" name="feature_calendar" id="" {if $feature_calendar eq 'y'}checked="checked"{/if}/></td>
      </tr>
            <tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_autolinks" id="" {if $feature_autolinks eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_view_tpl" id="" {if $feature_view_tpl eq 'y'}checked="checked"{/if}/></td>
      </tr>
            <tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_integrator" id="" {if $feature_integrator eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_phplayers" id="" {if $feature_phplayers eq 'y'}checked="checked"{/if}/></td>
      </tr>
            <tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_jscalendar" id="" {if $feature_jscalendar eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
	</td>
        <td></td>
...
{* ---------- Content features ------------ *}
      ...
      <tr>
        <td class="heading" colspan="5">{tr}Content Features{/tr}</td>
      </tr><tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_hotwords" id="" {if $feature_hotwords eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_edit_templates" id="" {if $feature_edit_templates eq 'y'}checked="checked"{/if}/></td>
      </tr><tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_hotwords_nw" id="" {if $feature_hotwords_nw eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_editcss" id="" {if $feature_editcss eq 'y'}checked="checked"{/if}/></td>
      </tr><tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_custom_home" id="" {if $feature_custom_home eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_dynamic_content" id="" {if $feature_dynamic_content eq 'y'}checked="checked"{/if}/></td>
      </tr><tr>
        <td>
				...
				{if $feature_help eq 'y'}</a>{/if}
				:</td>
        <td><input type="checkbox" name="feature_drawings" id="" {if $feature_drawings eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
		        ...
		        {if $feature_help eq 'y'}</a>{/if}
		        :</td>
        <td><input type="checkbox" name="feature_smileys" id=""
        ...
        <td>
		        ...
		        {if $feature_help eq 'y'}</a>{/if}
		        :</td>
        <td><input type="checkbox" name="feature_charts" id=""
            {if $feature_charts eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td  colspan="2">&nbsp;</td>
      </tr><tr>
        <td class="heading" colspan="5">{tr}Administration Features{/tr}</td>
      </tr><tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_banning" id=""
        ...
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_debug_console" id=""
        ...
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_stats" id=""
        ...
        <td>
		        ...
		        {if $feature_help eq 'y'}</a>{/if}
		        :</td>
        <td><input type="checkbox" name="feature_comm" id=""
        ...
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_phpopentracker" id=""
        ...
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_xmlrpc" id=""
        ...
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_referer_stats" id="" {if $feature_referer_stats eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_contact" id="" {if $feature_contact eq 'y'}checked="checked"{/if}/></td>
      </tr><tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_theme_control" id="" {if $feature_theme_control eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td colspan="2">&nbsp;</td>
      </tr><tr>
        <td class="heading" colspan="5">{tr}User Features{/tr}</td>
      </tr><tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_userPreferences" id="" {if $feature_userPreferences eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="user_assigned_modules" id="" {if $user_assigned_modules eq 'y'}checked="checked"{/if}/></td>
      </tr><tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_user_bookmarks" id="" {if $feature_user_bookmarks eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_usermenu" id="" {if $feature_usermenu eq 'y'}checked="checked"{/if}/></td>
      </tr><tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_user_watches" id="" {if $feature_user_watches eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_messages" id="" {if $feature_messages eq 'y'}checked="checked"{/if}/></td>
      </tr><tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_tasks" id="" {if $feature_tasks eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_notepad" id="" {if $feature_notepad eq 'y'}checked="checked"{/if}/></td>
      </tr><tr>
        <td>
        		...
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
        <td><input type="checkbox" name="feature_userfiles" id="" {if $feature_userfiles eq 'y'}checked="checked"{/if}/></td>
        <td>&nbsp;</td>
        <td colspan="2">&nbsp;</td>
      </tr><tr>
