...
<tr>
  ...
  <iframe frameborder="0" height="200" scrolling="auto" marginwidth="0" marginheight="0"  src="tiki-chat_users.php?channelId={$channelId}"></iframe>
  </td>
...
<tr>
  <td class="tdchatform">
  <iframe name="chatbox" scrolling="no"  height="52" frameborder="0" src="tiki-chat_box.php?nickname={$nickname}&amp;channelId={$channelId}">Browser not supported</iframe>
  </td>
</tr>  
</table>
<table class="chatform">
