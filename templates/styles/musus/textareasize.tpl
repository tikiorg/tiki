...
<a href="javascript:textareasize('{$area_name}', +10, 0, '{$formId}')" title="{tr}Click here to enlarge the textarea height{/tr}"><img src="img/icons2/enlargeH.gif" alt="{tr}Enlarge textarea height{/tr}" /></a>
<a href="javascript:textareasize('{$area_name}', -10, 0, '{$formId}')" title="{tr}Click here to reduce the textarea height{/tr}"><img src="img/icons2/reduceH.gif" alt="{tr}Reduce textarea height{/tr}" /></a>
