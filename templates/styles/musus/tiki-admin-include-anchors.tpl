...
<a href="tiki-admin.php?page=rss" title="{tr}RSS{/tr}">{tikicon igroup="admin" iname="rss" iexplain="{tr}RSS{/tr}"}</a>
<a href="tiki-admin.php?page=cms" title="{tr}Articles{/tr}">{tikicon igroup="admin" iname="articles" iexplain="{tr}Articles{/tr}"}</a>
<a href="tiki-admin.php?page=faqs" title="{tr}FAQs{/tr}">{tikicon igroup="admin" iname="faqs" iexplain="{tr}FAQs{/tr}"}</a>
<a href="tiki-admin.php?page=trackers" title="{tr}Trackers{/tr}">{tikicon igroup="admin" iname="trackers" iexplain="{tr}Trackers{/tr}"}</a>
<a href="tiki-admin.php?page=webmail" title="{tr}Webmail{/tr}">{tikicon igroup="admin" iname="webmail" iexplain="{tr}Webmail{/tr}"}</a>
<a href="tiki-admin.php?page=directory" title="{tr}Directory{/tr}">{tikicon igroup="admin" iname="directory" iexplain="{tr}Directory{/tr}"}</a>
<a href="tiki-admin.php?page=userfiles" title="{tr}User files{/tr}">{tikicon igroup="admin" iname="userfiles" iexplain="{tr}User files{/tr}"}</a>
<a href="tiki-admin.php?page=maps" title="{tr}Maps{/tr}">{tikicon igroup="admin" iname="maps" iexplain="{tr}Maps{/tr}"}</a>
