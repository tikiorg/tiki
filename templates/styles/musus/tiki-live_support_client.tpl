...
<html>
  ...
  <body onUnload="client_close();">
  	<div id='request_chat' align="center">
		...
		<br /><br />
		<!--<a href="tiki-live_support_message.php">{tr}Open a support ticket instead{/tr}</a>-->
	</div>
	
	<div id='requesting_chat' style='display:none;'>
		<b>{tr}Your request is being processed{/tr}....</b>
		<br /><br />
		<a href="javascript:client_close();window.close();">{tr}cancel request and exit{/tr}</a><br />
		<!--<a href="tiki-live_support_message.php">{tr}cancel request and leave a message{/tr}</a></br>-->
	</div>
