    ...
    <div class="simplebox">
      <form action="tiki-admin.php?page=blogs" method="post">
        <table class="admin"><tr>
          <td><label for="blogs-home">{tr}Home Blog (main blog){/tr}</label></td>
    ...
    <div class="simplebox">
      ...
      <form method="post" action="tiki-admin.php?page=blogs">
        <table class="admin"><tr>
          ...
          <td><input type="checkbox" name="blog_list_title" id="blogs-title"
              {if $blog_list_title eq 'y'}checked="checked"{/if}></td>
        </tr><tr>
          <td><label for="blogs-desc">{tr}Description{/tr}</label></td>
          <td><input type="checkbox" name="blog_list_description" id="blogs-desc"
              {if $blog_list_description eq 'y'}checked="checked"{/if}></td>
        </tr><tr>
          <td><label for="blogs-creation">{tr}Creation date{/tr}</label></td>
          <td><input type="checkbox" name="blog_list_created" id="blogs-creation"
              {if $blog_list_created eq 'y'}checked="checked"{/if}></td>
        </tr><tr>
          <td><label for="blogs-lastmod">{tr}Last modification time{/tr}</label></td>
          <td><input type="checkbox" name="blog_list_lastmodif" id="blogs-lastmod"
              {if $blog_list_lastmodif eq 'y'}checked="checked"{/if}></td>
        </tr><tr>
          <td><label for="blogs-user">{tr}User{/tr}</label></td>
          <td><input type="checkbox" name="blog_list_user" id="blogs-user"
              {if $blog_list_user eq 'y'}checked="checked"{/if}></td>
        </tr><tr>
          <td><label for="blogs-posts">{tr}Posts{/tr}</label></td>
          <td><input type="checkbox" name="blog_list_posts" id="blogs-posts"
              {if $blog_list_posts eq 'y'}checked="checked"{/if}></td>
        </tr><tr>
          <td><label for="blogs-visits">{tr}Visits{/tr}</label></td>
          <td><input type="checkbox" name="blog_list_visits" id="blogs-visits"
              {if $blog_list_visits eq 'y'}checked="checked"{/if}></td>
        </tr><tr>
          <td><label for="blogs-activity">{tr}Activity{/tr}</label></td>
          <td><input type="checkbox" name="blog_list_activity" id="blogs-activity"
