...
<table class="admin">
<tr><td>{tr}Allow viewing HTML mails?{/tr}</td><td><input type="checkbox" name="webmail_view_html" {if $webmail_view_html eq 'y'}checked="checked"{/if} /></td></tr>
<tr><td>{tr}Maximum size for each attachment{/tr}:</td><td><select name="webmail_max_attachment">
