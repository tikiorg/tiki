...
<tr>
  ...
  <tr><td>{tr}Is email public? (uses scrambling to prevent spam){/tr}</td><td>
  ...
  <tr><td>{tr}Theme{/tr}:</td><td><select name="style">
		...
		{if $feature_editcss and $tiki_p_create_css}
			<a href="tiki-edit_css.php" title="{tr}Edit CSS{/tr}">{tr}Edit CSS{/tr}</a>
		{/if}
				</td></tr>
  {/if}
  ...
  {/if}      
  <tr><td>{tr}Real Name{/tr}:</td><td><input type="text" name="realName" value="{$realName|escape}" /></td></tr>
  <tr><td>{tr}Avatar{/tr}:</td><td>{$avatar} <a href="tiki-pick_avatar.php">{tr}Pick user Avatar{/tr}</a></td></tr>
  <tr><td>{tr}Number of visited pages to remember{/tr}:</td><td>
  ...
  <tr><td>{tr}HomePage{/tr}:</td><td><input type="text" name="homePage" value="{$homePage|escape}" /></td></tr>
  {if $feature_wiki eq 'y'}
  <tr><td>{tr}Your personal Wiki Page{/tr}:</td><td><a href="tiki-index.php?page=UserPage{$userinfo.login}">UserPage{$userinfo.login}</a> (<a href="tiki-editpage.php?page=UserPage{$userinfo.login}">{tr}edit{/tr}</a>)</td></tr>
  {/if}
  
  <tr><td>{tr}Displayed time zone{/tr}:</td>
  <td>
  ...
  <tr><td>{tr}User information{/tr}:</td><td>
  ...
  {if $feature_wiki eq 'y'}
  <tr><td>{tr}Use dbl click to edit pages{/tr}:</td>
  <td>
  ...
  {section name=ir loop=$customfields}
    <tr><td>{$customfields[ir].prefName}:</td>
  ...
  <input type="hidden" name="view_user" value="{$userwatch|escape}" />
  <table class="admin">
  <tr><td>{tr}Email{/tr}:</td><td><input type="text" name="email" value="{$userinfo.email|escape}" /></td>
...
<tr>
  ...
  <td><input type="checkbox" name="allowMsgs" {if $allowMsgs eq 'y'}checked="checked"{/if}/></td>
</tr>
<tr>
...
<tr>
  ...
  <td><input type="checkbox" name="tasks_useDates" {if $tasks_useDates eq 'y'}checked="checked"{/if}/></td>
</tr>
...
<br />
    ...
    <div class="tiki">
      ...
      <div class="tiki-content">
        ...
        <form action="tiki-user_preferences.php" method="post">
<table class="admin">
<tr><td>{tr}My pages{/tr}</td><td><input type="checkbox" name="mytiki_pages" {if $mytiki_pages eq 'y'}checked="checked"{/if} /></td></tr>
<tr><td>{tr}My blogs{/tr}</td><td><input type="checkbox" name="mytiki_blogs" {if $mytiki_blogs eq 'y'}checked="checked"{/if} /></td></tr>
<tr><td>{tr}My galleries{/tr}</td><td><input type="checkbox" name="mytiki_gals" {if $mytiki_gals eq 'y'}checked="checked"{/if} /></td></tr>
<tr><td>{tr}My messages{/tr}</td><td><input type="checkbox" name="mytiki_msgs" {if $mytiki_msgs eq 'y'}checked="checked"{/if} /></td></tr>
<tr><td>{tr}My tasks{/tr}</td><td><input type="checkbox" name="mytiki_tasks" {if $mytiki_tasks eq 'y'}checked="checked"{/if} /></td></tr>
<tr><td>{tr}My items{/tr}</td><td><input type="checkbox" name="mytiki_items" {if $mytiki_items eq 'y'}checked="checked"{/if} /></td></tr>
<tr>
