{* $Header: /cvsroot/tikiwiki/tiki/templates/styles/musus/tiki-admin_drawings.tpl,v 1.2 2004-01-13 18:57:33 musus Exp $ *}

<a class="pagetitle" href="tiki-admin_drawings.php">{tr}Admin drawings{/tr}</a>
<!-- the help link info -->
  
{if $feature_help eq 'y'}
<a href="http://tikiwiki.org/tiki-index.php?page=DrawingsDoc" target="tikihelp" class="tikihelp" title="{tr}Tikiwiki.org help{/tr}: {tr}admin Drawings{/tr}"><img alt="{tr}Help{/tr}" src="img/icons/help.gif" /></a>
{/if}
...
<td>{tr}Name{/tr}</td>
<td>{tr}Ver{/tr}</a></td>
<td>{tr}Versions{/tr}</a></td>
<td>{tr}Action{/tr}</a></td>
</tr>
