...
<td valign="top"><a href="tiki-user_tasks.php" title="{tr}Tasks{/tr}">
...
<td valign="top"><a href="tiki-user_bookmarks.php" title="{tr}Bookmarks{/tr}">
...
<td valign="top"><a href="tiki-user_assigned_modules.php" title="{tr}Modules{/tr}">
