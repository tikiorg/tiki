...
<table  border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td id="page14"  {if $feature_right_column ne 'n'}colspan="2"{/if}><img src="styles/codex/page_0.gif" width="50" height="31" alt="" border="0" /></td>
	...
	<tr>
		...
		<td id="page34"  {if $feature_right_column ne 'n'}colspan="2"{/if}><img src="styles/codex/page_0.gif" width="50" height="41" alt="" border="0" /></td>
