...
<div class="t_navbar">
	{button href="tiki-user_tasks.php?show_form=y" _class="btn btn-primary" _text="{tr}New task{/tr}"}
	...
	{if (not $show_form)} 
		{button href="tiki-user_tasks.php?emty_trash=Empty trash" _class="btn btn-warning" _text="{tr}Empty Trash{/tr}"}
	{/if}
</div>
