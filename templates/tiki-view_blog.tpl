		...
		<div class="postfooter">
			...
			<div class="actions"> {* renamed to match forum footer layout *}
				...
				{if $allow_comments eq 'y' and $prefs.feature_blogposts_comments eq 'y'}
					<a class="link" href="tiki-view_blog_post.php?find={$find|escape:url}&amp;blogId={$blogId}&amp;offset={$offset}&amp;sort_mode={$sort_mode}&amp;postId={$listpages[ix].postId}&amp;show_comments=1">
