						...
						{if $users}
							<p align="left"> {*on the left to have it close to the checkboxes*}
								<div id="submit_mult">
									...
									<input class="submit_mult" type="submit" class="btn btn-default" value="{tr}OK{/tr}">
									<button id="enable" type="button" style="display: none" class="btn btn-default">{tr}Re-enable action choices{/tr}</button>
								</div>
							</p>
							...
							<div id="dg" style="display:none">
								...
								<br>
								<input type="submit" class="dg" disabled="disabled" class="btn btn-default" value="{tr}OK{/tr}">
