								...
								<td class="text">
									...
									<div style="margin-left:10px;">
										{if $channels[user].url}
											{tr}URL:{/tr} <a href="{if $escape_menu_labels}{$channels[user].url|escape}{else}{$channels[user].url}{/if}" class="link" target="_blank" title="{$channels[user].canonic|escape}">{$channels[user].canonic|truncate:40:' ...'|escape}</a>
										{/if}
