                ...
                <table class="table normal table-striped table-hover">
                    ...
                    {section name=user loop=$channels}
                        <tr>
                            ...
                            <td class="text">
                                <a href="tiki-admin_menu_options.php?menuId={$menuId}&amp;offset={$offset}&amp;sort_mode={$sort_mode}&amp;optionId={$channels[user].optionId}&amp;maxRecords={$maxRecords}{if !empty($nbRecords)}&amp;nbRecords={$nbRecords}{/if}"
                                   class="tips"
                            ...
                            <td class="action">
                                ...
                                <a class="tips"
                                   title="{tr}Actions{/tr}"
                                   href="#" {popup delay="0|2000" fullhtml="1" center=true text=$smarty.capture.menu_options_actions|escape:"javascript"|escape:"html"}
