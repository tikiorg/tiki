...
{tr}Someone{/tr} {if $clearpw eq 'y'}{tr}requested a reminder of the password for your {$prefs.mail_template_custom_text}account{/tr}{else}{tr}requested password reset for your {$prefs.mail_template_custom_text}account{/tr} {/if} ({$mail_site}).
