<a class="pagetitle" href="tiki-replicate.php">{tr}Replicate{/tr}</a>
...
<a href="tiki-edit_templates.php?template=templates/tiki-replicate.tpl" target="tikihelp" class="tikihelp" title="{tr}View tpl{/tr}: {tr}system admin tpl{/tr}">
