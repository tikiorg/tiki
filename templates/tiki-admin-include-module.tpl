...
<form action="tiki-admin.php?page=module" method="post">
	...
	<fieldset>
		...
		<div class="adminoptionbox">
			<div class="adminoptionlabel"><label for="user_flip_modules">{tr}Users can shade modules{/tr}:</label>
				<select id="user_flip_modules" name="user_flip_modules">
				...
				</select>{if $prefs.feature_help eq 'y'} {help url="Users+Shade+Modules"}{/if}
			</div>
		</div>
		<div class="adminoptionbox">
