            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                        {assign var='pref_name' value="fgal_$key"}
                         <input type="checkbox" id="fgal_{$key}" name="fgal_{$key}" {if $item.value eq 'y'}checked="checked"{/if}{if $edit_mode eq 'y' and $prefs.$pref_name neq 'y'} disabled="disabled"{/if}>
