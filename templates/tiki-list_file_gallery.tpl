...
$("#viewSwitcher").change(function() {
	...
	location.replace(loc);
		...
		{if $tiki_p_admin_file_galleries eq 'y' or $user eq $gal_info.user or $gal_info.public eq 'y'}
			{if $tiki_p_upload_files eq 'y'}
				{button _type="primary" _keepall='y' _text="{tr}Upload File{/tr}" href="tiki-upload_file.php" galleryId=$galleryId}
			{/if}
	...
	{else}
		...
		{/if}
		{if $tiki_p_upload_files eq 'y'}
			{button _type="primary" _text="{tr}Upload File{/tr}" href="tiki-upload_file.php"}
		{/if}
	{/if}
