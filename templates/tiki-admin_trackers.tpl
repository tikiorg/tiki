...
<tr>
<td class="{cycle advance=false}"><a href="tiki-admin_trackers.php?offset={$offset}&amp;sort_mode={$sort_mode}&amp;trackerId={$channels[user].trackerId}"><img src='img/icons/edit.gif' alt='{tr}edit{/tr}' title='{tr}edit{/tr}' border='0' /></a></td>
...
<td class="{cycle advance=false}" nowrap="nowrap">{if $channels[user].individual eq 'y'}({/if}<a 
...
<td class="{cycle advance=false}"><a class="link" href="tiki-admin_tracker_fields.php?trackerId={$channels[user].trackerId}"><img src='img/icons/ico_table.gif' alt='{tr}fields{/tr}' title='{tr}fields{/tr}' border='0' /></a></td>
...
<td  class="{cycle}"><a class="link" href="tiki-admin_trackers.php?offset={$offset}&amp;sort_mode={$sort_mode}&amp;remove={$channels[user].trackerId}"><img src='img/icons2/delete.gif' alt='{tr}remove{/tr}' title='{tr}remove{/tr}' border='0' /></a></td>
</tr>
{/section}
</table>
<div class="mini">
