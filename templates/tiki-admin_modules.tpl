{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-admin_modules.tpl,v 1.62.2.3 2007-11-06 23:50:28 sylvieg Exp $ *}
...
{if $prefs.feature_help eq 'y'}<a href="{$prefs.helpurl}Modules+Admin" target="tikihelp" class="tikihelp" title="{tr}Admin Modules{/tr}"><img border='0' src='pics/icons/help.png' alt="{tr}Help{/tr}" width="16" height="16" /></a>{/if}</td></tr>
...
<tr>
  ...
  <td class="form">
	...
	<a {popup text="Params: id= type=tree|phptree|plain|hort|vert file= sectionLevel=" width=100 center=true}><img src="pics/icons/help.png" border="0" height="16" width="16" alt='{tr}Help{/tr}' /></a>
