...
<ul>
	<li>{tr}Visit the <a href="tiki-admin.php?profile=&categories%5B%5D=12.x&repository=http%3a%2f%2fprofiles.tiki.org%2fprofiles&page=profiles&preloadlist=y&list=List#step2">Profiles Admin Panel</a> to continue configuring your site{/tr}.</li>
