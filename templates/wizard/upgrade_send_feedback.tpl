{* $Id: upgrade_send_feedback.tpl 51355 2014-05-17 08:07:20Z xavidp $ *}
...
<div class="adminWizardContent">
    ...
    <fieldset>
        ...
        <div class="adminWizardIconright"><img src="img/icons/large/gnome-globe48x48.png" alt="{tr}Connect{/tr}" title="{tr}Connect{/tr}"/></div>
