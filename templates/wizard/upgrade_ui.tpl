{* $Id: upgrade_ui.tpl 51358 2014-05-17 15:48:04Z xavidp $ *}

<div class="adminWizardIconleft"><img src="img/icons/large/wizard_upgrade48x48.png" alt="{tr}Upgrade Wizard{/tr}" title="{tr}Upgrade Wizard{/tr}"/></div><div class="adminWizardIconright"><img src="img/icons/large/ui48x48.png" alt="{tr}User Interface{/tr}" title="{tr}User Interface{/tr}"/></div>
