...
<br>
	...
	{tr}Look for the <img src="img/icons/camera.png" /> icon in the editor toolbar{/tr}. {tr}Requires Java{/tr}. <a href="https://www.java.com/verify/" target="_blank">Verify your Java installation</a>.<br>
