{* $Id: upgrade_wizard_completed.tpl 51355 2014-05-17 08:07:20Z xavidp $ *}

<div class="adminWizardIconleft"><img src="img/icons/large/wizard_upgrade48x48.png" alt="{tr}Wizard completed{/tr}" /></div>
<div class="adminWizardContent">
<img src="img/icons/tick.png" alt="{tr}Ok{/tr}" />{tr}Congratulations{/tr}. {tr}You are done with the upgrade wizard{/tr}.<br>
