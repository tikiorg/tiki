...
<div style="float:left; margin-right: 10px"><img src="img/icons/large/wizard48x48.png" alt="{tr}Tiki Admin Wizard{/tr}" /><br/><br/></div>
...
<div style="display:block;margin-left: auto; margin-right: auto">
<div style="float:left; margin-right: 10px"><img src="img/icons/large/profiles48x48.png" alt="{tr}Tiki Configuration Profiles{/tr}" /></div>
...
<div style="float:left; margin-right: 10px"><img src="img/icons/large/stock_missing-image48x48.png" alt="{tr}No wizard{/tr}" /></div>
