...
{/if}
  ...
  <div class="cbox">
    ...
    <form action="tiki-admin.php?page=wiki" method="post">
    <table class="admin">
    <tr><td class="form"><label for="pear_wiki_parser">{tra}Use <a href='http://pear.php.net/package/text_Wiki'>PEAR::Text_Wiki</a> to parse Wiki-text{/tra} ({tra}experimental{/tra})</label>:</td><td><input type="checkbox" name="pear_wiki_parser" id="pear_wiki_parser"{if $pear_wiki_parser eq 'y'} checked{/if}></td></tr>
