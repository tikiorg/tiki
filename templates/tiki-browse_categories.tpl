...
{if $user and $prefs.feature_user_watches eq 'y'}
	{if $user_watching_category eq 'n'}
		...
		<a href="tiki-browse_categories.php?parentId={$parentId|escape:"url"}&amp;watch_event=category_changed&amp;watch_object={$parentId|escape:"url"}&amp;deep={$deep}&amp;watch_action=add_desc" class="icon">{icon _id='eye_arrow_down' alt='{tr}Watch This Category and Their Descendants{/tr}'}</a>
	{else}
		...
		<a href="tiki-browse_categories.php?parentId={$parentId|escape:"url"}&amp;watch_event=category_changed&amp;watch_object={$parentId|escape:"url"}&amp;deep={$deep}&amp;watch_action=remove_desc" class="icon">{icon _id='no_eye_arrow_down' alt='{tr}Stop Watching This Category and Their Descendants{/tr}'}</a>
	{/if}
{/if}
