...
<h2><a title="{tr}Click here to refresh this page{/tr}" class="pagetitle" href="tiki-admin.php">{tr}Administration{/tr}</a>
{if $feature_help}
<a title="{tr}Click here for help on setting administrative options in your Tiki{/tr}" href="http://tikiwiki.org/tiki-index.php?page=TikiAdminSettings" target="help"><img border="0" alt="{tr}Help{/tr}" src="img/icons/help.gif" /></a>
{/if}
</h2>
