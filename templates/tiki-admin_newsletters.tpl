...
<td class="heading"><a href="tiki-admin_newsletters.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'author_desc'}author_asc{else}author_desc{/if}">{tr}Author{/tr}</a></td>
...
<td class="heading"><a>{tr}Drafts{/tr}</a></td>
