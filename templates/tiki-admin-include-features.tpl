...
{* ---------- Content features ------------ *}
      ...
      <tr>
        ...
        <td class="form">
	        	{if $feature_help eq 'y'}<a href="http://tikiwiki.org/tiki-index.php?page=TheneControl" target="tikihelp" class="tikihelp" title="{tr}Tikiwiki.org help{/tr}: {tr}Theme Control{/tr}">{/if}
        		{tr}Theme Control{/tr}
        		{if $feature_help eq 'y'}</a>{/if}
        		:</td>
