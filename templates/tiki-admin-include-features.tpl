...
<div class="tabs" style="clear: both;">
	...
	<span id="tab4" class="tabmark tabinactive"><a href="javascript:tikitabs(4,10);">{tr}Technical{/tr}</a></span>
	<span id="tab5" class="tabmark tabinactive"><a href="javascript:tikitabs(5,10);">{tr}UI enhancement{/tr}</a></span>
	<span id="tab6" class="tabmark tabinactive"><a href="javascript:tikitabs(6,10);">{tr}Experimental{/tr}</a></span>
	<span id="tab7" class="tabmark tabinactive"><a href="javascript:tikitabs(7,10);">{tr}Content{/tr}</a></span>
	<span id="tab8" class="tabmark tabinactive"><a href="javascript:tikitabs(8,10);">{tr}Administration{/tr}</a></span>
...
{if $prefs.feature_tabs neq 'y'}
  <legend class="heading"><a href="#"><span>{tr}Major{/tr}</span></a></legend>
{/if}
...
{if $prefs.feature_tabs neq 'y'}
  <legend class="heading"><a href="#"><span>{tr}Minor{/tr}</span></a></legend>
{/if}
<table width="100%" class="admin">
  <tr>
    <td class="heading" colspan="5"
...
{if $prefs.feature_tabs neq 'y'}
  <legend class="heading"><a href="#"><span>{tr}Site-wide{/tr}</span></a></legend>
{/if}
<table width="100%" class="admin">
  <tr>
    <td class="heading" colspan="5"
...
{if $prefs.feature_tabs neq 'y'}
  <legend class="heading"><a href="#"><span>{tr}Technical{/tr}</span></a></legend>
{/if}
<table width="100%" class="admin">
  <tr>
    <td class="heading" colspan="5"
...
{if $prefs.feature_tabs neq 'y'}
  <legend class="heading"><a href="#"><span>{tr}UI enhancement{/tr}</span></a></legend>
{/if}
<table width="100%" class="admin">
  <tr>
    <td class="heading" colspan="5"
...
{if $prefs.feature_tabs neq 'y'}
  <legend class="heading"><a href="#"><span>{tr}Experimental{/tr}</span></a></legend>
{/if}
<table width="100%" class="admin">
  <tr>
    <td class="heading" colspan="5"
...
{if $prefs.feature_tabs neq 'y'}
  <legend class="heading"><a href="#"><span><a href="#"><span>{tr}Content{/tr}</span></a></legend>
{/if}
<table width="100%" class="admin">
  <tr>
    <td class="heading" colspan="5"
...
{if $prefs.feature_tabs neq 'y'}
  <legend class="heading"><a href="#"><span>{tr}User{/tr}</span></a></legend>
{/if}
<table width="100%" class="admin">
  <tr>
    <td class="heading" colspan="5"
