...
{if $mode eq 'listing'}
	...
	{if $tiki_p_map_create eq 'y'}
		...
		<form action="tiki-map_edit.php" method="post" class="form-horizontal">
			<div class="form-group">
				<div class="col-sm-5">
			      	<input type="text" class="form-control" name="newmapfile" size="20">
			    </div>
			    <div class="col-sm-1">
...
{if $mode eq 'editing'}
	...
	<form enctype="multipart/form-data" action="tiki-map_edit.php" method="post" id='editpageform' class="form-horizontal">
