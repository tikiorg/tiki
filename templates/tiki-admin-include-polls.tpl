...
<div class="rbox-data" style="padding: 2px 10px; background-color: #eeee99;">{tr}To add/remove polls, look for "Polls" under "Admin" on the application menu, or{/tr} <a class="link" href="tiki-admin_polls.php">{tr}click here{/tr}</a>.</div>
</div>
<br />
