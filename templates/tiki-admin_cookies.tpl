...
<a href="{$prefs.helpurl}FortuneCookieDoc" target="tikihelp" class="tikihelp" title="{tr}Admin FortuneCookie{/tr}"><img src="pics/icons/help.png" border="0" height="16" width="16" alt='{tr}Help{/tr}' /></a>
{/if}
