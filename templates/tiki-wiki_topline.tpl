...
<div class="clearfix">
	<div class="wikiactions icons btn-group pull-right">
			...
			{if $prefs.feature_share eq 'y' && $tiki_p_share eq 'y'}
				<a class="btn btn-default" title="{tr}Share this page{/tr}" href="tiki-share.php?url={$smarty.server.REQUEST_URI|escape:'url'}"  name='share' alt="{tr}Share this page{/tr}"}</a>
			{/if}
