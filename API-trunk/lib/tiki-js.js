...
function openMediaUploader( formAdditions, formAction ) {
	if (jqueryTiki.ui) {
		...
		var $d = $("#kaltura_upload_dialog");

		if ($d.length){
			$d.detach();	// firefox doesn't like remove here, reports "Bad NPObject as private data!"
		}
		$d = $("<div id=\"kaltura_upload_dialog\" style=\"display:none\"></div>")
