	...
	return array(
		...
		'params' => array(
			...
			'groups' => array(
				...
				'description' => tra('List of groupIds from which to show users in the switch user drop-down. Multiple groupIds are separated by "|" and users from all listed groups will be shown. Leave empty to show all users.'),
			),
			'menu_id' => array(
				'name' => tra('Menu ID'),
