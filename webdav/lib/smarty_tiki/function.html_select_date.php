...
function smarty_function_html_select_date($params, &$smarty)
{
    ...
    if ($display_months) {
        ...
        for ($i = 1; $i <= 12; $i++) {
			...
			// added many missing translation blocks and german translations for user admin page, notepad and bookmarks, month from html_select_date is being translated now
