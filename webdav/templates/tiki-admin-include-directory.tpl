	...
	<fieldset class="admin">
		<legend>{tr}Directory{/tr}</legend>
			...
			<td><select name="directory_columns" id="directory-columns">
				...
				<td><input type="text" name="directory_links_per_page" id="directory-links" value="{$prefs.directory_links_per_page|escape}" /></td>
			</tr><tr>
				<td class="form"><label for="directory-validate">{tr}Validate URLs{/tr}</label></td>
				<td><input type="checkbox" name="directory_validate_urls" id="directory-validate" {if $prefs.directory_validate_urls eq 'y'}checked="checked"{/if}></td>
			</tr><tr>
				<td class="form"><label for="directory-cool-sites">{tr}enable cool sites{/tr}</label></td>
				<td><input type="checkbox" name="directory_cool_sites" id="directory-cool-sites" {if $prefs.directory_cool_sites eq 'y'}checked="checked"{/if}></td>
			</tr><tr>
				<td class="form"><label for="directory-country-flag">{tr}Show Country Flag{/tr}</label></td>
          <td><input type="checkbox" name="directory_country_flag" id="directory-country-flag" {if $prefs.directory_country_flag eq 'y'}checked="checked"{/if}></td>
			</tr><tr>
