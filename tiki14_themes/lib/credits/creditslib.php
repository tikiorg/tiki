...
class CreditsLib extends TikiLib
{
	...
	function _recCredits( $userId, $creditType, $amount, $product_id = null )
	{
		return $this->query(
			...
			" VALUES (?, NOW(), ?, ?, ?)",
			array($userId, $creditType, $amount, $product_id)
		);
	}
