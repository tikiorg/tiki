	...
	<table class="table normal">
		...
		{section name=user loop=$items}
			<tr>
				...
				<td class="action">
					<a class="link" href="tiki-directory_admin_related.php?offset={$offset}&amp;sort_mode={$sort_mode}&amp;categId={$items[user].categId}"><img src='img/icons/admin_move.gif' alt="{tr}relate{/tr}" title="{tr}relate{/tr}"></a>
