								...
								<li class="tgItem{if $tg_item.old neq $tg_item.new} changed{/if}">
									...
									>
										{if $tg_data_type.selector eq 'color'}
											...
											<input type="text" name="tg_swaps[{$tg_type}][{$tg_item.old}]" value="{$tg_item.new}" class="tgValue" >
										{elseif $tg_data_type.selector eq 'size'}
											<div class="tgLabel">
												{$tg_item.old}
											</div>
											<input type="text" name="tg_swaps[{$tg_type}][{$tg_item.old}]" value="{$tg_item.new}" class="tgValue tgSize">
										...
										{else}{* "fontfamily", "text" etc *}
											...
											<input type="text" name="tg_swaps[{$tg_type}][{$tg_item.old}]" value="{$tg_item.new}" class="tgValue tgWide">
										{/if}
									</div>
