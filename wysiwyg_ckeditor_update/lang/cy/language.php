...
// "When the site is accessed through specific domain names, redirect to an alternate domain preserving the URL. Useful for domain name transitions, like tiki.org to tiki.org" => "When the site is accessed through specific domain names, redirect to an alternate domain preserving the URL. Useful for domain name transitions, like tiki.org to tiki.org",
...
// "Colors" => "Colors",
// "Syntax highlighting to use. May not be used with line numbers. GeSHi - Generic Syntax Highlighter must be installed. Available: php, html, sql, javascript, css, java, c, doxygen, delphi, .." => "Syntax highlighting to use. May not be used with line numbers. GeSHi - Generic Syntax Highlighter must be installed. Available: php, html, sql, javascript, css, java, c, doxygen, delphi, ..",
...
// "Include minor edits" => "Include minor edits",
// "If set to \"n\", pages that were last saved as a \"minor\" edit will NOT be included in the list of pages. This option applies only when  the Wiki Minor Edits option is enabled" => "If set to \"n\", pages that were last saved as a \"minor\" edit will NOT be included in the list of pages. This option applies only when  the Wiki Minor Edits option is enabled",
// "Default: \"y\"" => "Default: \"y\"",
...
// "Enter &lt;your site URL&gt;tiki-socialnetworks.php as connect URL" => "Enter &lt;your site URL&gt;tiki-socialnetworks.php as connect URL",
