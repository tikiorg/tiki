...
CKEDITOR.dialog.add( 'tikilink', function( editor )
{
	var lang = {
		dlgTitle: "TikiLink",
		title: "TikiLink",
				...
				[
					{
						...
						html :
							'<style type="text/css">' +
								'.cke_tikilink_container' +
								'{' +
									'color:#000 !important;' +
									'padding:10px 10px 0;' +
									'margin-top:5px' +
								'}' +
								'.cke_tikilink_container p' +
								'{' +
									'margin: 0 0 10px;' +
								'}' +
								'.cke_tikilink_container .cke_tikilink_logo' +
								'{' +
									'height:81px;' +
									'background-color:#fff;' +
									'background-image:url(' + CKEDITOR.plugins.get( 'tikilink' ).path + 'dialogs/logo_ckeditor.png);' +
									'background-position:center; ' +
									'background-repeat:no-repeat;' +
									'margin-bottom:10px;' +
								'}' +
								'.cke_tikilink_container a' +
								'{' +
								...
								'}' +
							'</style>' +
							'<div class="cke_tikilink_container">' +
								'<div class="cke_tikilink_logo"></div>' +
								'<p>' +
