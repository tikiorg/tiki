...
// "<p>The Tiki installer can be used only by the site administrator. Please login as the administrator first.</p>" => "<p>The Tiki installer can be used only by the site administrator. Please login as the administrator first.</p>",
