...
"Daily report from" => "Taegliche Zusammenfassung vom",
"Monthly report from" => "Monatliche Zusammenfassung vom",
"Weekly report from" => "Woechentliche Zusammenfassung vom",
"Report for" => "Zusammenfassung fuer",
...
"added the file" => "fuegte die Datei",
"added the image" => "fuegte das Bild",
"added the article" => "fuegte den Artikel",
"added the wiki page" => "fuegte die Wikiseite",
...
"Reports are disabled, only standard reporting is available" => "Reports sind ausgeschaltet, nur Standart-Reporting ist verfuegbar",
