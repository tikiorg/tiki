...
{self_link page="workspaces" _class="icon"}{icon _id="pics/large/workspaces.png" alt="{tr}Workspaces{/tr}" class="reflect" style="vertical-align: middle" width="32" height="32"}{/self_link}
{/if}
