...
"Newsletter:" => "电子期刊:",
"You can unsubscribe from this newsletter following this link" => "你可以使用以下的链接停止订阅本电子期刊",
...
"you or someone registered this email address at" => "您或有人用此Email在本站注册：",
...
"slides" => "幻灯片",
"discuss" => "讨论",
"The newsletter was sent to {\$sent} email addresses" => "此电子期刊已发送至 {\$sent}",
"This newsletter will be sent to {\$subscribers} email addresses." => "此电子期刊将被发送给 {\$subscribers} 的Email中",
"attachments" => "附件",
"Watches" => "关注",
"calendar" => "日历",
"dump" => "dump",
