...
"Create a tag for the current wiki" => "為目前wiki產生一個標籤",
...
"Other users can upload images to this gallery" => "允許其它使用者上載影像至此圖庫",
"edit/create" => "編輯/產生",
...
"Gallery" => "圖庫",
"Now enter the image URL" => "輸入影像的URL",
...
"My galleries" => "我的圖庫",
"Featured links" => "功能連結",
"You dont have permission to use this feature" => "你沒有權限使用此功能",
...
"Allow other user to post in this blog" => "允許其他使用者發表於這個blog",
"Blogs" => "Blogs",
"Last Modified" => "最近修改",
...
"Blog not found" => "Blog找不到",
"Permission denied you cannot remove the post" => "權限不足, 你無法移除此文章",
...
"Permission denied you cannot edit this blog" => "權限不足, 你無法編輯此blog",
"Permission denied you cannot remove this blog" => "權限不足, 你無法移除此blog",
"Permission denied you cannot post" => "權限不足, 你無法發表文章",
"Permission denied you cannot edit this post" => "權限不足, 你無法編輯此文章",
"You can't post in any blog maybe you have to create a blog first" => "你無法在任何blog中發表文章, 請先建立一個blog",
"Rankings" => "排名",
"Top 10" => "前10",
"Top 20" => "前20",
"Top 50" => "前50",
...
"Other users can upload files to this gallery" => "允許其他使用者上載檔案到此檔案庫",
...
"File Gallery" => "檔案庫",
"Now enter the file URL" => "輸入這個檔案的URL",
...
"RSS feeds" => "RSS feeds",
"displays rss feed with id=n maximum=m items" => "顯示 id=n 最大值=m 的rss feed",
"Simple box" => "簡單方塊",
"Box content" => "方塊內容",
...
"There are inddividual permissions set for this blog" => "這個blog有獨立的權限設定",//perhaps not used
"Features" => "功能",
...
"Weblogs" => "Weblogs",
"Total posts" => "總發表佈告數",
"Average posts per weblog" => "weblog平均發表數",//perhaps not used
"Total size of blog posts" => "blog 佈告的總大小",
"Average posts size" => "平均佈告大小",
"Visits to weblogs" => "weblogs拜訪數",
"Poll Stats" => "投票統計",
"Total votes" => "總票數",
"Average votes per poll" => "投票平均票數",
"Faq Stats" => "Faq 統計",
"Total questions" => "全部問題數",
"Average questions per FAQ" => "FAQ平均問題數",
"User Stats" => "使用者統計",
...
"Request passcode to register" => "要求 passcode 才能註冊",
"Count admin pageviews" => "計算管理頁面瀏覽數",
"Browser title" => "瀏覽器標題",
"Reg users can change theme" => "允許註冊使用者變更佈景",
"Reg users can change language" => "允許註冊使用者變更語言",
"Wiki attachments" => "Wiki 附件",
"Use a directory to store files" => "使用資料匣來儲存檔案",
"Path" => "路徑",
"Use templates" => "使用模板",
"Show page title" => "顯示頁面標題",
"Use database to store images" => "使用資料庫來儲存影像",
"Use a directory to store images" => "使用資料匣來儲存影像",
"Directory path" => "資料匣路徑",
...
"Users can subscribe any email addresss" => "允許使用者以任何email訂閱",
"Frequency" => "頻率",
"editions" => "版本",
"last sent" => "上次寄出",
"subscriptions" => "訂閱",
...
"Change password enforced" => "強制變更密碼",
"page" => "頁面",
"page|desc" => "頁面|描述",
"SomeName" => "某個名稱",
"some text" => "某些文字",
...
"subject" => "主題",
"sent" => "送出",
"Average posts pero weblog" => "每weblog平均佈告數",
...
"Attachments" => "附件",
"No attachments for this item" => "此項目沒有任何附件",
"settings" => "設定",
"mailbox" => "郵件夾",
"compose" => "新郵件",
"contacts" => "通訊錄",
...
"list articles" => "列出文章",
"view articles" => "顯示文章",
"There are individual permissions set for this blog" => "這個blog有獨立的權限設定",
"data" => "資料",
...
"Path to where the dumped files are (relative to tiki basedir with trailing slash ex: dump/)" => "傾映檔案所在的路徑 (tiki目錄的相對路徑加上斜線 例如: dump/)",
"hist" => "歷史記錄",
...
"Send email notifications when this page changes to" => "頁面改變時寄出 email 提醒",
"add email" => "增加email",
"Notifications" => "提醒",
...
"MyFiles" => "我的檔案",
"Calendar" => "行事曆",
"Configure news servers" => "設定news伺服器",
"Select a news server to browse" => "選擇要瀏覽的news伺服器",
"server" => "伺服器",
"Add or edit a news server" => "增加或編輯news伺服器",
"News server" => "News伺服器",
"port" => "連接埠",
...
"topic image" => "主題影像",
"User Menu" => "使用者選單",
"May need to refresh twice to see changes" => "可能需要更新兩次才看得到改變",
...
"Must enter a url to add a site" => "增加站臺時必須輸入URL",
"Must select a category" => "請選擇一個分類",
"You can not download files" => "你無法下載檔案",
"No structure indicated" => "未指定結構",
"Invalid email address. You must enter a valid email address" => "不正確的email. 請輸入正確的email地址",
...
"URL cannot be accessed wrong URL or site is offline and cannot be added to the directory" => "無法存取URL, URL錯誤或站臺不存在, 無法加入目錄",
...
"Display menus as folders" => "用資料匣方式顯示選單",
...
"Modified" => "已變更",
"If you change the calendar selection, please refresh to get the appropriated list in Category, Location and people (if applicable to the calendar you choose)." => "如果你改變了行事曆選項, 請重新整理以取得正確的類別, 地點, 以及人名列表(如果適用於你所選的行事曆類型)",
...
"Admin folders and bookmarks" => "管理資料匣與書籤",
...
"the following link to login for the first time" => "以下的連結來進行第一次登入",//perhaps not used
...
"There is an error in the plugin data" => "plugin 資料發生錯誤",
"##end###" => "###結束###",//##First new line//perhaps not used
