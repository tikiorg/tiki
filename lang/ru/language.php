...
"Quizzes" => "Тесты",
"content templates" => "шаблоны содержимого",//perhaps not used
...
"There are individual permissions set for this survey" => "Для этой анкеты заданы особые права доступа",
"open" => "открыт",
"status" => "состояние",
...
"Stats for survey" => "Статистика по анкете",
"Stats for this survey Questions " => "Статистика по вопросам этой анкеты ",
...
"Style Sheet" => "Страница стилей",
"save a custom copy" => "сохранить свою копию",
"Cancel" => "Отмена",
"choose a stylesheet" => "выбрать стиль",
"try" => "попробовать",
...
"quizzes" => "тесты",
"Edit quiz questions" => "Редактировать вопросы теста",
...
"Admin instance" => "Настроить instance", // ?сущность
"Instance" => "Instance",
"Workitems" => "Workitems",
...
"Watches" => "Watches",   // ?наблюдения или изменения
"RSS feed" => "RSS feed",
"Edit blog" => "Редактировать блог",
