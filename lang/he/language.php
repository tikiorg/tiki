...
"Rows" => "שורות",
"The SandBox is a page where you can practice your editing skills, use the preview feature to preview the appearance of the page, no versions are stored for this page." => "�?רגז החול הו�? עמוד בו תוכלו להת�?מן בעריכה טקסט לפי כללי ויקי ולבחון �?ת התוצ�?ה ב�?מצעות התצוגה המקדימה. לעמוד זה ל�? נשמרות גרס�?ות.",
...
"Non-existent gallery" => "ספריה ל�? קיימת",
...
"Quiz time limit exceeded quiz cannot be computed" => "הזמן המוקצה לחידון עבר ולכן ל�? ניתן לחשב �?ת התוצ�?ה",
...
"The user has chosen to make his information private" => "המשתמש בחר לסמן מידע זה כפרטי",
