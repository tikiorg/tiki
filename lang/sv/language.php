...
"Use PHPLayers for category browser" => "Använd PHPLayers för kategoribläddring",
...
"Other sections" => "Andra sektioner",
...
"Create New structure" => "Skapa ny struktur",
...
"Create Tracker" => "Skapa ärendeföljare",
...
"If others post to blog, Author should always be Owner" => "Om andra gör inlägg i bloggen, så skall författaren alltid vara ägare",
...
"Edit or export/import languages" => "Redigera eller exportera/importera språk",
...
"Import languages" => "Importera språk",
...
"Available Sheets" => "Tillgängliga arbetsblad",
...
"Parent SheetId" => "ID för föräldraarbetsblad",
...
"Multiple" => "Flera",
"Site Language:" => "Webbplatsens språk:",
...
"\n\t\t\tExact match\n\t\t\n\t" => "Exakt träff",
"Beware that when importing a language, all translations in the database for that language are deleted." => "Tänk på att om du importerar ett språk, så kommer alla existerande översättningar för detta språk i databasen att raderas.",
...
"POP3 server:" => "POP3-server:",
"Português Brasileiro" => "Brasiliansk portugisiska",
...
"中文(簡体字)" => "Kinesiska (förenklade tecken)",
"日本語" => "Japanska",
"###end###"=>"###end###");
