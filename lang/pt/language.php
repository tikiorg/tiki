...
"Is repository visible to users" => "O repositório é visível aos utilizadors",
"Visible" => "Visível",
...
"Users can subscribe/unsubscribe to this list" => "Utilizadors podem inscrever/desinscrever nesta lista",
"Users can subscribe any email address" => "Utilizadors podem inscrever quaisquer endereços de e-mail",
...
"Displayed for the eligible users with no personal assigned modules" => "Mostrado para os utilizadors elegíveis sem módulos pessoais designados",
"Displayed now for all eligible users even with personal assigned modules" => "Mostrando agora para todos os utilizadors elegíveis com módulos pessoais designados",
...
"Users can vote for only one item from this chart per period" => "Utilizadors podem votar em um único ítem por período",
"Prevent users from voting for the same item more than once" => "Previne que utilizadors votem no mesmo ítem mais de uma vez",
...
"Hide anonymous-only modules from registered users" => "Esconder módulos de somente-anônimo de utilizadors registrados",
...
"You dont have permission to view other users data" => "Você não possui permissão para ver dados de outros utilizadors",
...
"Invalid username or password" => "Utilizador ou senha inválidos",
...
"Description" => "Descrição",
"Theme" => "Tema",
"Gallery is visible to non-admin users?" => "Galeria visível para utilizadors não administradores?",
...
"Other users can upload files to this gallery" => "Outros utilizadors podem carregar ficheiros nesta galeria",
...
"User information display" => "Exibição de informações dos utilizadors",
"flag" => "marca",
"posts" => "mensagens",
...
"Only users with attach permission" => "Apenas utilizadors com permissão de anexar",
...
"User accounts" => "Contas de utilizadors",
"user" => "utilizador",
"Edit" => "Editar",
"View All" => "Ver Todas",
"Unread" => "Não lida",
...
"Operators must be tiki users" => "Operadores devem ser utilizadors Tiki",
...
"Create New FAQ:" => "Criar um novo FAQ:",
"Users can suggest questions" => "Utilizadors podem sugerir perguntas",
...
"Quota (Mb)" => "Cota (Mb)",
"Use database to store userfiles" => "Utilizar o banco de dados para armazenar ficheiros dos utilizadors",
"Use a directory to store userfiles" => "Utilizar um diretório para armazenar ficheiros dos utilizadors",
"Top 10" => "10 Mais",
"Top 20" => "20 Mais",
"Top 50" => "50 Mais",
"Top 100" => "100 Mais",
...
"Process:" => "Processo:",
"Map users to roles" => "Associar utilizadors a perfis",
"Users" => "Utilizadors",
"Roles" => "Perfis",
"map" => "associar",
"Warning" => "Aviso",
...
"Users can lock pages (if perm)" => "Utilizadors podem travar páginas (se perm)",
...
"User instances" => "Instâncias de utilizadors",
"WikiMenu" => "MenuWiki",
"Orphan pages" => "Páginas órfãs",
"Structures" => "Estruturas",
"GalMenu" => "MenuGal",
...
"new users" => "novos utilizadors",
"Last Files" => "Ficheiros Recentes",
"Online users" => "Utilizadors on-line",
"online users" => "utilizadors on-line",
...
"comma separated usernames" => "utilizadors separados por vírgula",
...
"User Pages" => "Páginas de Utilizadors",
...
"User Blogs" => "Blogs de Utilizadors",
...
"Users have visited" => "Utilizadors visitaram",
"sites from the directory" => "sites do diretório",
"Users have searched" => "Utilizadors buscaram",
...
"Users can Configure Modules" => "Utilizadors pode Configurar Módulos",
...
"Other users can upload images to this gallery" => "Outros utilizadors podem carregar imagens nesta galeria",
...
"Users can register" => "Utilizadors podem se cadastrar",
...
"Validate users by email" => "Validar utilizadors por e-mail",
"Remind passwords by email" => "Lembrar de senhas por e-mail",
"Reg users can change theme" => "Utilizadors comuns podem alterar tema",
"Reg users can change language" => "Utilizadors comuns podem alterar idioma",
...
"Only for users" => "Apenas para utilizadors",
"Users and admins" => "Utilizadors e administradores",
"Duration:" => "Duração:",
"Create user if not in Tiki?" => "Criar utilizador se não estiver no Tiki?",
"Create user if not in Auth?" => "Criar utilizadors se não estiver no PEAR::Auth?",
...
"LDAP Admin User" => "Utilizador de Administração LDAP",
...
"User Stats" => "Estatísticas de utilizadors",
"User bookmarks" => "Bookmarks de utilizadors",
...
"Users can suggest new items" => "Utilizadors podem sugerir ítens",
"Auto validate user suggestions" => "Validades automaticamente sugestões de utilizadors",
...
"Use Cookies for unregistered users" => "Utilizar cookies para utilizadors não registrados",
"Users can vote again after" => "Utilizadors podem votar novamente",
...
"Contact user" => "Utilizador para contato",
...
"All users" => "Todos os utilizadors",
...
"Allow other user to post in this blog" => "Permitir a outros utilizadors escrever neste blog",
...
"Allow messages from other users" => "Permitir mensagens de outros utilizadors",
...
"Highest" => "Maior",
"Admin users" => "Administrar utilizadors",
"admin users" => "administrar utilizadors",
...
"Added users" => "Utilizadors adicionados",
"Rejected users" => "Utilizadors rejeitados",
...
"Operation" => "Operação",
"user processes" => "processos de utilizadors",
"user activities" => "atividades de utilizadors",
"user instances" => "instâncias de utilizadors",
...
"Users in this channel" => "Utilizadors neste canal",
...
"User Activities" => "Atividades de Utilizador",
"Galaxia User Activities" => "Atividades de Utilizador do Galaxia",
"process" => "processo",
"Galaxia User Instances" => "Instâncias de Utilizadors do Galaxia",
...
"Add all your site users to this newsletter (broadcast)" => "Adicionar todos utilizadors do seu site a este comunicado (comunicado geral)",
"Add users" => "Adicionar utilizadors",
"Subscriptions" => "Assinaturas",
"subscribed" => "inscrita",
...
"Maximum size for each attachment" => "Tamanho máximo para cada ficheiro anexado",
