...
// "applied" => "applied",
// "The Profile Repositories are not connecting. Don't worry you didn't do anything wrong :)" => "The Profile Repositories are not connecting. Don't worry you didn't do anything wrong :)",
// "Here are a few steps you can try to fix this issue" => "Here are a few steps you can try to fix this issue",
// "Verify that your internet connection is properly working" => "Verify that your internet connection is properly working",
// "Verify the URL of your profile repository is correctly; only if you manually entered a new one<" => "Verify the URL of your profile repository is correctly; only if you manually entered a new one<",
// "Profiles.TikiWiki.Org might be temporarily <b>Out of Service</b>. Please try again later" => "Profiles.TikiWiki.Org might be temporarily <b>Out of Service</b>. Please try again later",
