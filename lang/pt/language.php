...
// "Deletion email notification" => "Deletion email notification",
// "This email will receive a copy of each deleted file" => "This email will receive a copy of each deleted file",
...
// "Compress CSS files by removing additional spaces and grouping multiple files into one. Changes to CSS files will require cache to be cleared" => "Compress CSS files by removing additional spaces and grouping multiple files into one. Changes to CSS files will require cache to be cleared",
// "Minify CSS into a single file" => "Minify CSS into a single file",
// "In addition to reducing the size of the CSS, reduce the amount of included files" => "In addition to reducing the size of the CSS, reduce the amount of included files",
// "This setting may not work out of the box for all styles" => "This setting may not work out of the box for all styles",
...
// "Displays the most commented objects. Can be used for Wiki Pages, Blog Posts or Articles" => "Displays the most commented objects. Can be used for Wiki Pages, Blog Posts or Articles",
// "Content Type" => "Content Type",
// "used to identify which type of content you want. Default is Wiki Pages, Options are: wiki, blog, article" => "used to identify which type of content you want. Default is Wiki Pages, Options are: wiki, blog, article",
...
// "All terms will automatically be put in that category. '.\n\t\t\t\t                     'Note that the category must already exist. '.\n\t\t\t\t                     'Defaults to \\'Term\\'" => "All terms will automatically be put in that category. '.\n\t\t\t\t                     'Note that the category must already exist. '.\n\t\t\t\t                     'Defaults to \\'Term\\'",
...
// "No pages" => "No pages",
// "All pages selcted" => "All pages selcted",
// "Add Page" => "Add Page",
...
// "<ul><li>Index: <strong>\$name</strong></li>" => "<ul><li>Index: <strong>\$name</strong></li>",
// "<li>Directory: <strong>\$dir</strong></li></ul>" => "<li>Directory: <strong>\$dir</strong></li></ul>",
// "You need to change chmod 'whelp' manually to 777" => "You need to change chmod 'whelp' manually to 777",
// "<p>Creating directory structure in <strong>\$base</strong>.</p>" => "<p>Creating directory structure in <strong>\$base</strong>.</p>",
// "<p>Eliminating previous files.</p>" => "<p>Eliminating previous files.</p>",
