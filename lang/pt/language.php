...
// $Id: get_strings.php 29865 2010-10-07 11:27:00Z sept_7 $
// Parameters:
...
// "Pick the archive if exists created just before the date" => "Pick the archive if exists created just before the date",
...
// "Field names will be replaced when enclosed in % chars. e.g. %fileId%, %src%, %title%, %description%" => "Field names will be replaced when enclosed in % chars. e.g. %fileId%, %src%, %title%, %description%",
...
// "Using comments below wiki pages" => "Using comments below wiki pages",
...
// "Ok" => "Ok",
// "Fill this box with the list of e-mails you want to invit " => "Fill this box with the list of e-mails you want to invit ",
...
// "%d user-group assigments" => "%d user-group assigments",
...
// "There are more than one item in the tracker with this title" => "There are more than one item in the tracker with this title",
...
// "Congratulation ! you are now part of this invitation group(s)" => "Congratulation ! you are now part of this invitation group(s)",
...
// "Permission denied: you cannot view the comments for this blog" => "Permission denied: you cannot view the comments for this blog",
...
// "Permission denied: you cannot view this blog post while it is marked as private" => "Permission denied: you cannot view this blog post while it is marked as private",
