...
// "To test your system configuration, Tiki will attempt to send a test message to info@tikiwiki.org" => "To test your system configuration, Tiki will attempt to send a test message to info@tikiwiki.org",
...
// "To secure your Tiki installation - and if you are using Apache web server - you should rename the <span style=\"font-weight:bold\">_htaccess</span> file to <span style=\"font-weight:bold\">.htaccess</span> (this file is in the main directory)" => "To secure your Tiki installation - and if you are using Apache web server - you should rename the <span style=\"font-weight:bold\">_htaccess</span> file to <span style=\"font-weight:bold\">.htaccess</span> (this file is in the main directory)",
