...
// "Some changes below will affect only new file galleries" => "Some changes below will affect only new file galleries",
...
// "Users can change language" => "Users can change language",
...
// "Correct PNG transparency in IE5.5 and IE6 (experimental)" => "Correct PNG transparency in IE5.5 and IE6 (experimental)",
...
// "Show object filter" => "Show object filter",
// "Show search box" => "Show search box",
// "Show visit count" => "Show visit count",
// "Show pertinence" => "Show pertinence",
...
// "Plugin Alias Manager" => "Plugin Alias Manager",
...
// "Welcome" => "Welcome",
// "Welcome to the TikiWiki installation and upgrade script" => "Welcome to the TikiWiki installation and upgrade script",
// "Use this script to install a new TikiWiki database or upgrade your existing database to release" => "Use this script to install a new TikiWiki database or upgrade your existing database to release",
...
// "For more information about TikiWiki, please visit" => "For more information about TikiWiki, please visit",
// "Select your language" => "Select your language",
// "Read the License" => "Read the License",
// "TikiWiki is software distributed under the LGPL license" => "TikiWiki is software distributed under the LGPL license",
// "Please read the following license agreement" => "Please read the following license agreement",
// "Review the System Requirements" => "Review the System Requirements",
// "Before installing TikiWiki, <a href=\"http://doc.tikiwiki.org/tiki-index.php?page=Requirements+and+Setup&bl=y\" target=\"_blank\">review the documentation</a> and confirm that your system meets the minimum requirements" => "Before installing TikiWiki, <a href=\"http://doc.tikiwiki.org/tiki-index.php?page=Requirements+and+Setup&bl=y\" target=\"_blank\">review the documentation</a> and confirm that your system meets the minimum requirements",
...
// "TikiWiki requires <strong>at least</strong> 32MB of PHP memory for script execution" => "TikiWiki requires <strong>at least</strong> 32MB of PHP memory for script execution",
...
// "Mail" => "Mail",
// "TikiWiki uses the PHP <strong>mail</strong> function to send email notifications and messages" => "TikiWiki uses the PHP <strong>mail</strong> function to send email notifications and messages",
// "To test your system configuration, TikiWiki will attempt to send a test message to info@tikiwiki.org" => "To test your system configuration, TikiWiki will attempt to send a test message to info@tikiwiki.org",
// "Send Test Message" => "Send Test Message",
// "Tiki was able to send a test message to info@tikiwiki.org" => "Tiki was able to send a test message to info@tikiwiki.org",
...
// "TikiWiki uses the GD library to process images for the Image Gallery and CAPTCHA support" => "TikiWiki uses the GD library to process images for the Image Gallery and CAPTCHA support",
// "Set the Database Connection" => "Set the Database Connection",
// "TikiWiki requires an active database connection" => "TikiWiki requires an active database connection",
...
// "Use this page to create a new database connection" => "Use this page to create a new database connection",
...
// "User name" => "User name",
// "Install" => "Install",
// "Select the installation" => "Select the installation",
// "(or upgrade)" => "(or upgrade)",
// "script to use" => "script to use",
// "This script will populate {if \$tikidb_created}(or upgrade){/if} the database" => "This script will populate {if \$tikidb_created}(or upgrade){/if} the database",
...
// "See the documentation for <a target=\"_blank\" href=\"http://profiles.tikiwiki.org/Profiles_in_30_installer\" class=\"link\" title=\"{tr}Description of available profiles" => "See the documentation for <a target=\"_blank\" href=\"http://profiles.tikiwiki.org/Profiles_in_30_installer\" class=\"link\" title=\"{tr}Description of available profiles",
// "No Internet Connection has been found" => "No Internet Connection has been found",
...
// "To secure your TikiWiki installation - and if you are using Apache web server - you should rename the <span style=\"font-weight: bold\">_htaccess</span> file to <span style=\"font-weight: bold\">.htaccess</span> (this file is in the main directory)" => "To secure your TikiWiki installation - and if you are using Apache web server - you should rename the <span style=\"font-weight: bold\">_htaccess</span> file to <span style=\"font-weight: bold\">.htaccess</span> (this file is in the main directory)",
...
// "Enter Your TikiWiki" => "Enter Your TikiWiki",
...
// "Enter TikiWiki and Lock Installer" => "Enter TikiWiki and Lock Installer",
// "Recommended" => "Recommended",
// "Enter TikiWiki Without Locking Installer" => "Enter TikiWiki Without Locking Installer",
...
// "Go directly to the <strong>Install/Upgrade Profile</strong> step" => "Go directly to the <strong>Install/Upgrade Profile</strong> step",
// "Restart the installer" => "Restart the installer",
// "Database Connection" => "Database Connection",
// "Reset the" => "Reset the",
// "Install/Upgrade Profile" => "Install/Upgrade Profile",
...
// "Show Group Watches on structure" => "Show Group Watches on structure",
...
// "You need to create one calendar" => "You need to create one calendar",
