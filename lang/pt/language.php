...
// "Ouput Should be HTMLPurified" => "Ouput Should be HTMLPurified",
...
// "Anchor" => "Anchor",
// "pics/icons/anchor.png" => "pics/icons/anchor.png",
...
// "pics/icons/picture.png" => "pics/icons/picture.png",
...
// "pics/icons/world_edit.png" => "pics/icons/world_edit.png",
...
// "Includes a calendar within the page" => "Includes a calendar within the page",
// "Calendar ID" => "Calendar ID",
// "The calendar number (Id) to display. Default value refers to all visible calendars" => "The calendar number (Id) to display. Default value refers to all visible calendars",
// "View Mode" => "View Mode",
// "The view mode for the Calendar" => "The view mode for the Calendar",
// "View as a List of Events" => "View as a List of Events",
// "Show the list of events at the bottom" => "Show the list of events at the bottom",
// "View the List of Events" => "View the List of Events",
// "Decide or not to show the list of events at the bottom" => "Decide or not to show the list of events at the bottom",
...
// "~np~{CALENDAR(calIds=>1)}{CALENDAR}" => "~np~{CALENDAR(calIds=>1)}{CALENDAR}",
...
// "Movie URL" => "Movie URL",
// "Complete URL to the movie to include. e.g. lib/swfobject/test.swf" => "Complete URL to the movie to include. e.g. lib/swfobject/test.swf",
...
// "Makes the image a thumbnail when set to \"y\". Will link to the full size image unless \"link\" is set. Other parameter options indicate how the full image will be displayed: \"mouseover\", \"mousesticky\", \"popup\", \"browse\" and \"browsepopup\" (only works with image gallery) and \"download\" (only works with file gallery). " => "Makes the image a thumbnail when set to \"y\". Will link to the full size image unless \"link\" is set. Other parameter options indicate how the full image will be displayed: \"mouseover\", \"mousesticky\", \"popup\", \"browse\" and \"browsepopup\" (only works with image gallery) and \"download\" (only works with file gallery). ",
...
// "Button for enlarging image. Set to \"y\" for it to appear. If thumb is set, then same method as thumb will be used to enlarge, except if mouseover or mousesticky is used. If thumb is not set or set to mouseover or mousesticky, then choice of \"download\", \"popup\", \"browse\" and \"browsepopup\" (for image gallery), and \"plain\"" => "Button for enlarging image. Set to \"y\" for it to appear. If thumb is set, then same method as thumb will be used to enlarge, except if mouseover or mousesticky is used. If thumb is not set or set to mouseover or mousesticky, then choice of \"download\", \"popup\", \"browse\" and \"browsepopup\" (for image gallery), and \"plain\"",
// "For making the image a hyperlink. Enter a url to the page the image should link to. Not needed if thumb parameter is set. If set and thumb parameter is also set, then the link parameter will be used" => "For making the image a hyperlink. Enter a url to the page the image should link to. Not needed if thumb parameter is set. If set and thumb parameter is also set, then the link parameter will be used",
// "Link relation" => "Link relation",
// "\"rel\" attribute to add to the link. Enter \"box\" for colorbox effect (like shadowbox and lightbox) or appropriate syntax" => "\"rel\" attribute to add to the link. Enter \"box\" for colorbox effect (like shadowbox and lightbox) or appropriate syntax",
// "Image map" => "Image map",
...
// "Enter right, left or center to align the image itself. If the image is inside a box (because stylebox, desc or button has been set), then you should align the box using the align parameter" => "Enter right, left or center to align the image itself. If the image is inside a box (because stylebox, desc or button has been set), then you should align the box using the align parameter",
...
// "Enter right, left or center to align the box containing the image" => "Enter right, left or center to align the box containing the image",
...
// "CSS class" => "CSS class",
// "Image description to display on the page. \"desc\" or \"name\" for tiki images, \"idesc\" or \"ititle\" for iptc data, otherwise enter your own description" => "Image description to display on the page. \"desc\" or \"name\" for tiki images, \"idesc\" or \"ititle\" for iptc data, otherwise enter your own description",
...
// "AJAX feature required" => "AJAX feature required",
...
// "feature profile tester" => "feature profile tester",
...
// "Type of contribution:</label>" => "Type of contribution:</label>",
...
// "Tiki is a community project" => "Tiki is a community project",
// "<a href=\"http://info.tikiwiki.org/Join+the+community\">{tr}Join the community" => "<a href=\"http://info.tikiwiki.org/Join+the+community\">{tr}Join the community",
...
// "Translate changes which appear in pink on the left, in the page shown on the right" => "Translate changes which appear in pink on the left, in the page shown on the right",
