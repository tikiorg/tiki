...
// "Your account registration request for {\$mail_site} was validated by the site admin and your account is active now" => "Your Tiki account registration request for {\$mail_site} was validated by the site admin and your account is active now",
...
// "User Account Activated" => "Tiki User Account Activated",
...
// "User Registration Request" => "Tiki User Registration Request",
...
// "Your account information for %s" => "Your Tiki account information for %s",
...
// "If the page does not exist, it will be created" => "If the page does not exist, Tiki will create it",
