...
"Displays the text only if the language matchs" => "Mostrar o texto somente se o idioma coincide",
...
"use filename" => "use o nome do ficheiro",
...
"Username regex matching" => "Identificador de utilizador por expressão regular",
...
"Published" => "Publicado",
"User registration and login" => "Cadastro e login de utilizador",
...
"Users can register" => "Utilizadores podem se cadastrar",
...
"Remind passwords by email" => "Lembrar de palavras-passe por e-mail",
"Reg users can change theme" => "Utilizadores comuns podem alterar tema",
"Reg users can change language" => "Utilizadores comuns podem alterar idioma",
...
"Average votes per poll" => "Média de votos por votação",
...
"Module" => "Módulo",
"Column" => "Coluna",
"admin polls" => "administrar votações",
"Set last poll as current" => "Definir a última votação como actual",
"Close all polls but last" => "Fechar todas as votações excepto a última",
"Activate all polls" => "Activar todas as votações",
