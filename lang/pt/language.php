...
// "Experimental implementation of jQuery.sheet - data remains compatible with previous Tiki Sheets" => "Experimental implementation of jQuery.sheet - data remains compatible with previous Tiki Sheets",
...
// "LongCount: %baktun%, %katun%, %tun%, %winal%, %kin%" => "LongCount: %baktun%, %katun%, %tun%, %winal%, %kin%",
// "Tzolkin: %tzolkin13%, %tzolkin20%, %tzolkin20name%" => "Tzolkin: %tzolkin13%, %tzolkin20%, %tzolkin20name%",
// "Haab: %haabkin%, %haabwinal%, %haabwinalname%" => "Haab: %haabkin%, %haabwinal%, %haabwinalname%",
// "Misc: %longkin%, %julianday%" => "Misc: %longkin%, %julianday%",
// "Example: template \"%baktun%.%katun%.%tun%.%winal%.%kin%, %tzolkin13% %tzolkin20name%, %haabkin% %haabwinalname%\" for 22.05.2009 will return 12.19.16.6.11, 8 CHUEN, 9 SIP" => "Example: template \"%baktun%.%katun%.%tun%.%winal%.%kin%, %tzolkin13% %tzolkin20name%, %haabkin% %haabwinalname%\" for 22.05.2009 will return 12.19.16.6.11, 8 CHUEN, 9 SIP",
// "Default template: %baktun%.%katun%.%tun%.%winal%.%kin% %tzolkin13% %tzolkin20name% %haabkin% %haabwinalname%" => "Default template: %baktun%.%katun%.%tun%.%winal%.%kin% %tzolkin13% %tzolkin20name% %haabkin% %haabwinalname%",
