...
"descending" => "sestupně",
"ascending" => "vzestupně",
"Max description display size" => "Max. délka zobrazení popisku",
...
"You're invited to join my network of friends!" => "Zvu tě, aby ses připojil(a) do sítě mých přátel!",
"The user" => "Uživatel",
...
"No tabs" => "Žádné panely",
"Apply" => "Aplikovat",
"Reset" => "Resetovat",
"Main" => "Hlavní",
"Global Features" => "Globální funkce",
"More Functionality" => "Více možností",
"UI Enhancements" => "Vylepšení UI",
"Experimental" => "Experimentální",
"Programmer" => "Programátor",
"Main Features" => "Hlavní možnosti",
"Newsletters" => "Novinky e-mailem",
"Site Global Features" => "Globální funkce webu",
"Action Log" => "Záznam akcí",
"Action log setting" => "Nastavení záznamenávání akcí",
"Internationalization" => "Internacionalizace",
"Multilingual" => "Vícejazyčný",
"Additional Features" => "Přídavné funkce",
"Surveys" => "Dotazníky",
"Featured Help" => "Doporučujeme nápovědu",
"Copyright System" => "Copyright systém",
"Live support system" => "Systém live podpory",
"Tell a Friend" => "Pověz o tom příteli",
"HTML pages" => "HTML stránky",
"Contact Us" => "Kontaktujte nás",
"Comments Moderation" => "Moderování komentářů",
"Comments Locking" => "Uzamykání komentářů",
"User interface enhancement features" => "Možnosti vylepšení uživatelského rozhraní",
"JavaScript popup date selector" => "Usnadnění výběru data pomocí JavaScriptu",
"PhpLayers Dynamic menus" => "Dynamické nabídky PHPLayers",
"Fullscreen" => "Cel&aacute; obrazovka",
"Allow users to activate fullscreen mode" => "Povolit uživatelům aktivaci módu zobrazení na plnou obrazovku",
"Css Menus (suckerfish)" => "CSS menu (Suckerfish)",
"Mootools or JQuery" => "Mootools nebo jQuery",
"Floating help aka the Big Blue Help Icon" => "Plovoucí nápověda neboli Velká Modrá Ikona Nápovědy",
"Experimental Features" => "Experimentální funkce",
"Seem ok" => "Zdají se být OK",
"Ajax" => "AJAX",
"HTML Purifier" => "HTML čistič",
"Mobile" => "Mobil",
"Need polish" => "Vyžadují doladění",
"Tiki Sheet" => "Tiki tabulka",
"Malfunctioning" => "Fungují, ale často špatně",
"Drawings" => "Kreslení",
"Friendship" => "Přátelení",
...
"Edit Repository:" => "Upravit repozitář:",
"Create New Repository" => "Vytvořit nový repozitář",
"List Repositories" => "Vypiš repozitáře",
"New Repository" => "Nový repozitář",
"View Repository" => "Zobrazit repozitář",
"Human readable repository name" => "Srozumitelný název repozitáře",
...
"CSS file" => "CSS soubor",
"Is repository visible to users" => "Je repozitář viditelný pro uživatele",
"Can files from repository be cached" => "Mohou soubory z repozitáře být kešované",
"Cacheable" => "Kešovatelné",
"Are files from repository can be cached" => "Soubory z repozitáře mohou být kešované",
"Clear all cached pages of this repository" => "Vyčisti všechny kešované stránky tohoto repozitáře",
"Clear cache" => "Vyčisti keš",
"Seconds count 'till cached page will be expired" => "Počet sekund než kešovaná stránka expiruje",
"Cache expiration" => "Expirace keše",
"Human readable text description of repository" => "Popis repozitáře srozumitelný pro lidi",
