...
// "Fijian" => "Fijian",
// "Galician" => "Galician",
"Template %s not registered" => "Modelo (template) %s não registrado",
"Tiki Link - Insert internal link" => "Tiki Link - Insira um link interno",
"Select a Wiki page to link to:" => "Selecione uma página Wiki a ser linkada:",
"This is an approximation based on your server memory limit:" => "Essa é uma aproximação baseada no limite de memória do seu servidor (server memory limit):",
"This is the value of your server's PHP '%s' setting" => "Esse é o valor do '%s' configurado em seu servidor PHP.",
"unknown destination directory. Please set it up in <a href='tiki-admin.php?page=galleries'>tiki-admin.php?page=galleries</a>" => "diretório de destino desconhecido. Por favor ajuste isso na página de administração das galerias: <a href='tiki-admin.php?page=galleries'>tiki-admin.php?page=galleries</a>",
...
// "Hit" => "Hit",
// "Cyclic" => "Cyclic",
"Click to select visible calendars" => "Clique para selecionar calendários visíveis",
"Date and time of end" => "Data e hora de encerramento",
// "or new" => "or new",
// "chair" => "chair",
...
"Permission denied: you cannot view this blog post while it is marked private" => "Permissão negada: você não pode ver esse post enquanto ele estiver marcado como privado",
