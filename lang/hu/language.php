...
// "Your database requires an update to match the current TikiWiki version. Please proceed to <a href=\"tiki-install.php\">the installer</a>. Incorrect database version may create occasional errors" => "Your database requires an update to match the current TikiWiki version. Please proceed to <a href=\"tiki-install.php\">the installer</a>. Incorrect database version may create occasional errors",
...
"Create New" => "új létrehozása",
"Lookup" => "Keresés",
"Use the 'Quick Edit' module to easily create or edit wiki pages" => "Használjuk a 'Wiki oldal szerkesztése' modult wiki oldalak gyors létrehozásához/szerkesztéséhez",
...
"Wiki attachments" => "Wiki mellékletek",
"Wysiwyg means What You See Is What You Get, and is handled in Tikiwiki by <a href=\"http://fckeditor.net\">FCKeditor</a>" => "Wysiwyg egy rövidítés (What You See Is What You Get), mely lehetővé teszi a könnyed szövegszerkesztést és szövegformázást. Tikiwiki a <a href=\"http://fckeditor.net\">FCKeditor</a> megoldást használja.",
