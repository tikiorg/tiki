...
"Please wait %d secondes between posts" => "Por favor, espere %d segundos entre posts",
"A contribution is mandatory" => "Una contribución es obligatoria",
"Invalid Email" => "Email Inválido",
"Your message has been queued for approval, the message will be posted after a moderator approves it" => "Su mensaje está pendiente de aprobación, el mensaje será publicado cuando un moderador lo apruebe",
...
"You are alerted of a changement on " => "Usted es alertado de un cambio en ",
...
"Your database requires an update to match the current TikiWiki version. Please proceed to <a href=\"tiki-install.php\">the installer</a>. Using Tiki with an incorrect database version usually provoke errors" => "Su base de datos necesita ser actualizada a la nueva versión de Tikiwiki. Por favor, ejecute  <a href=\"tiki-install.php\">el instalador</a>. Utilizar Tiki con una base de datos incorrecta normalmente provoca errores",
...
"Displays an image and allow the users to define zones to highlight information on the image" => "Muestra una imagen y permite a los usuarios definir zonas donde resaltar información en la imagen",
...
"Includes a list of articles within the page" => "Incluye una lista de los artículos dentro de la página",
"Articles displayed" => "Artículos mostrados",
"The amount of articles to display in the list" => "La cantidad de artículos a mostrar en la lista",
...
"Puts the stuff between {ATTACH} tags as the link text instead of the file name or description" => "Coloca las cosas entre las etiquetas {ATTACH} tags como el texto del enlace en lugar del nombre del fichero o la descripción",
...
"Maximum amount of entries to list" => "Máxima cantidad de entradas en la lista",
...
"for box with width lesser than 100%, make text wrap around the box" => "para caja con ancho menor que el 100%, hacer que el texto se ajuste a la caja",
"CSS Class" => "Clase CSS",
