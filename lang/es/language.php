...
"Maps feature is not correctly setup : Maps path is missing." => "La funcion de Mapas no esta correctamente configurada: falta directorio para los mapas.",
...
"Missing information to read news (server,port,username,password,group) required" => "Informacion faltante para leer grupos de noticias (servidor,puerto,usuario,contraseña,grupo) requerida",
...
"Last sites of directory \".\$rc[\"name\"].\" ." => "Ultimos sitios en directorio \".\$rc[\"name\"].\" .",
"No subject" => "Sin tema",
...
"You will receive an email with information to login for the first time into this site" => "Recibirá un correo con informacion para loguearse por primera vez en este sitio",
...
"Invalid email address. You must enter a valid email address" => "Direccion de correo inválida. Debe entrar una dirección válida de correo",
...
"Last modifications to the Wiki." => "Ultimas modificaciones para el Wiki.",
...
"to the registered email address for" => "a la direccion registrada de correo para",
...
"Last images uploaded to the image galleries." => "Ultimas imágenes subidas a las galerías de imágenes.",
...
"Invalid password.  You current password is required to change your email address." => "Contraseña inválida. Su contraseña es requerida para cambiar su dirección de correo.",
...
"Last files uploaded to the file galleries." => "Ultimos archivos subidos a las galerías de archivos.",
...
"Forward messages to this forum to this e-mail address, in a format that can be used for sending back to the inbound forum e-mail address" => "Reenviar mensajes a este foro a esta direccion de correo, en un formato que puede ser usado para enviar para retornar a la direccion entrante de correo del foro",
"Originating e-mail address for mails from this forum" => "Direccion origen de correo para correos de este foro",
"Add messages from this email to the forum" => "Agregar mensajes para este correo a el foro",
...
"Add unsubscribe instructions to each newsletter" => "Agregar instrucciones de desuscripción a cada boletín",
...
"contacts" => "contactos",
"Contacts" => "Contactos",
"Add new mail account" => "Agregar cuenta de correo",
...
"Thanks for your subscription. You will receive an email soon to confirm your subscription. No newsletters will be sent to you until the subscription is confirmed." => "Gracias por su suscripción. Recibirá un correo pronto para confirmarla. No se enviarán newsletters hasta que la suscripción sea confirmada.",
"Your email address was removed from the list of subscriptors." => "Su direccion de correo ha sido removida de la lista de suscriptores.",
...
"Your email could not be validated; make sure you email is correct and click register below." => "Su correo no puede ser validado; asegúrese que su correo es correcto y cliquee registro abajo.",
...
"stop monitoring this blog" => "dejar de monitorizar este este blog",
"Find:" => "Encontrar:",
...
"I forgot my pass" => "Olvide mi contraseña",
...
"Last `\$module_rows` forum posts" => "Ultimos `\$module_rows` posts en foro",
"Last forum posts" => "Ultimos post en foro",
...
"Add Hotword" => "Agregar Palabra clave",
"Word" => "Palabra",
...
"Add top level bookmarks to menu" => "Agregar marcadores del nivel principal al menú",
...
"Email Encoding" => "Codificación de Correo",
...
"server" => "servidor",
"Add or edit a news server" => "Agregar o editar un servidor de grupos de noticias",
...
"Use [URL|description] or [URL] for links" => "Usar [URL|descripcion] o [URL] para enlaces",
...
"Add a subscription newsletters" => "Agregar suscripcion",
"Add all your site users to this newsletter (broadcast)" => "Agregar todos los usuarios a este boletín",
"Add users" => "Agregar usuarios",
"Subscriptions" => "Suscripciones",
"subscribed" => "suscripto",
"Edit quiz questions" => "Editar preguntas de cuestionario",
"Reuse question" => "Volver a usar pregunta",
