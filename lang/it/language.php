...
"The following image was succesfully uploaded" => "La seguente immagine Ã¨ stata ricevuta con successo",
"Thumbnail" => "Thumbnail",
...
"Tag already exists" => "Tag giÃ  esistente",
"Tag not found" => "Tag non trovato",
"The passwords dont match" => "Le password non coincidono",
"User already exists" => "Utente giÃ  registrato",
"This feature is disabled" => "Questa caratteristica Ã¨ disabilitata",
...
"The page cannot be found" => "La pagina non puÃ² essere trovata",
"Page cannot be found" => "La pagina non puÃ² essere trovata",
"Cannot edit page because it is locked" => "La pagina non puÃ² essere modificata perchÃ© Ã¨ lockata",
...
"Group already exists" => "Il gruppo giÃ  esiste",
...
to preview the appeareance of the page, no versions are stored for this page." => "La SandBox Ã¨ una pagina dove esercitare le tue abilitÃ  nell'editing, usa il preview per controllare il risultato,
...
"sandbox" => "sandbox",
"user preferences" => "preferenze utente",
"You cannot edit this page because it is a user personal page" => "Non puoi modificare questa pagina perchÃ© e una pagina utente personale",
"The SandBox is disabled" => "La SandBox Ã¨ disabilitata",
...
"Article is not published yet" => "L'articolo non Ã¨ ancora pubblicato",
...
"Most visited blogs" => "Blogs piÃ¹ visitati",
"Most Active blogs" => "Blogs piÃ¹ attivi",
...
"The following file was succesfully uploaded" => "Il file seguente Ã¨ stato ricevuto con successo",
...
"Last forum topics" => "Discussioni piÃ¹ recenti",
"Most read topics" => "Discussioni piÃ¹ lette",
"Top topics" => "Discussioni piÃ¹ votate",
"Most visited forums" => "Forum piÃ¹ visitati",
"Most commented forums" => "Forum con piÃ¹ commenti",
...
"This feature has been disabled" => "Questa sezione Ã¨ stata disabilitata",
...
All your tables will be replaced with the information in the backup." => "Il recupero di un backup puÃ² distruggere tutti i dati nel DB del Tiki.
...
from your php.ini file" => "Creare un backup puÃ² richiedere molto tempo, se il processo non Ã¨ completo riceverai uno schermo bianco.
In questo caso Ã¨ necessario aumentare il massimo tempo di esecuzione dello script in php.ini",
...
"Top Visited FAQs" => "FAQs piÃ¹ visitate",
...
"The following image was succesfully edited" => "La seguente immagine Ã¨ stata modificata con successo",
...
"Username cannot contain whitespace" => "La username non puÃ² contenere spazi",
...
"Column links to edit/view item?" => "La colonna Ã¨ link alla visualizzazione/modifica dell'elemento?",
...
Nessuna newsletters verrÃ  inviata prima della conferma della richiesta di abbonamento.",
...
"standard" => "standard",
"secure" => "sicuro",
"stay in ssl mode" => "resta in modalitÃ  ssl",
...
"Creating backups may take a long time. If the process is not completed you will see a blank screen. If so you need to increment the maximum script execution time from your php.ini file" => "La creazione di backup puoò richiedere molto tempo. Se il processo non è completo apparirà uno schermo bianco. In questo caso è necessario incrementare il tempo massimo di esecuzione degli schipt in php.ini",
"view blog" => "vedi blog",
...
"Tasks per page" => "Tasks per pagina",
"My Tiki" => "My Tiki",
"My pages" => "My pages",
...
"last updated (desc)" => "ultima modifica (desc)",
...
"Pos" => "Pos",
"Mode" => "Mode",
"Add or edit an item" => "Aggiungi o modifica un item",
...
"Create/edit extwiki" => "Crea/modifica extwiki",
