...
// "HTML" => "HTML",
"Include literal HTML in a Wiki page" => "Beinhaltet? \"literal HTML\" in einer Wiki Seite",
...
"Create a mouseover feature on some text" => "Erstelle einen Mouseovereffekt auf einem Text",
...
"Last modified image galleries" => "Zuletzt modifizierte Bildergallerien",
...
"Last Validated FAQs Questions" => "Letzte bestätigte FAQs Fragen",
...
// "Posted by" => "Posted by",
"Group Monitor" => "Grouppe beobachten",
...
"Most visited directory sub-categories" => "Am Meisten besuchte Verzeichnis Subkategorien",
"Directory Category description" => "Verzeichnis Kategorie Erklärung",
"Random directory sub-categories" => "zufällig gewählte Verzeichnis Subkategorien",
// "relate" => "relate",
...
// "2 dashes" => "2 dashes",
"show/hide heading section. + (shown) or - (hidden) by default" => "zeige/verberge Kopfbereich - standartmässig + (angezeigt) oder - (verborgen)",
...
"List all comments" => "Alle Kommentare auflisten",
...
"You do not have permission to edit this page." => "Zugriff verweigert. Sie können diese Seite nicht bearbeiten",
...
"You do not have permission to edit this post" => "Zugriff verweigert. Sie können diesen Eintrag nicht bearbeiten",
...
"You do not have permission to access this gallery" => "Zugriff verweigert. Sie können auf diese Galerie nicht zugreifen.",
"No gallery indicated" => "Keine Galerie angegeben",
"You do not have permission to remove images from this gallery" => "Zugriff verweigert. Sie können keine Bilder aus dieser Galerie entfernen",
...
"You do not have permission to move images from this gallery" => "Zugriff verweigert. Sie können keine Bilder dieser Galerie verschieben",
...
"You do not have permission to edit this article" => "Zugriff verweigert. Sie können diesen Artikel nicht bearbeiten",
...
"You do not have permission to edit this blog" => "Zugriff verweigert. Sie können dieses Blog nicht bearbeiten",
...
"You have permission to edit images but not in this gallery" => "Zugriff verweigert. Sie können Bilder bearbeiten, jedoch nicht in dieser Galerie",
...
"You do not have permission to edit submissions" => "Zugriff verweigert. Sie können Einreichungen nicht bearbeiten",
...
"last image" => "neuestes Bild",
"random image" => "zufälliges Bild",
"You do not have permission to create galleries and so you cannot edit them" => "Zugriff verweigert. Sie können Galerien nicht erzeugen, also auch nicht bearbeiten",
"You do not have permission to edit this gallery" => "Zugriff verweigert. Sie können diese Galerie nicht bearbeiten",
"You do not have permission to remove this gallery" => "Zugriff verweigert. Sie können diese Galerie nicht löschen",
"Top images" => "Top Bilder",
"Last images" => "Neueste Bilder",
...
"You do not have permission to remove articles" => "Zugriff verweigert. Sie können Artikel nicht entfernen",
"You do not have permission to remove banners" => "Zugriff verweigert. Sie können keine Banner entfernen",
"You do not have permission to remove this blog" => "Zugriff verweigert. Sie können dieses Blog nicht entfernen",
"Delete comments" => "Kommentare löschen",
"Non-existent gallery" => "Nicht existierende Galerie",
"Remove file: " => "Datei löschen:",
"You have permission to upload files but not to this file gallery" => "Zugriff verweigert. Sie können Dateien hochladen, jedoch nicht in dieses Archiv",
...
"You do not have permission to upload images" => "Zugriff verweigert. Sie können keine Bilder hochladen",
...
"4 comments so far" => "4 Kommentare bis jetzt",
...
"egyéb dolgok" => "egyéb dolgok - das war Ungarisch",
"Filter:" => "Filtern:",
"Groups watching this blog:" => "Gruppen, die diesen Blog beobachten:",
"i18n stuff" => "i18n Zeugs",
"In Progress" => "In Bearbeitung",
"komment 2" => "Kommentar 2",
...
"Prevents wiki parsing of the enclosed data." => "Verhindert das parsen von Wiki Syntax der eingeschlossenen Daten",
"Put tags separated by spaces. For tags with more than one word, use no spaces and put words together or enclose them with double quotes." => "Schreibe die Tags durch Leerzeichen getrennt. Für Tags, die aus mehr als einem Wort bestehen, benutze keine Leerzeichen und schreibe die Worte zusammen, oder packe sie in \"Anführungszeichen\" ein..",
"use square brackets for an external link: [URL], [URL|link_description],[URL|link_description|relation] or [URL|description|relation|nocache] (that last prevents the local Wiki from caching the linked page; relation can be used to insert rel attribute for the link - useful e.g. for shadowbox)." => "Benutze eckige Klammern für externe Links: [URL], [URL|Link_Beschreibung],[URL|Link_Beschreibung|Relation] or [URL|Link_Beschreibung|Relation|nocache] (Das Letzte verhindert das Cachen der gelinkten Seite durch das lokale Wiki; Relation kann benutzt werden, um relative Attribute für den Link einzufügen - nützlich zum Beispiel für Shadowbox).",
"Will display using the indicated HTML color or color name. Color name can contain two colors separated by a comma. In this case, the first color would be the foreground and the second one the background." => "Zeigt die indizierte HTML Farbe oder den Farbnamen an. Der Farbname kann zwei Farben durch ein Komma getrennt enthalten. In diesem Fall stellt die erste Farbe den vordergrund un die zweite Farbe den Hintergund dar.",
"Advanced search:" => "Erweiterte Suche:",
"Default:" => "Voreingestellt:",
"Other languages you can read (select on the left to add to the list on the right):" => "Andere Sprachen, die Du lesen kannst (Selektiere aus der linken Liste, füge sie der rechten Liste hinzu):",
