...
"Your post has not been posted" => "Dein Beitrag wurde nicht gepostet",
 "A contribution is mandatory" => "Deine Mitarbeit ist zwingend erforderlich",
"Copyright management" => "Copyright Management",
"Afghanistan" => "Afghanistan",
 ...
 "Template %s not registered" => "Template %s ist nicht registriert.",
 "Administration:" => "Administration:",
 "file gallery" => "Datei Galerie",
 "survey" => "Umfrage",
 ...
 "download" => "download",
 "Reply to the selected post" => "Antwort auf den ausgewählten Beitrag",
 "Reply to parent post" => "Antwort auf den übergeordneten Beitrag",
 ...
 "last modification:" => "Letzte Änderung:",
 "Show/Hide Left Column" => "Zeige/Verstecke linke Spalte",
 "Show/Hide Right Column" => "Zeige/Verstecke rechte Spalte",
 "logout" => "Ausloggen",
 "Anti-Bot verification code" => "Anti-Bot Verifizierungscode",
 "Enter the code you see above" => "Bitte geben Sie den untenstehenden Code ein",
 ...
 "Users Default Preferences" => "Standardbenutzereinstellungen",
 ...
 "Admin Contributions" => "Verwalte Contributions",
 "Edit the contribution:" => "Bearbeite contribution:",
 "Contributions are mandatory in wiki pages" => "Contributions sind zwingend erforderlich auf Wiki-Seiten",
 "Contributions are mandatory in forums" => "Contributions sind zwingend erforderlich in Foren",
 "Contributions are mandatory in comments" => "Contributions sind zwingend erforderlich für Kommentare",
 "Contributions are mandatory in blogs" => "Contributionssind zwingend erforderlich in Blogs",
 "Contributions are displayed in the comment/post" => "Contributions werden angezeigt in Kommentaren und Beiträgen",
 "Create a new contribution" => "Erstelle eine neue Contribution",
 "List of contributions" => "Liste der contributions",
 ...
 "Immediate feedback" => "Direktes Feedback",
 "Show correct answers" => "Zeige richtige Antworten",
 "Shuffle questions" => "Fragen mischen",
 "Shuffle answers" => "Antworten mischen",
 "Passing Percentage" => "Erreichte Prozentzahl",
 "%" => "%",
 ...
 "Portrait" => "Portrait",
 "Independant Scale" => "Unabhängige Skala",
 "Horizontal" => "Horizontal",
 "Vertical" => "Vertikal",
 "Horizontal Scale" => "Horizontal Skala",
 "Bottom" => "Unten",
 "Vertical Scale" => "Vertikale Skala",
 "Left" => "Links",
 "Right" => "Rechts",
 "Series" => "Serie",
 "Wiki plug-in" => "Wiki Plugin",
 "Import From File" => "Importiere aus Datei",
 "Grab Wiki Tables" => "Grab Wiki Tables",
 "Import pages from a Structured Text Dump" => "Importiere Seite aus einer strukturierten Textauflistung",
 "ImportingPagesPhpWikiPageAdmin" => "ImportingPagesPhpWikiPageAdmin",
 "tiki-import_phpwiki tpl" => "tiki-import_phpwiki tpl",
 "Name of the dump file (it has to be in dump/)" => "Name der Dump-Datei (it has to be in dump/)",
 "body" => "body",
 ...
 "twisted" => "twisted",
 "santa" => "santa",
 "Daily Usage" => "Täglicher Gebrauch",
 "SysLog" => "SysLog",
 ...
 "Image Galleries Admin Panel" => "Bildergalerie Admin Panel",
 "Could not read image %s." => "Kann Bild %s nicht lesen.",
 ...
 "Incorrect directory chosen for batch upload of images." => "Ungültiges Verzeichnis für den Batchupload von Bildern ausgewählt.",
 "Please setup that dir on " => "Bitte stellen Sie dieses dir ein unter ",
 ...
 "File update was successful" => "Dateiaktualisierung war erfolgreich",
 "Usage" => "Benutzung",
...
// "Your message has been queued for approval and will be posted after a moderator approves it" => "Ihre Nachricht wurde zur Freigabe auf die Warteliste gesetzt und wird gepostet sobald ein Moderator sie freigegeben hat.",
// "WikiDiff::apply: line count mismatch: %s != %s" => "WikiDiff::apply: line count mismatch: %s != %s",
// "WikiDiff::_check: failed" => "WikiDiff::_check: failed",
// "WikiDiff Okay: LCS = %s" => "WikiDiff Okay: LCS = %s",
// "Newsletter subscription information at" => "Informationen über das Newsletterabonnement unter",
// "The quota has been reached in" => "Die Quote wurde erfüllt in",
// "File gallery quota exceeded" => "Bildergalerie ist voll",
// "This is an approximation based on your server memory limit" => "Dies ist eine Annäherung basierend auf Ihrem Serverspeicherlimit",
// "You are alerted by the server " => "Sie werden vom Server gewarnt ",
// "You can check the modifications at : " => "Sie können die Modifikationen überprüfen unter : ",
// "You are alerted of a change on " => "Sie werden auf eine Änderung hingewiesen unter ",
// "unknown destination directory. Please set it up in <a href='tiki-admin.php?page=galleries'>tiki-admin.php?page=galleries</a>" => "unbekanntes Zielverzeichnis. Bitte einrichten unter<a href='tiki-admin.php?page=galleries'>tiki-admin.php?page=galleries</a>",
// "unlink failed" => "unlink fehlgeschlagen",
// "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Die hochgeladene Datei überschreitet die maximale Ubploadgrösse einer Datei in der php.ini",
// "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Die hochgeladene Datei überschreitet die maximale Dateigrösse, die im HTML Formular festgelegt wurde",
// "The uploaded file was only partially uploaded. Please try again" => "Die hochgeladene Datei wurde nur teilweise hochgleaden. Bitte versuchen Sie es erneut.",
// "File upload stopped by extension" => "Dateiupload durch Erweiterung gestoppt",//
// "XML file does not validate against the Mediawiki XML schema" => "XML passt nicht zum MediaWiki Schema",
// "Contributions" => "Mitwirkung",
// "Query point" => "Abfragepunkt",
// "No valid ogr2ogr executable" => "Keine gültige ogr2ogr ausführbar",
...
// "Display page title" => "Zeige Seitentitel",
