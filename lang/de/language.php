...
"The file you are trying to upload is too big." => "Die Datei, die Sie hochladen m&ouml;chten, ist zu groß.",
...
"items" => "Eintr&auml;ge",
"The tracker needs a text field named Subject" => "Der Tracker muß ein Eingabefeld 'Subject' besitzen (auch f&uuml;r RSS Feed n&ouml;tig)",
"version" => "Version",
...
"hit" => "Treffer",
"original size" => "Originalgr&ouml;ße",
...
"Note 2:" => "Hinweis 2:",
"The menu module installed by default is named" => "Das Modul mit den Standard Men&uuml;s heißt",
...
"That one can be heavily customized to match style used but it can be currently done only by editing mod-application_menu.tpl file \"manually\"" => "Letzteres kann an eigene Styles etc. angepaßt werden, daf&uuml;r muß aber die Datei mod-application_menu.tpl von Hand ge&auml;ndert werden.",
"del" => "l&ouml;schen",
"Create pdf" => "PDF erstellen",
"pdf" => "PDF",
...
"Invalid old password" => "Ung&uuml;ltiges altes Paßwort",
...
"Disallow access to the site (except for those with permission)" => "Zugriff auf den Server verbieten (außer f&uuml;r Personen mit Berechtigung)",
"Message to display when site is closed" => "Angezeigte Meldung, wenn der Server geschlossen ist",
"Disallow access when load is above the threshold (except for those with permission)" => "Zugriff auf den Server bei &Uuml;berschreiben der eingestellten Maximallast verbieten (außer f&uuml;r Personen mit Berechtigung)",
...
"Remind passwords by email (if \"Store plaintext passwords\" is activated.) Else, Reset passwords by email" => "Paßworterinnerungen per eMail (wenn \"Paßw&ouml;rter im Klartext speichern\" aktiviert ist.) Sonst, Paßw&ouml;rter per eMail zur&uuml;cksetzen",
"Store plaintext passwords" => "Speichere Klartext-Paßw&ouml;rter",
"Crypt passwords method" => "Paßwort-Verschl&uuml;sselung",
"Reg users can change password" => "Reg. Benutzer k&ouml;nnen Paßwort &auml;ndern",
...
"Force to use chars and nums in passwords" => "Erzwinge Benutzung von Buchstaben und Zahlen in Paßw&ouml;rtern",
"Minimum password length" => "Minimale Paßwortl&auml;nge",
"Password invalid after days" => "Tage bis zur Ung&uuml;ltigkeit des Paßwortes",
...
"This probably means you have no set limit (all is well)" => "Das heißt wahrscheinlich, dass Sie &uuml;berhaupt kein Limit gesetzt haben (dann ist alles in Ordnung)",
...
"Personal Blog and Profile" => "Pers&ouml;nliches Blog und Profil",
...
"Confirm new password" => "Paßwort best&auml;tigen",
...
"Max attachment size (bytes)" => "Maximale Gr&ouml;ße (Bytes)",
...
//New Translations
"For you to vote, cookies must be allowed" => "Um abstimmen zu k&ouml;nnen, m&uuml;ssen Sie Cookies zulassen.",
...
"Afghanistan" => "Afghanistan",
 ...
 "Equatorial Guinea" => "&Auml;quatorial Guinea",
 "Eritrea" => "Eritrea",
 "Estonia" => "Estland",
 ...
 "Finland" => "Finnland",
 "France" => "Frankreich",
 "French Guiana" => "Franz&ouml;sisch Guyana",
 "French Polynesia" => "Franz&ouml;sisch Polynesien",
 "French Southern Territories" => "Franz&ouml;sische S&uum;d Territorien",
 "Gabon" => "Gabon",
 "Gambia" => "Gambia",
 "Georgia" => "Georgien",
 "Germany" => "Deutschland",
 ...
 "Israel" => "Israel",
 "Italy" => "Italien",
 "Ivory Coast" => "Elfenbeink&uuml;ste",
 "Jamaica" => "Jamaika",
 "Japan" => "Japan",
 "Jersey" => "Jersey",
 "Jordan" => "Jordan",
 ...
 "Netherlands Antilles" => "Nieder&auml;ndische Antillen",
 ...
 "Northern Mariana Islands" => "N&ouml;rdliche Marianen-Inseln",
 "North Korea" => "Nord-Korea",
 "Norway" => "Norwegen",
 "Oman" => "Oman",
 "Pakistan" => "Pakistan",
 "Palau" => "Palau",
 "Palestine" => "Pal&auml;stina",
 "Panama" => "Panama",
 ...
 "South Georgia and South Sandwich Islands" => "S&uuml; Georgien and S&uuml;dliche Sandwich Inseln",
 "South Korea" => "S&uuml;dkorea",
 "Spain" => "Spanien",
 "Sri Lanka" => "Sri Lanka",
 ...
 "Email address not valid, test mail not sent" => "Ung&uuml;ltige E-Mail-Adresse; Test-Mail konnte nicht verschickt werden.",
 ...
 "This instance of activity is already complete" => "Diese Aktivit&auml;t ist bereits abgeschlossen",
 ...
 "Fatal error: non-deterministic decision for autorouting activity" => "Fatal error: nicht-deterministische Entscheidung f&uuml;r autorouting activity",
 "Cannot add transition only split activities can have more than one outbound transition" => "Kann keinen &Uuml;bergang hinzuf&uuml;gen. Nur gesplittete Aktivit&auml;ten k&ouml;nnen mehr als einen &Uuml;bergang haben.",
 "Circular reference found some activity has a transition leading to itself" => "Zirkul&auml;re Referenz. Eine Aktivit&auml;t hat einen &Uuml;bergang zu sich selbst.",
 ...
 "Activity '.\$res['name'].' is standalone and is using the \$instance object" => "Activit&auml;t '.\$res['name'].' ist standalone and benutzt \$instance object",
 "Activity '.\$res['name'].' is interactive so it must use the \$instance->complete() method" => "Activit&auml;t '.\$res['name'].' ist interaktiv. Du musst die \$instance->complete() Methode verwenden.",
 ...
 "You must select a file for upload." => "Du musst eine Datei zum Upload ausw&auml;hlen",
 "Continue" => "Weiter",
 "invalid mapfile name" => "ung&uuml;ltiger Mapfile Name",
 "Query point:" => "Abfragepunkt:",
 "layer:" => "Schicht:",
 "Record:" => "Datensatz:",
 "No valid ogr2ogr executable" => "Kein g&uuml;ltiges ogr2ogr ausf&uuml;hrbar",
 ...
 "File %s is not a valid archive" => "Datei %s ist kein g&uuml;ltiges Archiv",
 "%s is an empty archive file" => "%s ist eine leere Archiv-Datei",
 "Impossible to open %s : %s" => "Kann nicht ge&ouml;ffnet werden %s : %s",
 "section edit" => "Abschnitt editieren",
 "This poll is closed." => "Diese Umfrage ist geschlossen.",
 "Project Group for " => "Projektgruppe f&uuml;r ",
 "Project Admin Group for " => "Projekt-Admin-Gruppe f&uuml;r ",
 "Forums last posts" => "Letzte Beitr&auml;ge im Forum",
 "The passwords do not match" => "Die Passw&ouml;rter stimmen nicht &uuml;berein.",
 "The registration mail can't be sent. Contact the administrator" => "Die E_Mail f&uuml;r die Registrierung kann nicht versendet werden. Bitte kontaktieren Sie den Administrator dieser Site.",
 ...
 "Sea Surfing (CSRF) detected. Operation blocked." => "Sea Surfing (CSRF) entdeckt. Ausf&uuml;hrung geblockt.",
 "Status:" => "Status:",
 "(unchanged)" => "(unver&auml;ndert)",
 ...
 "append" => "angeh&auml;ngt",
 "max" => "max",
 "Text options: 1,size,prepend,append,max with size in chars, prepend will be displayed before the field append will be displayed just after, max is the maximum number of characters that can be saved, and initial 1 to make that next text field or checkbox is in same row. If you indicate only 1 it means next field is in same row too." => "Text Optionen:1,Gr&ouml;ße,Vorstehendes,Nachstehendes,max Gr&ouml;ße in Zeichen, Vorangestelltes wird vor dem Feld, Nachstehendes direkt hinter dem Feld angezeigt, max ist die maximale Anzahl an Zeichen, die gespeichert werden kann und eine f&uuml;hrende 1 setzt das n&auml;chste Textfeld oder Checkbox in die gleiche Reihe. Wenn Sie nur eine 1 angeben, wird das n&auml;chste Feld in der gleichen Reihe dargestellt.",
 "Textarea options: quicktags,width,height,max,listmax - Use Quicktags is 1 or 0, widthis indicated in chars, height is indicated in lines, max is the maximum number of characters that can be saved, listmax isthe maximum number of characters that are displayed in list mode. " => "Textbereich Optionen: quicktags,Breite,H&ouml;he,max,listmax -Use Quicktags ist 1 oder 0, die L&auml;nge wird in Zeichen angegeben, die H&ouml;he in Zeilen. Max ist die maximale Anzahl an Zeichen, die gespeichert werden k&ouml;nnen, listmax ist die maximale Anzahl an Zeichen die im List-Modus dargestellt werden k&ouml;nnen.",
 "Numeric options: 1,size,prepend,append with size in chars,prepend will be displayed before the field append will be displayed just after, and initial 1 to make that next text field or checkbox is in same row. If you indicate only 1 it means next field is in same row too." => "Numerische Optionen: 1,Gr&ouml;ße,Vorangestelltes,Nachgestelltes mit Gr&ouml;ße in Zeichen, Vorangestelltes wird vor dem Feld, Nachstehendes direkt hinter dem Feld angezeigt, und eine f&uuml;hrende 1 setzt das n&auml;chste Textfeld oder Checkbox in die gleiche Reihe. Wenn Sie nur eine 1 angeben, wird das n&auml;chste Feld in der gleichen Reihe dargestellt.",
 "Dropdown options: list of items separated with commas." => "Dropdown Optionen: Aufz&auml;hlungen in der Liste mit Kommas trennen.",
 "radio buttons" => "Radio buttons",
 "Radio buttons options: list of items separated with commas." => "Radio buttons Optionen: Aufz&auml;hlungen in der Liste mit Kommas trennen.",
 "User Selector: use options for automatic field feeding : you can use 1 for author login or 2 for modificator login." => "Benutzer ausw&auml;hlen: Benutzen Sie die Optionen f&uuml;r das automatische F&uuml;llen der Felder:  1 f&uuml;r den Autor-Login oder 2 f&uuml;r den Modifikator-Login.",
 "Group Selector: use options for automatic field feeding : you can use 1 for group of creation and 2 for group where modification come from. The default group has to be set, or the first group that come is chosen for a user, or the default group is Registered." => "Gruppen ausw&auml;hlen: Benutzen Sie die Optionen f&uuml;r das automatische F&uuml;llen der Felder: 1 f&uuml;r die Gruppe der Erstellung und 2 f&uuml;r die Gruppe in der die Modifikationen vorgenommen werden. Es muss eine Standardgruppe gestzt werden oder die erste Gruppe wird f&uuml;r einen Benutzer ausgew&auml;hlt oder die Standardgruppe wird als Registriert gesetzt.",
 "country selector" => "Land ausw&auml;hlen",
 "Country Selector options: 1|2 where 1 show only country name and 2 show only country flag. By default show both country name and flag" => "Optionen f&uuml;r die L&auml;nderauswahl: 1|2, dabei zeigt 1 nur den L&auml;ndernamen und 2 nur die Flagge. Als Standard ist die Anzeige des Namens und der Flagge gesetzt.",
 ...
 "item link" => "item Link",
 "Item Link options: trackerId,fieldId,linkToItem links to item from trackerId which fieldId matches the content of that field. linkToItem 1|0 to create a link to the item in view mode and listing" => "Item Link Optionen: trackerId,fieldId,linkToItem links vom item zur trackerId deren fieldId mit dem Inhalt des Feldes &uuml;berein stimmt.linkToItem 1|0 erzeugt einen Link zu einem Item im Lesemodus",
 "items list" => "items Liste",
 "Items list options: trackerId,fieldIdThere, fieldIdHere, displayFieldIdThere, linkToItems displays the list of displayFieldIdThere from item in tracker trackerId where fieldIdThere matches fieldIdHere. linkToItems 1|0 to create a link to items in view mode and listing" => "Items Liste Optionen: trackerId,fieldIdThere, fieldIdHere, displayFieldIdThere, linkToItems zeigt eine Liste von items in einem Tracker trackerId in dem fieldIdThere mit fieldIdHere &uuml;berein stimmt. linkToItems 1|0 erzeugt einen Link zu Items im Lesemodus.",
 "Email address options: 0|1|2 where 0 puts the address as plain text, 1 does a hex encoded mailto link (more difficult for web spiders to pick it up and spam) and 2 does the normal href mailto." => "E-Mail-Adress-Optionen: 0|1|2 wobei 0 die Adresse im plain text darstellt, 1 erzeugt einen hex mailto link (schwieriger f&uuml;r web spider zu erfassen und hilfreich gegen Spam) 2 erzeugt einen normalen href mailto_Link.",
 "Added:" => "Hinzugef&uuml;gt:",
 "Removed:" => "Entfernt:",
 "Remaining:" => "&Uuml;brig bleiben:",
 "Old:" => "Alt:",
 "New:" => "Neu:",
 "No extra information for that attached file. " => "Keine Zusatzinformation f&uuml;r die angeh&auml;ngte Datei. ",
 "Include all post in a blog" => "Umfasst alle Beitr&auml;ge in einem Blog",
 "Lists files in a directory" => "Listet alle Dateien eines Verzeichnisses auf",
 "could not be opened because it doesn't exist or permission was denied" => "Kann nicht ge&ouml;ffnet werden, weil nicht existent oder keine Zugriffsrechte vorhanden.",
 "Takes regex expressions and parses the content between the REGEX tags and replaces the text." => "Erkennt REGEX Ausdr&uuml;cke und parst den Inhalt zwischen den REGEX TAGS und ersetzt den Text.",
 "The SNARF plugin replaces itself with the HTML body of a URL.  Arbitrary regex replacement can be done on this content using regex and regexres, the latter being used as the second argument to preg_replace." => "Das SNARF Plugin ersetzt sich selbst durch den HTML body einer URL.  Arbitrary regex Ersetzungen k&ouml;nnen f&uuml;r diesen Inhalt mit regex und regexres ausgef&uuml;hrt werden, letzteres wird als zweites Argument gesetzt bei preg_replace.",
 "This data is put in a CODE caption." => "This data is put in a CODE caption.",
 "Missing url parameter for SNARF plugin." => "Fehlender URL Parameter f&uuml;r SNARF Plugin.",
 ...
 "~np~{~/np~ARTICLES(max=>3,topic=>topicName,type=>type,categId=>Category parent ID,sort=>columnName_asc|columnName_desc)}{ARTICLES} Insert articles into a wikipage" => "~np~{~/np~ARTICLES(max=>3,topic=>topicName,type=>type,categId=>Category parent ID,sort=>columnName_asc|columnName_desc)}{ARTICLES} F&uuml;gt Artikel auf einer Wiki-Seite ein.",
 "no such attachment on this page" => "Kein anhang zu dieser Seite vorhanden.",
 "Displays an attachment or a list of them" => "Zeigt einen Anhang oder eine Liste der Anh&auml;nge.",
 "\r\n \t\tname => Zeigt den Namen der angeh&auml;ngten Datei zum Verlinken.\r\n \t\tfile => Ebenso wie Name\r\n \t\tpage => Gibt den Namen der Seite an, an die die Datei angeh&auml;ngt ist. Auf die entsprechende Datei wird verlinkt. Funktioniert nur bei Wiki-Seiten.\r\n \t\tshowdesc => zeigt die Beschreibung als Linktext anstelle des Dateinamens \r\n\t\tbullets => Macht aus einer Liste der Anh&auml;nge eine Liste mit Gliederungspunkten. \r\n \t\timage => Besagt, dass die Datei eine Bilddatei ist und in einem im img tag verwendet werden sollte.\r\n \t\tinline => setzt alles zwischen den {ATTACH} tags als Linktext anstelle des Dateinamens oder der Beschreibung.\r\n \t\tall => Zeigt alle Anh&auml;nge des gesamten Wikis.\r\n \t\tnum => \r\n \t\tname => Zeigt den Namen der angeh&auml;ngten Datei zum Verlinken.\r\n \t\tfile => Ebenso wie Name\r\n \t\tpage => Gibt den Namen der Seite an, an die die Datei angeh&auml;ngt ist. Auf die entsprechende Datei wird verlinkt. Funktioniert nur bei Wiki-Seiten.\r\n \t\tshowdesc => zeigt die Beschreibung als Linktext anstelle des Dateinamens \r\n\t\tbullets => Macht aus einer Liste der Anh&auml;nge eine Liste mit Gliederungspunkten. \r\n \t\timage => Besagt, dass die Datei eine Bilddatei ist und in einem im img tag verwendet werden sollte.\r\n \t\tinline => setzt alles zwischen den {ATTACH} tags als Linktext anstelle des Dateinamens oder der Beschreibung.\r\n \t\tall => Zeigt alle Anh&auml;nge des gesamten Wikis.\r\n \t\tnum =>Zeigt die Nummer des Anhangs auf den verlinkt wird in der Anhangliste \r\n \t\tid => Zeigt die tats&auml;chliche ID des Anhangs auf den verlinkt wird. Es ist nicht sinnvoll das zu verwenden.\r\n \t\tdls => Zeigt die anzahl der Downloads im alt comment an.\r\n \t\ticon => Zeigt ein Datei Icon\r\n    " 
 ...
 "Insert a division block on wiki page" => "F&uuml;gt einen Trennblocl auf einer Wiki-Seite ein.",
 "Displays a Flash (.swf) file in the wiki page" => " Zeigt eine Flash-Datei (.swf) auf einer Wiki-Seite.",
 "Formula" => "Formel",
 "No formula specified." => "Keine Formel ausgew&auml;hlt.",
 "Impossible to render the graphic." => "Graphik kann nicht gerendert werden.",
 "View graphic" => "Graphik ansehen",
 "Display wiki text if user is in one of listed groups" => "Zeigt den Wiki-Text, falls der User einer der aufgef&uuml;hrten Gruppen angeh&ouml;rt.",
 ...
 "Displays the text only if the language matchs" => "Zeigt den Text nur dann wenn die Sprachen &uuml;bereinstimmen.",
 "Displays a map" => "Zeigt eine Karte,
 "Displays an miniquiz" => "zeigt ein Miniquiz.",
 "Displays object hit info by object and days" => "Zeigt Informationen &uuml;ber die Hits eines Objekts nach Objekt oder Tagen.",
 "Displays a list of plugins available in this wiki." => "Zeigt eine Liste der verf&uuml;gbaren Plugins f&uuml;r dieses Wiki.",
 ...
 "missing poll ID for plugin POLL" => "Fehlende Umfrage ID f&uuml;r das Plugin POLL",
 " wrote:" => " wrote:",
 "Quote:" => "Quote:",
 ...
 "~np~{~/np~RSS(id=>feedId,max=>3,date=>1,body=>1)}{RSS} Insert rss feed output into a wikipage" => "~np~{~/np~RSS(id=>feedId,max=>3,date=>1,body=>1)}{RSS} F&uuml;gt die Ausgabe eines RSS Feeds auf einer Wiki-Seite ein.",
 "Sheet Heading" => "Blatt &Uuml;berschrift",
 ...
 "Displays the thumbnail for an image" => "Zeigt Thumbnails (Vorschaubilder) f&uuml;r ein Bild.",
 ...
 "Following mandatory fields are missing" => "Folgende notwendige Felder sind nicht ausgef&uuml;llt.",
 "Following fields are incorrect" => "Folgende Felder sind nicht korrekt.",
 "Displays an input form for tracker submit" => "Zeigt das Eingabeformular f&uuml;r einen Tracker",
 "You do not have permission to insert an item" => "Sie haben nicht die Berechtigung ein Item hinzuzuf&uuml;gen.",
 "Fields marked with a * are mandatory." => "Mit einem * markierte Felder m&uuml;ssen ausgef&uuml;llt werden.",
 "All fileds must be from the same tracker" => "Alle Felder m&uuml;ssen aus ein und demselben Tracker stammen.",
 ...
 "tracker field type not processed yet" => "Tracker Feldtyp wird bisher nicht unterst&uuml;tzt.",
 ...
 "missing tracker ID for plugin TRACKER" => "Fehlende Tracker ID f&uuml;r das Plugin TRACKER",
 ...
 "Multiple collected items are separated in distinct table rows, or by comma or line break in one cell.<br />" => "Mehrfach gesammelte Items werden in unterschiedlichen Tabellenreihen einzeln aufgef&uuml;hrt oder durch Kommata oder Zeilenumbr&uuml;chen in einer Zelle.<br />",
 ...
 "a valid regex-expression (PCRE)" => "ein g&uuml;ltiger regex-Ausdruck (PCRE)",
 "non-valid custom regex" => "ung&uuml;ltiger individueller regex",
 ", " => ", ",
 "ignored" => "ignoriert",
 ...
 "Changed actual version to \$version" => "Aktuelle Version ge&auml;ndert auf \$version",
 "You have to be able to receive messages in order to send them. Goto your user preferences and enable 'Allow messages from other users'" => "Sie m&uuml;ssen Mails empfangen k&ouml;nnen um selbst welche zu verschicken. Aktivieren Sie in Ihren Benutzer-Einstellungen 'Erlaube Nachrichten von anderen Benutzern'",
 "list topics with links to the articles" => "listet die &Uuml;berschriften als Links zu den Artikeln",
 "Article Topics" => "Artikel &Uuml;berschriften",
 ...
 "new posts" => "Neue Beitr&auml;ge",
 "new FAQs" => "Neue FAQs",
 "new blogs" => "Neue Blogs",
 "new blog posts" => "Neue Blogeintr&auml;ge",
 ...
 "Workspace not selected" => "Workspace nicht ausgew&auml;hlt",
 "Resource type not selected" => "Resourcentyp nicht ausgew&auml;hlt.",
 "Owner not set" => "Eigent&uuml;mer nicht angegeben",
 ...
 "the main workspace group cant be removed" => "Die Hauptgruppde des Workspace kann nicht gel&ouml;scht werden.",
 ...
 "Invalid server key" => "Ung&uuml;ltiger Serverschl&uuml;ssel",
 "download" => "download",
 "Reply to the selected post" => "Antwort auf den ausgew&auml;hlten Beitrag",
 "Reply to parent post" => "Antwort auf den &uuml;bergeordneten Beitrag",
 "Type of contribution:" => "Typ der Contribution:",
 "Perhaps you were looking for:" => "Suchen Sie vielleicht das hier ?",
 "There are no wiki pages similar to '{\$page}'" => "Es bit keine &auml;hnlichen Seiten zu '{\$page}'",
 "(page will be orphaned)" => "(Seite verwaist)",
 "Close Window" => "Fenster schließen",
 "Last update from CVS" => "Letztes Update von CVS",
 "Folksonomy Tags" => "Folksonomy Tags",
 "Put tags separated by spaces. For tags with more than one word, use no spaces and put words together." => "Schließen Sie die Tags in Leerzeichen ein. F&uuml;r Tags, die aus mehr als einem Wort bestehen, lassen Sie bitte keine Leerzeichen zwischen den W&ouml;rtern, sondern ziehen Sie sie zu einem zusammen.",
 ...
 "PUT:WikiName to update/create a wiki page (use the body for the page data)" => "PUT:WikiName um eine Wiki-Seite zu erstellen oder zu aktualisieren (Nutzen Sie den body f&uuml;r die Seitendaten)",
 "APPEND:WikiName to append data to a Wiki page (use the body for the data to add)" => "APPEND:WikiName um Daten an eine Wiki-Seite anzuh&auml;ngen (Nutzen Sie den for um Daten hinzuzuf&uuml;gen)",
 "PREPEND:WikiName to append the data at the top" => "PREPEND:WikiName um Daten am Anfang hinzuzuf&uuml;gen",
 ...
 "Your Tiki account registration request for {\$mail_site} was validated by the site admin and your account is active now." => "Ihre TikiWiki Registrierungsanfrage f&uuml;r {\$mail_site} wurde von einem Admin gepr&uuml;ft und Ihr Zugang ist nun freigeschaltet.",
 ...
 "Go to your friendship network to accept or refuse this request" => "Sie k&ouml;nnen diese Anfrage in Ihrem Freunde-Netzwerk akzeptieren oder ablehnen.",
 ...
 "requested a reminder of the password for your account" => "forderte eine Passworterinnerung f&uuml;r Ihren Account an.",
 "requested password reset for your account" => "m&ouml;chte das Passwort f&uuml;r Ihren Account zur&uuml;cksetzen",
 "Please click on the following link to confirm you wish to reset your password and go to the screen where you must enter a new \"permanent\" password. Please pick a password only you will know, and don't share it with anyone else.\r\n{\$mail_machine}/tiki-remind_password.php?user={\$mail_user|escape:'url'}&actpass={\$mail_apass}\r\n\r\nDone! You should be logged in." => "Bitte klicken Sie auf den folgenden Link um zu best&auml;tigen, dass Sie das Passwort zur&uuml;cksetzen m&ouml;chten und gehen Sie zu der Maske in der Sie ein neues \"permanentes\" Passwort eingeben m&uuml;ssen. Bitte w&auml;hlen Sie ein Passwort, das nur Sie kennen und teilen Sie es niemandem mit.\r\n{\$mail_machine}/tiki-remind_password.php?user={\$mail_user|escape:'url'}&actpass={\$mail_apass}\r\n\r\n Fertig! Sie k&ouml;nnen sich jetzt einloggen.",
 ...
 "Tracker was modified at" => "Tracker wurde ver&auml;ndert in",
 ...
 "File Gallery %s changed" => "Dateiarchiv %s ge&auml;ndert",
 "A file was removed from the file gallery" => "Eine Datei wurde aus dem Dateiarchiv gel&ouml;scht",
 ...
 "The map {\$mail_page} was changed by {\$mail_user} at {\$mail_date|tiki_short_datetime}" => "Die Karte {\$mail_page} wurde ge&auml;ndert von {\$mail_user} am {\$mail_date|tiki_short_datetime}",
 "You can view the updated map following this link:" => "Sie k&ouml;nnen die aktuelle Karte unter diesem Link sehen:",
 "You can edit the map following this link:" => "Sie k&ouml;nnen die Karte unter diesem Link bearbeiten:",
 ...
 "Old name" => "Alter Name",
 "click on the map to zoom or pan, do not drag" => "Klicken Sie auf die Karte um sie zu vergr&ouml;ßern oder zu drehen. Sie k&ouml;nnen die Karte nicht ziehen."
 "Query Results" => "Ergebnisse der Abfrage",
 "Querying" => "Abfragen",
 "Scroll Up" => "Nach oben scrollen",
 "Scroll Down" => "Nach unten scrollen",
 "Zoom out x4" => "Vierfach vergr&ouml;ßern",
 "Zoom out x3" => "Dreifach vergr&ouml;ßern",
 "Zoom out x2" => "Doppelt vergr&ouml;ßern",
 "Pan" => "Drehen",
 "Zoom in x2" => "Doppelt verkleinern",
 "Zoom in x3" => "Dreifach verkleinern",
 "Zoom in x4" => "Vierfach verkleinern",
 "select zoom/pan/query and image size" => "W&auml;hlen Sie Zoom/Drehen/Abfrage und Bildgr&ouml;sse",
 "Go" => "Los",
 ...
 "If you want people to be able to reply to you, you have to check <a href='tiki-user_preferences.php'>Allow messages from other users</a>" => "Wenn Sie m&ouml;chten, dass andere Ihnen antworten k&ouml;nnen, m&uuml;ssen Sie die <a href='tiki-user_preferences.php'> &uuml;berpr&uuml;fen. Erlauben Sie Nachrichten von anderen Benutzern</a>",
 "No messages to download" => "Keine Nachrichten zum Downloaden.",
 "Unflag" => "Unflag",
 "'name' parameter for tikimodule missed" => "Parameter 'Name' f&uuml;r das TikiWiki-Modul fehlt.",
 "opp side" => "gegen&uuml;berliegende Seite",
 ...
 "Display type unknown, you have to enter the banner type" => "Darstellungstyp unbekannt. Sie m&uuml;ssen einen Bannertypen eingeben",
 "WfMenu" => "WfMen&uuml;",
 "FriendsMenu" => "FreundeMen&uuml;",
 "Community" => "Community",
 "WikiMenu" => "WikiMen&uuml;",
 "GalMenu" => "GalMen&uuml;",
 "ForMenu" => "ForMen&uuml;",
 "DirMenu" => "DirMen&uuml;",
 "FileGalMenu" => "FileGalMen&uuml;",
 "QuizMenu" => "QuizMen&uuml;",
 "ShtMenu" => "ShtMen&uuml;",
 "TrkMenu" => "TrkMen&uuml;",
 "SrvMenu" => "SrvMen&uuml;",
 ...
 "Last `\$module_rows` modified events" => "Neueste `\$module_rows` Termin&auml;nderungen",
 "Last `\$module_rows` Page Changes" => "Neueste `\$module_rows` Seiten&auml;nderungen",
 "Last Page Changes" => "Neueste Seiten&auml;nderungen",
 ...
 "Random Images" => "Zuf&auml;llige Bilder",
 ...
 "select" => "Auswahl",
 "You need to activate user and/or group trackers" => "Sie m&uuml;ssen die Benutzer - und/oder Gruppentracker aktivieren.",
 "Top users" => "Top User",
 "on host" => "auf Host",
 " on page " => " auf Seite ",
 ...
 "\$title" => "\$title",
 "prev posts" => "vorherige Beitr&auml;ge",
 "next posts" => "n&auml;chste Beitr&auml;ge",
 "prev files" => "vorherige Dateien",
 "next files" => "n&auml;chste Dateien",
 "prev images" => "vorherige Bilder",
 "next images" => "n&auml;chste Bilder",
 ...
 "are you sure to remove object " => "Sind Sie sicher, dass Sie dieses Objekt l&ouml;schen wollen ? ",
 "UserGroups" => "Benutzergruppen",
 "Group Name:" => "Gruppenname:",
 "User name:" => "Benutzername:",
 "are you sure to remove group " => "Sind Sie sicher, dass Sie diese Gruppe l&ouml;schen wollen ?",
 "are you sure to remove user from group " => "Sind Sie sicher, dass Sie diesen Benutzer aus der Gruppe l&ouml;schen wollen ?",
 ...
 "[-]" => "[-]",
 "error" => "Fehler",
 "Are you sure you want to remove this module?" => "Sind Sie sicher, dass Sie dieses Modul l&ouml;schen wollen ?",
 ...
 "List pages where I am a modificator" => "Liste die Seiten auf, die von mir ge&auml;ndert wurden",
 "Skip to navigation" => "Springe zur Navigation",
 "RSS Trackers" => "RSS Tracker",
 "Note: if you want to use images please save the post first and you\r\n\twill be able to edit/post images. Use the &lt;img&gt; snippet to include uploaded images in the textarea editor\r\n\tor use the image URL to include images using the WYSIWYG editor. " => "Hinweis: Wenn Sie Bilder einf&uuml;gen m&ouml;chten, speichern Sie bitte zuerst Ihren Beitrag, damit und \r\n\t Sie Bilder bearbeiten oder hinzuf&uuml;gen k&ouml;nnen. Nutzen Sie den &lt;img&gt; Schnipsel um die hochgeladenen Bilder im Texteditor zu bearbeiten \r\n\t oder verwenden Sie die URL des Bildes um es im WYSIWYG Editor einzuf&uuml;gen. ",
 "Location : " => "Location : ",
 "Translate in" => "&Uuml;bersetze nach",
 "babelfish it" => "babelfish it",
 "Welcome to" => "Willkommen in",
 "Change user preferences" => "&Auml;ndere Benutzereinstellungen",
 "Homepage" => "Startseite",
 "Personal portfolio" => "Pers&ouml;nliches Portfolio",
 "View tpl" => "Betrachte tpl",
 "UserPreferences tpl" => "Benutzereinstellungen tpl",
 "Your personal tracker information" => "Ihre pers&ouml;nliche Tracker Information",
 ...
 "To add/remove calendars, look for \"Calendar\" under \"Admin\" on the application menu, or" => "Um Kalender hinzuzuf&uuml;gen oder zu l&ouml;schen, suchen Sie nach \"Kalender\" unter \"Admin\" im Anwendermen&uuml;, oder",
 "Quarter" => "Viertel",
 "Semester" => "Semester",
 ...
 "You need to request a Google Maps Schl&uuml;ssel f&uuml;r diese Website. Sie k&ouml;nnen einen Schl&uuml;ssel f&uuml;r Ihre Domain generieren unter:" => "Sie m&uuml;ssen einen Google Maps Schl&uuml;ssel f&uuml;r diese Website anfordern. Hier k&ouml;nnen Sie einen Schl&uuml;ssel generieren:",
 "Google Map Key" => "Google Map Schl&uuml;ssel",
 "Default x for map center" => "Standard x-Wert f&uuml;r Kartenmitte",
 "Default y from map center" => "Standard y-Wert f&uuml;r Kartenmitte",
 "Default zoom level" => "Standardzoomlevel",
 "whole earth" => "gesamte Erde",
 "country size" => "L&auml;ndergr&ouml;ße",
 "city size" => "Stadtgr&ouml;ße",
 ...
 "Limit group import (comma-separated list of imported groups, leave empty to avoid limitation)" => "Grenze Gruppenimport (durch Kommata getrennte Liste der importierten Gruppen, wenn Sie keine Limitierung setzen m&ouml;chten lassen Sie das Feld leer.)",
 ...
 "Change users defaults" => "&Auml;ndere Benutzerstandard",
 "Map Zone" => "Map Zone",
 "Geourl" => "Geourl",
 "Robots" => "Robots",
 "Editor" => "Editor",
 "Webmaster" => "Webmaster",
 "Search may show forbidden results. Much better performance though." => "Suche kann verbotene Ergebnisse anzeigen. Bietet aber h&ouml;here Effizienz.",
 "Wiki Administration" => "Wiki Administration",
 "latin" => "Latein",
 "Backlinks" => "Backlinks",
 "optional" => "optional",
 "Wiki attachments preferences" => "Wiki Einstellungen f&uuml;r Anh&auml;nge",
 ...
 "Perms inherited from closest parent if possible or from global perms" => "Rechte von den n&auml;chsten Eltern erben, falls m&ouml;glich oder von den globalen Rechten.",
 ...
 "Contributions are mandatory in comments" => "Contributions sind zwingend erforderlich f&uuml;r Kommentare",
 "Contributions are mandatory in blogs" => "Contributionssind zwingend erforderlich in Blogs",
 "Contributions are displayed in the comment/post" => "Contributions werden angezeigt in Kommentaren und Beitr&auml;gen",
 ...
 "Help on Drawings" => "Hilfe f&uuml;r Zeichnungen",
 "admin Drawings tpl" => "Verwalte Zeichnungen tpl",
 "To create a drawing in a Wiki page, use {literal}{draw name=foo}{/literal}, where foo is the name of the drawing. After saving, click on the drawing link." => "Um eine Zeichnung auf einer Wiki-Seite zu erstellen, nutzen Sie {literal}{draw name=foo}{/literal}, wobei foo f&uuml;r den Namen der Zeichnung steht. Nachdem dem Speichern klicken Sie auf den Link zu der Zeichnung."
 ...
 "Click here to delete this forum" => "Klicken Sie hier um dieses Forum zu l&ouml;schen.",
 ...
 "Use {literal}{/literal}ed id=name} or {literal}{/literal}ted id=name} to insert dynamic zones" => "Benutzen Sie {literal}{/literal}ed id=name} oder {literal}{/literal}ted id=name} um dynamische Zonen einzuf&uuml;gen",
 "An easier way to integrate content from another site into Tiki is via iframed links using Tiki's <a class=\"rbox-link\" href=\"tiki-admin_links.php\">featured links</a> feature." => "Ein einfacherer Weg um Inhalte von anderen Seiten in Tiki einzuf&uuml;gen ist mittels eines iframe-Links der TikiWikis <a class=\"rbox-link\" href=\"tiki-admin_links.php\">featured links</a> Funktion verwendet.",
 ...
 "Is repository visible to users" => "Ist das Repository f&uuml;r Benutzer sichtbar",
 "Can files from repository be cached" => "K&ouml;nnen Dateien aus dem Repository im Cache gespeichert werden",
 "Are files from repository can be cached" => "Are files from repository can be cached",
 "Clear all cached pages of this repository" => "L&ouml;sche alle gechacheten Seiten aus diesem Repository",
 "Seconds count 'till cached page will be expired" => "Sekunden z&auml;hlen bis die gecachete Seite abl&auml;uft",
 "Human readable text description of repository" => "Menschlich lesbare Textbeschreibung des Repository",
 "view/hide copy rules dialog" => "Zeige/Verstecke Dialog f&uuml;r Kopierregeln",
 "Source repository" => "Quellrepository",
 "According this order rules will be applied ('0' or empty = auto)" => "Regeln werden gem&auml;ß dieser Anforderung gesetzt ('0' or empty = auto)",
 "Is this regular expression or simple search/replacer" => "Ist das ein regul&auml;rer Ausdruck oder eine einfache Suche/Ersetzen",
 "Is case sensitive (for simple replacer)" => "Groß- und Kleinschreibung beachten (f&uuml;r einfaches Ersetzen)",
 ...
 "Test file from repository to generate preview for (empty = configured start page)" => "Testdatei f&uuml;r Repository um eine Vorschau zu generieren (leer = konfigurierte Startseite)",
 "Case" => "Case",
 "admin featured links template" => "Verwalte featured links template",
 "To use these links, you must assign the featured_links <a class=\"rbox-link\" href=\"tiki-admin_modules.php\"> module</a>." => "Um diese Links zu verwenden m&uuml;ssen Sie das <a class=\"rbox-link\" href=\"tiki-admin_modules.php\"> featured-links-Modul</a> zuweisen.",
 "admin mailin template" => "Verwalte Mailin-Template",
 "article-put" => "article-put",
 "Discard to the end from" => "Ablegen am Ende von",
 "mn" => "mn",
 "admin menu builder" => "Verwalte Men&uuml;-Builder",
 "admin menus template" => "Verwalte Men&uuml;-Template",
 "To use menus in a <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">module</a>, <a class=\"rbox-link\" href=\"tiki-admin.php?page=siteid\">Site identity</a> or a template, use {literal}{menu id=x}{/literal}, where x is the ID of the menu. To use <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:phplayersmenu.sourceforge.net/\">phplayersmenu</a>, you can use one of the three following syntaxes:" => "Um Men&uuml;s in einem<a class=\"rbox-link\" href=\"tiki-admin_modules.php\">Modul</a>, <a class=\"rbox-link\" href=\"tiki-admin.php?page=siteid\">Site identity</a> oder einem Template zu verwenden, nutzen Sie {literal}{menu id=x}{/literal}, wobei x die ID des Men&uuml;s ist. Um <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:phplayersmenu.sourceforge.net/\">phplayersmenu</a> zu verwenden, k&ouml;nnen Sie eine der drei folgenden Schreibweisen benutzen:",
 "This will work well (or not!) depending on your theme. To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:themes.tikiwiki.org\">themes</a>" => "Ob das funktioniert oder nicht ist abh&auml;ngig von Ihrem gew&auml;hlten Theme. Um mehr &uuml;ber <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:themes.tikiwiki.org\">Themes</a>" zu erfahren,
 "admin modules template" => "Verwalte Modul-Template",
 "\r\n<b>Note 1</b>: if you allow your users to configure modules then assigned\r\nmodules won't be reflected in the screen until you configure them\r\nfrom MyTiki->modules.<br />\r\n<b>Note 2</b>: If you assign modules to groups make sure that you\r\nhave turned off the option 'display modules to all groups always'\r\nfrom Admin->General\r\n" => "\r\n<b>Hinweis 1</b>: Wenn Sie Ihren Benutzern gestatten Module zu konfigurieren dann erscheinen zugewiesene\r\n Module solange nicht auf dem Bildschirm bis Sie sie konfiguriert haben.<br />\r\n<b>Hinweis 2</b>: Wenn Sie Gruppen Module zuweisen, dann stellen Sie sicher, dass\r\n Sie die Option 'Module immer f&uuml;r alle Gruppen anzeigen' von Admin auf General umgestellt haben.\r\n",
 "parameters" => "Parameter",
 "structure" => "Struktur",
 ...
 "Don't send confirmation mail" => "Keine Best&auml;tigungsmail versendet",
 ...
 "To <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:security.tikiwiki.org/tiki-contact.php\">report any security issues</a>." => "F&uuml;r<a class=\"rbox-link\" target=\"tikihelp\" href=\"http:security.tikiwiki.org/tiki-contact.php\">Sicherheitsbelange</a>.",
 "admin shoutbox words template" => "Verwalte shoutbox-words-Template",
 "Add Banned Word" => "F&uuml;ge gebanntes Wort hinzu",
 ...
 "visible by admin only" => "nur f&uuml;r den Admin sichtbar",
 ...
 "choose a group tracker ..." => "W&auml;hlen Sie einen Gruppentracker ...",
 "choose a field ..." => "W&auml;hlen Sie ein Feld ...",
 "Users Information Tracker" => "Benutzer-Informationstracker",
 "choose a users tracker ..." => "W&auml;hlen Sie einen Benutzertracker ...",
 ...
 "remove users and their userpages" => "L&ouml;sche Benutzer und ihre Benutzerseiten",
 "Tip: hold down CTRL to select multiple" => "Tipp: dr&uuml;cken Sie CTRL f&uuml;r Mehrfachauswahl",
 "Warning: changing the username will require the user to change his password and will mess with slave intertiki sites that use this one as master" => "Warnung: das &Auml;ndern eines Benutzernamens erfordert das &Auml;ndern des Passwortes durch den Benutzer und f&uuml;hrt zu Schwierigkeiten mit Intertiki-Seiten im Slave-Modus, die diese Seite als Master benutzen.",
 "Warning: changing the username will require the user to change his password" => "Warnung: Das &Auml;ndern des Benutzernamens erfordert das &Auml;ndern des Passwortes durch den Benutzer.",
 ...
 "Your image gallery storage is set to \"{\$prefs['gal_use_dir']}\", you will need to backup this using FTP or SCP." => "Ihr Bildergaleriespeicher wurde auf\"{\$prefs['gal_use_dir']}\"gesetzt, Sie m&uuml;ssen einen Backup per FTP oder SCP machen.",
 "Your file gallery storage is set to \"{\$prefs['fgal_use_dir']}\", you will need to backup this using FTP or SCP." => "Ihr Dateiarchivspeicher wurde auf\"{\$prefs['fgal_use_dir']}\"gesetzt, Sie m&uuml;ssen einen Backup per FTP oder SCP machen.",
 "Note: if you want to use images please save the post first and you\r\nwill be able to edit/post images. Use the &lt;img&gt; snippet to include uploaded images in the textarea editor\r\nor use the image URL to include images using the WYSIWYG editor. " => "Hinweis: Wenn Sie Bilder einf&uuml;gen m&ouml;chten, speichern Sie bitte zuerst Ihren Beitrag, damit und \r\n\t Sie Bilder bearbeiten oder hinzuf&uuml;gen k&ouml;nnen. Nutzen Sie den &lt;img&gt; Schnipsel um die hochgeladenen Bilder im Texteditor zu bearbeiten \r\n\t oder verwenden Sie die URL des Bildes um es im WYSIWYG Editor einzuf&uuml;gen. ",
 ...
 "click to view" => "Klicken f&uuml;r Ansicht",
 "Format" => "Format",
 "(NOT supported by PDFLIB!)" => "(wird nicht von  PDFLIB unterst&uuml;tzt!)",
 "Create WebHelp" => "Erstelle WebHelp",
 "You can browse the generated WebHelp here" => "Sie k&ouml;nnen die generierte WebHilfe hier durchsuchen",
 ...
 "Remove Zones (you lose entered info for the banner)" => "L&ouml;sche Zonen (Sie verlieren die eingegebenen Bannerinformationen)",
 "edit blog tpl" => "Bearbeite Blog-Template",
 "A category is mandatory" => "Eine Kategorie ist zwingend erforderlich",
 "For more information, please see <a href=\"{\$helpurl}Wiki Page Editor\">Wiki Page Editor</a>" => "F&uuml;r weitere Informationen lesen Sie bitte <a href=\"{\$helpurl}Wiki Page Editor\">Wiki-Seiten-Editor</a>",
 "Because the Wiki paragraph formatting feature is on, all groups of non-blank lines are collected into paragraphs.  Lines can be of any length, and will be wrapped together with the next line.  Paragraphs are separated by blank lines." => "Weil die Wikiabsatzformatierungsfunktion eingeschaltet ist, werden alle Zeilen, die nicht Leerzeilen sind, zu einem Absatz zusammengefasst. Die Zeilen k&ouml;nnen von beliebiger L&auml;nge sein und werden mit der n&auml;chsten Zeile geb&uuml;ndelt. Abs&auml;tze werden durch Leerzeilen getrennt.",
 "Because the Wiki paragraph formatting feature is off, each line will be presented as you write it.  This means that if you want paragraphs to be wrapped properly, a paragraph should be all together on one line." => "Weil die Wikiabsatzformatierungsfunktion ausgeschaltet ist, wird jede Zeile so dargestellt wie Sie sie eingeben. Das heißt, wenn Sie einen Absatz gestalten m&ouml;chten, sollten Sie den gesamten Text in einer Zeile eingeben.",
 "Bold text" => "Fett",
 "underscores" => "Unterstrich",
 "Italic text" => "Kursiv",
 "single quotes" => "Einfache Anf&uuml;hrungszeichen",
 ...
 "(very useful especially in tables)" => "(besonders n&uuml;tzlich in Tabellen)",
 "Horizontal rule" => "Waagrechte Linie",
 "Creates a link to the named file.  If page is not given, the file must be attached to the current page.  If desc is not given, the file name is used for the link text, unless showdesc is used, which makes the file description be used for the link text.  If image=1 is given, the attachment is treated as an image and is displayed directly on the page; no link is generated." => "Erstellt einen Link zur genannten Datei. Falls die Seite nicht vorhanden ist, muss die Datei an die aktuelle Seite angeh&auml;ngt werden. Falls keine Beschreibung vorhanden ist, wird der Dateiname als Linktext genutzt. Falls Bild=1 gesetzt ist, wird der Anhang als Bild behandelt und direkt auf der Seite angezeigt; es wird kein Link erzeugt.",
 "Inserts an editable variable" => "F&uuml;gt eine beschreibbare Variable ein",
 "Prevents wiki parsing of the enclosed data." => "Verhindert, dass Wiki die eingef&uuml;gten Daten parst.",
 "\"~pp~ data ~/pp~\" Displays preformated text/code; no Wiki processing is done inside these sections (as with np), and the spacing is fixed (no word wrapping is done).  \"~pre~ data ~/pre~\" also displayes preformatted text with fixed spacing, but wiki processing still occurs on the text." => "\"~pp~ data ~/pp~\" zeigt vorformatierten Text/Code an. In diesen Abschnitten wird kein Wiki-Prozess ausgef&uuml;hrt und Leerzeichen werden fixiert (kein Word-Wrapping)  \"~pre~ data ~/pre~\" zeigt ebenfalls vorformatieten Text mit fixierten Leerzeichen an, aber Wiki-Prozesse werden ausgef&uuml;hrt.",
 "\"~tc~ Tiki Comment ~/tc~\" makes a Tiki comment.  It will be completely removed from the display, but saved in the file for future reference.  \"~hc~ HTML Comment ~/hc~\" makes an HTML comment.  It will be inserted as a comment in the output HTML; these are not normally displayed in browsers, but can be seen using \"View Source\" or similar." => "\"~tc~ Tiki Comment ~/tc~\" erstellt einen Tiki-Kommentar. Er wird komplett vom Bildschirm gel&ouml;scht, aber in der Datei als zuk&uuml;nftige Referenz gespeichert.  \"~hc~ HTML Comment ~/hc~\" erstellt einen HTML-Kommentar. Er wird als Kommentar in die HTML-Ausgabe eingef&uuml;gt; solche Kommentar werden normalerweise nicht im Browser angezeigt, sondern k&ouml;nnen nur in der Quellcodeansicht gelesen werden.",
 ...
 "\"{literal}{toc}{/literal}\", \"{literal}{maketoc}{/literal}\" prints out a table of contents for the current page based on structures (toc) or ! headings (maketoc)" => "\"{literal}{toc}{/literal}\", \"{literal}{maketoc}{/literal}\" erstellt ein Inhaltsverzeichnis f&uuml;r die aktuelle Seite basierend auf der Struktur oder den &Uuml;berschriften.",
 "Quicktags" => "Quicktags",
 ...
 "toggle interactive translation" => "auf interaktive &Uuml;bersetzung umschalten",
 "off" => "aus",
 ...
 "Instructions: Type, or paste, your multiple choice questions below.  One line for the question, then start answer choices on subsequent lines.  Separate additional questions with a blank line.  Indicate correct answers by starting them with a \"*\" (without the quotes) character." => "Anweisung: Tippe oder f&uuml;ge deine Multiple-Choice-Fragen unten ein. Eine Zeile f&uuml;r die Frage, danach die Antwortm&ouml;glichkeiten in die nachfolgenden Zeilen. Trenne weitere Fragen mit einer Leerzeile. gib die richtige Anntwort an, indem du ihr ein \"*\" (ohne Anf&uuml;hrungszeichen)  voranstellst.",
 "Input" => "Eingabe",
 "Promote" => "Vorw&auml;rts",
 "Demote" => "Zur&uuml;ck",
 "Help on Articles" => "Hilfe f&uuml;r Artikel",
 "edit submissions tpl" => "Bearbeite Submission-Template",
 "<b>*</b>=optional" => "<b>*</b>=optional",
 "<b>Topline</b>=small line above Title" => "<b>Topline</b>=kleine Linie &uuml;ber dem Titel",
 ...
 "Delete the copy in the theme:" => "L&ouml;sche die Kopie im Theme:",
 "edit translations" => "Bearbeite &Uuml;bersetzungen",
 "edit translations template" => "Bearbeite &Uuml;bersetzungstemplate",
 ...
 "The object has already a translation for this language" => "Es existiert bereits eine &Uuml;bersetzung f&uuml;r die Sprache des Objekts",
 ...
 "detach" => "entfernen",
 "Enter the name of the page for which the current page is the translation." => "Geben Sie den Namen der Seite ein, f&uuml;r die die aktuelle Seite eine &Uuml;bersetzung ist.",
 ...
 "list sheets" => "Liste Bl&auml;tter auf",
 ...
 "To learn more about the <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:workflow.tikiwiki.org\">Galaxia workflow engine</a>" => "Erfahren Sie mehr &uuml;ber die <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:workflow.tikiwiki.org\">Galaxia workflow engine</a>",
 ...
 "Galaxia Monitor Activities" => "Galaxia Monitor Aktivit&auml;ten",
 "Galaxia Monitor Activities tpl" => "Galaxia Monitor Ativit&auml;ten tpl",
 "Enter the name of this instance" => "Geben Sie den Namen der Instanz ein",
 "The name is not valid. Please, enter the name again" => "Der Name ist ung&uuml;ltig. Bitte geben Sie einen neuen Namen ein.",
 ...
 "Galaxia User Activities" => "Galaxia User Aktivit&auml;ten",
 "Galaxia User Activities tpl" => "Galaxia User Aktivit&auml;ten tpl",
 ...
 "Reset view to site-wide default" => "Setze die Ansicht auf den Seitenstandard zur&uuml;ck",
 "Users Map" => "Benutzerkarte",
 "Select Graphic Type" => "W&auml;hle Graphentyp",
 "Pie Chart" => Kreisdiagramm
 "Multiline" => "Multilinie",
 "Multibar" => "Multibar",
 "Bar Stack" => "Leistenblock",
 "Portrait" => "Portrait",
 "Independant Scale" => "Unabh&auml;ngige Skala",
 ...
 "body" => "body",
 "Interactive translator" => "Interaktiver &Uuml;bersetzer",
 ...
 "To use content blocks in a text area (Wiki page, etc), a <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">module</a> or a template, use {literal}{content id=x}{/literal}, where x is the ID of the content block." => "Wenn Sie Inhaltsbl&ouml;cke in einem Textbereich (Wiki-Seite etc.), einem <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">Modul</a> oder einem Template verwenden m&ouml;chten, nutzen Sie {literal}{content id=x}{/literal}, wobei x die ID des Inhaltsblocks ist.",
 "Future vers" => "Zuk&uuml;nftige Version",
 "list faqs tpl" => "Liste faqs tpl",
 "monitor this gallery" => "&Uuml;berwache diese Galerie",
 "stop monitoring this gallery" => "&Uuml;berwachen dieser Galerie beenden",
 ...
 "To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:mods.tikiwiki.org\">mods</a>." => "Erfahren Sie mehr &uuml;ber <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:mods.tikiwiki.org\">mods</a>.",
 "Apache has the right to write in your file tree, which enables the installation, removal or \r\nupgrade of packages. When you are done with those operations, think to fix those permissions back to a safe state (by using \r\n\"./setup.sh\" for example)." => "Apache besitzt das Recht in den Verzeichnisbaum zu schreiben, um die Installation, das L&ouml;schen oder ein Upgrade zu veranlassen. Wenn Sie die gew&uuml;nschten Operationen ausgef&uuml;hrten haben, sollten Sie die Berechtigungen wieder auf einen sicheren Status einstellen.(zum Beispiel mit \r\n\"./setup.sh\" ).",
 "To install, remove or upgrade packages you need to give the apache user the right\r\nto write files in your web tree (you can use \"./setup.sh open\" to set it up). After installation you need to remove that\r\npermission (using \"./setup.sh\")." => "Zum Installieren, L&ouml;schen oder Upgraden der Pakete m&uuml;ssen Sie Apache das Recht\r\nDateien in Ihrem Verzeichnisbaum zu beschreiben einr&auml;umen. (Sie k&ouml;nnen \"./setup.sh open\" zum Einstellen nutzen.). Nach der Installation sollten Sie dieses\r\nRecht wieder l&ouml;schen (Nutzen Sie \"./setup.sh\").",
 "Display only this type" => "Nur diesen Typen anzeigen",
 "Unpublish" => "Nicht ver&ouml;ffentlichen",
 "Republish" => "Wieder ver&ouml;ffentlichen",
 ...
 "Errors:" => "Fehler:",
 "Delete errors" => "L&ouml;sche Fehler",
 ...
 "{\$atts|@count} files attached" => "{\$atts|@count} Dateien angeh&auml;ngt",
 "Preview of version" => "Vorschau der Version",
 "(current)" => "(aktuell)",
 "rollback to this version" => "Zur&uuml;ck zu dieser Version",
 "Source of version" => "Quelle der Version",
 "Any" => "alle",
 "Number of voices" => "Anzahl der Stimmen",
 "Selected Pages" => "Ausgew&auml;hlte Seiten",
 "add structure" => "Struktur hinzuf&uuml;gen",
 "clear page list" => "L&ouml;sche Seitenliste",
 "Edit quiz" => "Bearbeite Quiz",
 "Current Version" => "Aktuelle Version",
 "General Options" => "Allgemeine Optionen",
 "Publication Date" => "Ver&ouml;ffentlichungsdatum",
 "at " => "am ",
 "Use " => "Benutze ",
 "randomly selected questions." => "zuf&auml;llig ausgew&auml;hlte Fragen",
 ...
 "Allow students to store partial results and return to quiz." => "Erlauben Sie den Teilnehmern Zwischenergebnisse zu speichern und sp&auml;ter zum Quiz zur&uuml;ckzukehren.",
 ...
 "Publish statistics " => "Statistiken ver&ouml;ffentlichen ",
 "Extra Options" => "Zusatzoptionen",
 "Solicit additional questions from students" => "Bitten Sie die Teilnehmer um zus&auml;tzliche Fragen.",
 "Link quiz to forum named: " => "Verlinken Sie das Quiz zum Forum: ",
 "Prologue:" => "Prolog:",
 "Epilogue:" => "Epilog:",
 "time taken" => ben&ouml;tigte Zeit",
 "P/F" => "P/F",
 "P" => "P",
 "F" => "F",
 "received articles tpl" => "eingegangene Artikel tpl",
 "Help on Communication Center" => "Hilfe f&uuml;r das Kommunikationscenter",
 ...
 "Select your group" => "W&auml;hlen Sie Ihre Gruppe",
 ...
 "There are individual permissions set for this sheet" => "F&uuml;r dieses Blatt sind individuelle Berechtigungen eingerichtet",
 ...
 "Available Sheets" => "Vorhandene Bl&auml;tter",
 "Graph" => "Graph",
 "admin Tiki Shoutbox tpl" => "VerwalteTiki Shoutbox tpl",
 "Date Selector" => "Datum ausw&auml;hlen",
 "quater" => "Viertel",
 "first" => "erster",
 "mr green" => "mr green",
 "razz" => "razz",
 ...
 "twisted" => "twisted",
 "santa" => "santa",
 "Daily Usage" => "T&auml;glicher Gebrauch",
 "SysLog" => "SysLog",
 "system logs" => "system logs",
 "system logs tpl" => "system logs tpl",
 "Thank you for your submission" => "Vielen Dank f&uuml;r Ihren Beitrag",
 "ThemeControl tpl" => "ThemeControl tpl",
 "To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:themes.tikiwiki.org\">themes</a>." => "Erfahren Sie mehr &uuml;ber <a class=\"rbox-link\" target=\"tikihelp\" href=\"http:themes.tikiwiki.org\">Themes</a>.",
 ...
 "You have to \r\ncreate a gallery first!" => "Sie m&uuml;ssen zuerst eine Galerie erzeugen!",
 "Image Gallery tpl" => "Bildergalerie tpl",
 "Image ID thumb" => "Bild ID (klein)",
 "You can include the image in an Wiki page using" => "Sie k&ouml;nnen ein Bild auf einer Wiki-Seite einf&uuml;gen, dem Sie folgendes benutzen:",
 ...
 "This task is public to a special group" => "Diese Aufgabe ist innerhalb einer Spezialgruppe &ouml;ffentlich",
 ...
 "Marked as deleted" => "Als gel&ouml;scht markiert",
 "You can only view this task" => "Sie k&ouml;nnen diesen Task nur ansehen",
 "Public for group" => "&ouml;ffentlich f&uuml;r die Gruppe",
 ...
 "admin menus tpl" => "Verwalte Men&uuml; tpl",
 ...
 "remove image" => "Bild l&ouml;schen",
 ...
 "Personal workspace" => "Pers&ouml;nlicher Workspace",
 ...
 "MenuID" => "MenuID",
 "Allow private user zone" => "Zone f&uuml;r private Benutzer zulassen",
 ...
 "Help on \$admintitle Config" => "Hilfe f&uuml;r \$admintitle Konfiguration",
 "Must specify actionId" => "Sie m&uuml;ssen eine actionID angeben",
 "Category can`t be parent of itself" => "Kategorie kann nicht sich selbst &uuml;bergeordnet werden.",
 "Admin: DSN" => "Verwalte: DSN",
 "Admin: External Wikis" => "Verwalte: Externe Wikis",
 "Admin: Forums" => "Verwalte: Foren",
 "Admin: Hotwords" => "Verwalte: Hotwords",
 "You have to provide a hotword and a URL" => "Sie m&uuml;ssen ein Hotword und eine URL angeben",
 "moved %d images, %d errors occured." => " %d Bilder verschoben, %d Fehler aufgetreten.",
 "a timeout occured. Hit the reload button to move the rest" => "Timeout aufgetreten. Dr&uuml;cken Sie den Reload-Button um den Rest zu verschieben",
 "You cannot have a blank password" => "Sie d&uuml;rfen kein leeres Passwort verwenden",
 "No valid gdaltindex executable" => "Kein g&uuml;ltiger gdaltindex ausf&uuml;hrbar",
 "You cannot mix old and new trackers" => "Sie k&ouml;nnen nicht alte und neue Tracker vermischen",
 "Requested action is not supported on repository" => "Gew&uuml;nschte Aktion wird von diesem Repository nicht unterst&uuml;tzt.",
 "Requested action in not supported on repository" => "Gew&uuml;nschte Aktion wird von diesem Repository nicht unterst&uuml;tzt.",
 ...
 "Mail-in accounts set to be checked every %s minutes" => "Mail-in Zug&auml;nge werden alle %s Minuten &uuml;berpr&uuml;ft",
 "Automatic Mail-in accounts checking disabled" => "Automatische Mail-in Zugangs&uuml;berpr&uuml;fung deaktiviert",
 "Admin: Modules" => "Verwalte: Module",
 "Cannot create or update module: You need to specify a name to the module" => "Kann Modul nicht erstellen oder aktualisieren: Sie m&uuml;ssen den Namen des Moduls angeben",
 "Cannot create or update module: You cannot leave the data field empty" => "Kann Modul nicht erstellen oder aktualisieren: Sie d&uuml;rfen das Datenfeld nicht leer lassen",
 "Error opening uploaded file" => "Fehler beim &ouml;ffnen der Datei",
 ...
 "The \"Bloglist Wikiplugin\" is installed. It can be used by wiki editors to disclose private blog posts." => "Das \"Bloglist Wikiplugin\" ist installiert. Es kann von Wikieditoren verwendet werden um private Blogeintr&auml;ge bekanntzugeben.",
 ...
 "This is not a Tikiwiki file. Check if this file was uploaded and if it is dangerous." => "Dies ist keine TikiWiki-Datei. Pr&uuml;fen Sie ob diese Datei hochgeladen wurde und eine Sicherheitsgefahr darstellt.",
 "This is a modified File. Cannot check version. Check if it is dangerous." => "Dies ist eine modifizierte Datei. Die Version kann nicht &uuml;berpr&uuml;ft werden. &Uuml;berpr&uuml;fen Sie ob eine Sicherheitsgefahr besteht.
 ...
 "Impossible to create new %s with %s %s." => "Erstellen neuer %s mit %s %s nicht m&ouml;glich.",
 "%s <b>%s</b> assigned to %s <b>%s</b>." => "%s <b>%s</b> zugewiesen an %s <b>%s</b>.",
 "%s <b>%s</b> removed from %s <b>%s</b>." => "%s <b>%s</b> gel&ouml;scht von %s <b>%s</b>.",
 "group <b>%s</b> set as the default group of user <b>%s</b>." => "Gruppe <b>%s</b> als Standardusergruppe gesetzt <b>%s</b>.",
 "%s changed from %s to %s" => "%s ge&auml;ndert von %s to %s",
 "Impossible to change %s from %s to %s" => "&Auml;ndern von %s von %s nach %s nicht m&ouml;glich",
 "You have to indicate a group" => "Sie m&uuml;ssen eine Gruppe angeben",
 "This group is invalid" => "Gruppe ist ung&uuml;ltig",
 ...
 "Image %s removed from Batch directory." => "Bild %s aus dem Batchverzeichnis gel&ouml;scht.",
 "Impossible to remove image %s from Batch directory." => " Bild %s kann nicht aus dem Batchverzeichnis gel&ouml;scht werden.",
 "Permission denied you cannot use the batch directory loading" => "Sie haben keine Berechtigung das Batchverzeichnis zu laden",
 "Incorrect directory chosen for batch upload of images." => "Ung&uuml;ltiges Verzeichnis f&uuml;r den Batchupload von Bildern ausgew&auml;hlt.",
 ...
 "Tiki RSS feed for calendars" => "Tiki RSS feed f&uuml;r Kalender",
 "Upcoming events." => "Anstehende Termine.",
 "Start:" => "Start:",
 "End:" => "Ende:",
 "Permission denied; you cannot assign permissions for this category" => "Keine Berechtigung; Sie k&ouml;nnen dieser Kategorie keine Rechte zuweisen",
 "ERROR: you must include a subject or a message at least" => "FEHLER: Sie m&uuml;ssen einen Betreff oder eine Nachricht eingeben",
 "You need to change chmod 'whelp' manually to 777" => "Sie m&uuml;ssen chmod 'whelp' manuell auf 777 setzen",
 "No parent specified" => "Keine Eltern angegeben",
 "Last sites of directory \".\$rc[\"name\"].\" ." => "Letzte Sites des Verzeichnis \".\$rc[\"name\"].\" .",
 "The language can't be changed as its set of translations has already this language" => "Die Sprache kann nicht ge&auml;ndert werden.",
 ...
 "Not enable for this type of object" => "Nicht aktiviert f&uuml;r diesen Objekttypen",
 "You have mistyped the anti-bot verification code; please try again." => "Sie haben den Anti-Bot Verifizierungscode falsch eingegeben; bitte versuchen Sie es sp&auml;ter noch einmal",
 ...
 "You must be logged in to use this feature" => "Sie m&uuml;ssen sich einloggen um diese Funktion nutzen zu k&ouml;nnen",
 ...
 "Activity name cannot be empty" => "Aktivit&auml;t kann nicht leer sein",
 "A start activity requires a name for the instance" => "Eine Startaktivit&auml;t erfordert einen Namen f&uuml;r die Instanz",
 "You couldn't abort a instance" => "Sie k&ouml;nnen eine Instanz nicht abbrechen",
 "You couldn't exception a instance" => "You couldn't exception a instance",
 "Permission denied you cannot make the map of this gallery" => "Keine Berechtigung; Sie k&ouml;nnen in dieser Galerie keine Karte erstellen",
 "Back to preferences" => "Zur&uuml;ck zu Pr&auml;ferenzen",
 "No valid renderer found. GD or PDFLib required." => "Kein g&uuml;ltiger Renderer gefunden. GD or PDFLib erforderlich.",
 "No sheet specified." => "Kein Blatt angegeben.",
 "You must select a renderer." => "Sie m&uuml;ssen einen Renderer angeben.",
 "Invalid Series for current graphic." => "Ung&uuml;ltige Serie f&uuml;r den aktuellen Graphen",
 "Last images uploaded to the image galleries." => "Neueste Bilder, die in die Bildergalerie eingef&uuml;gt wurden.",
 ...
 "Invalid password" => "Ung&uuml;ltiges Passwort",
 "Account disabled" => "Account deaktiviert",
 "You must use the right case for your user name" => "Sie m&uuml;ssen die Groß-und Kleinschreibung beachten",
 ...
 "This Tikiwiki site is prepared for access from a lot of mobile devices, e.g. WAP phones, PDA's, i-mode devices and much more." => "Diese TikiWiki-Seite ist f&uuml;r viele mobile Treiber zug&auml;nglich, z.Bsp.: WAP phones, PDA's, i-mode Treiber und viele mehr.",
 "You can browse this site on your mobile device by directing your device's browser towards the following URL here on this site:" => "Sie k&ouml;nnen diese Site mit Ihrem mobilen Endger&auml;t besuchen unter folgender URL:",
 "You need to run setup.sh :<br />./setup.sh \$APACHEUSER all<br />Common Apache users are www-data, apache or nobody" => "Sie m&uuml;ssen Setup starten:<br />./setup.sh \$APACHEUSER all<br />&Uuml;bliche Apache Benutzer sind www-data, apache oder nobody",
 "Permission denied you cannot view the source of this page" => "Keine Berechtigung; Sie k&ouml;nnen den Quellcode dieser Site nicht sehen",
 ...
 "Username cannot contain more than" => "Benutzername darf nicht l&auml;nger sein als",
 "characters" => "Zeichen",
 "Please enter a valid %s.  No spaces, more than %d characters and contain %s" => "Bitte geben Sie einen g&uuml;ltigen %s ein.  Keine Leerzeichen, mehr als %d Zeichen und enth&auml;lt %s",
 "This is not a valid mail adress" => "Dies ist keine g&uuml;ltige E-Mail-Adresse",
 "mail adress" => "E-Mail-Adresse",
 "Invalid username or activation code. Maybe this code has already been used." => "Ung&uuml;ltiger Benutzername oder Aktivierungscode. M&ouml;glicherweise wurde der Code bereits benutzt.",
 ...
 "A new (and temporary) password and your IP address has been sent " => "Ein neues (und vorl&auml;ufiges) Passwort und Ihre IP Adresse wurden versendet ",
 "Permission denied you cannot rename this page" => "Keine Berechtigung; Sie k&ouml;nnen diese Seite nicht umbenennen",
 "Cannot rename page because the new name begins with reserved prefix" => "Sie k&ouml;nnen diese Seite nicht umbenennen, weil der neue Name mit einem reservierten Pr&auml;fix beginnt",
 "changed '%s' from '%s' to '%s'" => "ge&auml;ndert '%s' von '%s' nach '%s'",
 "Error Message" => "Fehlermeldung",
 "Tiki RSS Feed Error Message: \$errmsg" => "Tiki RSS Feed Fehlermeldung: \$errmsg",
 "One of the email addresses you typed is invalid" => "Eine der angegebenen E-Mail-Adressen ist ung&uuml;ltig",
 "Use this thread to discuss the page:" => "Benutzen Sie diesen Thread um die Seite zu diskutieren:",
 "Invalid variable value : " => "Ung&uuml;ltiger Variablenwert : ",
 "Permission denied you cannot remove this sheet" => "Keine Berechtigung; Sie k&ouml;nnen dieses Blatt nicht verschieben",
 "%m/%d" => "%m/%d",
 "No trackerId specified" => "Keine trackerId angegeben",
 "File update was successful" => "Dateiaktualisierung war erfolgreich",
 "Usage" => "Benutzung",
 "Invalid password.  Your current password is required to change administrative information" => "Ung&uuml;ltiges Passwort. Ihr aktuelles Passwort ist erforderlich um administrative &Auml;nderungen vorzunehmen.",
 "was moved into trash" => "in den Papierkorb verschoben",
 "trashed by" => "gel&ouml;scht von",
 ...
 "Task entries:" => "Aufgabeneing&auml;nge:",
 "Sorry you are not allowed to send tasks to other users, or the user is not allowed to receive tasks!" => "Sorry, Sie d&uuml;rfen keine Aufgaben an andere User verschicken oder der User darf keine Aufgaben empfangen!",
 "You've to start your work at least on" => "Sie m&uuml;ssen mit Ihrer Aufgabe sp&auml;testens beginnen am",
 "You've to finish your work on" => "Sie m&uuml;ssen Ihre Aufgabe beenden sp&auml;testens am ",
 ...
 "Permission denied you cannot remove trackbacks" => "Keine Berechtigung; Sie d&uuml;rfen keine trackbacks l&ouml;schen",
 "That tracker don't use extras." => "Dieser Tracker benutzt keine Extras.",
 "Code in use, please select a different code" => "Code wird verwendet, bitte w&auml;hlen Sie einen anderen Code.",
 "Code not selected" => "Code nicht ausgew&auml;hlt",
 ...
 "Role name not selected" => "Rollenname nicht ausgew&auml;hlt",
 "Role name in use, please select a different name" => "Rollenname wird bereits verwendet, bitte w&auml;hlen Sie einen anderen",
 "Workspace type not found" => "Workspacetyp nicht gefunden",
 "Workspace type not selected" => "Workspacetyp nicht ausgew&auml;hlt",
...
"You will remove" => "Sie l&ouml;schen",
...
"wiki overwrite" => "Wiki &uuml;berschreiben",
"Vote poll" => "W&auml;hle Umfrage",
"Quiz" => "Quiz",
"Top 10" => "Top 10",
"Top 20" => "Top 20",
"Top 50" => "Top 50",
...
"usernames separated with ," => "Benutzernamen mit , trennen",
 ...
 "Invalid Email" => "Ung&uuml;ltige E-Mail",
...
"Those comments are locked" => "Diese Kommentare sind gesperrt.",
 ...
 "Select a Wiki page to link to" => "W&auml;hlen Sie eine Wiki Seite zum Verlinken aus",
 "Link" => "Link",
 "Cannot open this file" => "Datei kann nicht ge&ouml;ffnet werden.",
...
"Missing a temporary folder" => "Tempor&auml;rer Ordner fehlt",
"Failed to write file to disk" => "Datei konnte nicht auf die Disk geschrieben werden",
"Invalid file mime type" => "Ung&uuml;tiger MIME Typ",
"File %s is not a valid archive" => "Datei %s ist kein g&uuml;ltiges Archiv",
"menu" => "Men&uuml;",
"No box" => "Keine Box",
...
"Description not available" => "Beschreibung nicht verf&uuml;gbar",
...
"Shibboleth" => "Shibboleth",
"Available languages" => "Verf&uuml;gbare Sprachen",
 "Allow users to change the language of the menus and labels" => "Erlaubt Benutzern die Sprache der Men&uuml;s und Labels zu &auml;ndern",
 "Spell checking" => "Rechtschreibpr&uuml;fung",
 ...
 "utf-8" => "utf-8",
 "iso-8859-1" => "iso-8859-1",
 "Users can change site language" => "Benutzer k&ouml;nnen die Sprache der Site ver&auml;ndern.",
"Show Country Flag" => "Zeige Landesfahne",
"Show the country flag" => "Zeige Landesfahne",
"PHP errors visible to admin only" => "PHP Fehlermeldungen nur f&uuml;r Admin sichtbar",
...
"Multimedia" => "Multimedia",
 ...
 "FAQ" => "FAQ",
 "Copyright" => "Copyright",
 "Enables searching for content on the website" => "Erm&ouml;glicht das Suchen nach Inhalten auf der Website",
 "Freetags" => "Freetags",
 ...
 "Experimental. This feature is not actively maintained" => "Experimental. Diese Funktion wird nicht aktiv unterst&uuml;tzt.",
 ...
 "Comments can be closed (no new comments)" => "Kommentare k&ouml;nnen geschlossen werden (keine neuen Kommentare)",
 "Permit anonymous visitors to add a comment without needing to create an account" => "Erlaube anonymen Besuchern einen Kommentar hinzuzuf&uuml;gen, ohne einen Account anzulegen.",
 ...
 "Css Menus" => "Css Men&uuml;s",
 "Css Menus (suckerfish)" => "Css Men&uuml;s (Suckerfish)",
...
// "This is an approximation based on your server memory limit" => "Dies ist eine Ann&auml;herung basierend auf Ihrem Serverspeicherlimit",
...
"Cannot upload this file - maximum upload size exceeded" => "Datei &uuml;berschreitet maximale Gr&ouml;ß f&uuml;r das Hochladen",
"Anonymous" => "Unbekannt",
...
"Content templates" => "Inhaltsvorlagen",
"Print" => "Drucken",
"Ignore category viewing restrictions" => "Kategorie-Sichteinschr&auml;nkungen ignorieren",
"Local" => "Lokal",
"List pages" => "Seiten auflisten",
...
"Maximum mailbox size (messages, 0=unlimited)" => "Mailbox-Gr&ouml;ße (in Nachrichten, 0=unbegrenzt)",
"Maximum mail archive size (messages, 0=unlimited)" => "Mailboxarchiv-Gr&ouml;ße (in Nachrichten, 0=unbegrenzt)",
"Maximum sent box size (messages, 0=unlimited)" => "Ausgangsordner-Gr&ouml;ße (in Nachrichten, 0=unbegrenzt)",
...
"Maximum size for each attachment" => "Maximale Gr&ouml;ße pro Anlage",
...
"Enlarge area height" => "H&ouml;he vergr&ouml;ßern",
"Wiki Help" => "Wiki Hilfe",
"Item" => "Eintrag",
"Subject" => "Betreff",
...
"Invalid username or password" => "Ung&uuml;ltiger Benutzername oder Paßwort",
...
"Security" => "Sicherheit",
"User files" => "Benutzer-Dateien",
"To add/remove blogs, go to \"Create/Edit Blog\" under \"Blogs\" on the application menu, or" => "Blogs hinzuf&uuml;gen/verschieben &uuml;ber Men&uuml;punkt 'Blogs' im Men&uuml; im Seitenbalken oder",
...
"Send me an email for messages with priority equal or greater than" => "Schicke mir eine eMail beim Eintreffen von Nachrichten mit Priorit&auml;t gr&ouml;ßer gleich",
...
"To add/remove forums, look for \"Admin forums\" under \"Forums\" on the application menu, or" => "Foren hinzuf&uuml;gen/verschieben &uuml;ber Men&uuml;punkt 'Foren verwalten' im Men&uuml; im Seitenbalken oder",
...
"Note: if you change this directory, you have to move the contents to the new directory. You can also use the 'Mover' below." => "Hinweis: wenn das Verzeichnis ge&auml;ndert wird, muß auch der Inhalt im Filesystem entsprechend manuell verschoben werden. Oder Sie k&ouml;nnen die Dateien in die Datenbank verlagern (s.u.)",
...
"Change admin password" => "Admin-Paßwort &auml;ndern",
"Change password" => "Paßwort &auml;ndern",
...
"Larger font for" => "Gr&ouml;ßere Schrift f&uuml;r",
"Use page description:" => "Seitenbeschreibung benutzen:",
...
"Maximum size" => "Maximale Gr&ouml;ße",
"Wiki attachments" => "Wiki-Anh&auml;nge",
"Change" => "&Auml;ndern",
...
"Show size" => "Zeige Gr&ouml;ße",
"Show the size of the article" => "Gr&ouml;ße des Artikels anzeigen",
...
"Change your password" => "&Auml;ndern Sie Ihr Paßwort",
...
"You can see the list of wiki pages in your site" => "Sie k&ouml;nnen die Liste von Wiki-Seiten auf ihrer Seite sehen",
"here" => "hier",
"Locked" => "Gesperrt",
...
"For complete documentation, please visit" => "F&uuml;r eine vollst&auml;ndige Dokumentation besuchen Sie bitte",
...
"Review the System Requirements" => "Pr&uuml;fen Sie die System-Voraussetzungen",
"Before installing Tiki, <a href=\"http://doc.tikiwiki.org/Requirements\" target=\"_blank\">review the documentation</a> and confirm that your system meets the minimum requirements." => "Lesen Sie vor der Installation bitte die <a href=\"http://doc.tikiwiki.org/Requirements\" target=\"_blank\">Seite &uuml;ber die Voraussetzungen</a> und stellen Sie sicher, dass die Mindestanforderungen erf&uuml;llt werden.",
"Memory" => "Speicher",
"Success" => "Erfolgreich",
...
"Registering does not give you any benefits except one more link to your site." => "Eine Registrierung bringt keine Vorteile außer einen zus&auml;tzlichen Link auf die Site.",
...
"Total size of images" => "Gr&ouml;ße der Bilder gesamt",
"Average image size" => "Durchschn. Bildgr&ouml;ße",
...
"Total size of files" => "Gr&ouml;ße der Dateien gesamt",
"Average file size" => "Durchschn. Dategr&ouml;ße",
...
"Total articles size" => "Artikel Gr&ouml;ße gesamt",
"Average article size" => "Durchschn. Artikelgr&ouml;ße",
...
"Total size of blog posts" => "Gesamtgr&ouml;ße der Blog-Posts",
"Average posts size" => "Durchschn. Post Gr&ouml;ße",
...
"Theme is selected as follows" => "Die Theme wird folgendermaßen gew&auml;hlt",
...
"Leave \"New password\" and \"Confirm new password\" fields blank to keep current password" => "Felder \"Neues Paßwort\" und \"Paßwort best&auml;tigen\" frei lassen um das alte Paßwort zu behalten",
...
"Your admin password has been changed" => "Das Administrator-Paßwort wurde ge&auml;ndert",
"All Fields except gdaltindex must be filled" => "Alle Felder außer gdaltindex m&uuml;ssen ausgef&uuml;llt werden",
...
"setting the xbithack option is unsafe. Depending on the file handling of your webserver and your tiki settings, it may be possible that a attacker can upload scripts to file gallery and execute them" => "Setzen der xbithack Option ist unsicher. Abh&auml;ngig vom Dateihandling des Webservers und der Tiki-Einstellungen ist es unter Umst&auml;nden m&ouml;glich, dass jemand Scripte ins Dateiarchiv hochl&auml;d und dort ausf&uuml;hrt.",
...
"Must select a category. " => "Eine Kategorie muß ausgew&auml;hlt werden. ",
...
"Error: " => "Fehler: ",
"Page must be defined inside a structure to use this feature" => "F&uuml;r diese Funktion muß die Seite innerhalb einer Struktur angelegt werden",
...
"The passwords did not match" => "Die Paßw&ouml;rter stimmen nicht &uuml;berein",
"no" => "nein",
"unicode" => "Unicode",
"open / in process" => "offen / in Bearbeitung",
"Changes:" => "&Auml;nderungen:",
