...
"Set home forum" => "Hauptforum setzen",
...
"idle" => "unt&auml;tig",
"MyTiki (click!)" => "Mein Tiki (Klick mich!)",
"Admin (click!)" => "Verwaltung (Klick mich!)",
...
"Values are stored in a dedicated table for each tracker, then you can easily manipulate them outside TikiWiki" => "Die Werte f&uuml;r jeden Tracker werden in der seperaten Tabelle gespeichert, diese k&ouml;nnen ausserhalb von Tiki angepasst werden.",
...
"Transversal features (which apply to more than one section)" => "&Uuml;bergeordnete Einstellungen",
"Navigation features" => "Navigation",
"Look &amp; feel (themes)" => "Look &amp; Feel (Themes)",
"Text area features (features you can use in all text areas, like wiki pages, blogs, articles, forums, etc)" => "Einstellungen zu Textinhalten (Dinge die Wikiseiten, Blogs, Artikeln, Foren etc. vorhanden sind)",
