...
"Path to where the dumped files are (relative to tiki basedir with trailing slahs ex: dump/)" => "Path to where the dumped files are (relative to tiki basedir with trailing slahs ex: dump/)", // TODO
"hist" => "hist", // TODO
