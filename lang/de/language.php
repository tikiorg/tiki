...
"changes" => "&Auml;nderungen",
"change" => "&Auml;nderung",
"No changes" => "Keine &Auml;nderungen",
...
"Report for" => "Zusammenfassung f&uuml;r",
"Last Report sent on" => "Letzter Report am",
"Changes in detail:" => "&Auml;nderungen im Detail:",
"changed the picture gallery" => "&Auml;nderte die Bildergalerie",
"uploaded the picture" => "lud das Bild",
"onto" => "nach",
"removed the picture" => "entfernte das Bild",
"edited the wikipage" => "&Auml;nderte die Seite",
"this history" => "diese &Auml;nderung",
"all history" => "alle &Auml;nderungen",
"edited the file gallery" => "&auml;nderte das Dateiarchiv",
"Last Report sent on" => "Letzter Report am",
"Last Report sent on" => "Letzter Report am",
...
"edited the category" => "&auml;nderte die Kategorie",
"removed the article" => "l&ouml;schte den Artikel",
"created the article" => "erstellte den Artikel",
"edited the article" => "&Auml;nderte den Artikel",
"replied to the blog" => "antwortete auf den Blog",
"created the topic" => "erstellte das Thema",
"at forum" => "im Forum",
"replied" => "antwortete",
"to the topic" => "auf das Thema",
"Nothing has happened." => "Es wurde nichts g�ndert",
