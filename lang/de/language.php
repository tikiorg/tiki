...
"Tiki Calendars" => "MyTiki Kalender",
"browse by" => "betrachte",
...
"You can include the image in an HTML/Tiki page using" => "Sie k&ouml;nnen das Bild in eine HTML-/MyTiki-Seite einf&uuml;gen",
...
"Path to where the dumped files are (relative to tiki basedir with trailing slash ex: dump/)" => "Verzeichnis, in dem die gesicherten Exporte liegen (relativ zum MyTiki-Hauptverzeichnis mit abschlie&szlig;endem Slash, z.B. dump/)",
"ver" => "Version",
"Newss from" => "News aus",
...
"You can include the image in an HTML or Tiki page using" => "Sie k&ouml;nnen das Bild in eine HTML- oder MyTiki-Seite einf&uuml;gen",
...
"idle" => "unt&auml;tig",
"MyTiki (click!)" => "Mein MyTiki (Klick!)",
...
"Displays user's contribution in the user information page" => "Zeigt die Nutzeraktivit&auml;t in MeinMyTiki an",
...
"This is not a TikiWiki File. Check if this file was uploaded and if it is dangerous." => "Dies ist keine MyTiki-Datei. Bitte &uuml;berpr&uuml;fen ob sie hochgeladen wurde und gef&auml;hrlich ist.",
...
"Tiki RSS Feed Error Message" => "MyTiki RSS Feed Fehlermeldung",
...
"New article post: {\$mail_title} by {\$mail_user} at {\$mail_date|tiki_short_datetime}" => "Neuer Artikel erschienen: {\$mail_title} von {\$mail_user} am {\$mail_date|tiki_short_datetime}", // ## CLOSE: "New blog post: {\$mail_title} by {\$mail_user} at {\$mail_date|tiki_short_datetime}" => "Neuer Blog-Eintrag: {\$mail_title} von {\$mail_user} um {\$mail_date|tiki_short_datetime}",
...
"Available styles:" => "Verf&uuml;gbare Styles:", // ## CLOSE: "Available scales" => "Verf&uuml;gbare Skalierungen",
...
"Values are stored in a dedicated table for each tracker, then you can easily manipulate them outside TikiWiki" => "Die Werte f&uuml;r jeden Tracker werden in der seperaten Tabelle gespeichert, diese k&ouml;nnen ausserhalb von MyTiki angepasst werden.",
"Intertiki client" => "Intertiki Client",
"Tiki Unique key" => "Eindeutiger MyTiki Schl&uuml;ssel",
...
"This page is to configure settings of RSS feeds read/imported by Tiki. To generate/export RSS feeds, look for \"RSS feeds\" on the admin panel, or" => "Auf dieser Seite werden die RSS Feeds konfiguriert, die von MyTiki gelesen und importiert werden. Zum generieren/exportieren von RSS Feeds \"RSS Feeds\" im Men&uuml; w&auml;hlen oder",
...
"This may be necessary if you created content with tiki &lt; 1.8.4 and Default Charset settings in apache set to ISO-8859-1" => "Notwendig, wenn Sie mit MyTiki &lt; v1.8.4 und ISO-8859-1 Codierung gearbeitet haben.",
...
"TikiWiki Mods Configuration" => "MyTiki Mod Konfiguration",
...
"Display Tiki objects that have not been categorized" => "Noch nicht kategorisierte MyTiki-Objekte anzeigen",
...
"Displays the data using the TikiWiki odd/even table style" => "Daten im MyTiki gerade/ungerade Stil anzeigen",
"cells" => "Zellen",
...
"Message" => "Nachricht",
"Tiki mail-in instructions" => "MyTiki Mail-in Anweisungen",
...
"best regards" => "Gruss",
"your Tikiwiki" => "Ihr MyTiki",
"Tiki User Registration Request" => "Anfrage MyTiki Benutzerregistrierung",
"The user" => "Der Benutzer",
"registered at your site" => "hat sich auf Ihrer MyTiki-Site registriert",
...
"Tiki email notification" => "MyTiki eMail-Benachrichtigung",
...
"Your Tiki account information for %s" => "Ihre MyTiki-Accountinformationen f&uuml;r %s",
...
"Your Tiki information registration" => "Ihre MyTiki Registrierungsinformationen",
...
"User Menu" => "Benutzer-Men&uuml;",
"TikiWiki Assistant" => "MyTiki Assistent",
"Thank you for installing TikiWiki" => "Vielen Dank f&uuml;r die Nutzung von MyTiki",
...
"This is" => "Dies ist",
"by the" => "von der",
"Tiki community" => "MyTiki Community",
"My Tiki" => "Mein MyTiki",
...
"Tiki sections and features" => "MyTiki-Bereiche und Funktionen",
...
"Tiki Calendar" => "MyTiki Kalender",
"Tiki Template Viewing" => "MyTiki Templates betrachten",
...
"Wiki_Tiki_Title" => "Wiki_MyTiki_Titel",
...
"Change password" => "Pa&szlig;wort &auml;ndern",
"Enable/disable Tiki features in " => "MyTiki-Features ein/ausschalten in ",
...
"Just Tiki" => "Nur &uuml;ber MyTiki",
"Web Server" => "Webserver",
"Tiki and PEAR::Auth" => "MyTiki und PEAR::Auth",
"Tiki and PAM" => "MyTiki und PAM",
"Tiki and HTTP Auth" => "MyTiki und HTTP Auth",
"Use WebServer authentication for Tiki" => "Webserver-Authentifizierung f&uuml;r MyTiki benutzen",
...
"Create user if not in Tiki?" => "Benutzer anlegen falls im MyTiki nicht vorhanden?",
"Create user if not in Auth?" => "Benutzer anlegen falls in Auth nicht vorhanden?",
"Just use Tiki auth for admin?" => "Nur MyTiki-Authentifizierung f&uuml;r Administrator?",
...
"This page is to configure settings of RSS feeds generated/exported by Tiki. To read/import RSS feeds, look for \"RSS modules\" on the application menu, or" => "Auf dieser Seite werden die RSS Feeds konfiguriert, die von MyTiki erstellt und exportiert werden. Zum Einlesen/Importieren von RSS Feeds \"RSS Module\" im Men&uuml; w&auml;hlen oder",
...
"TikiWiki settings" => "MyTiki Einstellungen",
"Tiki variable" => "MyTiki Variable",
"Check all tiki files" => "Alle MyTiki-Dateien &uuml;berpr&uuml;fen",
...
"Warning!" => "Warnung!",
"Restoring a backup destoys all the data in your Tiki database. All your tables will be replaced with the information in the backup." => "Das Wiederherstellen eines Backups zert&ouml;rt alle bisherigen Daten in Ihrer MyTiki Datenbank. Die Information in allen Tabellen wird durch das Backup ersetzt.",
...
"Welcome to the Tiki Chat Rooms" => "Willkommen bei den MyTiki Chatr&auml;umen",
...
"Structure" => "Struktur",
"Top page" => "Top-Seite",
"Tiki Debugger Console" => "MyTiki Debug-Konsole",
...
"Operators must be tiki users" => "Operatoren m&uuml;ssen MyTiki Benutzer sein",
...
"Tiki site registered" => "MyTiki Site registriert",
...
"On this page you can make your tiki site known to tikiwiki.org. It will get shown there in a list of known tiki sites." => "Hier k&ouml;nnen Sie Ihre Site bei tikiwiki.org bekanntmachen. Dort wird sie in die Liste der bekannten MyTiki-Sites eingetragen.",
...
"Registering is just for us to get an overview of Tiki's usage." => "Die Registrierung hilft uns einen kleinen &Uuml;berblick &uuml;ber die Nutzung von MyTiki zu gewinnen.",
"If your site is private or inside your intranet, you should not register!" => "Wenn ihre MyTiki Site rein privat oder nur in ihrem Intranet zu erreichen ist, tragen sie ihre Site bitte nicht ein!",
...
"Tiki Shoutbox" => "MyTiki-Shoutbox",
"admin Tiki Shoutbox" => "MyTiki-Shoutbox verwalten",
...
"You can include the file in an HTML/Tiki page using" => "Sie k&ouml;nnen die Datei in eine HTML-/MyTiki-Seite einf&uuml;gen mit",
...
"Enable/disable Tiki features here, but configure them elsewhere" => "MyTiki-Features hier ein/ausschalten, konfiguriert werden sie dann an anderen Stellen.",
...
"setting the xbithack option is unsafe. Depending on the file handling of your webserver and your tiki settings, it may be possible that a attacker can upload scripts to file gallery and execute them" => "Setzen der xbithack Option ist unsicher. Abh&auml;ngig vom Dateihandling des Webservers und der MyTiki-Einstellungen ist es unter Umst&auml;nden m&ouml;glich, da&szlig; jemand Scripte ins Dateiarchiv hochl&auml;d und dort ausf&uuml;hrt.",
"The Path to store files in the filegallery should be outside the tiki root directory" => "Der Pfad des Dateiarchivs sollte au&szlig;erhalb des MyTiki-Verzeichnisses liegen.",
"The Path to store files in the imagegallery should be outside the tiki root directory" => "Der Pfad der Bildergalerien sollte au&szlig;erhalb des MyTiki-Verzeichnisses liegen.",
...
"Tiki RSS feed for articles" => "MyTiki RSS Artikel Feed",
...
"Tiki RSS feed for blog: " => "MyTiki RSS Feed von Weblog: ",
"Tiki RSS feed for weblogs" => "MyTiki RSS Weblog Feed",
...
"Tiki RSS feed for directory sites" => "MyTiki RSS Feed von Linkverzeichnis",
...
"Last files" => "Neueste Dateien",
"Tiki RSS feed for file galleries" => "MyTiki RSS Dateiarchiv Feed",
...
"Tiki RSS feed for the file gallery: " => "MyTiki RSS Feed von Dateiarchiv: ",
"No forum indicated" => "Kein Forum angegeben",
"Forum posts" => "Zahl der Eintr&auml;ge",
"No forumId specified" => "Keine forumId angegeben",
"Tiki RSS feed for forum: " => "MyTiki RSS Feed von Forum: ",
"Tiki RSS feed for forums" => "MyTiki RSS Foren Feed",
...
"Top images" => "Top Bilder",
"Last images" => "Neueste Bilder",
"Tiki RSS feed for image galleries" => "MyTiki RSS Feed von Bildergalerien",
"Tiki RSS feed for the image gallery: " => "MyTiki RSS Feed von Bildergalerie: ",
...
"Tiki RSS feed for maps" => "MyTiki RSS Karten Feed",
...
"Tiki RSS feed for individual trackers: " => "MyTiki RSS Feed von Tracker: ",
...
"Tiki RSS feed for the wiki pages" => "MyTiki RSS Wiki Feed",
...
"View parsed by Tikilib" => "Seite mit MyTikilib parsen",
