...
"cms" => "Artikel",
"Your message has been queued for approval, the message will be posted after\r\na moderator approves it." => "Ihre Nachricht wurde in die Warteschlange zur Best&auml;stigung eingereiht. Sie wird angezeigt, sobald sie ein Moderator freigegeben hat.",
"comm" => "Schnittstellen",
"community" => "Community",
...
// "debug ignore xdebug" => "debug ignore xdebug",
...
// "Daily Repors for User Watches" => "Daily Repors for User Watches",
...
// "Workflow" => "Workflow",
// "Use Minified Scripts" => "Use Minified Scripts",
// "Ignore XDebug: Don't use XDebug debugging info if installed. Try this if you use xdebug and are geting blank pages" => "Ignore XDebug: Don't use XDebug debugging info if installed. Try this if you use xdebug and are geting blank pages",
// "Ignore XDebug" => "Ignore XDebug",
...
// "Enter a character to use as the delimiter when displaying page titles. All characters after the delimiter will be stripped when displaying the page name.</em>" => "Enter a character to use as the delimiter when displaying page titles. All characters after the delimiter will be stripped when displaying the page name.</em>",
...
// "Depending on the size of the file from the source software the import process may take a while to complete. This migth be a problem according to your PHP and web server settings. This script tries to change the relevant settings but there are some settings that the script cannot change. So if you are having problems with the script try to increase the value of the following settings: max_input_time, post_max_size, upload_max_filesize. It is recommended that you run this script in a server where you can change the values of those settings if needed" => "Depending on the size of the file from the source software the import process may take a while to complete. This migth be a problem according to your PHP and web server settings. This script tries to change the relevant settings but there are some settings that the script cannot change. So if you are having problems with the script try to increase the value of the following settings: max_input_time, post_max_size, upload_max_filesize. It is recommended that you run this script in a server where you can change the values of those settings if needed",
// "ATTENTION: make sure to have a backup before running the script. If you do not have a backup this is the last chance to cancel the importer by clicking on the cancel button" => "ATTENTION: make sure to have a backup before running the script. If you do not have a backup this is the last chance to cancel the importer by clicking on the cancel button",
// "Congratulations! You have successful imported your {\$softwareName} data to Tikiwiki" => "Congratulations! You have successful imported your {\$softwareName} data to Tikiwiki",
...
// "Creator group perms apply only if no tiki_p_view_trackers" => "Creator group perms apply only if no tiki_p_view_trackers",
...
"email is public" => "E-Mail ist öffentlich",
"homePage" => "Startseite",
