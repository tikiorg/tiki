...
">Block description: " => ">Block-Beschreibung: ",//perhaps not used
">I forgot my password" => ">Ich habe mein Pa&szlig;wort vergessen",//perhaps not used
...
"Admin content" => "Admin Inhalt",//perhaps not used
"Admin cookies" => "Admin-Cookies",
"Admin Cookies" => "Admin Cookies",//perhaps not used
...
"All pages" => "Alle Seiten",//perhaps not used
...
"Allow viewing HTML mails" => "Lesen von HTML-Nachrichten erlauben",//perhaps not used
"Allow viwing HTML mails?" => "Ansehen von HTML-Mails erlauben?",//perhaps not used
"Allowed HTML:" => "Erlaubtes HTML:",//perhaps not used
"announce" => "Annoncieren",
"Anonymous users can edit pages" => "Anonymous Benutzer k&ouml;nnen Seiten bearbeiten",//perhaps not used
...
"Assign permissions to thispage" => "Dieser Seite Berechtigungen zuweisen",//perhaps not used
"Assign user" => "Benutzer zuweisen",
"assign" => "zuweisen",
"assign_perms" => "Rechte zuweisen",
"Assigned Modules" => "Zugewiesene Module",
"assigned" => "zugewiesen",//perhaps not used
"at" => "um",
...
"Cannot get file from URL" => "Datei kann nicht von URL geholt werden",//perhaps not used
...
"Change preferences" => "&Uuml;bernehmen",
...
"Choose" => "Ausw&auml;hlen",//perhaps not used
...
"column" => "Spalte",//perhaps not used
"Column" => "Spalte",
"Com" => "Kom",
"Comm" => "Komm",
"Comment" => "Kommentar",
...
"content templates" => "Inhaltsvorlagen",//perhaps not used
...
"create tag" => "Marke hinzuf&uuml;gen",//perhaps not used
...
"Current version" => "Aktuelle Version",//perhaps not used
"current" => "aktuell",
"current_version" => "Aktuelle_Version",//perhaps not used
...
"dispay" => "anzeigen",//perhaps not used
...
"drawings" => "Zeichnungen",//perhaps not used
"drop down" => "Dropdown",
"dump" => "Datenbankabzug",
"Dump" => "Datenbankabzug",
...
"Edit Blog" => "Blog bearbeiten",
"Edit desc" => "Beschr. bearb.",//perhaps not used
"Edit drawings &amp; pictures" => "Zeichnungen und Bilder bearbeiten",//perhaps not used
...
"Edit questions" => "Umfragen bearbeiten",//perhaps not used
"Edit Templates" => "Vorlagen bearbeiten",
"Edit this FAQ" => "Diese FAQ bearbeiten",
"Edit this HTML page" => "Diese HTML Seite bearbeiten",//perhaps not used
...
"Entire site" => "Ganze Site",//perhaps not used
"Error" => "Fehler",
"Event" => "Termin",
"event" => "Termin",
"excerpt" => "Auszug",
...
"feat" => "Features",//perhaps not used
...
"file galleries" => "Dateigalerien",//perhaps not used
"File galleries" => "Dateigalerien",
"File Galleries" => "Dateigalerien",
"File Gallery" => "Dateigalerie",
"File gals" => "Dateigall.",
"file gls" => "Dateigal.",//perhaps not used
...
"General" => "Allgemein",
"general" => "allgemeine",//perhaps not used
...
"gral" => "Allgemeines",//perhaps not used
...
"HasImg" => "HatBild",//perhaps not used
"Heading" => "&Uuml;berschrift",
"heading1" => "&Uuml;berschrift1",
"heading2" => "&Uuml;berschrift2",//perhaps not used
"heading3" => "&Uuml;berschrift3",//perhaps not used
...
"image galleries" => "Bildergalerien",//perhaps not used
...
"images" => "Bilder",
"Images" => "Bilder",
"img gls" => "Bildergal.",//perhaps not used
"img nc" => "img nc",
"Img" => "Bild",
"img" => "img",//perhaps not used
"Imgs" => "Bilder",
"Import page" => "Seite importieren",
"Import pages from a PHPWiki Dump" => "Importiere Seite von PHPWiki-Datenbankabzug",
"import" => "Import",
"Impressions" => "Aufrufe",
...
"Include" => "Aufnehmen",
"Includes" => "Beinhaltet",
"Index page" => "Indexseite",//perhaps not used
...
"JoinCapitalizedWords" => "GrosskleinWoerterZusammenschreiben",//perhaps not used
"July" => "Juli",
"June" => "Juni",
"Language" => "Sprache",
...
"lastModif" => "lastModif",
"Layout options" => "Layout-Optionen",//perhaps not used
...
"like pages" => "&auml;hnl. Seiten",//perhaps not used
...
"Links" => "Links",
"links" => "Links",//perhaps not used
"Links/Commands" => "Links/Befehle",//perhaps not used
...
"List Trackers" => "Tracker auflisten",
"List" => "Liste",
"list_pages" => "Seiten_auflisten",//perhaps not used
...
"Module" => "Modul",
"modules" => "Module",//perhaps not used
"Modules" => "Module",
"mon" => "Mo",
"Mon" => "Mo",
"Month" => "Monat",
...
"my galleries" => "Meine Galerien",//perhaps not used
...
"Next version" => "N&auml;chste Version",//perhaps not used
"Next" => "N&auml;chst.",
"next" => "n&auml;chstes",
"Nickname" => "Nickname",
"No article indicated" => "Kein Artikel angegeben",
"No attachments for this item" => "Keine Anh&auml;nge f&uuml;r diesen Eintrag",
"No attachments for this page" => "Keine Anh&auml;nge f&uuml;r diese Seite",//perhaps not used
...
"No file" => "Keine Datei",//perhaps not used
...
"No individual permissions global permissions to all pages apply" => "Keine individuellen Berechtigungen, globale Berechtigungen gelten",//perhaps not used
...
"Old versions" => "Alte Versionen",//perhaps not used
"on" => "an",
"on:" => "Am:",
...
"options" => "Optionen",
"or use square brackets for an" => "oder benutzen Sie eckige Klammern f&uuml;r einen",//perhaps not used
"or" => "oder",
"Order" => "Reihenfolge",
"order" => "Reihenfolge",
...
"Password" => "Pa&szlig;wort",
"Path to where the dumped files are" => "Pfad zu den Datenbankabzugs-Dateien",//perhaps not used
"path" => "Pfad",
"Path" => "Pfad",
"Percentage completed" => "Prozent erledigt",
"Perm" => "Rechte",//perhaps not used
...
"Permission denied you cant view this section" => "Zugriff verweigert. Sie k&ouml;nnen diese Sektion nicht betrachten",//perhaps not used
...
"poll" => "Abstimmung",
"polls" => "Abstimmungen",//perhaps not used
"Polls" => "Abstimmungen",
...
"Public" => "&Ouml;ffentlich",//perhaps not used
"public" => "oeffentlich",
...
"References" => "Verweise",//perhaps not used
...
"rollback" => "Rollback",
"Rollback_page" => "Rollback_Seite",//perhaps not used
"rows" => "Zeilen",
"Rows" => "Zeilen",
...
"Show comments" => "Kommentare anzeigen",//perhaps not used
...
"sub categories" => "Unterkategorien",//perhaps not used
"subject" => "Betreff",
"Subject" => "Betreff",
...
"suggested" => "vorgeschlagen",//perhaps not used
"sun" => "So",
"Sun" => "So",
...
"Survey" => "Umfrage",
"Surveys" => "Umfragen",
"system gallery" => "Systemgalerie",//perhaps not used
...
"Tasks" => "Aufgaben",
"tasks" => "Aufgaben",//perhaps not used
"Tbl vis" => "Tbl vis",
...
"text" => "Text",
"textarea" => "Textfeld",
"TextFormattingRules" => "Textformatierungs-Regeln",//perhaps not used
...
"Title" => "Titel",
"title" => "Titel",
"Title_bar" => "Titel_Balken",//perhaps not used
"To date" => "Bis Datum",
"to groups" => "zu Gruppen",
"to insert a random tagline" => "um eine zuf&auml;llige Tagline einzuf&uuml;gen",//perhaps not used
...
"trckrs" => "Tracker",//perhaps not used
"Tue" => "Di",
"tue" => "Di",
"Type" => "Typ",
"type" => "Typ",
...
"Unlimited" => "unbegrenzt",//perhaps not used
"unlock" => "entsperren",
"Unread" => "Ungelesen",
...
"use" => "benutzen",
"Use" => "Nutzen",
"UseImg" => "NutztBild",//perhaps not used
...
"User Bookmarks" => "Benutzer-Lesezeichen",
"user bookmarks" => "Benutzer-Lesezeichen",//perhaps not used
...
"Version" => "Version",
"version" => "Version",
"versions" => "Versionen",//perhaps not used
"Versions" => "Versionen",
"Very High" => "sehr hoch",
...
"Visits to file galleries" => "Besuche in Dateigalerien",
...
"You cant use the same password again" => "Sie k&ouml;nnen dasselbe Pa&szlig;wort nicht noch einmal verwenden",//perhaps not used
...
"You have to provide a name to the file" => "Sie m&uuml;ssen einen Namen f&uuml;r die Datei angeben",//perhaps not used
...
"Users can save pages to notepad" => "Benutzer darf Seiten im Notizblock speichern",//perhaps not used
"Tables syntax" => "Tabellensyntax",
"|| for rows" => "|| f&uuml;r Spalten",
"\n for rows" => "\n f&uuml;r Spalten",
"Wiki History" => "Wiki Historie",
"Forum settings" => "Forum Einstellungen",//perhaps not used
"Allow wiki markup" => "Wiki-Verlinkung erlauben",//perhaps not used
"Describe topics in listing" => "Themen in der Auflistung beschreiben",//perhaps not used
"Quota (Mb)" => "Quota (MB)",
"quota" => "Quota",
...
"rotate left" => "links drehen",//perhaps not used
...
"wiki pages" => "Wiki Seiten",//perhaps not used
"Relevance" => "Relevanz",
"locked by" => "gesperrt von",
"Save to notepad" => "Im Notizblock speichern",
"pvs" => "Views",
"display" => "anzeigen",
"Kb" => "KB",//perhaps not used
"Mb" => "MB",
"bytes" => "Bytes",
...
"Dont use external mail validation" => "Keine externe Mail&uuml;berpr&uuml;fung benutzen",//perhaps not used
"Use external mail validation" => "Externe Mail&uuml;berpr&uuml;fung benutzen",//perhaps not used
...
"remove structure" => "Struktur entfernen",//perhaps not used
...
"If you want to be a registered user in this site you will have to use" => "registriert. Wenn sie ein registrierter Benutzer der Site werden wollen,",//perhaps not used
"the following link to login for the first time" => "dann klicken sie auf den folgenden Link, um sich das erste mal anzumelden",//perhaps not used
...
"Invalid user:" => "Unbekannter Benutzer:",//perhaps not used
"Message will be sent to: " => "Die Nachricht wird versandt an: ",
"Is email public? (uses scrambling to prevent spam)" => "EMai-Adresse &ouml;ffentlich? (es wird Verschl&uuml;sselung gegen Spam benutzt)",
"No notes yet" => "Noch keine Notizen vorhanden.",
"merge notes into" => "Notizen zusammenf&uuml;hren in",//perhaps not used
...
"Last post" => "Neuester Eintrag",
"Go back" => "zur&uuml;ck",
"visible" => "sichtbar",//perhaps not used
"Visible" => "Sichtbar",//perhaps not used
...
"more" => "weiter",//perhaps not used
"today" => "heute",
"browse by" => "betrachte",
"You will receive an email with your password soon" => "Eine EMail mit dem neuen Pa&szlig;wort ist unterwegs.",//perhaps not used
...
"PluginsHelp" => "PlugIn-Hilfe",//perhaps not used
...
"Wiki quick help" => "Wiki Kurzhilfe",//perhaps not used
...
"syntax highlighting" => "Hervorhebung",//perhaps not used
...
"Click twice if once is not enough !" => "Zweimal Klicken falls einmal nicht ausreicht!",//perhaps not used
"Toggle display of comment zone" => "Kommentarblock ein-/ausschalten",//perhaps not used
...
"PDF Export" => "PDF Export",//perhaps not used
"Custom Locations" => "Custom Locations", // TODO
"Custom Categories" => "Custom Categories", // TODO
"Custom Languages" => "Custom Languages", // TODO
"Custom Priorities" => "Custom Priorities", // TODO
"loc" => "loc", // TODO
"cat" => "cat", // TODO
"lang" => "lang", // TODO
"prio" => "prio", // TODO
...
"online" => "online",
"Approval type" => "Approval type", // TODO
...
"Send trackback pings to:" => "Send trackback pings to:", // TODO
...
"hide from display" => "hide from display", // TODO
"+1d" => "+1Tag",
"+7d" => "+7Tag",
"+1m" => "+1Monat",
"+" => "+",
...
"Modified" => "Ge&auml;ndert",
"If you change the calendar selection, please refresh to get the appropriated list in Category, Location and people (if applicable to the calendar you choose)." => "If you change the calendar selection, please refresh to get the appropriated list in Category, Location and people (if applicable to the calendar you choose).", // TODO
...
"comma separated username:role" => "comma separated username:role", // TODO
"Chair" => "Chair", // TODO
"Required" => "Erforderlich",
"Optional" => "Optional",
"with roles" => "with roles", // TODO
"End" => "End", // TODO
"Url" => "Url",
"Tentative" => "Unter Vorbehalt",
"Confirmed" => "Zugesagt",
"Cancelled" => "Abgelehnt",
"duplicate" => "duplicate", // TODO
...
"Height of top Heading" => "Height of top Heading", // TODO
"Height of mid Heading" => "Height of mid Heading", // TODO
"Height of inner Heading" => "H&ouml;he von &Uuml;berschriften im Text",
"tbheight" => "tbheight", // TODO
...
"try" => "try", // TODO
"File with names appended by -{\$user} are modifiable, others are only duplicable and be used as model." => "File with names appended by -{\$user} are modifiable, others are only duplicable and be used as model.", // TODO
...
"horizontal ruler" => "horizontal ruler", // TODO
...
"Listing configuration" => "Listing configuration", // TODO
"icon" => "icon", // TODO
"id" => "ID",
"downloads" => "Downloads",
"Name-filename" => "Name-filename", // TODO
"Filename only" => "nur Dateiname",
"Max description display size" => "Max description display size", // TODO
"configure listing" => "configure listing", // TODO
"Message queue for" => "Message queue for", // TODO
"back to forum" => "zur&uum;ck zum Forum",
"Edit queued message" => "Edit queued message", // TODO
"make this a thread of" => "make this a thread of", // TODO
...
"attachment" => "Anhang",
"No messages queued yet" => "No messages queued yet", // TODO
"reject" => "reject", // TODO
"adm" => "adm", // TODO
...
"split" => "split", // TODO
"join" => "join", // TODO
"standalone" => "standalone", // TODO
"interactive" => "interactive", // TODO
"auto routed" => "auto routed", // TODO
...
"Add a transition" => "&Uuml;bergan hinzuf&uuml;gen",
"Admin instance" => "Admin Instanzen",
"Instance" => "Instanz",
"Workitems" => "Workitems", // TODO
"Send all to" => "Send all to", // TODO
"Don't move" => "Don't move", // TODO
"run" => "starten", // TODO
"Properties" => "Properties", // TODO
"Property" => "Property", // TODO
"Value" => "Wert",
"Add property" => "Add property",  // TODO
"value" => "Wert",
...
"new minor" => "new minor", // TODO
"new major" => "new major", // TODO
"activities" => "Aktivit&auml;ten",
...
"Admin process sources" => "Admin process sources", // TODO
"select source" => "select source", // TODO
"Shared code" => "Shared code", // TODO
"Set next user" => "Set next user", // TODO
"Get property" => "Get property", // TODO
"Set property" => "Set property", // TODO
"Complete" => "Complete", // TODO
"Process form" => "Process form",  // TODO
"Set Next act" => "Set Next act", // TODO
"If:SetNextact" => "If:SetNextact", // TODO
"Swicth construct" => "Swicth construct", // TODO
"Map process roles" => "Prozess-Rollen zuordnen",
"admin processes" => "Admin Prozesse",
"admin activities" => "Admin Aktivit&auml;ten",
"admin roles" => "admin roles", // TODO
...
"int" => "int", // TODO
"routing" => "routing", // TODO
"run activity" => "Aktivit&auml;t starten", // TODO
...
"Valid" => "G&uuml;ltig", // TODO
"Invalid" => "Ung&uuml;ltig", // TODO
"Monitor workitems" => "Monitor workitems", // TODO
"List of workitems" => "List of workitems", // TODO
"instance" => "Instanz",
"Ins" => "Ins", // TODO
"stop" => "Anhalten",
"activate" => "Aktivieren",
...
"exception instance" => "exception instance", // TODO
"exceptions instance" => "exceptions instance", // TODO
"send instance" => "send instance", // TODO
"run instance" => "Instanz starten",
"abort instance" => "Instanz abbrechen",
"grab instance" => "grab instance", // TODO
"release instance" => "Instanz freigeben",
"Browsing Workitem" => "Browsing Workitem", // TODO
"Workitem information" => "Workitem information", // TODO
...
"Requested" => "Requested", // TODO
"Accept" => "Annehmen",
"Join" => "Beitreten",
"Support chat transcripts" => "Support Chat-Logb&uuml;cher",
"back to admin" => "back to admin", // TODO
"op" => "op", // TODO
"started" => "started", // TODO
"reason" => "Grund",
"msgs" => "msgs", // TODO
"Transcript" => "Logbuch",
"wiki create" => "wiki create", // TODO
"wiki overwrite" => "wiki overwrite", // TODO
"discuss" => "diskutieren",
"attachments" => "Anh&auml;nge",
"Vote poll" => "Vote poll", // TODO
"posted by" => "eingetragen von",
"Permalink" => "Permalink", // TODO
"referenced by" => "referenced by", // TODO
"references" => "Verweise",
...
"Trackback pings" => "Trackback pings",  // TODO
"URI" => "URI",
"Blog name" => "Blog Name",
"viewed" => "viewed",  // TODO
...
"Chart" => "Chart", // TODO
"Item" => "Eintrag",
"Permanency" => "Permanency", // TODO
"Previous" => "Previous", // TODO
"Dif" => "Dif", // TODO
"Best Position" => "Best Position", // TODO
"Vote this item" => "F&uuml;r diesen Eintrag stimmen",
"Highest" => "Highest", // TODO
"Q" => "F",
"A" => "A",
...
"queued messages:" => "queued messages:", // TODO
...
"In order to confirm your subscription you must access the following URL:" => "Zur Best&auml;tigung der Rundbrief-Registrierung m&uuml;ssen Sie diesem Link folgen:",
...
"You can always cancel your subscription using:" => "Sie k&ouml;nnen die Rundbrief-Registrierung jederzeit r&uuml;ckg&auml;ngig machen &uuml;ber:",
...
"since this is your registered email address we inform that the" => "da dies Ihre registrierte EMail-Adresse ist, informieren wir Sie dar&uuml;ber,",
"password for this account is" => "da&szlig das Pa&szlig;wort f&uuml;r diesen Account wie folgt lautet:",
"Syntax highlighting" => "Syntax-Highlighting",
"online user" => "Benutzer online",
"Send a message to" => "Schicke eine Nachricht an",
"Send message" => "Schicke Nachricht",
"More info about" => "Weitere Informationen &uuml;ber", // ... onlineuser
"idle" => "unt&auml;tig",
...
"No chart indicated" => "Kein Chart angegeben", // TODO
...
"blog_ranking_top_blogs" => "blog_ranking_top_blogs", // TODO
"blog_ranking_last_posts" => "blog_ranking_last_posts", // TODO
...
"filegal_ranking_top_galleries" => "filegal_ranking_top_galleries", // TODO
"filegal_ranking_top_files" => "filegal_ranking_top_files", // TODO
"filegal_ranking_last_files" => "filegal_ranking_last_files", // TODO
...
"Post recommendation at" => "Post recommendation at", // TODO
...
"WikiDiff::apply: line count mismatch: %s != %s" => "WikiDiff::apply: line count mismatch: %s != %s", // TODO
"WikiDiff::_check: failed" => "WikiDiff::_check: failed", // TODO
"WikiDiff::_check: edit sequence is non-optimal" => "WikiDiff::_check: edit sequence is non-optimal", // TODO
"WikiDiff Okay: LCS = %s" => "WikiDiff Okay: LCS = %s", // TODO
...
" tags. Example: {tr}The newsletter was sent to {\$sent} email addresses" => " tags. Example: {tr}The newsletter was sent to {\$sent} email addresses",//perhaps not used TODO:
...
"Wiki top file galleries" => "Wiki top file galleries", // TODO
"Wiki top images" => "Wiki top images", // TODO
"Wiki top files" => "Wiki top files", // TODO
"Wiki last images" => "Wiki last images", // TODO
"Upload date" => "Hochlade-Datum",
"Wiki last files" => "Wiki last files", // TODO 
"Most active blogs" => "Aktivste Blogs",
"Blogs last posts" => "Neueste Blog-Eintr&auml;ge",
"Post date" => "Eintragsdatum",
"Wiki top authors" => "Wiki Top Autoren",  // TODO
"Top article authors" => "Top article authors",  // TODO
...
\nwill be able to edit/post images. Use the &lt;img&gt; snippet to include uploaded images in the textarea editor
\nor use the image URL to include images using the WYSIWYG editor. ", // TODO
"with role" => "mit Rolle",
...
"Command" => "Befehle",
"exec" => "Ausf&uuml;hren",
"Type <code>help</code> to get list of available commands" => "<code>help</code> f&uuml;r eine Vefehls&uuml;bersicht eingeben",
