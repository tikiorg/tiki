...
"Your post has not been posted" => "Ihr Eintrag konnte nicht gesendet werden",
...
"Link" => "Link",
"Cannot open this file:" => "Kann Datei nich &ouml;ffnen:",
// "Blog" => "Blog",
"Continue" => "Weiter",
...
"You must select a file." => "Sie m&uuml;ssen eine Datei ausw&auml;hlen.",
...
"View graphic" => "Grafik betrachten",
...
"RSS Id incorrect:" => "RSS-Id falsch:",
...
"Fields marked with a * are mandatory." => "Mit einem * gekennzeichnete Felder sind Pflichtfelder.",
// "Filter" => "Filter",
...
"Syntax" => "Syntax",
"Duplicate File Gallery" => "Dateiarchiv kopieren",
...
"The files can be locked at download:" => "Die Dateien k&ouml;nnen f&uuml;r das Herunterladen gesperrt werden:",
...
"To validate your account and login to the site, please click on the following link:" => "Zum aktivieren Ihres Benutzerkontos, bitte den folgenden Link anklicken:",
...
"You sent a request with the subject:" => "Sie haben eine Anfrage mit dem Betreff:",
...
"Tiki User Account Activated" => "Tiki-Benutzerkonto aktiviert",
...
"Important: The old password remains active if you don't click the link above." => "Wichtig: Das alte Kennwort bleibt aktiv, wenn Sie nicht auf den Link oben klicken.",
...
"Sandbox" => "Sandbox",
"GalMenu" => "Galleriemen&uuml;",
"New article" => "Neuer Artikel",
"ForMenu" => "ForMenu",
"DirMenu" => "DirMenu",
"FileGalMenu" => "Dateigalleriemen&uuml",
"QuizMenu" => "QuizMenu",
"ShtMenu" => "ShtMenu",
"TrkMenu" => "TrkMenu",
"SrvMenu" => "SrvMenu",
"Send events" => "Events verschicken",
"Admin events" => "Ereignisse verwalten",
"EphMenu" => "EphMenu",
"ChartMenu" => "ChartMenu",
"AdmMenu" => "Admin-Men&uuml;",
"Admin" => "Einstellungen",
...
"Your email could not be validated; make sure you email is correct and click register below." => "Ihre Mail-Adresse wurde nicht als g&uuml;ltig erkannt. Bitte pr&uuml;fen Sie Ihre Mail-Adresse auf Richtigkeit und klicken unten auf 'Registrieren' .",
"RSS Feeds" => "RSS Feeds",
"Wiki RSS" => "Wiki RSS",
"Blogs RSS" => "Blogs RSS",
"Calendars" => "Kalender",
...
// "Location : " => "Location : ",
"Show/Hide Left Menus" => "linke Men&uuml;s ein-/ausblenden",
"Show/Hide Right Menus" => "rechte Men&uuml;s ein-/ausblenden",
...
"Last update from CVS" => "letzte Aktuallisierung von CVS",
...
"Blogs have a custom heading" => "Blogs haben einen eigenen Kopfbereich",
...
"Can specify notification emails when creating an article" => "Benachrichtigungs-Email bei Artikel-Erstellung",
// "Batch upload (CSV file):" => "Batch upload (CSV file):",
"Users sort order" => "Benutzer-Sortierung",
...
// "Copyright Management" => "Copyright Management",
"Enable Feature for Wiki" => "Funktion f&uuml;r Wiki-Seiten aktivieren",
"Enable Feature for Articles" => "Funktion f&uuml;r Artikel aktivieren",
"Enable Feature for Blogues" => "Funktion f&uuml;r Blogs aktivieren",
"Enable Feature for Faqs" => "Funktion f&uuml;r FAQs aktivieren",
...
"PodCast directory (must be web accessible):" => "PodCast Verzeichnis (mu&szlig; per Browser erreichbar sein):",
...
"Administer modules" => "Verwalten Sie Module",
...
"Search refresh mode" => "Suche Aktualisierungsmodus",
// "Text area (that apply throughout many features)" => "Text area (that apply throughout many features)",
"Show quicktags over textareas (instead on left side)" => "Quicktags &uuml;ber Textbereich anzeigen (statt auf linker Seite)",
...
"History only for data, description, comment change" => "Zugriff",
...
"Help on Banning System" => "Hilfe zum Sperrsystem",
...
"browse the category system" => "Kategorie-System durchst&ouml;bern",
// "Top" => "Top",
...
"Help on Drawings" => "Hilfe zu Zeichnungen",
...
"show threads preferences" => "Thread-Einstellungen anzeigen",
...
"You can add several email addresses by separating them with commas." => "mehrere eMail-Adressen mit Kommas trennen",
...
"Configure Polls" => "Abstimmungen einrichten",
...
"Show creation date when viewing tracker item?" => "Erstellungsdatum beim Anzeigen von Tracker-Eintr&auml;gen anzeigen?",
"Show lastModif date when viewing tracker item?" => "&Auml;nderungsdatum beim Anzeigen von Tracker-Eintr&auml;gen anzeigen?",
...
"Warning: changing the username will require the user to change his password" => "Warnung: Das &Auml;ndern des Benutzernamens wird verlangen, dass der Benutzer sein Kennwort &auml;ndert",
...
"User must change his password at first login" => "Benutzer muss Kennwort bei erster Anmeldung &auml;ndern",
...
"Add a site" => "Link hinzuf&uuml;gen",
"URL:" => "URL:",
"Use Ctrl+Click to select multiple categories." => "Benutzen Sie Strg+Klick um mehrere Kategorien auszuw&auml;hlen.",
...
"Mutual" => "Gegenseitig",
"Admin Directory Sites tpl" => "tpl - Links verwalten",
...
"Upload from disk to change the image:" => "neues Bild hochladen:",
...
"Help on Articles" => "Hilfe zu Artikeln",
...
"Select from available options..." => "W&auml;hlen Sie aus den verf&uuml;gbaren Optionen...",
...
"Preview your changes." => "Vorschau Ihrer &Auml;nderungen.",
"Save the page." => "Seite speichern.",
"Cancel the edit, you will lose your changes." => "Bearbeiten abrechen. Ihre &Auml;nderungen werden verworfen.",
...
"<strong>Preview</strong> or <strong>Save</strong> your work to restart the edit session timer." => "<strong>Vorschau</ strong> oder <strong>Speichern</ strong>, startet den Timer f&uuml;r die Bearbeitungszeit neu.",
// "Categories will be inherited from the structure top page" => "Categories will be inherited from the structure top page",
"disable" => "ausgeschalten",
"or use" => "oder",
"an existing poll" => "vorhandene Abstimmung verwenden",
// "Regex search " => "Regex search ",
"Translation request" => "Anfrage &Uuml;bersetzung",
"Send urgent translation request." => "Senden Sie dringende &Uuml;bersetzung Anfrage.",
...
"Update database using script" => "Datenbank aktualisieren mit Script",
...
// "Orphan" => "Orphan",
"Help on Dynamic Content" => "Hilfe zu Dynamische Inhalte",
...
"These permissions override any global permissions or category permissions affecting this object." => "Diese Berechtigungen &uuml;berschreiben alle globalen Berechtigungen oder Gruppen Berechtigungen, f&uuml;r dieses Objekt.",
"To edit global permissions <a class=\"rbox-link\" href=\"tiki-admingroups.php\">click here</a>." => "Zum bearbeiten der globalen Berechtigungen <a class=\"rbox-link\" href=\"tiki-admingroups.php\">hier klicken</a>.",
...
"These permissions do not apply. Special permissions apply." => "Diese Berechtigungen gelten nicht. Spezielle Berechtigungen gelten.",
...
"and also to all pages of the sub-structure:" => "und allen Seiten der Struktur zuweisen:",
...
// "Avatar:" => "Avatar:",
"(Only .gif images, and aproximately 45px x 45px)" => "(nur .Gif-Dateien, Gr&ouml;&szlig;e in etwa 45px x 45px)",
// "Any" => "Any",
"Items found:" => "Eintr&auml;ge gefunden:",
...
"NOTE: Make sure to whitelist this domain to prevent registration emails being canned by your spam filter!" => "Bitte schalten Sie diese Domain in ihrem Spamfilter frei, damit die Registrierungs-eMail auch ankommt!",
...
"return to wikipage" => "zur&uuml;ck zur Wikiseite",
"Replicate" => "Replicate",
"Slave" => "Slave",
"Master" => "Master",
...
"Edit this sheet:" => "Diese Seite bearbeiten:",
...
"Unzip all zip files" => "entpacke alle zip-Dateien",
...
"Can you read more languages?" => "Verstehen Sie weitere Sprachen?",
...
"Select language..." => "ausgew&auml;hlte Sprachen...",
...
"There are no questions in this FAQ." => "Es gibt keine Fragen in dieser FAQ.",
"A" => "Antwort",
...
"You have {\$unread} unread private messages" => "Sie haben {\$unread} ungelesene private Nachrichten",
"Your message has been queued for approval, the message will be posted after a moderator approves it." => "Ihre Nachricht wurde in die Warteschlange f&uuml;r Best&auml;stigungen eingereiht. Sie wird angezeigt, sobald sie ein Moderator freigegeben hat.",
...
"Tracker Items for" => "Trackereintr&auml;ge f&uuml;r",
...
"fields marked with a * are mandatory" => "Mit einem * gekennzeichnete Felder sind Pflichtfelder.",
"Edit mail account" => "e-mail Adresse ver&auml;ndern",
// "Clip" => "Clip",
...
"Save the page, but do not send notifications and do not count it as new content to be translated." => "Speichern Sie die Seite, aber keine Mitteilungen senden und nicht z&auml;hlen als neue Inhalte zu &uuml;bersetzen.",
...
"%s <b>%s</b> assigned to %s <b>%s</b>." => "%s <b>%s</b> zugeteilt an %s <b>%s</b>.",
"%s <b>%s</b> removed from %s <b>%s</b>." => "%s <b>%s</b> wurde aus %s <b>%s</b> entfernt.",
...
"Image %s removed from Batch directory." => "Bild %s aus Batchverzeichnis verschieben",
"Impossible to remove image %s from Batch directory." => "Bild %s konnte nicht aus dem Batchupload-Verzeichnis gel&ouml;scht werden.",
...
"You must clear your browser cache." => "Sie m&uuml;ssen Ihren Browser-Cache leeren.",
...
"Last images uploaded to the image galleries." => "letztes hochgeladenes Bild in die Bildergalerie",
...
"Notice: invalid variable value:" => "Hinweis: ung&uuml;ltiger Wert f&uuml;r Variable:",
...
"Invalid password.  Your current password is required to change administrative information" => "Ung&uuml;ltiges Kennwort. Ihr gegenw&auml;rtiges Kennwort ist erforderlich, um die Verwaltungsinformation zu &auml;ndern",
...
"Task entries:" => "Aufgaben-Eintr&auml;ge:",
