...
// "Log start and end of each smarty templates as an html comment" => "Log start and end of each smarty templates as an html comment",
...
"Install/Upgrade Profile" => "Perfil d'Instal·lació / Actualització",
