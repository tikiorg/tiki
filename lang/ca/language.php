...
"Select the installation (or upgrade) profile to use. This profile will populate (or upgrade) the database" => "Selecciona el perfil que vols emprar d'instal·lació (o actualitaació). Aquest perfil s'instal·larà a (o actualitzarà) la base de dades",
...
"_HOMEPAGE_CONTENT_" => "\n!Felicitats!\nAquesta és la ))PàginaInicial(( per omissió per al teu Tiki. Si estàs veient aquesta pàgina, la teva instal·lació ha funcionat sense problemes.\n\nPots canviar aquesta pàgina després de connectar-te. Si us plau, revisa la [http://doc.tikiwiki.org/wiki+syntax|sintaxi wiki] per a detalls d'edició.\n\n\n!!{img src=pics/icons/star.png alt=\"Star\"} Posa't en marxa.\nPer començar a configurar el teu lloc:\n{FANCYLIST()}\n1) Connecta't com a __admin__ amb contrasenya __admin__.\n2) Canvia la contrasenya d'admin.\n3) Habilita funcionalitats de Tiki especifiques.\n4) Configura les funcionalitats.\n{FANCYLIST}\n\n!!{img src=pics/icons/help.png alt=\"Help\"} Necessites ajuda?\nPer més informació:\n*[http://info.tikiwiki.org/Learn+More|Aprèn més sobre TikiWiki].\n*[http://info.tikiwiki.org/Help+Others|Aconsegueix ajuda], incloent la [http://doc.tikiwiki.org|documentació oficial] i els [http://www.tikiwiki.org/forums|fòrums de suport].\n*[http://info.tikiwiki.org/Join+the+community|Ajunta't amb la comunitat TikiWiki].\n",
...
"MySQL Improved (mysqli). Requires MySQL 4.1+" => "Controlador de MySQL Mmillorat (mysqli). Requereix MySQL 4.1+",
...
"<p><strong>Tiki \"mods\" are undergoing refubishment.</strong></p>" => "<p><strong>Els \"mods\" de Tiki estan en procés de reformes.</strong></p>",
"<p>You will probably some find mods shown as being compatible with older versions of Tiki will work with later versions with little or no modification</p>" => "<p>Probablement trobaràs que alguns mods mostrats com a compatibles amb versions antigues de Tiki fruncionaran amb versions posteriors de Tiki amb poques o cap modificació</p>",
"<p><em>Your help is needed! Please visit <a href=\"http://dev.tikiwiki.org/tiki-index.php?page=Mods\">dev.tikiwiki.org</a> to find out more.</em></p>" => "<p><em>Es necessita la teva ajuda! Si us plau, visita <a href=\"http://dev.tikiwiki.org/tiki-index.php?page=Mods\">dev.tikiwiki.org</a> per saber-ne mes.</em></p>",
"Attention" => "Atenció",
