...
// "The database must already exist. You can create the database using mysqladmin, PHPMyAdmin, or ask your\nhosting provider.  Normally Tiki tables won't conflict with other product names" => "The database must already exist. You can create the database using mysqladmin, PHPMyAdmin, or ask your\nhosting provider.  Normally Tiki tables won't conflict with other product names",
