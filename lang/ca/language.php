...
// "incorrect filedId" => "incorrect filedId",
...
// "Assign aulawiki_myworkspaces" => "Assign aulawiki_myworkspaces",
// "to the users that you want to use AulaWiki workspaces" => "to the users that you want to use AulaWiki workspaces",
// "Change theme" => "Change theme",
// "to AulaWiki.css" => "to AulaWiki.css",
// "Define the <a class='link' href=\"./aulawiki-roles.php\">workspace roles</a> and permission levels." => "Define the <a class='link' href=\"./aulawiki-roles.php\">workspace roles</a> and permission levels.",
// "Define the <a class='link' href=\"./aulawiki-workspace_types.php\">workspace types</a> , use MenuID 100 or <a class='link' href=\"./tiki-admin_menus.php\">define your own menu</a>. Assign <img src='img/icons/change.gif' border='0' alt='Workspace type resources' title='Workspace type resources' /> default resources and <img src='img/icons/mo.png' border='0' alt='Assigned modules' title='Assigned modules' /> desktop modules." => "Define the <a class='link' href=\"./aulawiki-workspace_types.php\">workspace types</a> , use MenuID 100 or <a class='link' href=\"./tiki-admin_menus.php\">define your own menu</a>. Assign <img src='img/icons/change.gif' border='0' alt='Workspace type resources' title='Workspace type resources' /> default resources and <img src='img/icons/mo.png' border='0' alt='Assigned modules' title='Assigned modules' /> desktop modules.",
...
// "Only one item per user" => "Only one item per user",
...
"Current Node" => "Node actual",
"Page alias" => "Àlies de pàgina",
"update" => "actualitza",
"Move" => "Moure",
"Promote" => "Promocionar",
"Previous" => "Anterior",
...
"down" => "avall",
"right" => "dreta",
"move to right column" => "moure a la columna dreta",
"unassign" => "desassigna",
"left" => "esquerra",
...
"Tip" => "Pista",
"Admin->Features" => "Admin->Característiques",
"%s enabled" => "%s activat",
...
"Trackers settings" => "Pàràmetres dels formularis",
"RSS feeds" => "Alimentació per RSS",
"RSS settings" => "Paràmetres de RSS ",
"Directory settings" => "Paràmetres del directori",
"Maps configuration" => "Configuració dels mapes",
"Search" => "Cercar",
"Search settings" => "Paràmetres de búsqueda",
"Score settings" => "Paràmetres de la puntuació",
"Projects" => "Projectes",
"Projects configuration" => "Configuració dels projectes",
"Community settings" => "Paràmetres de la comunitat",
"Site Identity" => "Identitat de la web",
"Site Identity features" => "Caràcterístiques de la identitat de la web",
...
"Welcome to %s at %s" => "Benvingut a %s a %s",
...
"Wiki page %s changed" => "Pàgina wiki %s canviada",
...
"Wiki page renamed" => "Pàgina wiki reanomenada",
"Old name" => "Nom antic",
"New name" => "Nou nom",
...
"Change settings" => "Canvia paràmetres",
...
"Size" => "Mida",
"Img" => "Imatge",
"User identity features" => "Característiques d'identitat de l'usuari",
"Picture" => "Dibuix",
"Number of friends" => "Nombre d'amics",
...
"Best language" => "Selecció del millor idioma",
...
"Site Logo and Identity" => "Logo i identitat de la web",
"Mobile" => "Mòbil",
...
"Redirect On Error" => "Redirecciona quan hi ha error",
...
"always" => "sempre",
"module decides" => "el mòdul decideix",
...
"Bottom bar icons" => "Icones de la barra inferior",
"Bottom bar debug" => "Depurador de la barra inferior",
...
"Change password" => "Canvia la contrasenya",
"Google Map setup" => "Configuració de Google Map",
"You need to request a Google Maps Key for this web site. You can easily generate a key for your domain at :" => "Cal demanar una clau de Google Maps per aquesta web. Podeu generar facilment una clau pel vostre domini a :",
"Google Map Key" => "Clau de Google Map",
"Default x for map center" => "X per defecte pel centre del mapa",
"Default y from map center" => "Y per defecte pel centre del mapa",
"Default zoom level" => "Nivell de zoom per defecte",
"whole earth" => "la Terra sencera",
"country size" => "mida país",
"city size" => "mida ciutat",
"max zoom" => "zoom màxim",
"Internationalization" => "Internacionalització",
"I18n setup" => "Configuració I18n",
...
"Case Insensitivity" => "Sensible a caixa",
"replace" => "substitueix",
...
"Male" => "Home",
"Female" => "Dona",
"use google map locator" => "utilitza el mapa localitzador de google",
