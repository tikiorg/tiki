...
// "Use antibot at registration" => "Use antibot at registration",
...
// "Note 2" => "Note 2",
// "If you assign modules to groups make sure that you have turned off the option " => "If you assign modules to groups make sure that you have turned off the option ",
// "Move Up" => "Move Up",
// "Move Down" => "Move Down",
...
// "Select tags in the list or put them separated by spaces." => "Select tags in the list or put them separated by spaces.",
...
"Lock this page" => "çBloqueja aquesta pàgian",
...
"Set language" => "Especifica language",
"Universal" => "Universal",
"Show the following languages" => "Mostra els següens idiomes",
...
"Override lock and carry on with edit" => "Ignora el bloqueig i continúa per editar",
