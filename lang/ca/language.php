...
"Return to HomePage" => "Torna a la pàgina d'Inici",
...
"Displays an image and allow the users to define zones to highlight information on the image" => "Mostra una imatge i permet als usuaris definir zones per ressaltar informació a la imatge",
...
"Your database requires an update to match the current TikiWiki version. Please proceed to <a href=\"tiki-install.php\">the installer</a>. Using Tiki with an incorrect database version usually provoke errors" => "La teva base de dades requereix una actualització per coincidir amb la versió actual de Tikiwiki. Si us plau, dirigeix-te a <a href=\"tiki-install.php\">l'instal·lador</a>. Emprar Tiki amb una versió de base de dades normalment provoca errors",
...
"Includes a list of articles within the page" => "Inclou una llista d'articles dins de la pàgina",
"The amount of articles to display in the list" => "La llista d'articles a mostrar de la llista",
"The ID of the category to list from" => "L'ID de la categoria des de la qual llistar el seu contingut",
"The article language to list" => "L'idioma de l'article a llistar",
...
"Maximum amount of entries to list" => "Número màxim d'entrades a llistar",
...
"for box with width lesser than 100%, make text wrap around the box" => "per a caixes amb amplada inferior al 100%, fes que el text envolti la caixa",
...
"left|right, for box with width lesser than 100%, make text wrap around the box" => "left|right, per a caixes amb amplada inferior al 100%, fes que el text envolti a la caixa",
...
"CSS Class to apply on the heading row" => "Classe CSS a aplicar a la fila de la capçalera",
...
"Ex" => "Ex",
"Delete events older than" => "Esborra esdeveniments més antics de",
"If no role is provided, default role will be \"Chair participant\"" => "Si no es proveeix cap rol, el rol per omissió serà \"Participant ras\"",
"No articles yet" => "Cap article encara",
"Focus:" => "Focus:",
...
"Please wait %d secondes between posts" => "Si us plau, espera %d segons entre publicacions",
...
"Puts the stuff between {ATTACH} tags as the link text instead of the file name or description" => "Ho encaixa entre les etiquetes {ATTACH} com a enllaç de text en lloc del nom del fitxer o la descripció",
...
"Class" => "Classe",
"CSS class of the fancylist" => "Classe CSS de la llista maca",
...
"Inserts a section for collected footnotes within the wiki page" => "Inserta una secció per a les notes al peu recollides dins de la pàgia wiki",
...
"Sticky" => "Enganxós",
"data" => "dades",
"Displays a SWF myspace mp3 playlist on the wiki page" => "Mostra una llista de reproducció mp3 de myspace tipus SWF a la pàgina wiki",
"Object" => "Objecte",
"Days" => "Dies",
...
"Go to Login Page" => "Ves a la pàgina de connexió",
...
"Default calendars to display" => "Calendaris per omissió a mostrar",
...
"View list begins" => "Llista de vista comença",
"Focus Date" => "Data d'interès",
"Period beginning" => "Inici del període",
...
"Manual selection of time/date" => "Selecció manual de dia/hora",
"JS calendar" => "Calendari JavaScript (JS)",
"Year selection is valid when the JS Calendar <strong>is not</strong> enabled" => "La selecció d'any és vàlida quan <strong>no s'ha activat</strong> el Calendari JavaScript (JS)",
"First year in the dropdown" => "Primer any al desplegable",
"Enter a year or use +/- N to specify a year relative to the current\n\tyear" => "Introdueix un any o empra +/- N per especificar un any relatiu a l'any \n\tactual",
"Last year in the dropdown" => "Darrer any al desplegable",
"Group calendars" => "Calendaris de grup",
"Sticky popup" => "Emergent enganxós",
"Item view tab" => "Pestanya de visualització d'ítem",
...
"User/IP" => "Usuari/a-IP",
"Sections" => "Seccions",
"Configure" => "Configura-ho",
"Admin Calendars" => "Administrar Calendaris",
"Create Calendar" => "Crea un Calendari",
"View Calendars" => "Visualitza els Calendaris",
...
"Create/Edit Calendars" => "Crea/Edita Calendaris",
...
"Default event status" => "Estatus per omissió dels esdeveniments",
"Show in calendar view" => "Mostra a la vissta de calendari",
"Group of users alerted when calendar event is modified" => "Grup d'usuaris notificats quan es modifica un esdeveniment del calendari",
...
"Details" => "Detalls",
"popup" => "emergent",
"You can view this gallery's configured image (first, random, etc.) in your browser using" => "Pots veure la imatge configurada d'aquesta galeria (primera, a l'atzar, etc.) en el teu navegador emprant",
"You can include the gallery's image in an HTML page using one of these lines" => "Pots incloure la imatge de la galeria en una pàgina HTML emprant una d'aquestes línies",
...
"Admin Calendar" => "Administra el Calendari",
"Export Calendars" => "Exporta Calendaris",
"Click to export calendars" => "Clica per exportar calendaris",
...
"View this Day" => "Visualitza aquest Dia",
"Calendar Item" => "Ítem del Calendari",
...
"On a weekly basis" => "En una base setmanal",
"Each" => "Cada",
"of the week" => "de la setmana",
"On a monthly basis" => "En una base mensual",
"of the month" => "del mes",
"On a yearly basis" => "En una base anual",
"There's no such date as" => "No hi ha una data com el",
"Starting on" => "Començant el",
"ending by" => "acabant el",
"ending after" => "acabant després de",
"events" => "esdeveniments",
"Start period" => "Període d'inici",
"End after" => "Acaba després de",
"occurrences" => "occurrències",
"End before" => "Acaba abans de",
"Event is repeated" => "L'esdeveniment és repetit",
"times" => "vegades",
"every" => "cada",
...
"Events cannot end before they start" => "Els esdeveniments no poden acabar abans que comencin",
"or new" => "o nou/va",
"Choose users to alert" => "Esculls els usuaris que hagin de ser notificats",
"Roles" => "Rols",
"chair" => "presideix",
...
"Update every unchanged events of this recurrence rule" => "Actualitzat tots els esdeveniments no modificats d'aquesta regla de recurrència",
"Update every events of this recurrence rule" => "Actualitza tots els esdeveniments d'aquesta regla de recurrència",
"Delete Recurrent events" => "Esborra esdeveniments recurrents",
"Calendar import" => "Importa calendari",
"Calendar has been updated" => "El calendari ha estat actualitzat",
"import" => "importa",
"Previous" => "Anterior",
"Avanced parameters for iCal export" => "Paràmetres avançats per a l'exportació iCal",
...
"Emails to be notified (separated with commas)" => "Correus-e que han de ser notificats(separats per comes)",
"From:" => "de part de:",
...
"text, bold" => "text, negreta",
"text, italic" => "text, cursiva",
"text, underline" => "text, subratlla",
"table" => "taula",
...
"Add image from File Gallery" => "Afegeix una imatge des d'una galeria d'arxius",
"quote" => "cita",
"Add Image from File Gallery" => "Afegeix una Imatge des d'una galeria d'arxius",
"special chars" => "caracters especials",
"special characters" => "caràcters especials",
"Leave Fullscreen Edit" => "Deixa l'edició a pantalla completa",
"Fullscreen Edit" => "Edició a pantalla completa",
