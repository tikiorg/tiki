...
// "No graphic library found." => "No graphic library found.",
...
// "Loading" => "Loading",
// "<span class=\"shortcut\">C</span>lose" => "<span class=\"shortcut\">C</span>lose",
// "<span class=\"shortcut\">N</span>ext" => "<span class=\"shortcut\">N</span>ext",
// "<span class=\"shortcut\">P</span>revious" => "<span class=\"shortcut\">P</span>revious",
...
// "You must install the lightbox library in lib/lightbox" => "You must install the lightbox library in lib/lightbox",
// "Shadowbox" => "Shadowbox",
...
"Macedonia" => "Macedònia",
"Republic_of_Macedonia" => "Macedònia",
"Mongolia" => "Mongòlia",
"Macao" => "Macau",
...
"Right &amp; left boxes" => "Requadres a la dreta &amp; esquerra",
...
"Your database has been configured and Tikiwiki is ready to run! {if isset(\$smarty.post.scratch)}If this is your first install, your admin password is <strong>admin</strong>.{/if} You can\n    \t\tnow log in into Tikiwiki as user <strong>admin</strong> and start configuring\n    \t\tthe application." => "La teva base de dades ha estat configurada i Tikiwiki està llest per funcionar! {if isset(\$smarty.post.scratch)}Si és la teva primera instal·lació, la teva contrasenya d'usuari admin (administrador) és <strong>admin</strong>.{/if} Ara pots connectar-te\n    \t\ta Tikiwiki com a usuari <strong>admin</strong> i començar a configurar\n    \t\tl'aplicació.",
...
"You have completed the TikiWiki {if isset(\$smarty.post.scratch)}installation{else}upgrade{/if}. Use one of these links to continue" => "Has completat la {if isset(\$smarty.post.scratch)}instal·lació{else}actualització{/if} de TikiWiki. Empra una d'aquests enllaços per continuar",
