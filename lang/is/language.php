...
"from" => "frá",
"edited the wikipage" => "breytti vefbókarsíðunni",
...
"Your edit session has expired" => "Setan er útrunnin",
...
"Last Modification" => "Síðast breytt",
"Filter" => "Sía",
"Template" => "Sniðmát",
"Days" => "Dagar",
"Date" => "Dagsetning",
...
"Approved" => "Samþykkt",
"Edit comments" => "Breyta athugasemdum",
"Spreadsheet" => "Töflureiknir",
"Edit Languages" => "Breyta tungumálum",
"View template" => "Skoða sniðmát",
"Edit template" => "Breyta sniðmáti",
"Admin Forums" => "Stýra málþingum",
"Create new forum" => "Stofna nýtt málþing",
"Duplicate forum" => "Tvífalda málþing",
"View this forum" => "Skoða málþing",
"Import forums" => "Flytja inn málþing",
"Age" => "Aldur",
"Create/Edit Forums" => "Stofna eða breyta málþingum",
...
"Fri" => "Fös",
"Sat" => "Lau",
"Add a translation" => "Bæta við þýðingu",
"Edit translations" => "Breyta þýðingu",
"Translation" => "Þýðing",
...
"Edit wiki page" => "Breyta vefbókarsíðu",
...
"Go Back" => "Til baka",
"Edit/Create" => "Breyta eða stofna",
"Distance (km)" => "Fjarlægð (km)",
"Reminders" => "Áminning",
"no reminders" => "engar áminningar",
"Edit Permissions" => "Breyta leyfum",
"Paste" => "Líma",
...
"Retry" => "Reyna aftur",
"Unzip zip files" => "Afþjappa zip skrár",
"Personal Information" => "Einstaklingsupplýsingar",
"Male" => "Maður",
"Female" => "Kona",
"Move into Trash" => "Sett í ruslið",
"Task saved" => "Verk vistað",
"Edit Forum" => "Breyta málþingi",
"Edit/Delete" => "Breyta eða eyða",
"close" => "loka",
"Complete Translation" => "Fullfrágengin Þýðing",
"Administration" => "Stjórnun",
"Permission denied you cannot edit this article" => "Ekki leyft, þú getur ekki breytt þessari grein",
