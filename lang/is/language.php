...
// "directory" => "directory",
// "faq" => "faq",
"file gallery" => "skráarsafn",
// "forum" => "forum",
"image gallery" => "myndasaafn",
// "newsletter" => "newsletter",
// "poll" => "poll",
// "quiz" => "quiz",
// "survey" => "survey",
...
"Temporary directory" => "Bráðabirgða skráarsafn",
...
"removed the file" => "fjarlægði skrá",
...
"<strong>Preview</strong> or <strong>Save</strong> your work to restart the edit session timer" => "<strong>Forskoðaðu</strong> eða <strong>Vistaðu</strong> verkið til að endurræsa klukkuna",
