...
"Creates a link to an anchor in a wiki page. Use in conjunction with the ANAME plugin, which specifies the location and name of the anchor" => "Plaats een koppeling naar een anker in een wiki pagina. Gebruik in combinatie met de ANAME plugin die de locatie en naam van het anker bepaald",
"linktext" => "tekst van koppeling",
"Creates an anchor in a wiki page. Use in conjunction with the ALINK plugin, which specifies a link to the anchor" => "Plaats een anker in een wiki pagina. Gebruik in combinatie met de ALINK plugin die de koppeling naar het anker voorziet",
"Field" => "Veld",
"Attachment" => "Bijlage",
"File" => "Bestand",
...
"username" => "gebruikernaam",
"Back" => "Terug",
"List all pages that link to specific pages" => "Toon alle pagina's die naar specifieke pagina's verwijzen",
...
"Insert list of items with the current/given category in the wiki page" => "Voeg lijst van items voor de huidige categorie toe aan de wiki pagina",
...
"Date" => "Datum",
"sort" => "sorteer",
"Displays a Flash (.swf) file in the wiki page" => "Toont een SWF in de wiki pagina",
"Blog Posts" => "Blogbijdragen",
"all" => "alle",
...
"Displays a module inline in a wiki page" => "Toon de module in de pagina",
...
"Information" => "Informatie",
"Table" => "Tabel",
"Displays a list of plugins available in this wiki." => "Geeft een lijst van plugins voor dit wiki.",
"Poll" => "Opiniepeiling",
