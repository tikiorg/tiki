<?php
   ...
   $link2 = new HAW_link(reconvert_html_entities(tra("Wiki")),"tiki-index.php?mode=mobile");
   $link3 = new HAW_link(reconvert_html_entities(tra("Blog")),"tiki-list_blogs.php?mode=mobile");
