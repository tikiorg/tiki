...
{if $haspdflib}
	<input type="submit" class="btn btn-default btn-sm" name="renderer" value="PDF">
{/if}
{if $hasps}
	<input type="submit" class="btn btn-default btn-sm" name="renderer" value="PS">
{/if}
</div>
{/if}
{if $hasgd}
<div>
	...
	<input type="submit" class="btn btn-default btn-sm" name="renderer" value="PNG">
	<input type="submit" class="btn btn-default btn-sm" name="renderer" value="JPEG">
</div>
{/if}
</form>
{/if}
...
{/section}
	<tr>
		<td colspan="2"><input type="submit" class="btn btn-default btn-sm" value="{tr}Show{/tr}" class="button"></td>
	</tr>
</table>
