var FileGallery = {
	...
	open: function(url, form, post) {
		...
		if (this.dialogmode) {
			jQuery('#fg-jquery-dialog').dialog({
				autoOpen: false,
				width: 702,
				modal: false,
				resizable: false,
	...
	editGallery: function(url) {
		jQuery("#fg-jquery-gallery-dialog").load(url, function() {
...
//			jQuery("#fg-jquery-gallery-dialog").dialog('option','height','auto');
//			jQuery("#fg-jquery-gallery-dialog").dialog('option','width','504');
			jQuery("#fg-jquery-gallery-dialog").dialog('open');
		});
	},
