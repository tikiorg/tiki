...
{if $user}
  ...
  <a class="separator" href="javascript:icntoggle('mymenu');"><img src="img/icons/{$icn_mymenu}fo.gif" name='mymenuicn' class='fldicn' alt='{tr}MyMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_workflow eq 'y' and $tiki_p_use_workflow eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('wfmenu');"><img src="img/icons/{$icn_workflow}fo.gif" name='wfmenuicn' alt='{tr}WfMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_friends eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('friendsmenu');"><img src="img/icons/{$icn_friendsmenu}fo.gif" name='friendsmenuicn' alt='{tr}FriendsMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_wiki eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('wikimenu');"><img src="img/icons/{$icn_wikimenu}fo.gif" name='wikimenuicn' alt='{tr}WikiMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_galleries eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('galmenu');"><img src="img/icons/{$icn_galmenu}fo.gif" name='galmenuicn' alt='{tr}GalMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_articles eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('cmsmenu');"><img src="img/icons/{$icn_cmsmenu}fo.gif" name='cmsmenuicn' alt='' /></a>&nbsp;
...
{if $prefs.feature_blogs eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('blogmenu');"><img src="img/icons/{$icn_blogmenu}fo.gif" name='blogmenuicn' alt='' /></a>&nbsp;
...
{if $prefs.feature_forums eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('formenu');"><img src="img/icons/{$icn_formenu}fo.gif" name='formenuicn' alt='{tr}ForMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_directory eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('dirmenu');"><img src="img/icons/{$icn_dirmenu}fo.gif" name='dirmenuicn' alt='{tr}DirMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_file_galleries eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('filegalmenu');"><img src="img/icons/{$icn_filegalmenu}fo.gif" name='filegalmenuicn' alt='{tr}FileGalMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_faqs eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('faqsmenu');"><img src="img/icons/{$icn_faqsmenu}fo.gif" name='faqsmenuicn' alt='' /></a>&nbsp;
...
{if $prefs.feature_maps eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('mapsmenu');"><img src="img/icons/{$icn_mapsmenu}fo.gif" name='mapsmenuicn' alt='' /></a>&nbsp;
...
{if $prefs.feature_quizzes eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('quizmenu');"><img src="img/icons/{$icn_quizmenu}fo.gif" name='quizmenuicn' alt='{tr}QuizMenu{/tr}' /></a>&nbsp;
  ...
  &nbsp;<a href="tiki-edit_quiz.php" class="linkmenu">{tr}Admin Quizzes{/tr}</a><br />
  {/if}
  </div>
{/if}
...
{if $prefs.feature_sheet eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('shtmenu');"><img src="img/icons/{$icn_shtmenu}fo.gif" name='shtmenuicn' alt='{tr}ShtMenu{/tr}' /></a>&nbsp;
  {else}<a class="separator" href="javascript:toggle('shtmenu');">[-]</a>{/if} 
  <a href="tiki-sheets.php" class="separator">{tr}TikiSheet{/tr}</a>
  {if $prefs.feature_menusfolderstyle ne 'y'}<a class="separator" href="javascript:toggle('shtmenu');">[+]</a>{/if}
  </div>
...
{if $prefs.feature_trackers eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('trkmenu');"><img src="img/icons/{$icn_trkmenu}fo.gif" name='trkmenuicn' alt='{tr}TrkMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_surveys eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('srvmenu');"><img src="img/icons/{$icn_srvmenu}fo.gif" name='srvmenuicn' alt='{tr}SrvMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_newsletters eq 'y' && ($tiki_p_subscribe_newsletters eq 'y' || $tiki_p_admin_newsletters eq 'y' || $tiki_p_send_newsletters eq 'y')}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('nlmenu');"><img src="img/icons/{$icn_nlmenu}fo.gif" name='nlmenuicn' alt='' /></a>&nbsp;
...
{if $prefs.feature_events eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('evmenu');"><img src="img/icons/{$icn_evmenu}fo.gif" name='evmenuicn' alt='' /></a>&nbsp;
...
{if $feature_eph eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('ephmenu');"><img src="img/icons/{$icn_ephmenu}fo.gif" name='ephmenuicn' alt='{tr}EphMenu{/tr}' /></a>&nbsp;
...
{if $prefs.feature_charts eq 'y'}
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('chartmenu');"><img src="img/icons/{$icn_chartmenu}fo.gif" name='chartmenuicn' alt='{tr}ChartMenu{/tr}' /></a>&nbsp;
...
{if $tiki_p_admin eq 'y' or 
 ...
 $tiki_p_admin_users eq 'y'
  ...
  <div class="separator">
  {if $prefs.feature_menusfolderstyle eq 'y'}
  <a class="separator" href="javascript:icntoggle('admmnu');"><img src="img/icons/{$icn_admmnu}fo.gif" name='admmnuicn' alt='{tr}AdmMenu{/tr}' /></a>&nbsp;
  ...
  {sortlinks}
    ...
    {/if}
    {if $prefs.feature_drawings eq 'y' and $tiki_p_admin_drawings eq 'y'}
  ...
  <div class="separator">
    ...
    {if $prefs.feature_menusfolderstyle eq 'y'}
      <a class="separator" href="javascript:icntoggle('usrmenu');">
        <img src="img/icons/{$icn_usrmenu}fo.gif" name="usrmenuicn" alt='{tr}UsrMenu{/tr}' /></a>&nbsp;
    {else}
