...
<table border="1" >
  ...
  <tr>
  <td><input type="radio" name="use" value="useFixedURL" {if $use eq 'useFixedURL'}checked="checked"{/if}/></td>
...
<td class="{cycle}"><a class="link" href="tiki-edit_banner.php?removeZone={$zones[ix].zone}">{icon _id='cross' alt='{tr}Remove{/tr}'}</a></td>
</tr>
{/section}
</table>
</div>
