...
"Edit succesful!" => "העריכה התבצעה בהצלחה",
...
"Cannot get file from URL" => "טעינת קובץ מכתובת URL נכשלה",
...
"password for this account is" => "הסיסמה לחשבון זה היא:",
"Blog settings" => "העדפת בלוגים",
"FAQs settings" => "העדפת שאלות נפוצות (FAQ)",
"FAQ comments" => "העדפת הערות שאלות נפוצות",
...
"next" => "הבא",
"View Comments" => "הצגת הערות",
"Add a subscription newsletters" => "הוספת מנוי לידיעון",
...
"Please see <a href=\"http://doc.tikiwiki.org/\">the documentation</a> for more information" => "על מנת לקבל פרטים נוספים נא הסתכל על <a href=\"http://doc.tikiwiki.org/\">הוראות ההפעלה</a>",
...
"Test mail from Tiki installer " => "הודעת בדיקה ממערכת ההתקנה של טיקי ",
...
"Template %s not registered" => "תבנית %s לא רשומה",
...
"User location saved for " => "מיקום המשתמש נשמר על ",
...
"Numeric ID of a File Gallery. Displays a random image from that gallery" => "הזיהוי של גלרית קובץ. הציגה תמונות באופן אקראי מספריה זו.",
...
"Freetags Wiki" => "תגיות חופשיות ויקי",
...
// "Website" => "Website",
"Rate this Article (10=best, 0=worse)" => "דרג את המאמר (10=הגבוה ביותר,0=הנמוך ביותר)",
...
"Gallery is visible to non-admin users" => "הספריה אינה גלויה בפני משתמשים שאינם מנהלים",
...
"There are no wiki pages similar to '{\$page}'" => "אין דף דומה ל '{\$page}'",
...
"Welcome on the site" => "ברוכים הבאים לאתר",
...
"Minimum {\$prefs.min_pass_length} characters long" => "{\$prefs.min_pass_length} מינימום תווים",
...
"Left Modules" => "טור שמאל מודולים",
"Move Up" => "הזז למעלה",
"Move Down" => "הזז למטה",
"Move to Right Column" => "מעבר לטור הימנית",
"Right Modules" => "טור ימון מודולים",
...
"Included group, group users and emails will be refreshed at each newsletter sending" => "קבוצה מתחתיה, קבוצת משתמשים וכתובות דוא''ל ירועננו עם כל שליחת ניוזלטר",
...
"New tracker field" => "שדה עוקב חדש",
...
"Description text is wiki-parsed" => "טקסט התיאור הוא מדובלל-ויקי",
...
"Edit This Tracker's Fields" => "עריכת שדות של העוקב",
"trackers" => "עוקבים",
"Items" => "פריטים",
"with" => "עם",
"Edit Tracker" => "עריכת עוקב",
"Create Tracker" => "צור עוקב",
"Create/Edit Tracker" => "צור/עריכת עוקב",
"Auto create corresponding categories" => "יצירה אוטומטית של הקטגוריות המקבילה",
...
"Show status to tracker admin only" => "הצג מצבי העוקב למנהל בלבד",
"Send copies of all activity in this tracker to this e-mail address" => "שלח עותקים של כל פעילות עוקב זה לכתובת דואר אלקטרוני זה",
...
"New items are created with status" => "פריטים חדשים נוצרים עם מצב",
"Authoritative status for modified items" => "מצב סמכותי עבור פריטים לאחר שינוי",
"No change" => "ללא שינוי",
"Item creator can modify his items" => "יוצר פריט יכול לשנות פריטים שלו",
"The tracker needs a user field with the option 1" => "העוקב צריך שדה משתמש עם אפשרות אחת",
...
"The tracker needs a user or IP field with the option 1" => "העוקב צריך שדה משתמש או IP עם אפשרות אחת",
"Member of the creator group can modify items" => "חבר בקבוצת היוצר יכול לשנות פריטים",
"The tracker needs a group field with the option 1" => "העוקב צריך שדה קבוצה עם אפשרות אחת",
"Format if not the default short one" => "הכנס פורמט או השתמש בברירת מחדל המקוצר",
"Show creation date when viewing tracker item" => "הצג תאריך יצירת כאשר צופיפ פריט בעוקב",
"Identify creation user in tracker item" => "זיהוי משתמש היוצר בפריט העוקב",
"Show lastModif date when viewing tracker item" => "הצג תאריך שינוי אחרון כאשר צופים בפריט העוקב",
"Identify lastModif user in tracker item" => "זיהוי משתמש האחרון ששינה הפריט בעוקב",
"What field is used for default sort" => "מה השדה המשמש למיון כברירת מחדל",
"What is default sort order in list" => "מה סדר ברירת המחדל ברשימה",
"Tracker items allow ratings" => "אשר את האפשרות לדרג את פירטי העוקב",
"with values" => "מהערכים שלפניך",
"and display rating results in listing" => "הצג את תוצאות הדירוג ברשימת הפריטים",
"and display comments in listing" => "הצג הערות ברשימת הפריטים",
"and display last comment user/date" => "הצג המשתמש שכתב את ההודעה האחרונה",
"and display attachments in listing" => "הצג קבצים מצורפים ברשימת הפריטים",
"Attachment display options (Use numbers to order items, 0 will not be displayed, and negative values display in popups)" => "אפשרויות תצוגה לקובץ מצורף (השתמש במספרים על מנת לדרג את פירטי הקובץ, פריטים עם הסיפרה 0 לא יוצגו,  פריטים עם מקף לפני המספר יוצגו בחלונית)",
"Filetype" => "סוג קובץ",
"LongDesc" => "תאור רגיל",
"Items can be created only during a certain time" => "פריטים יכולים להיווצר רק משך זמן מסוים",
"Do not show empty fields in item view" => "אל תציג שדות ריקים בתצוגת הפריט",
"Show these fields (ID comma separated) in a popup on item link when listing tracker items" => "הצג השדות האלו (ID comma separated) בחלונית מעל הקישור המוביל אל הפריט ברשימת פירטי העוקב",
// "Group of users alerted when tracker is modified" => "Group of users alerted when tracker is modified",
"Wiki page to display an item" => "השתמש בדף ויקי על מנת להציג פריט",
...
"Status changes" => "שינוים במעמד",
"After creation" => "לאחר יצירה",
"After last modification" => "לאחר השינוי האחרון",
"Warn creator of an upcoming status change" => "הזהר את היוצר משינוי מעמד בקרוב",
"before" => "ליפני",
...
"Validate user" => "אימות המשתמש",
"Confirm user email" => "אשר דוא''ל המשתמש",
...
"Show Help" => "הצג עזרה",
"Article type" => "סוג מאמר",
"Shows up in the drop down list of article types" => "הצג תפרית מתגלגל מסוגי המאמרים",
"Allow ratings by the author" => "אפשר דירוגים על ידי המחבר",
"Show before publish date" => "הצג לפני תאריך פרסום",
"non-admins can view before the publish date" => "משתמשים יכולים לקרוא לפני תאריך פרסום",
"Show after expire date" => "הצג לאחר תאריך פג תוקף",
"non-admins can view after the expire date" => "משתמשים יכולים לקרוא לאחר פג תוקף",
"Heading only" => "מבוא בלבד",
"No article body, heading only" => "ללא תוכן, מבוא בלבד",
"Allow comments for this type" => "אפשר הערות לסוג זה",
"Comment Can Rate Article" => "המגיב יכול לדרג מאמר",
"Allow comments to include a rating value" => "אפשר דירוג בהודעות",
"Show image" => "הצג תמונה",
"Show topic or own image" => "הצג תמונת הנושא או תמונה שנוספה",
"Show avatar" => "הצג דמות מייצגת",
"Show author's avatar" => "הצג דמות מייצגת של הבתב",
"Show author" => "הצג המחבר",
"Show author name" => "הצג שם המחבר",
"Show publish date" => "הצג תאריך פרסום",
"Show expire date" => "הצג תאריך פג תוקף",
"Show reads" => "הצג מספר קריאות",
"Show the number of times the article was read" => "הצג את מספר הפעמים שהמאמר נקרא",
"Show size" => "הצג גודל",
"Show the size of the article" => "הצג בגודל המאמר",
"Show topline" => "הצג כותרת על",
"Show a small title over the title" => "הצג כותרת קטנה מעל הכותרת",
"Show subtitle" => "הצג תת כותרת",
"Show the subtitle" => "הצג התת כותרת",
"Show source" => "הצג מקור המאמר",
"Show link to source after article body" => "הצג הקישור למקור אחרי גוף המאמר",
"Show Image Caption" => "הצג תאור התמונה",
"Show a legend under the image" => "הצג תאור מתחת לתמונה",
"Show Language" => "הצג שפה",
"Show the language" => "הצג את השפה",
"Creator can edit" => "היוצר יכול לערוך",
"The person who submits an article of this type can edit it" => "יוצר מאמר מסוג זה יכול לערוך אותו",
"Actions on this article type" => "הפעולות האפשריות לסוג מאמר זה",
"List of article types" => "רשימת סוגי המאמרים",
"view articles with this type" => "צפה במאמרים מסוג זה",
// "Classified" => "Classified",
"Show lang" => "הצג שפה",
// "Custom attribute" => "Custom attribute",
"Create a new type" => "יצירת סוג חדש",
...
"Assign User {\$assign_user|escape} to Groups" => "הקצאת למשתמש {\$assign_user|escape} בקבוצות",
...
"for this edit session" => "עריכה זו",
...
"Edit a topic" => "ערוך נושא",
"Add Notification Email" => "הוסף דוא''ל למעקב",
...
"If an object is not listed in the section below, then only the global perms are on" => "אם אובייקט אינו מופיע בסעיף שלהלן, רק הרשאות גלובלית עליו",
...
"Advanced Search Help" => "עזרה לחיפוש מתקדם",
...
"The link was posted on your facebook wall" => "הקישור פורסמה על הקיר הפייסבוק שלך",
...
"Authorize with twitter first" => "להסמיך עם טוויטר",
// "Have a look at " => "Have a look at ",
"Put on my facebook wall" => "לשים על הקיר הפייסבוק שלי",
"Authorize with facebook first" => "להסמיך עם פייסבוק",
...
"Separate multiple recipients with a comma" => "באפשרותך להפריד נמענים רבים באמצעות שימוש בפסיקים",
...
"twitter authorisation" => "הסמכת טוויטר",
"to manage your authorisations at twitter" => "כדי לנהל את ההסמכות שלך בטוויטר",
"this site with twitter.com to use twitter integration of this site" => "אתר זה להשתמש באינטגרצית טוויטר",
...
"facebook authorisation" => "הסמכת פייסבוק",
"to manage your authorisations at facebook" => "כדי לנהל את ההסמכות שלך בפייסבוק",
"this site with facebook.com to use twitter integration of this site" => "אתר זה להשתמש באינטגרצית פייסבוק",
...
"Male" => "זכר",
"Female" => "נקבה",
"Use Google Map locator" => "השתמש בגוגל מפ",
...
"Detect user timezone if browser allows, otherwise site default" => "זיהוי אזור זמן המשתמש אם הדפדפן מאפשר, אחרת להשתמש בריחת מחדל באתר",
...
"Save the page as a draft" => "שמור הדף כטיוטא",
"Save Draft" => "שמור טיוטא",
// "%0 enabled" => "%0 enabled",
...
"New %s created with %s %s" => "%s חדש מיוצר אם‫ s%‬ %s",
...
"Top Visited FAQs" => "שאלות ותשובות נצפות ביותר",
"User Blogs" => "בלוגים",
...
"Found" => "החיפוש מצא",
"Show creation date when listing tracker items?" => "הצג תאריך היצירה ברשימת הפריטים",
"Show lastModif date when listing tracker items?" => "הצג תאריך שינוי אחרון ברשימת הפריטים",
...
"Edit New Submissions" => "הצעה חדשה",
