...
// "If Pagination is set to y (Yes), this will determine the amount of artilces per page" => "If Pagination is set to y (Yes), this will determine the amount of artilces per page",
...
// "Enter a category ID to filter list by a certain category" => "Enter a category ID to filter list by a certain category",
...
// "feature custom doctype content" => "feature custom doctype content",
