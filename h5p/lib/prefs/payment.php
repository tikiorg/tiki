...
function prefs_payment_list()
{
	return array(
		...
		'payment_manual' => array(
			'name' => tra('Wiki page containing instructions to send a manual payment such as a check'),
		...
		'payment_user_only_his_own' => array(
			'name' => tra('The user can only see his or her own outstanding payments'),
		...
		'payment_user_only_his_own_past' => array(
			'name' => tra('The user can only see his or her own past or cancelled payments'),
		...
		'payment_cart_giftcerttemplate_fieldname' => array(
			...
			'description' => tra('In the products tracker, the name of the field for the Gift Cert Template, needed for the Gift Certificates cart feature.'),
			'type' => 'text',
			'default' => '',
		),
		'payment_cart_orders' => array(
			'name' => tra('Record cart orders in trackers (registered users)'),
			'description' => tra('This feature requires two trackers to be created and configured, an Orders tracker and an Orders Item tracker. Profiles also need to be configured, to do the recording.'),
			'type' => 'flag',
		...
		'payment_cart_anonymous' => array(
			'name' => tra('Allow anonymous shopping and record the orders in trackers'),
			'description' => tra('Allows shopping by anonymous users'),
			'help' => 'Shopping Cart',
		...
		'payment_cart_associatedevent' => array(
			'name' => tra('Allow association of product orders with events (or projects, etc.)'),
