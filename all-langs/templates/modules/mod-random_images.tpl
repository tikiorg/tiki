...
{tikimodule title=$tpl_module_title name="random_images" flip=$module_params.flip decorations=$module_params.decorations nobox=$module_params.nobox notitle=$module_params.notitle}
  ...
  {if $module_params.showdescription eq 'y'}<div class="description">{$img.description}</div>{/if}
  </div>
  {/tikimodule}
{/if}
