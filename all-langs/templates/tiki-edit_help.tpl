...
<tr><td class="{cycle advance=false}"><strong>{tr}Tables{/tr}</strong></td><td class="{cycle}"> "||{tr}row{/tr}1-{tr}col{/tr}1|{tr}row{/tr}1-{tr}col{/tr}2|{tr}row{/tr}1-{tr}col{/tr}3<br />{tr}row{/tr}2-{tr}col{/tr}1|{tr}row{/tr}2-{tr}col{/tr}2|{tr}row{/tr}2-{tr}col{/tr}3||" {tr}creates a table{/tr}</td></tr>
{else}
...
<tr><td class="{cycle advance=false}"><strong>{tr}Dynamic content{/tr}</strong></td><td class="{cycle}"> "{literal}{{/literal}content id=n}" {tr}Will be replaced by the actual value of the dynamic content block with id=n{/tr}</td></tr>
<tr><td class="{cycle advance=false}"><strong>{tr}Dynamic variables{/tr}</strong></td><td class="{cycle}"> "%{tr}Name{/tr}%" {tr}Inserts an editable variable{/tr}</td></tr>
