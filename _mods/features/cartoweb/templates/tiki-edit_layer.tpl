<h1><a class="pagetitle" href="tiki-edit_layer.php">{tr}Edit or create layers{/tr}</a></h1>
<a class="linkbut" href="tiki-list_layers.php?mapId={$mapId}">{tr}List layers{/tr}</a><br /><br />
<form action="tiki-edit_layer.php" method="post" enctype="multipart/form-data">
