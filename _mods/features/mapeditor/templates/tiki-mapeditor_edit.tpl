<h1><a class="pagetitle" href="tiki-mapeditor_edit.php">{tr}Edit or create maps{/tr}</a></h1>
<a class="linkbut" href="tiki-mapeditor_maps.php">{tr}List maps{/tr}</a><br /><br />
<form action="tiki-mapeditor_edit.php" method="post" enctype="multipart/form-data">
