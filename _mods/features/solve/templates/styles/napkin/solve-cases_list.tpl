{* @version $Id: solve-cases_list.tpl,v 1.3 2005-10-11 13:10:45 michael_davey Exp $ *}
        ...
        <tr>
          <td style="width: 80%">
            <table style="width: 100%;" border="0" cellspacing="1" cellpadding="1" class="tabForm">
              <tr>
                {foreach from=$queryfields key=key item=value name=list}
                  <td style="width: 20%;">{$value.label}</td>
                  <td style="width: 25%;">{$value.formfield}</td>
