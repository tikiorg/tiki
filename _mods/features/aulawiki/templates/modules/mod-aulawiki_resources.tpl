...
*}
{tikimodule title={tr}Resources{/tr} name="aulawiki_resources" flip=$module_params.flip decorations=$module_params.decorations}
...
{*     <td class="formcolor">{tr}Category:{/tr}<br/><input name="createObjectCategoryName" type="text" id="createObjectCategoryName" value="" size="30" maxlength="100"></td>*}
    ...
    <tr> 
     ...
     <tr> 
      ...
      <td class="formcolor">{include file="aulawiki-resource_types.tpl" value=$resource.type listName="createObjectType" multiple="false" showlabel="false" listsize="1"} 
      </td>
    </tr>
...
<a class="edubutton" href="#" onclick="document.getElementById('createForm').style.display = 'block';"><img border=0 src="images/aulawiki/pageNueva.gif"/> New</a>
<a class="edubutton" href="#" onclick="document.getElementById('pasteIdCateg').value='{$selectedCategory.categId}';document.getElementById('pasteForm').submit();"><img border=0 src="images/aulawiki/edu_paste.gif"/> Paste</a>
...
<td>
{include file="aulawiki-list_resources.tpl" resources=$categObjects viewType="y" viewDesc="n"} 
</td>
</tr>
</table>
{/tikimodule}
