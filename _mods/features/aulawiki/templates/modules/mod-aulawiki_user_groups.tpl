...
*}
{tikimodule title={tr}UserGroups{/tr} name="user_groups" flip=$module_params.flip decorations=$module_params.decorations}
...
<div class="eduerror">
<img src='images/aulawiki/edu_stop.gif' align="middle"/>
