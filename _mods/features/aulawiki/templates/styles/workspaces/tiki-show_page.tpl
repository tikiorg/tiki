{* $Header: /cvsroot/tikiwiki/_mods/features/aulawiki/templates/styles/workspaces/tiki-show_page.tpl,v 1.3 2007-03-03 08:52:06 jreyesg Exp $ *}
...
{if $print_page ne 'y'}
	...
	{include file="tiki-workspaces_copy_to_clipboard.tpl" copyIdObj=$page copyType="wiki page" copyName=$page copyDesc=$description copyHref="./tiki-index.php?page=$page"} 
