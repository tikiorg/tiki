...
<select name="country">
  ...
  <tr><td class="form">{tr}Your personal tracker information{/tr}:</td><td class="form">
	...
	{/if}
  <tr>
  <td class="form">{tr}Personal Learning Folder{/tr}:</td>
  <td class="form">
    <img src="images/aulawiki/edu_workspace.png"> <a class="link" href="aulawiki-workspace_desktop.php?workspaceCode=PWS{$userinfo.login}">{$userinfo.login} {tr}Personal portfolio{/tr}</a>
  </td>
  </tr>
  {* Custom fields *}
