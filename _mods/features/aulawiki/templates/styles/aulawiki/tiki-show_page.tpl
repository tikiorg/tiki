{* $Header: /cvsroot/tikiwiki/_mods/features/aulawiki/templates/styles/aulawiki/tiki-show_page.tpl,v 1.1 2006-04-25 18:31:33 jreyesg Exp $ *}
...
{include file="aulawiki-copy_to_clipboard.tpl" copyIdObj=$page copyType="wiki page" copyName=$page copyDesc=$description copyHref="./tiki-index.php?page=$page"} 
...
{/if}
{*
{include_php file="aulawiki-include_category.php" var1="hola"}
*}
