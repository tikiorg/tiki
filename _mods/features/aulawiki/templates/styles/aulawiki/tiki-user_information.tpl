...
{/if}
  ...
  <td class="form">&nbsp;</td>
  <td class="form">
    <img src="images/aulawiki/edu_workspace.png"> <a class="link" href="aulawiki-workspace_desktop.php?workspaceCode=PWS{$userinfo.login}">{tr}Personal portfolio{/tr}</a>
  </td>
  </tr>
  </table>
  </form>
