...
<form name="form1" method="post" action="aulawiki-workspace_types_resources.php">
  ...
  <table class="normal">
    <tr> 
      ...
      <td class="formcolor"><a href="aulawiki-workspace_types.php?edit={$wstype.id}">({$wstype.code}) {$wstype.name}</a></td>
    </tr>
    <tr> 
    ...
    <td class="formcolor">
		{include file="aulawiki-resource_types.tpl" value=$resource.type listName="type" multiple="false" showlabel="false" listsize="10"} 
	</td>
	</tr>
