...
$resource = $categUtil->get_category_object($workspace["categoryId"], $_REQUEST["name"], $type);
...
$resource = $categUtil->get_category_object($workspace["categoryId"], $workspace["code"]."-".$_REQUEST["name"], $type);
