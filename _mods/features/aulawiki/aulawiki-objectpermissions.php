...
* Based on:
* */
// $Header: /cvsroot/tikiwiki/_mods/features/aulawiki/aulawiki-objectpermissions.php,v 1.1 2006-04-25 18:31:32 jreyesg Exp $
...
}elseif($_REQUEST["objectType"]=="faq"){
	$admin_perm_name = "tiki_p_admin_faqs";
...
$smarty->assign('mid', 'aulawiki-objectpermissions.tpl');
