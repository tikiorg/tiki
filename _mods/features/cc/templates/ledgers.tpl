...
<th align=left><a class="tableheading" href="cc.php?page=ledgers&amp;sort_mode=acct_id_{if $sort_mode eq 'acct_id_desc'}asc{else}desc{/if}{if $userid}&amp;user={$userid}{/if}{if $ccid}&amp;cc={$ccid}{/if}">{tr}User{/tr}</a></th>
<th align=left><a class="tableheading" href="cc.php?page=ledgers&amp;sort_mode=cc_id_{if $sort_mode eq 'cc_id_desc'}asc{else}desc{/if}{if $userid}&amp;user={$userid}{/if}{if $ccid}&amp;cc={$ccid}{/if}">{tr}Currency{/tr}</a></th>
