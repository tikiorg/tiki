...
<div class="dircategs">
<table  width="100%" cellspacing=8 cellpadding=6 bgcolor=#EFEFEF >
    <tr>
...
<span class="dirsitetrail">{tr}. . . URL{/tr}: {$items[ix].url} </span>
<br/>
<span class="dirsitetrail">{tr}. . . Added{/tr}: {$items[ix].created|tiki_short_date} {tr}Last updated{/tr}: {$items[ix].lastModif|tiki_short_date} {tr}Hits{/tr}: {$items[ix].hits}</p></span>
</div>
{/section}
</div>
<br/>
