<a class="pagetitle" href="tiki-search_stats.php">{tr}Search Statistics{/tr}</a>
...
<br/><br/>
<a class="linkbut" href="tiki-search_stats.php?clear=1">[{tr}Clear statistics{/tr}]</a><br/><br/>
