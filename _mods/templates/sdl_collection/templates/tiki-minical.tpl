...
<tr>
	<td class="{cycle}">
    	...
    	[<a class="link" href="tiki-minical.php?view={$view}&amp;remove={$slots[ix].events[jj].eventId}">Delete</a>]
    	<br />
    	{/section}
    	</td>
    	</tr>
...
<table class="normal">
<tr>
<td class="heading"><input type="submit" name="delete" value={tr}"Delete"{/tr}/></td>
