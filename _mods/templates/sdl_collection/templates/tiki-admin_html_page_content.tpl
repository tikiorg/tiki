...
<td class="odd">
   <a class="link" href="tiki-admin_html_page_content.php?pageName={$pageName|escape:"url"}&amp;offset={$offset}&amp;sort_mode={$sort_mode}&amp;zone={$channels[user].zone}"><img alt="{tr}Edit{/tr}" src="img/icons/edit.gif" border="0" /></a>
</td>
</tr>
{else}
<tr>
...
<td class="even">
   <a class="link" href="tiki-admin_html_page_content.php?pageName={$pageName|escape:"url"}&amp;offset={$offset}&amp;sort_mode={$sort_mode}&amp;zone={$channels[user].zone}"><img alt="{tr}Edit{/tr}" border="0" src="img/icons/edit.gif" /></a>
</td>
</tr>
{/if}
{/section}
