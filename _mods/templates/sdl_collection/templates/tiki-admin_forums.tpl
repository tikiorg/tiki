<a class="pagetitle" href="tiki-admin_forums.php">{tr}Admin Forums{/tr}</a>
...
<a href="tiki-edit_templates.php?template=templates/tiki-admin_forums.tpl" target="tikihelp" class="tikihelp" title="{tr}View tpl{/tr}: {tr}admin forums tpl{/tr}"><img border="0"  alt="{tr}Edit template{/tr}" src="img/icons/info.gif" /></a><br /><br />
{/if}
...
<a href="tiki-admin_forums.php" class="linkbut">[{tr}Create new forum{/tr}]</a><br />
{else}
<h2>{tr}Create New Forum{/tr}</h2>
{/if}
{if $individual eq 'y'}
<a class="link" href="tiki-objectpermissions.php?objectName=forum%20{$name}&amp;objectType=forum&amp;permType=forums&amp;objectId={$forumId}">[{tr}There are individual permissions set for this forum{/tr}]</a><br />
{/if}
...
<table class="normal">
<tr align="right">
<td class="heading" align="left"><a class="tableheading" href="tiki-admin_forums.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'name_desc'}name_asc{else}name_desc{/if}">{tr}Name{/tr}</a></td>
...
<td class="heading"><a class="tableheading" href="tiki-admin_forums.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'comments_desc'}comments_asc{else}comments_desc{/if}">{tr}Comments{/tr}</a></td>
