<?php
// $Header: /cvsroot/tikiwiki/_mods/lib/html2pdf/index.php,v 1.1 2008-01-15 09:21:06 mose Exp $
...
<span class="formw">
<input class="nulinp" type="radio" id="ps" name="method" value="fastps"/>PostScript&nbsp;&nbsp;<label for="pdf">&nbsp;</label>
...
<div class="form-row">
<label class="hand" for="ps"><span class="labl">PDF compatibility level:</span></label>
<span class="formw">
...
<input class="nulinp" type="checkbox" id="compr" name="compress" value="1"/>Compress output file using GZIP<label for="compr1">&nbsp;&nbsp;</label><br />
</span>
</div>
