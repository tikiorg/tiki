...
<div align="center"></div></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td id="page28" width="10" border="0" cellspacing="0" cellpadding="0" height="100%"><img src="styles/greenmetal/page_0.gif" width="10" height="1" alt="" border="0" /></td>
...
<a href="{$tikiIndex}" class="linkmenu">{tr}Return to home page{/tr}</a>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="46" id="page31"><img src="styles/greenmetal/page_0.gif" width="46" height="29" alt="" border="0" /></td>
