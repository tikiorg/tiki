{* $Header: /cvsroot/tikiwiki/_mods/themes/planetfall/theme/templates/styles/planetfall/tiki-show_page.tpl,v 1.1 2006-02-04 09:27:30 chibaguy Exp $ *}
{* Added a 10px-wide td to right side of wikitopline table for Planetfall theme to compensate for IE margin trouble. -- chibaguy. *}
...
</td><td width="10"> {* couldn't otherwise get IE to give proper right margin -- chibaguy *}
</tr></table>
</div>
