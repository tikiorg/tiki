{* $Header: /cvsroot/tikiwiki/_mods/themes/tikipedia/theme/templates/styles/tikipedia/tiki-list_file_gallery.tpl,v 1.1 2006-05-02 05:54:38 chibaguy Exp $ *}
...
{if $tiki_p_admin_file_galleries eq 'y' or $user eq $owner}
  <span class="button2"><a href="tiki-file_galleries.php?edit_mode=1&amp;galleryId={$galleryId}" class="linkbut">{tr}edit gallery{/tr}</a></span>
{/if}
{if $tiki_p_upload_files eq 'y' && ($tiki_p_admin_file_galleries eq 'y' or $user eq $owner or $public eq 'y')}
 <span class="button2"> <a href="tiki-upload_file.php?galleryId={$galleryId}" class="linkbut">{tr}upload file{/tr}</a></span>
{/if}
{if $rss_file_gallery eq 'y'}
<span class="button2"><a href="tiki-file_gallery_rss.php?galleryId={$galleryId}" class="linkbut">RSS</a></span>
{/if}
</div>
