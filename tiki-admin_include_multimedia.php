...
$pref_toggles_Values_external_flash = array(
    'MultimediaDefaultLength',
    'MultimediaDefaultHeight'
);
$pref_toggles_Values = array(
    'PreloadDelay',
    'VideoHeight',
    'VideoLength',
    'MaxPlay'
);
$pref_toggles_Text = array(
    'URLAppend',
    'LimitedMsg'
);
$pref_toggles_System = array(
    'MultimediaGalerie'
);
