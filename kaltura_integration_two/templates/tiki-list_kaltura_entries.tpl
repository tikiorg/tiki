      			...
      			<div class='box-data'>
          			...
          			{/if}
           			{if $tiki_p_edit_kaltura_entry eq 'y' or $tiki_p_admin_kaltura eq 'y' or $tiki_p_admin}
           				 ...
           				 <a href="tiki-kaltura_video.php?videoId={$item.id}&action=edit"><div class ="iconmenu" ><img src="pics/icons/page_edit.png" class="icon"/>Change Details</div></a>
          			{/if}
          			{if $tiki_p_remix_kaltura_entry eq 'y' or $tiki_p_admin_kaltura eq 'y' or $tiki_p_admin}
           				 <a href="tiki-kaltura_video.php?videoId={$item.id}&action=remix"><div class ="iconmenu" ><img src="pics/icons/layers.png" class="icon"/>Remix Video</div></a>
           				 {if $item.mediaType == 6}
          			...
          			{if $tiki_p_download_kaltura_entry eq 'y' or $tiki_p_admin_kaltura eq 'y' or $tiki_p_admin}
           				 ...
           				 <a href="{if $item.downloadUrl ne ''}{$item.downloadUrl}">{else}tiki-kaltura_video.php?videoId={$item.id}&action=download">{/if}<div class ="iconmenu" ><img src="pics/icons/disk.png" class="icon"/>Download</div></a>
          			{/if}
