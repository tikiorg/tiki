...
// "Keep track of the untranslated strings" => "Keep track of the untranslated strings",
...
// "Nothing was installed, check profile for errors" => "Nothing was installed, check profile for errors",
...
// "You need JQuery enabled for this feature" => "You need JQuery enabled for this feature",
// "Tab View" => "Tab View",
// "No Tab" => "No Tab",
...
// "Subscript" => "Subscript",
// "pics/icons/text_subscript.png" => "pics/icons/text_subscript.png",
// "Superscript" => "Superscript",
// "pics/icons/text_superscript.png" => "pics/icons/text_superscript.png",
// "Wiki Link" => "Wiki Link",
...
// "Makes the image a thumbnail. Will link to the full size image unless \"link\" is set. Parameter options indicate how the full image will be displayed: \"shadowbox\", \"mouseover\", \"mousesticky\", \"popup\", \"browse\" and \"browsepopup\" (only works with image gallery) and \"plain\". " => "Makes the image a thumbnail. Will link to the full size image unless \"link\" is set. Parameter options indicate how the full image will be displayed: \"shadowbox\", \"mouseover\", \"mousesticky\", \"popup\", \"browse\" and \"browsepopup\" (only works with image gallery) and \"plain\". ",
// "Full size image will open in a shadowbox when thumbnail is clicked" => "Full size image will open in a shadowbox when thumbnail is clicked",
...
// "Mouse Over (Sticky)" => "Mouse Over (Sticky)",
...
// "Full size image appears on a new blank page when thumbnail is clicked" => "Full size image appears on a new blank page when thumbnail is clicked",
// "Enlarge button" => "Enlarge button",
// "Button for enlarging image. Set to \"y\" for it to appear. If thumb is set, then same method as thumb will be used to enlarge, except if mouseover or mousesticky is used. If thumb is not set or set to mouseover or mousesticky, then choice of \"shadowbox\", \"popup\", \"browse\" and \"browsepopup\" (for image gallery), and \"plain\"" => "Button for enlarging image. Set to \"y\" for it to appear. If thumb is set, then same method as thumb will be used to enlarge, except if mouseover or mousesticky is used. If thumb is not set or set to mouseover or mousesticky, then choice of \"shadowbox\", \"popup\", \"browse\" and \"browsepopup\" (for image gallery), and \"plain\"",
...
// "Link relation" => "Link relation",
// "\"rel\" attribute to add to the link. Overrides any shadowbox settings from the thumb or button parameters" => "\"rel\" attribute to add to the link. Overrides any shadowbox settings from the thumb or button parameters",
// "Image map" => "Image map",
...
// "Click to fade this out" => "Click to fade this out",
// "Show Tree" => "Show Tree",
// "Hide Tree" => "Hide Tree",
...
// "Article archives by `\$module_sort_mode`" => "Article archives by `\$module_sort_mode`",
// "Articles archives" => "Articles archives",
// "Articles by `\$module_sort_mode`" => "Articles by `\$module_sort_mode`",
// "Articles by Rating" => "Articles by Rating",
...
// "WARNING" => "WARNING",
// "The Terminology is module can only work if the following profile has been installed" => "The Terminology is module can only work if the following profile has been installed",
// "That profile has not been installed yet, so you need to install it first" => "That profile has not been installed yet, so you need to install it first",
// "To install this profile, click on the following link" => "To install this profile, click on the following link",
// "Then click on the name of that profile, wait a few seconds, and click on Install" => "Then click on the name of that profile, wait a few seconds, and click on Install",
// "Note that you may need admin privileges" => "Note that you may need admin privileges",
// "Find term" => "Find term",
...
// "Last `\$module_rows` article comments" => "Last `\$module_rows` article comments",
// "Last `\$module_rows` comments" => "Last `\$module_rows` comments",
...
// "(experimental - not comprehensively tested and requires javascript)" => "(experimental - not comprehensively tested and requires javascript)",
// "Enable" => "Enable",
...
// "You have succesfully enabled  Workspaces in TikiWiki. <br /><br />\nThis feature is <strong>under development</strong>. If you want to get more info go to the " => "You have succesfully enabled  Workspaces in TikiWiki. <br /><br />\nThis feature is <strong>under development</strong>. If you want to get more info go to the ",
// "Workspaces wiki page" => "Workspaces wiki page",
// "Things you can currently do: <br />\n<ul>\n<li>In the General Settings Tab you can configure certain aspects of Workspaces (not functional right now).</li>\n<li>In the Workspaces Dev Tools Tab, you can initiate (and other stuff) a set of Workspaces.</li>\n</ul>\n<strong>These sections listed here could change in the future!</strong>" => "Things you can currently do: <br />\n<ul>\n<li>In the General Settings Tab you can configure certain aspects of Workspaces (not functional right now).</li>\n<li>In the Workspaces Dev Tools Tab, you can initiate (and other stuff) a set of Workspaces.</li>\n</ul>\n<strong>These sections listed here could change in the future!</strong>",
// "Workspaces Dev Tools" => "Workspaces Dev Tools",
// "Script Creator" => "Script Creator",
// "Create a set of Workspaces, and some items whithin them" => "Create a set of Workspaces, and some items whithin them",
// "Clear the entire cache of TikiWiki" => "Clear the entire cache of TikiWiki",
// "Delete all Workspaces created before" => "Delete all Workspaces created before",
// "Delete all Workspaces including the WS container (Not working)" => "Delete all Workspaces including the WS container (Not working)",
...
// "Assign group <em>management</em> persmissions" => "Assign group <em>management</em> persmissions",
...
// "Feedback" => "Feedback",
// "\$tikifeedback[n].mes" => "\$tikifeedback[n].mes",
...
// "Edit Workspace Settings" => "Edit Workspace Settings",
// "Remove this Workspace and its childrens (if apply)" => "Remove this Workspace and its childrens (if apply)",
...
// "You do not belong to any workspace" => "You do not belong to any workspace",
...
// "No permissions yet applied to this object but category permissions affect this object" => "No permissions yet applied to this object but category permissions affect this object",
...
// "No permissions yet applied to this object. Global permissions apply" => "No permissions yet applied to this object. Global permissions apply",
...
// "Some of your groups have been automatically hidden. Click 'Show/hide columns' to select the group columns to display" => "Some of your groups have been automatically hidden. Click 'Show/hide columns' to select the group columns to display",
// "Show/hide Group List" => "Show/hide Group List",
// "Show/hide columns" => "Show/hide columns",
// "\n\n\t\t<div class=\"input_submit_container\" style=\"text-align: center\">\n\t\t\t<input type=\"submit\" name=\"assign\" value=\"{tr}Assign" => "\n\n\t\t<div class=\"input_submit_container\" style=\"text-align: center\">\n\t\t\t<input type=\"submit\" name=\"assign\" value=\"{tr}Assign",
...
// "Workspaces have been successfully enabled. Please note that this feature is under development. More information in the " => "Workspaces have been successfully enabled. Please note that this feature is under development. More information in the ",
...
// "Workspace name or group name can not be blank" => "Workspace name or group name can not be blank",
// "There already exists a Workspace with that name in the same level. Please choose another name" => "There already exists a Workspace with that name in the same level. Please choose another name",
...
// "Workspaces Home" => "Workspaces Home",
// "Tidy Extension not present" => "Tidy Extension not present",
