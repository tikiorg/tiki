...
"Filter the list of wanted pages according to page_regex or custom filter. The default value is the site's __current__ page_regex.<br />" => "Filtrer la liste des pages voulues selon l'expression régulière ou le filtre local. La valeur par defaut est __current__ page_regex.<br />",à
