...
if (isset($_REQUEST['banId'])) {
	...
	$info['ip4'] = 255;
	$info['use_dates'] = 'n';
	$info['date_from'] = gmdate("U");
	$info['date_to'] = gmdate("U") + 7 * 24 * 3600;
	$info['message'] = '';
}
...
if (isset($_REQUEST['save'])) {
	...
	$_REQUEST['date_from'] = gmmktime(0, 0, 0, $_REQUEST['date_fromMonth'], $_REQUEST['date_fromDay'], $_REQUEST['date_fromYear']);
	$_REQUEST['date_to'] = gmmktime(0, 0, 0, $_REQUEST['date_toMonth'], $_REQUEST['date_toDay'], $_REQUEST['date_toYear']);
