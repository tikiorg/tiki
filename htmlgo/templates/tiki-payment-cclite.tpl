...
<p><strong>{tr}Cclite{/tr}</strong> ({tr}Transaction ID{/tr} - {$payment.details.0|escape})</p>
<p>{*tr 0=$payment.details.last_name|escape 1=$payment.details.first_name|escape 2=$payment.details.payer_email|escape}Payment made by <em>%0, %1</em> (%2).{/tr*}</p>
<div class="address">
