...
DELETE FROM users_permissions WHERE permName IN( 'tiki_p_edit_categorized', 'tiki_p_view_categories', 'tiki_p_view_categorized', 'tiki_p_search_categorized' );
DELETE FROM users_grouppermissions WHERE permName IN( 'tiki_p_edit_categorized', 'tiki_p_view_categories', 'tiki_p_view_categorized', 'tiki_p_search_categorized' );
DELETE FROM users_objectpermissions WHERE permName IN( 'tiki_p_edit_categorized', 'tiki_p_view_categories', 'tiki_p_view_categorized', 'tiki_p_search_categorized' );
