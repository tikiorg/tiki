...
// "Exibe uma listagem dos próximos eventos da agenda" => "Exibe uma listagem dos próximos eventos da agenda",
// "~np~{AGENDA()}{AGENDA}~/np~" => "~np~{AGENDA()}{AGENDA}~/np~",
...
// "Exibe uma chamada para o último artigo do tipo editorial" => "Exibe uma chamada para o último artigo do tipo editorial",
// "~np~{EDITORIAL()}{EDITORIAL}~/np~" => "~np~{EDITORIAL()}{EDITORIAL}~/np~",
...
// "Lista as últimas notícias ou artigos publicados no site" => "Lista as últimas notícias ou artigos publicados no site",
// "~np~{LISTAGEM(tipo=>tipo)}{LISTAGEM}~/np~" => "~np~{LISTAGEM(tipo=>tipo)}{LISTAGEM}~/np~",
// "Displays a SWF myspace mp3 playlist on the wiki page" => "Displays a SWF myspace mp3 playlist on the wiki page",
// "Lista as últimas notícias publicadas no site" => "Lista as últimas notícias publicadas no site",
// "~np~{NOTICIAS()}{NOTICIAS}~/np~" => "~np~{NOTICIAS()}{NOTICIAS}~/np~",
...
// "Exibe uma chamada para o último artigo do tipo revista" => "Exibe uma chamada para o último artigo do tipo revista",
// "~np~{REVISTA()}{REVISTA}~/np~" => "~np~{REVISTA()}{REVISTA}~/np~",
...
// "Log SQL:" => "Log SQL:",
// "only queries using more than seconds:" => "only queries using more than seconds:",
...
// "Enter TikiWiki and lock installer (Best)" => "Enter TikiWiki and lock installer (Best)",
// "Enter TikiWiki" => "Enter TikiWiki",
// "Login as the administrator and lock installer (Best)" => "Login as the administrator and lock installer (Best)",
...
// "Note: Maximum file size is limited to:" => "Note: Maximum file size is limited to:",
// "a folder" => "a folder",
// "a URL" => "a URL",
