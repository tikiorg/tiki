...
<tr class="formcolor"><td>{tr}standard colors{/tr}:</td><td>
	<select name="options[customcolors]" onChange="javascript:document.getElementById('fgColorField').disabled=(this.options[this.selectedIndex].value != 0);document.getElementById('bgColorField').disabled=(this.options[this.selectedIndex].value != 0);">
	  ...
	  <option value="996699-c2a6d2" style="background-color:#e0cae5;color:#996699" {if ($customColors) eq 'c2a6d2-996699'}selected{/if}>{tr}Purple{/tr}</option>
...
<input type="text" id="fgColorField" name="options[customfgcolor]" value="{$customfgcolor}" size="6" disabled="disabled"/>
</td></tr>
<tr class="formcolor"><td>{tr}Custom background color{/tr}:</td><td>
<input type="text" id="bgColorField" name="options[custombgcolor]" value="{$custombgcolor}" size="6" disabled="disabled"/>
