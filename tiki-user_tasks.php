...
// $Header: /cvsroot/tikiwiki/tiki/tiki-user_tasks.php,v 1.11 2003-08-07 04:33:57 rossta Exp $
...
if (isset($_REQUEST['save'])) {
	...
	$date = $dc->getServerDateFromDisplayDate(
		mktime(0, 0, 0, $_REQUEST["Date_Month"], $_REQUEST["Date_Day"], $_REQUEST["Date_Year"]));
	...
	$tasklib->replace_task($user, $_REQUEST["taskId"], $_REQUEST["title"], $_REQUEST["description"],
		$date, $_REQUEST['status'], $_REQUEST['priority'], $completed, $_REQUEST['percentage']);
	$info = array();
	$info['title'] = '';
	$info['description'] = '';
	$info['priority'] = 3;
