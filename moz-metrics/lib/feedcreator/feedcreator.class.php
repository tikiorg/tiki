...
class FeedCreator extends HtmlDescribable {
	...
	*/
	...
	function _createStylesheetReferences() {
		$xml = "";
		if (isset($this->cssStyleSheet)) { if ($this->cssStyleSheet) $xml .= "<?xml-stylesheet href=\"".$this->cssStyleSheet."\" type=\"text/css\"?>\n"; }
		if (isset($this->xslStyleSheet)) { if ($this->xslStyleSheet) $xml .= "<?xml-stylesheet href=\"".$this->xslStyleSheet."\" type=\"text/xsl\"?>\n"; }
		return $xml;
	}
