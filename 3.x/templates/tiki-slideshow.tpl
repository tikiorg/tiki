...
{if $structure eq 'y'}
<tr class="footer">
<td width="30%"><a class="buttons" accesskey="p" title="previous [alt-p]" href="tiki-slideshow2.php?page_ref_id={$prev_info.page_ref_id}">{$prev_info.pageName}</a></td>
<td align="center"><a class="buttons" href="tiki-slideshow2.php?page_ref_id={$home_info.page_ref_id}">{$home_info.pageName}</a></td>
<td align="right" width="30%"><a class="buttons" title="next [alt-space]" accesskey=" " href="tiki-slideshow2.php?page_ref_id={$next_info.page_ref_id}">{$next_info.pageName}</a></td>
</tr>
{else}
<tr class="footer">
<td width="30%">
...
<tr><td colspan="3" class="Main">{$slide_data}</td></tr>
