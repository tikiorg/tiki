...
if ($tiki_p_admin != 'y' &&  $tiki_p_admin_workspace != 'y' && !$userlib->object_has_permission($user, $ws["workspaceId"], 'workspace', "tiki_p_admin_workspace")) {
	$smarty->assign('msg', tra("Permission denied YOU CANNOT edit: $edit - user: $user - - tiki_p_ad_ws: $tiki_p_admin_workspace"));
