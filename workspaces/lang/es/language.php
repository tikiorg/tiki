...
"To test your system configuration, Tiki will attempt to send a test message to info@tikiwiki.org" => "Para probar la configuración de su sistema, Tiki intentará enviar un mensaje de prueba a info@tikiwiki.org",
...
"Upgrade" => "Actualizar",
"Automatically upgrade your existing database to v" => "Actualiza automáticamente su existente base de datos a v",
...
"Email sent by your site will use this address" => "Emails enviados por su sitio utilizarán esta dirección",
"Secure Login" => "Registro Seguro",
"HTTPS login" => "Registro HTTPS",
"Administrator" => "Administrador",
"Admin email" => "Email del Administrador",
"This is the email address for your administrator account" => "Este es el email para la cuenta de administración",
"Enter Your Tiki" => "Entre en Tiki",
"The installation is complete" => "La instalación ha sido completada",
"Tiki is an opensource project, <em>you</em> can <a href='http://info.tikiwiki.org/Join+the+Community' target='_blank'>join the community</a> and help <a href='http://info.tikiwiki.org/tiki-index.php?page=Develop+Tiki' target='_blank'>develop Tiki</a>" => "Tiki es un proyecto opensource, <em>usted</em> puede <a href='http://info.tikiwiki.org/Join+the+Community' target='_blank'>unirse a la comunidad</a> y ayudar <a href='http://info.tikiwiki.org/tiki-index.php?page=Develop+Tiki' target='_blank'>a desarrollar Tiki</a>",
"Installation" => "Instalación",
"If this is a first time installation, go to <strong>tiki-admin.php</strong> after login to start configuring your new Tiki installation" => "Si esta es una nueva instalación de Tiki, vaya a <strong>tiki-admin.php</strong> después de registrarse para comenzar a configurar la aplicación",
"If this is an upgrade, clean the Tiki caches manually (the <strong>templates_c</strong> directory) or by using the <strong>Admin &gt; System</strong> option from the Admin menu" => "Si esto es una actualización, limpie las caches de Tiki manualmente (el directorio <strong>templates_c</strong>) o utilizando la opción  <strong>Admin &gt; System</strong> desde el menú de Administración",
"Enter Tiki and Lock Installer" => "Entrar en Tiki y Bloquear Instalador",
"Recommended" => "Recomendado",
"Enter Tiki Without Locking Installer" => "Entrar en Tiki sin Bloquear Instalador",
...
"New blog post: {\$mail_title}, \"{\$mail_post_title}\", by {\$mail_user} at {\$mail_date|tiki_short_datetime}" => "Nuevo post en blog: {\$mail_title}, \"{\$mail_post_title}\", por {\$mail_user} en {\$mail_date|tiki_short_datetime}",
