...
{tabset name="admin_forums"}
	...
	<div class="adminoptionbox">
		<div class="adminoptionlabel"><label for="home_forum">{tr}Home Forum (main forum){/tr}</label>
			...
			{else}<a href="tiki-admin_forums.php" class="button" title="{tr}Create a forum{/tr}"> {tr}Create a forum{/tr} </a>
			{/if}
		</div>
	</div>

	<fieldset>
		<legend>{tr}Features{/tr}{if $prefs.feature_help eq 'y'} {help url="Forum+Admin"}{/if}</legend>
		<input type="hidden" name="forumprefs" />
		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="feature_forum_rankings" name="feature_forum_rankings" {if $prefs.feature_forum_rankings eq 'y'}checked="checked" {/if}/></div>
			<div class="adminoptionlabel"><label for="feature_forum_rankings">{tr}Rankings{/tr}</label></div>
		</div>

		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="feature_forum_parse" name="feature_forum_parse" {if $prefs.feature_forum_parse eq 'y'}checked="checked"{/if}/></div>
		...
		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="feature_forum_topics_archiving" name="feature_forum_topics_archiving" {if $prefs.feature_forum_topics_archiving eq 'y'}checked="checked"{/if}/></div>
			<div class="adminoptionlabel"><label for="feature_forum_topics_archiving">{tr}Topic archiving{/tr}</label></div>
		</div>

		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="feature_forum_quickjump" name="feature_forum_quickjump" {if $prefs.feature_forum_quickjump eq 'y'}checked="checked"{/if}/></div>
			<div class="adminoptionlabel"><label for="feature_forum_quickjump">{tr}Quick jumps{/tr}</label></div>
		</div>

		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="feature_forum_replyempty" name="feature_forum_replyempty" {if $prefs.feature_forum_replyempty eq 'y'}checked="checked"{/if}/></div>
		...
		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="forum_comments_no_title_prefix" name="forum_comments_no_title_prefix" {if $prefs.forum_comments_no_title_prefix eq 'y'}checked="checked"{/if}/></div>
			<div class="adminoptionlabel"><label for="forum_comments_no_title_prefix">{tr}Do not prefix messages titles by 'Re: '{/tr}</label></div>
		</div>

		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="feature_forums_allow_thread_titles" name="feature_forums_allow_thread_titles" {if $prefs.feature_forums_allow_thread_titles eq 'y'}checked="checked"{/if}/></div>
			<div class="adminoptionlabel"><label for="feature_forums_allow_thread_titles">{tr}First post of a thread can have an empty body{/tr}.</label>
				<br /><em>{tr}Will be a thread title{/tr}.</em>
			</div>
		</div>
		<div class="adminoptionbox">
	...
	<fieldset>
		...
		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="forum_thread_defaults_by_forum" name="forum_thread_defaults_by_forum" {if $prefs.forum_thread_defaults_by_forum eq 'y'}checked="checked"{/if} /></div>
			<div class="adminoptionlabel"><label for="forum_thread_defaults_by_forum">{tr}Manage thread defaults per-forum{/tr}.</label></div>
		</div>
		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="forum_thread_user_settings" name="forum_thread_user_settings" {if $prefs.forum_thread_user_settings eq 'y'}checked="checked"{/if} onclick="flip('useconfigurationbar');" /></div>
			...
			<div class="adminoptionboxchild" id="useconfigurationbar" style="display:{if $prefs.forum_thread_user_settings eq 'y'}block{else}none{/if};">
				<div class="adminoption"><input type="checkbox" id="forum_thread_user_settings_keep" name="forum_thread_user_settings_keep" {if $prefs.forum_thread_user_settings_keep eq 'y'}checked="checked"{/if} /></div>
	...
	<fieldset>
		...
		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="feature_forums_name_search" name="feature_forums_name_search" {if $prefs.feature_forums_name_search eq 'y'}checked="checked"{/if}/></div>
		...
		<div class="adminoptionbox">
			<div class="adminoption"><input type="checkbox" id="feature_forums_search" name="feature_forums_search" {if $prefs.feature_forums_search eq 'y'}checked="checked"{/if}/></div>
		...
		<div class="adminoptionbox">
			<div class="adminoption"><input id="feature_forum_content_search" type="checkbox" name="feature_forum_content_search" {if $prefs.feature_forum_content_search eq 'y'}checked="checked" {/if}onclick="flip('usecontentsearch');" /></div>
			<div class="adminoptionlabel"><label for="feature_forum_content_search">{tr}Topic content search{/tr}</label>
				{if $prefs.feature_search ne 'y'}<br />{icon _id=information} {tr}Search is disabled{/tr}. <a href="tiki-admin.php?page=features" title="{tr}Features{/tr}">{tr}Enable now{/tr}</a>.{/if}
			</div>
			<div class="adminoptionboxchild" id="usecontentsearch" style="display:{if $prefs.feature_forum_content_search eq 'y'}block{else}none{/if};">
				<div class="adminoptionbox">
					<div class="adminoption"><input type="checkbox" id="feature_forum_local_tiki_search" name="feature_forum_local_tiki_search" {if $prefs.feature_forum_local_tiki_search eq 'y'}checked="checked"{/if}/></div>
				...
				<div class="adminoptionbox">
					<div class="adminoption"><input type="checkbox" id="feature_forum_local_search" name="feature_forum_local_search" {if $prefs.feature_forum_local_search eq 'y'}checked="checked"{/if}/></div>
...
<div class="adminoptionbox">
	<div class="adminoption"><input type="checkbox" id="forum_list_topics" name="forum_list_topics" {if $prefs.forum_list_topics eq 'y'}checked="checked"{/if} /></div>
	<div class="adminoptionlabel"><label for="forum_list_topics">{tr}Topics{/tr}</label></div>
</div>
<div class="adminoptionbox">
	<div class="adminoption"><input type="checkbox" id="forum_list_posts" name="forum_list_posts" {if $prefs.forum_list_posts eq 'y'}checked="checked"{/if} /></div>
	<div class="adminoptionlabel"><label for="forum_list_posts">{tr}Posts{/tr}</label></div>
</div>
<div class="adminoptionbox">
	<div class="adminoption"><input type="checkbox" id="forum_list_ppd" name="forum_list_ppd" {if $prefs.forum_list_ppd eq 'y'}checked="checked"{/if} /></div>
	<div class="adminoptionlabel"><label for="forum_list_ppd">{tr}Posts per day{/tr} (PPD)</label></div>
</div>
<div class="adminoptionbox">
	<div class="adminoption"><input type="checkbox" id="forum_list_lastpost" name="forum_list_lastpost" {if $prefs.forum_list_lastpost eq 'y'}checked="checked"{/if} /></div>
	<div class="adminoptionlabel"><label for="forum_list_lastpost">{tr}Last post{/tr}</label></div>
</div>
<div class="adminoptionbox">
	<div class="adminoption"><input type="checkbox" id="forum_list_visits" name="forum_list_visits" {if $prefs.forum_list_visits eq 'y'}checked="checked"{/if} /></div>
	<div class="adminoptionlabel"><label for="forum_list_visits">{tr}Visits{/tr}</label></div>
</div>
<div class="adminoptionbox">
	<div class="adminoption"><input type="checkbox" id="forum_list_desc" name="forum_list_desc" {if $prefs.forum_list_desc eq 'y'}checked="checked"{/if} onclick="flip('descriptionlength');" /></div>
