...
<div class="adminoptionbox">
	...
	<div class="adminoptionlabel"><label for="feature_machine_translation">{tr}Machine Translation (by Google Translate){/tr}&nbsp;&nbsp;{icon _id="error"} <em>{tr}Experimental{/tr}</em></label></div>
</div>
