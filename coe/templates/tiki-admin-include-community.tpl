...
<form action="tiki-admin.php?page=community" method="post">
	...
	{tabset name="admin_community"}
			...
			<fieldset>
				...
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" name="feature_community_gender" id="community-gender" {if $prefs.feature_community_gender eq 'y'}checked="checked" {/if}/>
					</div>
					<div class="adminoptionlabel">
						<label for="community-gender">{tr}Users can choose to show their gender{/tr}.</label>
						{if $prefs.feature_help eq 'y'}
							<br />
							<em>{tr}Requires User Preferences feature{/tr}.</em>
							{help url="User+Preferences"}
						{/if}
					</div>
				</div>
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" onclick="flip('userinformation');" name="feature_community_mouseover" id="community-mouseover" {if $prefs.feature_community_mouseover eq 'y'}checked="checked" {/if}/>
					</div>
					<div class="adminoptionlabel">
						<label for="community-mouseover">{tr}Show user's information on mouseover{/tr}.</label>
						{if $prefs.feature_help eq 'y'}
							<br />
							<em>{tr}Requires user's information to be public{/tr}.</em>
							{help url="User+Preferences"}
						{/if}
						...
						<div id="userinformation" class="adminoptionboxchild" style="display:{if $prefs.feature_community_mouseover eq 'y'}block{else}none{/if};">
							<div class="adminoptionbox">
								<div class="adminoption">
									<input type="checkbox" name="feature_community_mouseover_name" id="community-mouseover-name"{if $prefs.feature_community_mouseover_name eq 'y'} checked="checked"{/if} />
								</div>
								<div class="adminoptionlabel">
									<label for="community-mouseover-name">{tr}Real name{/tr}</label>
								</div>
							</div>
							<div class="adminoptionbox">
								<div class="adminoption">
									<input type="checkbox" name="feature_community_mouseover_gender" id="community-mouseover-gender"{if $prefs.feature_community_mouseover_gender eq 'y'} checked="checked"{/if} />
								</div>
								<div class="adminoptionlabel">
									<label for="community-mouseover-gender">{tr}Gender{/tr}</label>
								</div>
							</div>
							<div class="adminoptionbox">
								<div class="adminoption">
									<input type="checkbox" name="feature_community_mouseover_picture" id="community-mouseover-picture" {if $prefs.feature_community_mouseover_picture eq 'y'}checked="checked"{/if} />
								</div>
								<div class="adminoptionlabel">
									<label for="community-mouseover-picture">{tr}Picture{/tr} ({tr}avatar{/tr})</label>
								</div>
							</div>
							<div class="adminoptionbox">
								<div class="adminoption">
									<input {if $prefs.feature_friends ne 'y'}disabled="disabled" {/if}type="checkbox" name="feature_community_mouseover_friends" id="community-mouseover-friends"{if $prefs.feature_community_mouseover_friends eq 'y'} checked="checked"{/if} />
								</div>
								<div class="adminoptionlabel">
									<label for="community-mouseover-friends">
										{tr}Number of friends{/tr}{if $prefs.feature_friends ne 'y'}
										<br />
										{icon _id=information} {tr}Feature is disabled{/tr}.
										<a href="tiki-admin.php?page=features" title="{tr}Features{/tr}">{tr}Enable now{/tr}.</a>
									{/if}
									{if $prefs.feature_help eq 'y'}
										{help url="Friendship+Network"}
									{/if}
								</label>
							</div>
						</div>
						<div class="adminoptionbox">
							<div class="adminoption">
								<input type="checkbox" name="feature_community_mouseover_score" id="community-mouseover-score" {if $prefs.feature_community_mouseover_score eq 'y'}checked="checked"{/if} />
							</div>
							<div class="adminoptionlabel">
								<label for="community-mouseover-score">{tr}Score{/tr}</label>
								{if $prefs.feature_help eq 'y'}
									{help url="Score"}
								{/if}
							</div>
						...
						<div class="adminoptionbox">
							<div class="adminoption">
								<input type="checkbox" name="feature_community_mouseover_country" id="community-mouseover-country" {if $prefs.feature_community_mouseover_country eq 'y'}checked="checked"{/if} />
							</div>
							<div class="adminoptionlabel">
								<label for="community-mouseover-country">{tr}Country{/tr}</label>
							</div>
						</div>
						<div class="adminoptionbox">
							<div class="adminoption">
								<input type="checkbox" name="feature_community_mouseover_email" id="community-mouseover-email" {if $prefs.feature_community_mouseover_email eq 'y'}checked="checked"{/if} />
							</div>
							<div class="adminoptionlabel">
								<label for="community-mouseover-email">{tr}E-mail{/tr}</label>
							</div>
						</div>
						<div class="adminoptionbox">
							<div class="adminoption">
								<input type="checkbox" name="feature_community_mouseover_lastlogin" id="community-mouseover-lastlogin" {if $prefs.feature_community_mouseover_lastlogin eq 'y'}checked="checked"{/if} />
							</div>
							<div class="adminoptionlabel">
								<label for="community-mouseover-lastlogin">{tr}Last login{/tr}</label>
							</div>
						</div>
						<div class="adminoptionbox">
							<div class="adminoption">
								<input type="checkbox" name="feature_community_mouseover_distance" id="community-mouseover-distance" {if $prefs.feature_community_mouseover_distance eq 'y'}checked="checked"{/if} />
							</div>
							<div class="adminoptionlabel">
								<label for="community-mouseover-distance">{tr}Distance{/tr}</label>
							</div>
						</div>
					</div>
				</div>
		...
		<fieldset>
			...
			<div class="adminoptionbox">
				<div class="adminoptionlabel">
					<label for="users_prefs_userbreadCrumb">{tr}Number of visited pages to remember{/tr}:</label>
			...
			<div class="adminoptionbox">
				<div class="adminoptionlabel">
					<label>{tr}Displayed time zone{/tr}:</label>
				</div>
				<div class="adminoptionboxchild">
					<div class="adminoptionlabel">
						<input type="radio" name="users_prefs_display_timezone" id="users_prefs_display_timezone1" value="Site" {if $prefs.users_prefs_display_timezone eq 'Site'}checked="checked"{/if}/>
						<label for="users_prefs_display_timezone1">{tr}Site default{/tr}</label>
					</div>
					<div class="adminoptionlabel">
						<input type="radio" name="users_prefs_display_timezone" id="users_prefs_display_timezone2" value="Local" {if $prefs.users_prefs_display_timezone ne 'Site'}checked="checked"{/if}/>
						<label for="users_prefs_display_timezone2">{tr}Detect user timezone if browser allows, otherwise site default{/tr}</label>
					</div>
				</div>
			</div>
			<div class="adminoptionbox">
				<div class="adminoptionlabel">
					<label for="users_prefs_user_information">{tr}User information{/tr}:</label>
			...
			{if $prefs.feature_wiki eq 'y'}
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" id="users_prefs_user_dbl" name="users_prefs_user_dbl" {if $prefs.users_prefs_user_dbl eq 'y'}checked="checked"{/if} />
					</div>
					<div class="adminoptionlabel">
						<label for="users_prefs_user_dbl">{tr}Use double-click to edit pages{/tr}</label>
					</div>
				</div>
				{* not used
					{if $prefs.feature_history eq 'y'}
						<div class="adminoptionbox">
							<div class="adminoption">
								<input type="checkbox" id="users_prefs_diff_versions" name="users_prefs_diff_versions" {if $prefs.users_prefs_diff_versions eq 'y'}checked="checked"{/if} />
							</div>
							<div class="adminoptionlabel">
								<label for="users_prefs_diff_versions">Use new diff any version interface</label>
							</div>
						</div>
					{/if}
				*}
			...
			{if $prefs.feature_community_mouseover eq 'y'}
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" id="users_prefs_show_mouseover_user_info"  name="users_prefs_show_mouseover_user_info" {if $prefs.users_prefs_show_mouseover_user_info eq 'y'}checked="checked"{/if} />
					</div>
					<div class="adminoptionlabel">
						<label for="users_prefs_show_mouseover_user_info">{tr}Show user's info on mouseover{/tr}.</label>
					</div>
				</div>
			{/if}
			...
			{if $prefs.feature_tasks eq 'y' and $tiki_p_tasks eq 'y'}
				...
				<div class="adminoptionbox">
					<div class="adminoptionlabel">
						<label for="users_prefs_tasks_maxRecords">{tr}Tasks per page{/tr}: </label>
						...
						{if $prefs.feature_help eq 'y'} {help url="Task"}{/if}
					</div>
				</div>
			{/if}
		</fieldset>
		...
		<fieldset>
			...
			<div class="adminoptionbox">
				<div class="adminoptionlabel">
					<label for="users_prefs_mess_maxRecords">{tr}Messages per page{/tr}:</label>
			...
			<div class="adminoptionbox">
				<div class="adminoption">
					<input type="checkbox" id="users_prefs_allowMsgs" name="users_prefs_allowMsgs" {if $prefs.users_prefs_allowMsgs eq 'y'}checked="checked"{/if}/>
				</div>
				<div class="adminoptionlabel">
					<label for="users_prefs_allowMsgs">{tr}Allow messages from other users{/tr}.</label>
				</div>
			</div>
			<div class="adminoptionbox">
				<div class="adminoption">
					<input type="checkbox" id="users_prefs_mess_sendReadStatus" name="users_prefs_mess_sendReadStatus" {if $prefs.users_prefs_mess_sendReadStatus eq 'y'}checked="checked"{/if}/>
				</div>
				<div class="adminoptionlabel">
					<label for="users_prefs_mess_sendReadStatus">{tr}Notify sender when reading mail{/tr}.</label>
				</div>
			</div>
			<div class="adminoptionbox">
				<div class="adminoptionlabel">
					<label for="users_prefs_minPrio">{tr}Send me an email for messages with priority equal or greater than{/tr}:</label>
			...
			<div class="adminoptionbox">
				<div class="adminoptionlabel">
					<label for="users_prefs_mess_archiveAfter">{tr}Auto-archive read messages after x days{/tr}:</label>
		...
		<fieldset>
			...
			{if $prefs.feature_wiki eq 'y'}
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" id="users_prefs_mytiki_pages" name="users_prefs_mytiki_pages" {if $prefs.users_prefs_mytiki_pages eq 'y'}checked="checked"{/if} />
					</div>
					<div class="adminoptionlabel">
						<label for="users_prefs_mytiki_pages">{tr}My pages{/tr}</label>
					</div>
				</div>
			{/if}
			{if $prefs.feature_blogs eq 'y'}
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" id="users_prefs_mytiki_blogs" name="users_prefs_mytiki_blogs" {if $prefs.users_prefs_mytiki_blogs eq 'y'}checked="checked"{/if} />
					</div>
					<div class="adminoptionlabel">
						<label for="users_prefs_mytiki_blogs">{tr}My blogs{/tr}</label>
					</div>
				</div>
			{/if}
			{if $prefs.feature_galleries eq 'y'}
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" id="users_prefs_mytiki_gals" name="users_prefs_mytiki_gals" {if $prefs.users_prefs_mytiki_gals eq 'y'}checked="checked"{/if} />
					</div>
					<div class="adminoptionlabel">
						<label for="users_prefs_mytiki_gals">{tr}My galleries{/tr}</label>
					</div>
				</div>
			{/if}
			{if $prefs.feature_messages eq 'y' and $tiki_p_messages eq 'y'}
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" id="users_prefs_mytiki_msgs" name="users_prefs_mytiki_msgs" {if $prefs.users_prefs_mytiki_msgs eq 'y'}checked="checked"{/if} />
					</div>
					<div class="adminoptionlabel">
						<label for="users_prefs_mytiki_msgs">{tr}My messages{/tr}</label>
					</div>
				</div>
			{/if}
			{if $prefs.feature_tasks eq 'y' and $tiki_p_tasks eq 'y'}
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" id="users_prefs_mytiki_tasks" name="users_prefs_mytiki_tasks" {if $prefs.users_prefs_mytiki_tasks eq 'y'}checked="checked"{/if} />
					</div>
					<div class="adminoptionlabel">
						<label for="users_prefs_mytiki_tasks">{tr}My tasks{/tr}</label>
					</div>
				</div>
			{/if}
			{if $prefs.feature_forums eq 'y'}
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" id="users_prefs_mytiki_forum_topics" name="users_prefs_mytiki_forum_topics" {if $prefs.users_prefs_mytiki_forum_topics eq 'y'}checked="checked"{/if} />
					</div>
					<div class="adminoptionlabel">
						<label for="users_prefs_mytiki_forum_topics">{tr}My forum topics{/tr}</label>
					</div>
				</div>
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" id="users_prefs_mytiki_forum_replies" name="users_prefs_mytiki_forum_replies" {if $prefs.users_prefs_mytiki_forum_replies eq 'y'}checked="checked"{/if} />
					</div>
					<div class="adminoptionlabel">
						<label for="users_prefs_mytiki_forum_replies">{tr}My forum replies{/tr}</label>
					</div>
				</div>
			{/if}
			{if $prefs.feature_trackers eq 'y'}
				<div class="adminoptionbox">
					<div class="adminoption">
						<input type="checkbox" id="users_prefs_mytiki_items" name="users_prefs_mytiki_items" {if $prefs.users_prefs_mytiki_items eq 'y'}checked="checked"{/if} />
					</div>
					<div class="adminoptionlabel">
						<label for="users_prefs_mytiki_items">{tr}My items{/tr}</label>
					</div>
				</div>
			{/if}
		</fieldset>
	...
	{tab name="{tr}Friendship Network{/tr}"}
		...
		{if $prefs.feature_friends eq 'y'}
			...
			<div class="adminoptionbox">
				<div class="adminoption">
					<input type="checkbox" name="feature_community_list_name" id="community-list-name" {if $prefs.feature_community_list_name eq 'y'}checked="checked"{/if} />
				</div>
				<div class="adminoptionlabel">
					<label for="community-list-name">{tr}Name{/tr}</label>
				</div>
			</div>
			<div class="adminoptionbox">
				<div class="adminoption">
					<input type="checkbox" name="feature_community_list_score" id="community-list-score" {if $prefs.feature_community_list_score eq 'y'}checked="checked"{/if} />
				</div>
				<div class="adminoptionlabel">
					<label for="community-list-score">{tr}Score{/tr}</label>
					{if $prefs.feature_help eq 'y'}{help url="Score"}{/if}
				</div>
			</div>
			<div class="adminoptionbox">
				<div class="adminoption">
					<input type="checkbox" name="feature_community_list_country" id="community-list-country" {if $prefs.feature_community_list_country eq 'y'}checked="checked"{/if} />
				</div>
				<div class="adminoptionlabel">
					<label for="community-list-country">{tr}Country{/tr}</label>
				</div>
			</div>
			<div class="adminoptionbox">
				<div class="adminoption">
					<input type="checkbox" name="feature_community_list_distance" id="community-list-distance" {if $prefs.feature_community_list_distance eq 'y'}checked="checked"{/if} />
				</div>
				<div class="adminoptionlabel">
					<label for="community-list-distance">{tr}Distance{/tr}</label>
				</div>
			</div>
		{/if}
