...
// $Id: /cvsroot/tikiwiki/tiki/tiki-newsreader_servers.php,v 1.26 2007-10-12 07:55:29 nyloth Exp $
$section = 'newsreader';
...
if (isset($_REQUEST['save'])) {
	...
	$newslib->replace_server($user, $_REQUEST["serverId"], $_REQUEST["server"], $_REQUEST["port"], $_REQUEST['news_username'], $_REQUEST['password']);
	$info = array();
	$info['server'] = '';
	$info['port'] = 119;
	$info['news_username'] = '';
