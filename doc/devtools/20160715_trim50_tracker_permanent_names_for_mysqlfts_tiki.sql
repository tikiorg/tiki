...
--
--  Using same arbitrary convention as added in the code here: https://sourceforge.net/p/tikiwiki/code/59180
--
...
SET permName = REPLACE(permName,
                       permName,
                       (SELECT CONCAT( LEFT(permName, 40), '_', RIGHT(permName, 9)))
                      )
WHERE char_length(permName) > 50
