...
function iconset_default()
{
	return array(
		...
		'icons' => array(
			/* This is the definition of an icon in the icon set.
			 * For this one icon all options are explained.
			 * The key must be unique, it is the "name" parameter at the icon function,
			 * so eg: {icon name="save"}
			 * will find 'save' in the array and apply the specified configuration */
			
			'save' => array( 
				'class' => 'fa fa-save fa-fw',	// string added to classPrepend set above for a font icon (font-awesome, glyphicon, etc)
