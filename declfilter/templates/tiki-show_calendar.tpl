...
<tr><td style="text-align:center; padding-top:5px; padding-bottom: 5px">{if $viewlist eq 'list'}<span class="button2"><a href="tiki-calendar.php?viewlist=table{if $viewmonth}&amp;mon={$viewmonth}&amp;day={$viewday}&amp;year={$viewyear}{/if}" title="{tr}Calendar View{/tr}">{tr}Calendar View{/tr}</a></span>{else}<span class="button2"><a href="tiki-calendar.php?viewlist=list" title="{tr}List View{/tr}">{tr}List View{/tr}</a></span>{/if}
</td></tr>
