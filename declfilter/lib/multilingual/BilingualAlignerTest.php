...
class  BilingualAlignerTest extends PHPUnit_Framework_TestCase
{
   ...
   function test__generate_shortest_path_matrix() {
      ...
      $exp_cost_matrix["-1m1|-1m1"]["1m1|0m1"] = "match_cost";
      $exp_cost_matrix["-1m1|-1m1"]["1m1|0m2"]  = "match_cost";
      $exp_cost_matrix["-1m1|-1m1"]["1m2|0m1"] = "match_cost";
      $exp_cost_matrix["-1m1|-1m1"]["1s1|0s0"]  = "skip_cost";
      $exp_cost_matrix["-1m1|-1m1"]["1s0|0s1"] = "skip_cost";

      $exp_cost_matrix["-1m1|-1m1"]["0m1|1m1"] = "match_cost";
      $exp_cost_matrix["-1m1|-1m1"]["0m1|1m2"] = "match_cost";
      $exp_cost_matrix["-1m1|-1m1"]["0m2|1m1"] = "match_cost";
      $exp_cost_matrix["-1m1|-1m1"]["0s1|1s0"] = "skip_cost";
      $exp_cost_matrix["-1m1|-1m1"]["0s0|1s1"] = "skip_cost";
      ...
      $this->fail("Cost Matrix is wrong. Pickup development from there");
...
//       print "-- assert_parse_node_ID_yields: \$node_id=$node_id\n";
   ...
   private function assertCostMatrixEquals($exp_cost_martix, $got_cost_matrix, $message) {
//      $this->fail("TODO: Make the cost matrix check more user friendly when it fails.");
      $exp_origins = array_keys($exp_cost_martix);
      ...
      foreach (array_keys($exp_origins) as $origin) {
