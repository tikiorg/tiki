{* $Id: mod-switch_lang.tpl 38119 2011-10-10 13:15:35Z jonnybradley $ *}
{strip}
...
{if $mode eq 'flags'}
	{section name=ix loop=$languages}
		...
		{if $flag neq ''}
			{icon href="tiki-switch_lang.php?language=$val" alt="$langname" title="$langname" _id="img/flags/$flag.gif" height=11 class="icon $class"}
		{else}
