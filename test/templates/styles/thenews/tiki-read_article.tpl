...
{/if}
{if $prefs.feature_multilingual eq 'y' and $show_lang eq 'y' and $lang}
<span>{include file="translated-lang.tpl" td='y' type='article'}</span>
{/if}
{if $tiki_p_edit_article eq 'y'}
<span><a class="trailer" href="tiki-edit_article.php?articleId={$articleId}">{icon _id='page_edit'}</a></span>
{/if}
{if $prefs.feature_cms_print eq 'y'}
<span><a class="trailer" href="tiki-print_article.php?articleId={$articleId}">{icon _id='printer' alt='{tr}Print{/tr}'}</a></span>
{/if}
...
<span><a class="trailer" href="tiki-edit_translation.php?id={$articleId}&amp;type=article">{icon _id='world' alt='{tr}Translation{/tr}'}</a> &nbsp;</span>
{/if}
{if $tiki_p_remove_article eq 'y'}
<span><a class="trailer" href="tiki-list_articles.php?remove={$articleId}">{icon _id='cross' alt='{tr}Remove{/tr}'}</a></span>
{/if}
{*</div>*}
</div>
<div class="articleheading">
