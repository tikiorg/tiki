...
// $Header: /cvsroot/tikiwiki/tiki/tiki-admin_include_wiki.php,v 1.61 2006-11-15 08:37:40 mose Exp $
...
if (isset($_REQUEST["setwikiregex"])) {
	...
	$tikilib->set_preference('wiki_page_regex', $_REQUEST["wiki_pagename_strip"]);
