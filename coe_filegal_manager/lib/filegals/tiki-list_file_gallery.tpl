  ...
  {/if}
	...
	<div class="fg-galleries">
		...
		<div class="fg-toolbar">
			<div class="fg-toolbar-left">
				<a class="fg-toolbar-icon"><img src="images/file_gallery/icon-home.gif" border="0"/></a>
				<a class="fg-toolbar-icon"><img src="images/file_gallery/icon-edit-folder.gif" border="0"/></a>
	...
	<div class="fg-files">
		...
		<div class="fg-toolbar">
			...
			<div class="fg-toolbar-right">
				<input class="fg-toolbar-search-input" type="text"/>
				<a class="fg-toolbar-search-submit"><img src="images/file_gallery/icon-search.gif" border="0"/></a>
			</div>
		</div>
		<div class="fg-files-tools">
			<div class="fg-files-stats">1 folder, 5 files</div>
