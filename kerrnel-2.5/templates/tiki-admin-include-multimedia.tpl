...
{include file=multiplayer.tpl url="" w=$prefs.MultimediaDefaultLength h=$prefs.MultimediaDefaultHeight video='n'}
	...
	<td class="form">{tr}Flash Height{/tr}:</td><td class="form"><input type="text" name="MultimediaDefaultHeight" value="{$prefs.MultimediaDefaultHeight|escape}" size=7/></td>
	</tr>
	<tr>
	...
	<td class="form">{tr}Video Height{/tr}:</td><td class="form"><input type="text" name="VideoHeight" value="{$prefs.VideoHeight|escape}" size=7/></td>
	</tr>
	<tr>
