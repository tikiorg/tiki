...
#2008-08-29 kerrnel22
ALTER TABLE `tiki_tracker_items` ADD `createdBy` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `tiki_tracker_items` ADD `lastModifBy` VARCHAR( 200 ) NOT NULL;
