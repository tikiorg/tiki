...
function wikiplugin_file( $data, $params )
{
	...
	if (isset($params['fileId'])) {
		...
		if (isset($params['showicon']) && $params['showicon'] == "y") {
			return "{img src=tiki-download_file.php?fileId=$fileId&amp;thumbnail=y link=tiki-download_file.php?fileId=$fileId styleimage=max-width:32px} [tiki-download_file.php?fileId=$fileId|$data]";
		} else {
