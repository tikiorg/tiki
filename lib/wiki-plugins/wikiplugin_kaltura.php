...
function wikiplugin_kaltura($data, $params)
{
	...
	extract($params, EXTR_SKIP);
     ...
     $code ='<object name="kaltura_player" id="kaltura_player" type="application/x-shockwave-flash" allowScriptAccess="always" allowNetworking="all" allowFullScreen="true" height="365" width="400" data="'.$prefs['kaltura_kServiceUrl'].'index.php/kwidget/wid/'.$prefs['kaltura_kdpWidget'].'/uiconf_id/'.$prefs['kaltura_kdpUIConf'].'/entry_id/'.urlencode($id).'">
