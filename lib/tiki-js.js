...
function tr(str) {
	...
	if (lang !== undefined /* language.js is included after tiki-js.js. This prevents errors in case tr() is called before language.js is loaded. Ideally, language.js would be loaded before tr() is defined. */ && typeof lang[str] == 'string') {
		return lang[str];
	} else {
		return str;
	}
