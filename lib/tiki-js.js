...
// NOTE Prior to 11-May-09 this deleted empty fields, but users might add a field empty for a reason,
// NOTE so I've added them regardless.
      //if( val != '' ) {
        params.push( param + '="' + val + '"' );
      //} else {
	//alert('val for '+param+' is empty');
      //}
    }
