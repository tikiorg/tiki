...
function SetMyUrl(area,url) {
  ...
  str = "{img src=\""+myurl.replace(/display$/, 'thumbnail')+"\" link=\""+myurl+"\" rel=\"shadowbox[g];type=img\"} ";
  insertAt(area, str);
}
...
/* wikiplugin editor */
function popup_plugin_form( area_name, type, index, pageName, args, bodyContent, edit_icon )
{
