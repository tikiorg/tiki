	...
	if ($textareaEditor) {
		...
		var newString = '';
	 	...
	 	if (perLine) { //for bullets
			if (selection) {//we kill all contect because we already have the selection, and when we split it and re-insert, we get the lines again
			...
			$textareaEditor.replaceSelection(replaceString(toBeReplaced, selection));
