...
function prefs_watershed_list() {
	return array(
		...
		'watershed_archive_fieldId' => array(
			...
			'description' => tra('The Archive tracker must have a field for the videoId of each archive'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
		'watershed_archive_brand_fieldId' => array(
			...
			'description' => tra('The Archive tracker must have a field for the BrandId of each archive'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
		'watershed_archive_channel_fieldId' => array(
			...
			'description' => tra('The Archive tracker must have a field for the ChannelCode of each archive'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
		'watershed_archive_rtmpurl_fieldId' => array(
			'name' => tra('Field ID of rtmpURL for Archive'),
			'description' => tra('The Archive tracker must have a field for storing the RTMP URL to access the archive'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
		'watershed_archive_flvurl_fieldId' => array(
			'name' => tra('Field ID of flvURL for Archive'),
			'description' => tra('The Archive tracker must have a field for storing the FLV URL to access the archive'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
		'watershed_archive_date_fieldId' => array(
			'name' => tra('Field ID of Date for Archive'),
			'description' => tra('The Archive tracker can have a datetime field for storing the time the recording completed'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
		'watershed_archive_duration_fieldId' => array(
			...
			'description' => tra('The Archive tracker can have a field for storing the duration of the recording'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
		'watershed_archive_filesize_fieldId' => array(
			...
			'description' => tra('The Archive tracker can have a field for storing the filesize of the recording'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
		'watershed_archive_title_fieldId' => array(
			...
			'description' => tra('The Archive tracker could have a field for storing the title of the recording'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
		'watershed_archive_desc_fieldId' => array(
			'name' => tra('Field ID of Description for Archive'),
			'description' => tra('The Archive tracker could have a field for storing the description of the recording'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
