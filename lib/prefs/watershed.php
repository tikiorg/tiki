...
function prefs_watershed_list() {
	return array(
		...
		'watershed_archive_rtmpurl_fieldId' => array(
			'name' => tra('Field ID of rtmpURL for Archive (url)'),
		...
		'watershed_archive_flvurl_fieldId' => array(
			'name' => tra('Field ID of flvURL for Archive (url)'),
		...
		'watershed_archive_desc_fieldId' => array(
			'name' => tra('Field ID of Description for Archive (textarea)'),
		...
		'watershed_archive_tags_fieldId' => array(
			'name' => tra('Field ID of Tags for Archive'),
			'description' => tra('The Archive tracker could have a text field for storing the tags of the recording'),
			'type' => 'text',
			'size' => '3',
			'filter' => 'digits',
		),
