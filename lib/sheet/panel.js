...
// Panel Object {{{1
function Panel( title, x, y, width )
{
    this.title = title;
    this.x = x;
    this.y = y;
...
{
    var total = '<div class="panel" id="Panel_' + this.title + '" style="position: absolute; left: ' + String( this.x ) + '; top: ' + String( this.y ) + '; width: ' + String( this.width ) + ';">';
