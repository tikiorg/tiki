...
$(function () {
	...
	var compareSheetButtons = $('.compareSheet1,.compareSheet2').click(function() {
		compareSheetButtons.removeAttr('disabled');
		$(this).parent().parent().find('input').not(this).attr('disabled', true).removeAttr('checked');
	});
});