...
(function ($) {
	...
	function browserAddFile(link)
	{
		var content = $(link).closest('.media-body').clone(true),
			icon = $(link).closest('.media').find('.media-object').children().clone(true).width('16px'),
	...
	$(document).on('selection-update', '.file-browser', function (e) {
		...
		$('.gallery-list .media-heading a', this).each(function () {
	...
	$(document).on('click', '.file-browser .gallery-list .media-heading a', function (e) {
		e.preventDefault();
		e.stopPropagation();
		browserAddFile(this);
	});
	$(document).on('click', '.file-browser .gallery-list .media', function (e) {
		e.preventDefault();
		$('.media-heading a', this).click();
	});
