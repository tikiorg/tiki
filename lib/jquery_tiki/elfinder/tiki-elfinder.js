...
elFinder.prototype.commands.info = function() {
	...
	this.exec = function(hashes) {
		...
		if (cnt == 1) {
			...
			var desc;
			if (file.write) {
				desc = '<textarea cols="40" rows="5" id="elfinder-fm-file-desc" class="ui-widget ui-widget-content" disabled="true" >' + msg.calc + '</textarea><br><input type="button" id="elfinder-fm-file-desc-btn-save" value="' + fm.i18n('btnSave') + '" />';
			} else {
				desc = '<div id="elfinder-fm-file-desc">' + msg.calc + '</div>'
			}
