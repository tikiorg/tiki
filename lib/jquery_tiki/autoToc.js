...
$(function () {
    ...
    if (document.getElementById("page-data") && !document.getElementById("toc-off") && document.location.href.indexOf("tiki-print.php") == -1 ) {
        ...
        if (headers.length > 1) {
			...
			tocString = "<div id='outerToc'> <a href='#'> Table of Contents, or Click for Page Top</a><div id='innerToc'></div></div><div id='outerToc-static'><p>Table of Contents</a><div id='toc-static'></div></div>";
