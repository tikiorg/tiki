...
function confirmAction(form) {
	...
	$.ajax({
		...
		success: function (data) {
			...
			/* if extra is set to post or simple and forward and modal are not set
			...
			if (extra && !forward && !modal) {
				...
				//related php and smarty logic provided by the smarty feedback function and related code
				} else if (extra === 'post') {
