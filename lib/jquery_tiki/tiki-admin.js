(function ($) {
	$(document).on('change', '.preference :checkbox:not(.pref-reset)', function () {
		var childBlock = $(this).data('tiki-admin-child-block')
			...
			, childrenElements = $(this).parents('.adminoptionbox').siblings('.adminoptionboxchild').find(':input[id^="pref-"]')
			;
	...
	$(document).on('change', '.preference select', function () {
		var childBlock = $(this).data('tiki-admin-child-block')
			, selected = $(this).val()
			, childMode = $(this).data('tiki-admin-child-mode')
			, childrenElements = $(this).parent().parent('.adminoptionbox').siblings('.adminoptionboxchild').find(':input[id^="pref-"]')
			;
