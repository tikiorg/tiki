...
/**
 * An onclick function that can be used to open a tab on the current page, e.g.:
 *
 * <a href="#" onclick="goToTab(this, 2); return false;">Open tab 2 on this page</a>
 *
 * @param element           the element clicked
 * @param tabNumber         number of the tab on the current page to show
 * @returns {boolean}
 */
function goToTab(tabNumber, element) {
	var thisTabId = $(element).parents('.tab-pane.active').attr('id'),
