...
$(function () {
	...
	var toggleZone = function (zone) {
		if (location.pathname.indexOf("tiki-admin_modules.php") > -1) {
			return;
		}
		if (zone === "right") {
			if (getCookie("hide_right_zone")) {
				$col3.addClass("hidden");
				if ($col2.length) {
					if ($col1.is(".col-md-8")) {
						$col1.removeClass("col-md-8").addClass("col-md-10");
					} else if ($col1.is(".col-md-10")) {
						$col1.removeClass("col-md-10").addClass("col-md-12");
					}
					$col2.removeClass("col-md-pull-8").addClass("col-md-pull-10");
				} else {
					$col1.removeClass("col-md-9").addClass("col-md-12");
				}
			} else {
				$col3.removeClass("hidden");
				if ($col2.length) {
					if ($col1.is(".col-md-10")) {
						$col1.removeClass("col-md-10").addClass("col-md-8");
					} else if ($col1.is(".col-md-12")) {
						$col1.removeClass("col-md-12").addClass("col-md-10");
					}
					$col2.removeClass("col-md-pull-10").addClass("col-md-pull-8");
				} else {
					$col1.removeClass("col-md-12").addClass("col-md-9");
				}
			}
		} else if (zone === "left") {
			if (getCookie("hide_left_zone")) {
				$col2.addClass("hidden");
				if ($col3.length) {
					if ($col1.is(".col-md-8")) {
						$col1.removeClass("col-md-push-2").removeClass("col-md-8").addClass("col-md-10");
					} else if ($col1.is(".col-md-10")) {
						$col1.removeClass("col-md-push-2").removeClass("col-md-10").addClass("col-md-12");
					}
				} else {
					$col1.removeClass("col-md-push-3").removeClass("col-md-9").addClass("col-md-12");
				}
			} else {
				$col2.removeClass("hidden");
				if ($col3.length) {
					if ($col1.is(".col-md-10") && ! $col1.is(".col-md-push-2")) {
						$col1.removeClass("col-md-10").addClass("col-md-8").addClass("col-md-push-2");
					} else if ($col1.is(".col-md-12")) {
						$col1.removeClass("col-md-12").addClass("col-md-10").addClass("col-md-push-2");
					}
				} else {
					$col1.removeClass("col-md-12").addClass("col-md-9").addClass("col-md-push-3");
				}
			}
		}
	};
	...
	$(".toggle_zone").click(function () {
		...
		if ($this.is(".right")) {
			if ($this.find(".icon-minus-circle").length) {	// hide it
				$this.find(".icon").setIcon("plus-circle");
				setCookie('hide_right_zone', 'y');
			} else {
				$this.find(".icon").setIcon("minus-circle");
				deleteCookie('hide_right_zone');
			}
			toggleZone("right");
		} else if ($this.is(".left")) {
			if ($this.find(".icon-minus-circle").length) {	// hide it
				$this.find(".icon").setIcon("plus");
				setCookie('hide_left_zone', 'y');
			} else {
				$this.find(".icon").setIcon("minus-circle");
				deleteCookie('hide_left_zone');
			}
			toggleZone("left");
		}
	});
 ...
 * vendor/jquery/plugins/tablesorter/js/jquery.tablesorter.combined.js:2373
 *
 * @param str
 */
