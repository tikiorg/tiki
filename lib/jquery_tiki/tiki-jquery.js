...
(function($) {
	...
	$.fn.comment_toggle = function (type, id) {
		this.each(function () {
	...
	$.fn.comment_load = function (type, id) {
		this.each(function () {
			var comment_container = this;
			$(this).load('tiki-ajax_services.php', {
				controller: 'comment',
				action: 'list',
				type: type,
				objectId: id
				...
				$('.comment-form a', this).click(function () {
					$(this).parent().removeClass('button').load($(this).attr('href'), function () {
						$('form', this).submit(function () {
							var form = this, errors;
							$.post('tiki-ajax_services.php', $(this).serialize(), function (data, st) {
								if (data.threadId) {
									$(comment_container).empty().comment_load(type, id);
								} else {
