...
$.fn.rangyRestore = function(serializedSelection, fn) {
	var me = $(this);
	$.rangySupported(function() {
		rangy.deserializeSelection(serializedSelection, me[0]);
		rangy.createCssClassApplier("ui-state-highlight rangy-highlight").toggleSelection();
		
		var highlighted = $('.rangy-highlight');
		$('html,body').animate({
