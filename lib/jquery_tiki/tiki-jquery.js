...
function popupPluginForm(area_name, type, index, pageName, pluginArgs, bodyContent, edit_icon){
	...
	// See smarty_tiki/block.add_help.php for the other end of this
	if (typeof window.pluginHelpTempSelectionStart != 'undefined' && typeof window.pluginHelpTempSelectionEnd != 'undefined') {
                if (textarea.selectionStart != window.pluginHelpTempSelectionStart) {
                        textarea.selectionStart = window.pluginHelpTempSelectionStart;
                }
                if (textarea.selectionEnd != window.pluginHelpTempSelectionEnd) {
                        textarea.selectionEnd = window.pluginHelpTempSelectionEnd;
                }
		delete window.pluginHelpTempSelectionStart;
		delete window.pluginHelpTempSelectionEnd;
	}
