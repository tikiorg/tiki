	...
	$.fn.object_selector = function (prepareOptionFn, value, title) {
		...
		this.each(function () {
			...
			var $spinner = $(this).parent(),
				...
				$selection = $container.find('.panel-footer .selection').first(),
				$results = $container.find('.results'),
				$noresults = $container.find('.no-results');
			...
			$spinner.tikiModal(" "),
			loadSelectorData(filter, {maxRecords: threshold}, function (data) {
				loadResult(data.resultset.result);
