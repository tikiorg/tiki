					...
					case "jscalendar":	// replacements for jscalendar
						...
						opts = {
							...
							onClose: function(dateText, inst) {
								...
								var val = $(inst.settings.altField).val();
								val = val.substring(0, val.indexOf(" ") );
								var timestamp = parseInt(val / 1000, 10);
...
$(function () {
    ...
    var chkUrl = document.getElementById(maincol).baseURI || document.URL;
    if (chkUrl.indexOf('tiki-admin_modules.php') >= 0) {
        return;
    }
