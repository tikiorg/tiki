 ...
 * If tikifeedback div is outside of the viewport, place it at the top of the viewport and have it disappear after
 * 5 seconds
 */
	...
	if (feedback) {
		...
		tfb.fadeIn(200, function() {
			...
			if (tfb.offset().top < $(window).scrollTop()) {
				tfb.find('div.rboxcontent').after('<div id="timer" style="font-size:smaller;margin-top:10px"><em>'
					+ tr('This message will disappear after') + ' <span id="timer-seconds">5</span> '
					+ tr('seconds') + '.</em>');
