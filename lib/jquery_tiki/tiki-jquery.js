...
(function($) {
	...
	$.fn.object_selector = function (prepareOptionFn, value, title) {
		...
		function loadData(filter, success) {
			...
			loadData(filter, function (data) {
				...
				if (data.resultset.count <= threshold) {
					...
					$search.click(function (e) {
						...
						this.ajax = loadData($.extend(filter, {title: $filter.val()}), function (data) {
							$results.empty();
							$noresults.removeClass('hidden');
							...
							$.each(data.resultset.result, function (key, value) {
								...
								$(':radio', item)
									...
									.click(function () {
										if ($(this).is(':checked')) {
											$(input).object_selector('set', $(this).val(), value.title);
										}
									});
								$results.append(item);
