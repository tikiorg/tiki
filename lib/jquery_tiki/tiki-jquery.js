...
(function($) {
	...
	$.fn.favoriteToggle = function () {
		this.each(function () {
			...
			$(this).prepend($('<span />').attr({'class' : isFavorite() ? 'glyphicon glyphicon-star' : 'glyphicon glyphicon-star-empty', 'title' : isFavorite() ? 'Remove from favorites' : 'Add to favorites'}));
...
$(document).on('shown.bs.modal', '#bootstrap-modal', function () {
	// TODO : This needs to trigger on loaded.bs.modal when available
