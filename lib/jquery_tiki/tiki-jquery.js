...
// Adjust the top margin of the middle to match the height of the header
var headerh = $(".layout_basic .page-header").height();
$(".layout_basic .row-middle").css("margin-top", headerh + "px");

// Adjust the width of the module zones in header to match width of the middle
var middlew = $(".layout_basic .row-middle").width();
$(".layout_basic .page-header > div > div").css("width", middlew + "px");
...
$(function () {
	...
	if (document.location.search.match(/cookietab=/)) {
		...
		$(".tabs").each(function () {
			var t = getCookie($(this).data("name"), "tabs");
