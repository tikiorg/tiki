...
// $Header: /cvsroot/tikiwiki/tiki/lib/setup/wiki.php,v 1.1 2007-10-06 15:18:45 nyloth Exp $
...
if ( $feature_wiki_discuss == 'y' ) {
	$wiki_discussion_string = $smarty->fetchLang($language, 'wiki-discussion.tpl');
