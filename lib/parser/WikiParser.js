...
break;
case 6:this.$ = yy.cmd.plugin($$[$0]);
break;
case 7:
		$$[$0].body = $$[$0-1];
		this.$ = yy.cmd.plugin($$[$0]);
...
case 10:this.$ = $$[$0];
break;
case 11:this.$ = yy.cmd.html($$[$0]);
break;
case 12:this.$ = $$[$0];
break;
case 13:this.$ = $$[$0];
break;
case 14:this.$ = yy.cmd.make_bold($$[$0-1]);
break;
case 15:this.$ = yy.cmd.make_box($$[$0-1]);
break;
case 16:this.$ = yy.cmd.make_center($$[$0-1]);
break;
case 17:
		var text = $$[$0-1].split(':');
		this.$ = yy.cmd.make_colortext(text[0], text[1]);
	
break;
case 18:this.$ = yy.cmd.make_italics($$[$0-1]);
break;
case 19:this.$ = yy.cmd.make_header6($$[$0-1]);
break;
case 20:this.$ = yy.cmd.make_header5($$[$0-1]);
break;
case 21:this.$ = yy.cmd.make_header4($$[$0-1]);
break;
case 22:this.$ = yy.cmd.make_header3($$[$0-1]);
break;
case 23:this.$ = yy.cmd.make_header2($$[$0-1]);
break;
case 24:this.$ = yy.cmd.make_header1($$[$0-1]);
break;
case 25:
		var link = $$[$0-1].split('|');
		var href = $$[$0-1];
		...
		this.$ = yy.cmd.make_link(href, text);
	
break;
case 26:this.$ = $$[$0-1];
break;
case 27:this.$ = yy.cmd.make_strikethrough($$[$0-1]);
break;
case 28:
		var tableContents = '';
		var rows = yy.cmd.split('<br />', $$[$0-1]);
		...
		this.$ = yy.cmd.make_table(tableContents);
	
break;
case 29:this.$ = yy.cmd.make_titlebar($$[$0-1]);
break;
case 30:this.$ = yy.cmd.make_underscore($$[$0-1]);
break;
case 31:
		...
		this.$ = yy.cmd.make_wikilink(href, text);
...
case 0:
		var pluginName = yy.cmd.match(/^\{([a-z]+)/, yy_.yytext)[1];
		var pluginParams = yy.cmd.match(/[ ].*?[}]|[/}]/, yy_.yytext);
		yy_.yytext = {
			name: pluginName,
			params: pluginParams,
			body: ''
...
case 2:
		if (yy.pluginStack) {
			if (
				...
				yy.cmd.match(yy.pluginStack[yy.pluginStack.length - 1].name, yy_.yytext)
			) {
...
break;
case 6:
		var smile = this.yy.cmd.substring(yy_.yytext, 2, -2);
		yy_.yytext = this.yy.cmd.make_smile(smile);
		return 15;
	
break;
case 7:
		yy_.yytext = this.yy.cmd.substring(yy_.yytext, 2, -1);
		return 12;
	
break;
case 8: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'BOLD_END'); 
break;
case 9: this.begin('bold');			return (this.yy.npOn ? 'CONTENT' : 'BOLD_START'); 
break;
case 10: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'BOX_END'); 
break;
case 11: this.begin('box');			return (this.yy.npOn ? 'CONTENT' : 'BOX_START'); 
break;
case 12: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'CENTER_END'); 
break;
case 13: this.begin('center');		return (this.yy.npOn ? 'CONTENT' : 'CENTER_START'); 
break;
case 14: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'COLORTEXT_END'); 
break;
case 15: this.begin('colortext');		return (this.yy.npOn ? 'CONTENT' : 'COLORTEXT_START'); 
break;
case 16: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'HEADER6_END'); 
break;
case 17: this.begin('header6');		return (this.yy.npOn ? 'CONTENT' : 'HEADER6_START'); 
break;
case 18: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'HEADER5_END'); 
break;
case 19: this.begin('header5');		return (this.yy.npOn ? 'CONTENT' : 'HEADER5_START'); 
break;
case 20: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'HEADER4_END'); 
break;
case 21: this.begin('header4');		return (this.yy.npOn ? 'CONTENT' : 'HEADER4_START'); 
break;
case 22: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'HEADER3_END'); 
break;
case 23: this.begin('header3');		return (this.yy.npOn ? 'CONTENT' : 'HEADER3_START'); 
break;
case 24: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'HEADER2_END'); 
break;
case 25: this.begin('header2');		return (this.yy.npOn ? 'CONTENT' : 'HEADER2_START'); 
break;
case 26: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'HEADER1_END'); 
break;
case 27: this.begin('header1');		return (this.yy.npOn ? 'CONTENT' : 'HEADER1_START'); 
break;
case 28: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'ITALIC_END'); 
break;
case 29: this.begin('italic');		return (this.yy.npOn ? 'CONTENT' : 'ITALIC_START'); 
break;
case 30: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'LINK_END'); 
break;
case 31: this.begin('link');			return (this.yy.npOn ? 'CONTENT' : 'LINK_START'); 
break;
case 32: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'STRIKETHROUGH_END'); 
break;
case 33: this.begin('strikethrough');	return (this.yy.npOn ? 'CONTENT' : 'STRIKETHROUGH_START'); 
break;
case 34: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'TABLE_END'); 
break;
case 35: this.begin('table');			return (this.yy.npOn ? 'CONTENT' : 'TABLE_START'); 
break;
case 36: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'TITLEBAR_END'); 
break;
case 37: this.begin('titlebar');		return (this.yy.npOn ? 'CONTENT' : 'TITLEBAR_START'); 
break;
case 38: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'UNDERSCORE_END'); 
break;
case 39: this.begin('underscore');	return (this.yy.npOn ? 'CONTENT' : 'UNDERSCORE_START'); 
break;
case 40: this.popState();				return (this.yy.npOn ? 'CONTENT' : 'WIKILINK_END'); 
break;
case 41: this.begin('wikilink');		return (this.yy.npOn ? 'CONTENT' : 'WIKILINK_START'); 
break;
case 42:return 13
break;
case 43:return 12
break;
case 44:
		yy_.yytext = this.yy.cmd.replace(/\n/g, '<br />', yy_.yytext);
		return 12;
