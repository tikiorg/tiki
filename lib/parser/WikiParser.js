...
case 3:this.$ = $$[$0];
break;
case 4:this.$ = parserlib.join($$[$0-1], $$[$0]);
break;
case 5:this.$ = parserlib.join($$[$0-2], $$[$0-1], $$[$0]);
break;
case 6:this.$ = parserlib.plugin($$[$0]);
break;
case 7:
		$$[$0].body = $$[$0-1];
		this.$ = parserlib.plugin($$[$0]);
	
break;
case 8:this.$ = $$[$0];
break;
case 9:this.$ =  parserlib.join($$[$0-1], $$[$0]);
break;
case 10:this.$ = $$[$0];
break;
case 11:this.$ = parserlib.html($$[$0]);
break;
case 12:this.$ = $$[$0];
break;
case 13:this.$ = $$[$0];
break;
case 14:this.$ = parserlib.bold($$[$0-1]);
break;
case 15:this.$ = parserlib.box($$[$0-1]);
break;
case 16:this.$ = parserlib.center($$[$0-1]);
break;
case 17:this.$ = parserlib.colortext($$[$0-1]);
break;
case 18:this.$ = parserlib.italics($$[$0-1]);
break;
case 19:this.$ = parserlib.header6($$[$0-1]);
break;
case 20:this.$ = parserlib.header5($$[$0-1]);
break;
case 21:this.$ = parserlib.header4($$[$0-1]);
break;
case 22:this.$ = parserlib.header3($$[$0-1]);
break;
case 23:this.$ = parserlib.header2($$[$0-1]);
break;
case 24:this.$ = parserlib.header1($$[$0-1]);
break;
case 25:this.$ = parserlib.link($$[$0-1]);
break;
case 26:this.$ = $$[$0-1];
break;
case 27:this.$ = parserlib.strikethrough($$[$0-1]);
break;
case 28:this.$ = parserlib.table($$[$0-1]);
break;
case 29:this.$ = parserlib.titlebar($$[$0-1]);
break;
case 30:this.$ = parserlib.underscore($$[$0-1]);
break;
case 31:this.$ = parserlib.wikilink($$[$0-1]);
break;
}
},
