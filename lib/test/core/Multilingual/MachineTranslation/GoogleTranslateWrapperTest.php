...
//  protected $backupGlobals = FALSE;
   ...
   public function _test_translate_text_that_translates_into_accentuated_text() {
   	  ...
   	  $translation = $this->translator->translateText($text);
   	  $this->assertEquals("Niente al mondo Ã¨ mai completamente sbagliato; fermato anche un orologio Ã¨ giusto due volte al giorno.", $translation, "The translation was not correct for text that translates into text that contains accentuated chars.");
   }
   ...
   public function _test_translate_text_with_up_to_1800_chars() {
   	  ...
   	  $translation = $this->translator->translateText($text);
   	  $this->assertEquals(trim(str_repeat("Niente al mondo Ã¨ mai completamente sbagliato; fermato anche un orologio Ã¨ giusto due volte al giorno. ",19)), $translation, "The translation was not correct for text of 1800 chars.");
   }
   ...
   public function _test_translate_text_with_more_than_1800_chars() {
   	  ...
   	  $translation = $this->translator->translateText($text);
   	  $this->assertEquals(trim(str_repeat("Niente al mondo Ã¨ mai completamente sbagliato; fermato anche un orologio Ã¨ giusto due volte al giorno. ",24)), $translation, "The translation was not correct for text of 1800 chars.");
   }
...
///////////////////////////////////////////////
    ...
    */ 
	public function test_english_one_title_gets_translated() {
		...
		$translator = new Multilingual_MachineTranslation_GoogleTranslateWrapper('en','fr');
	  	$translation = $translator->translateText($text);
		$this->assertEquals('<h3 class="showhide_heading" id="Get_Started_using_Profiles"><a class="wiki"  href="tiki-admin.php?profile=&amp;category=Featured+profiles&amp;repository=http%3a%2f%2fprofiles.tikiwiki.org%2fprofiles&amp;preloadlist=y&amp;page=profiles&amp;list=List#profile-results" rel="">commencer à utiliser panneau admin</a><br /></h3>', $translation, "The translation was not correct for text: $text.");	
	}
    ...
    */ 
	public function test_english_titles_get_translated() {
		...
		$translator = new Multilingual_MachineTranslation_GoogleTranslateWrapper('en','fr');
	  	$translation = $translator->translateText($text);
		$this->assertEquals('<h3 class="showhide_heading" id="Get_Started_using_Profiles"><a class="wiki"  href="tiki-admin.php?profile=&amp;category=Featured+profiles&amp;repository=http%3a%2f%2fprofiles.tikiwiki.org%2fprofiles&amp;preloadlist=y&amp;page=profiles&amp;list=List#profile-results" rel="">commencer à utiliser panneau admin</a><br /></h3><h3 class="showhide_heading" id="Get_Started_using_Profiles"><a class="wiki"  href="tiki-admin.php?profile=&amp;category=Featured+profiles&amp;repository=http%3a%2f%2fprofiles.tikiwiki.org%2fprofiles&amp;preloadlist=y&amp;page=profiles&amp;list=List#profile-results" rel="">commencer à utiliser des profils</a><br /></h3>', $translation, "The translation was not correct for text: $text.");	
	}
