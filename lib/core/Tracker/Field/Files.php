			...
			if ($this->getOption(3)) { // images
				...
				foreach ($this->getConfiguration('files') as $fileId => $file) {
					...
					if (
						...
						$src = smarty_modifier_sefurl($file['fileId'], 'file');

						$ret .= " <a href='tiki-edit_draw.php?fileId=" . $file['fileId'] . "' onclick='return $(this).ajaxEditDraw();'  title='Edit: ".$file['name']."' data-fileid='".$file['fileId']."' data-galleryid='".$file['galleryId']."' data-src='" . $src . "'>
