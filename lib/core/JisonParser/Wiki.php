...
break;
case 9:
        $thisS = $this->doubleDynamicVar($S[$O]); //js
    
break;
case 10:
        $thisS = $this->singleDynamicVar($S[$O]); //js
...
break;
case 46:
   	    if ($this->skipNextBr == false) {
   	        $thisS = "<br />";
   	    }

   	    $this->skipNextBr = false;
