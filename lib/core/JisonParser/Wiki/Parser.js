...
break;
case 4:
		this.$ = this.join($$[$0-1], $$[$0]);//js
		//php this.$ = this->join($$[$0-1], $$[$0]);
	
break;
case 5:
		this.$ = this.join($$[$0-2], $$[$0-1], $$[$0]);//js
		//php this.$ = this->join($$[$0-2], $$[$0-1], $$[$0]);
	
break;
case 6:
		this.$ = this.plugin($$[$0]);//js
...
break;
case 14:
		this.$ = this.bold($$[$0-1]);//js
		//php this.$ = this->bold($$[$0-1]);
		
	
break;
case 15:
		this.$ = this.box($$[$0-1]);//js
		//php this.$ = this->box($$[$0-1]);
	
break;
case 16:
		this.$ = this.center($$[$0-1]);//js
		//php this.$ = this->center($$[$0-1]);
	
break;
case 17:
		this.$ = this.colortext($$[$0-1]);//js
		//php this.$ = this->colortext($$[$0-1]);
	
break;
case 18:
		this.$ = this.italics($$[$0-1]);//js
		//php this.$ = this->italics($$[$0-1]);
	
break;
case 19:
		this.$ = this.header6($$[$0-1]);//js
		//php this.$ = this->header6($$[$0-1]);
	
break;
case 20:
		this.$ = this.header5($$[$0-1]);//js
		//php this.$ = this->header5($$[$0-1]);
	
break;
case 21:
		this.$ = this.header4($$[$0-1]);//js
		//php this.$ = this->header4($$[$0-1]);
	
break;
case 22:
		this.$ = this.header3($$[$0-1]);//js
		//php this.$ = this->header3($$[$0-1]);
	
break;
case 23:
		this.$ = this.header2($$[$0-1]);//js
		//php this.$ = this->header2($$[$0-1]);
	
break;
case 24:
		this.$ = this.header1($$[$0-1]);//js
		//php this.$ = this->header1($$[$0-1]);
	
break;
case 25:
		this.$ = this.link($$[$0-1]);//js
...
break;
case 27:
		this.$ = this.strikethrough($$[$0-1]);//js
		//php this.$ = this->strikethrough($$[$0-1]);
	
break;
case 28:
		this.$ = this.table($$[$0-1]);//js
		//php this.$ = this->table($$[$0-1]);
	
break;
case 29:
		this.$ = this.titlebar($$[$0-1]);//js
