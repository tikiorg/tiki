...
case 4:
		...
		//php this.$ = JisonParser_Wiki_Handler::join($$[$0-1], $$[$0]);
	
break;
case 5:
		this.$ = Parser.join($$[$0-2], $$[$0-1], $$[$0]); //js
		
		//php this.$ = JisonParser_Wiki_Handler::join($$[$0-2], $$[$0-1], $$[$0]);
	
break;
case 6:
		this.$ = Parser.plugin($$[$0]); //js
		
		//php this.$ = JisonParser_Wiki_Handler::plugin($$[$0]);
...
case 11:
		...
		//php this.$ = JisonParser_Wiki_Handler::html($$[$0]);
...
case 14:
		...
		//php this.$ = JisonParser_Wiki_Handler::bold($$[$0-1]);
		
	
break;
case 15:
		this.$ = Parser.box($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::box($$[$0-1]);
	
break;
case 16:
		this.$ = Parser.center($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::center($$[$0-1]);
	
break;
case 17:
		this.$ = Parser.colortext($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::colortext($$[$0-1]);
	
break;
case 18:
		this.$ = Parser.italics($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::italics($$[$0-1]);
	
break;
case 19:
		this.$ = Parser.header6($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::header6($$[$0-1]);
	
break;
case 20:
		this.$ = Parser.header5($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::header5($$[$0-1]);
	
break;
case 21:
		this.$ = Parser.header4($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::header4($$[$0-1]);
	
break;
case 22:
		this.$ = Parser.header3($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::header3($$[$0-1]);
	
break;
case 23:
		this.$ = Parser.header2($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::header2($$[$0-1]);
	
break;
case 24:
		this.$ = Parser.header1($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::header1($$[$0-1]);
	
break;
case 25:
		this.$ = Parser.link($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::link($$[$0-1]);
...
case 27:
		...
		//php this.$ = JisonParser_Wiki_Handler::strikethrough($$[$0-1]);
	
break;
case 28:
		this.$ = Parser.tableParser($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::tableParser($$[$0-1]);
	
break;
case 29:
		this.$ = Parser.titlebar($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::titlebar($$[$0-1]);
	
break;
case 30:
		this.$ = Parser.underscore($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::underscore($$[$0-1]);
	
break;
case 31:
		this.$ = Parser.wikilink($$[$0-1]); //js
		//php this.$ = JisonParser_Wiki_Handler::wikilink($$[$0-1]);
...
case 0:
		...
		//php $yy_.yytext = JisonParser_Wiki_Handler::inlinePlugin($yy_.yytext);
...
case 1:
		...
		//php $yy->pluginStack = JisonParser_Wiki_Handler::stackPlugin($yy_.yytext, $yy->pluginStack);
...
case 2:
		...
		//php 		JisonParser_Wiki_Handler::substring($yy_.yytext, 1, -1) == $yy->pluginStack[JisonParser_Wiki_Handler::size($yy->pluginStack) - 1]->name
		//php 	) {
		//php 		if (JisonParser_Wiki_Handler::size($yy->pluginStack) == 1) {
		//php 			$yy_.yytext = $yy->pluginStack[JisonParser_Wiki_Handler::size($yy->pluginStack) - 1];
...
case 5:
		...
		//php $yy_.yytext = JisonParser_Wiki_Handler::hr();
...
case 6:
		...
		//php $yy_.yytext = JisonParser_Wiki_Handler::substring($yy_.yytext, 2, -2);
		//php $yy_.yytext = JisonParser_Wiki_Handler::smile($yy_.yytext);
...
case 7:
		...
		//php $yy_.yytext = JisonParser_Wiki_Handler::substring($yy_.yytext, 2, -1);
...
case 44:
		if (Parser.npState(this.yy.npOn, false, true) == true) { //js
			yy_.yytext = Parser.formatContent(yy_.yytext); //js
		} //js
		
		//php if (JisonParser_Wiki_Handler::npState($this->npOn, false, true) == true) {
		//php 	$yy_.yytext = JisonParser_Wiki_Handler::formatContent($yy_.yytext);
		//php }
