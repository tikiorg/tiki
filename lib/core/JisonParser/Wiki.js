...
break;
case 4:
		this.$ = Wiki.join($$[$0-1], $$[$0]); //js
		
		//php this.$ = this->join($$[$0-1], $$[$0]);
	
break;
case 5:
		this.$ = Wiki.join($$[$0-2], $$[$0-1], $$[$0]); //js
		
		//php this.$ = this->join($$[$0-2], $$[$0-1], $$[$0]);
	
break;
case 6:
		this.$ = Wiki.plugin($$[$0]); //js
...
break;
case 14:
		this.$ = Wiki.bold($$[$0-1]); //js
		//php this.$ = this->bold($$[$0-1]);
	
break;
case 15:
		this.$ = Wiki.box($$[$0-1]); //js
		//php this.$ = this->box($$[$0-1]);
	
break;
case 16:
		this.$ = Wiki.center($$[$0-1]); //js
		//php this.$ = this->center($$[$0-1]);
	
break;
case 17:
		this.$ = Wiki.colortext($$[$0-1]); //js
		//php this.$ = this->colortext($$[$0-1]);
	
break;
case 18:
		this.$ = Wiki.italics($$[$0-1]); //js
		//php this.$ = this->italics($$[$0-1]);
	
break;
case 19:
		this.$ = Wiki.header6($$[$0-1]); //js
		//php this.$ = this->header6($$[$0-1]);
	
break;
case 20:
		this.$ = Wiki.header5($$[$0-1]); //js
		//php this.$ = this->header5($$[$0-1]);
	
break;
case 21:
		this.$ = Wiki.header4($$[$0-1]); //js
		//php this.$ = this->header4($$[$0-1]);
	
break;
case 22:
		this.$ = Wiki.header3($$[$0-1]); //js
		//php this.$ = this->header3($$[$0-1]);
	
break;
case 23:
		this.$ = Wiki.header2($$[$0-1]); //js
		//php this.$ = this->header2($$[$0-1]);
	
break;
case 24:
		this.$ = Wiki.header1($$[$0-1]); //js
		//php this.$ = this->header1($$[$0-1]);
	
break;
case 25:
		this.$ = Wiki.link($$[$0-1]); //js
...
break;
case 27:
		this.$ = Wiki.strikethrough($$[$0-1]); //js
		//php this.$ = this->strikethrough($$[$0-1]);
	
break;
case 28:
		this.$ = Wiki.tableParser($$[$0-1]); //js
		//php this.$ = this->tableParser($$[$0-1]);
	
break;
case 29:
		this.$ = Wiki.titlebar($$[$0-1]); //js
		//php this.$ = this->titlebar($$[$0-1]);
	
break;
case 30:
		this.$ = Wiki.underscore($$[$0-1]); //js
		//php this.$ = this->underscore($$[$0-1]);
	
break;
case 31:
		this.$ = Wiki.wikilink($$[$0-1]); //js
...
case 0:
		yy_.yytext = Wiki.inlinePlugin(yy_.yytext); //js
...
break;
case 1:
		yy.pluginStack = Wiki.stackPlugin(yy_.yytext, yy.pluginStack); //js
...
case 2:
		if (yy.pluginStack) { //js
			if ( //js
				...
				Wiki.substring(yy_.yytext, 1, -1) == yy.pluginStack[Wiki.size(yy.pluginStack) - 1].name //js
			) { //js
				if (Wiki.size(yy.pluginStack) == 1) { //js
					yy_.yytext = yy.pluginStack[Wiki.size(yy.pluginStack) - 1]; //js
		...
		//php 		$this->substring($yy_.yytext, 1, -1) == $this->pluginStack[$this->size($this->pluginStack) - 1]['name']
		//php 	) {
		//php 		if ($this->size($this->pluginStack) == 1) {
		//php 			$yy_.yytext = $this->pluginStack[$this->size($this->pluginStack) - 1];
...
break;
case 6:
		yy_.yytext = Wiki.substring(yy_.yytext, 2, -2); //js
		yy_.yytext = Wiki.smile(yy_.yytext); //js
...
break;
case 7:
		yy_.yytext = Wiki.substring(yy_.yytext, 2, -1); //js
...
case 44:
		if (Wiki.npState(this.yy.npOn, false, true) == true) { //js
			yy_.yytext = Wiki.formatContent(yy_.yytext); //js
		} //js
		
		//php if ($this->npState($this->npOn, false, true) == true) {
		//php 	$yy_.yytext = $this->formatContent($yy_.yytext);
		//php }
