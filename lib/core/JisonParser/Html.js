...
break;
case 2:
		//php if ($this->isLastInHtmlElementStack($yy_.yytext)) {
		//php   $this->popState();
		//php   $close = $yy_.yytext;
		//php   $yy_.yytext = array_pop($this->htmlElementStack);
		//php   $yy_.yytext['close'] = $close;
		//php   if ($yy_.yytext['state'] == 'open') {
		//php       $yy_.yytext['state'] = 'closed';
		//php   }
