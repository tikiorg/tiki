...
class LatexRender
{
    ...
    function getFormulaURL($latex_formula) {
        ...
        $formula_hash = md5($latex_formula . ";fd=" . $this->_formula_density);
        ...
        if (is_file($full_path_filename)) {
            ...
            for ($i=0, $isizeof_latex = sizeof($this->_latex_tags_blacklist); $i < $isizeof_latex; $i++) {
