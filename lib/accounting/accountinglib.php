...
class AccountingLib extends LogsLib
{
										...
										)
	{
		...
		$res = $this->query($query, array($bookName
																		, $bookClosed
																		, $bookStartDate
																		, $bookEndDate
																		, $bookCurrency
												...
												)
	{
		...
		$res = $this->query($query, array($newAccountId
																		, $accountName
																		, $accountNotes
																		, $cleanbudget
																		, $accountLocked
