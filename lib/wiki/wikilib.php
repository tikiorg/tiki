...
class WikiLib extends TikiLib {
  ...
  function wiki_rename_page($oldName,$newName)
  {
	...
	$this->query($query,array($newName_as,$newName_as,$newcathref,$oldName_as));
