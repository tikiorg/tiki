-- $Header: /cvsroot/tikiwiki/tiki/db/tiki-1.9-oci8.sql,v 1.10 2004-03-10 13:49:12 mose Exp $
...
CREATE SEQUENCE "tiki_live_support_requests_sequ" INCREMENT BY 1 START WITH 1;
...
CREATE TRIGGER "tiki_live_support_requests_trig" BEFORE INSERT ON "tiki_live_support_requests" REFERENCING NEW AS NEW OLD AS OLD FOR EACH ROW
BEGIN
SELECT "tiki_live_support_requests_sequ".nextval into :NEW."logId" FROM DUAL;
END;
/
...
CREATE SEQUENCE "hw_pages_sequ" INCREMENT BY 1 START WITH 1;
...
CREATE TRIGGER "hw_pages_trig" BEFORE INSERT ON "hw_pages" REFERENCING NEW AS NEW OLD AS OLD FOR EACH ROW
BEGIN
SELECT "hw_pages_sequ".nextval into :NEW."id" FROM DUAL;
END;
/
