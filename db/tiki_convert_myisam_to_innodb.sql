...
ALTER TABLE `tiki_h5p_contents` ENGINE=InnoDB;
...
ALTER TABLE `tiki_h5p_tmpfiles` ENGINE=InnoDB;
...
-- ALTER TABLE `users_score` ENGINE=InnoDB;
ALTER TABLE `users_usergroups` ENGINE=InnoDB;
ALTER TABLE `users_users` ENGINE=InnoDB;
ALTER TABLE `tiki_search_queries` ENGINE=InnoDB;
