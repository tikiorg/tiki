...
CREATE  INDEX "`tiki_calendar_items`_calendarId" ON "`tiki_calendar_items`"("calendarId");
CREATE  INDEX "`tiki_calendar_items`_ft" ON "`tiki_calendar_items`"(`"name"``"description"`);
