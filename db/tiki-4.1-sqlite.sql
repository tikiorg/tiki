...
CREATE TABLE `messu_messages` (  `msgId` int(14) NOT NULL   `user` varchar(200) NOT NULL default '',
...
CREATE TABLE `messu_archive` (  `msgId` int(14) NOT NULL   `user` varchar(40) NOT NULL default '',
...
CREATE TABLE `messu_sent` (  `msgId` int(14) NOT NULL   `user` varchar(40) NOT NULL default '',
  `user_from` varchar(40) NOT NULL default '',
  `user_to` text,
  `user_cc` text,
  `user_bcc` text,
...
CREATE TABLE `tiki_actionlog` (  `actionId` int(8) NOT NULL   `action` varchar(255) NOT NULL default '',
...
CREATE TABLE `tiki_articles` (  `articleId` int(8) NOT NULL   `topline` varchar(255) default NULL,
...
CREATE TABLE `tiki_banners` (  `bannerId` int(12) NOT NULL   `client` varchar(200) NOT NULL default '',
...
CREATE TABLE `tiki_banning` (  `banId` int(12) NOT NULL   `mode` enum('user','ip') default NULL,
...
CREATE TABLE `tiki_blog_posts` (  `postId` int(8) NOT NULL   `blogId` int(8) NOT NULL default '0',
  `data` text,
...
CREATE TABLE `tiki_blog_posts_images` (  `imgId` int(14) NOT NULL   `postId` int(14) NOT NULL default '0',
...
CREATE TABLE `tiki_blogs` (  `blogId` int(8) NOT NULL   `created` int(14) default NULL,
  `lastModif` int(14) default NULL,
  `title` varchar(200) default NULL,
  `description` text,
  `user` varchar(200) default '',
...
CREATE TABLE `tiki_calendar_categories` (  `calcatId` int(11) NOT NULL   `calendarId` int(14) NOT NULL default '0',
...
CREATE TABLE `tiki_calendar_recurrence` (  `recurrenceId` int(14) NOT NULL   `calendarId` int(14) NOT NULL default '0',
...
CREATE TABLE `tiki_calendar_items` (  `calitemId` int(14) NOT NULL   `calendarId` int(14) NOT NULL default '0',
...
CREATE TABLE `tiki_calendar_locations` (  `callocId` int(14) NOT NULL   `calendarId` int(14) NOT NULL default '0',
  `name` varchar(255) NOT NULL default '',
  `description` blob,
...
CREATE TABLE `tiki_calendars` (  `calendarId` int(14) NOT NULL   `name` varchar(80) NOT NULL default '',
...
CREATE TABLE `tiki_categories` (  `categId` int(12) NOT NULL   `name` varchar(100) default NULL,
...
CREATE TABLE `tiki_objects` (  `objectId` int(12) NOT NULL   `type` varchar(50) default NULL,
...
CREATE TABLE `tiki_chat_channels` (  `channelId` int(8) NOT NULL   `name` varchar(30) default NULL,
  `description` varchar(250) default NULL,
...
CREATE TABLE `tiki_chat_messages` (  `messageId` int(8) NOT NULL   `channelId` int(8) NOT NULL default '0',
...
CREATE TABLE `tiki_comments` (  `threadId` int(14) NOT NULL   `object` varchar(255) NOT NULL default '',
  `objectType` varchar(32) NOT NULL default '',
...
CREATE TABLE `tiki_content` (  `contentId` int(8) NOT NULL   `description` text,
  `contentLabel` varchar(255) NOT NULL default '',
  PRIMARY KEY (`contentId`)
)   ;

DROP TABLE IF EXISTS `tiki_content_templates`;
CREATE TABLE `tiki_content_templates` (  `templateId` int(10) NOT NULL   `template_type` VARCHAR( 20 ) NOT NULL DEFAULT 'static',
  `content` longblob,
  `name` varchar(200) default NULL,
  `created` int(14) default NULL,
...
CREATE TABLE `tiki_cookies` (  `cookieId` int(10) NOT NULL   `cookie` text,
  PRIMARY KEY (`cookieId`)
)   ;

DROP TABLE IF EXISTS `tiki_copyrights`;
CREATE TABLE `tiki_copyrights` (  `copyrightId` int(12) NOT NULL   `page` varchar(200) default NULL,
  `title` varchar(200) default NULL,
...
CREATE TABLE `tiki_directory_categories` (  `categId` int(10) NOT NULL   `parent` int(10) default NULL,
...
CREATE TABLE `tiki_directory_sites` (  `siteId` int(14) NOT NULL   `name` varchar(240) default NULL,
  `description` text,
  `url` varchar(255) default NULL,
...
CREATE TABLE `tiki_dsn` (  `dsnId` int(12) NOT NULL   `name` varchar(200) NOT NULL default '',
...
CREATE TABLE `tiki_extwiki` (  `extwikiId` int(12) NOT NULL   `name` varchar(200) NOT NULL default '',
  `extwiki` varchar(255) default NULL,
  PRIMARY KEY (`extwikiId`)
)   ;

DROP TABLE IF EXISTS `tiki_faq_questions`;
CREATE TABLE `tiki_faq_questions` (  `questionId` int(10) NOT NULL   `faqId` int(10) default NULL,
...
CREATE TABLE `tiki_faqs` (  `faqId` int(10) NOT NULL   `title` varchar(200) default NULL,
  `description` text,
  `created` int(14) default NULL,
...
CREATE TABLE `tiki_file_galleries` (  `galleryId` int(14) NOT NULL   `name` varchar(80) NOT NULL default '',
...
CREATE TABLE `tiki_files` (  `fileId` int(14) NOT NULL   `galleryId` int(14) NOT NULL default '0',
...
CREATE TABLE `tiki_forum_attachments` (  `attId` int(14) NOT NULL   `threadId` int(14) NOT NULL default '0',
...
CREATE TABLE `tiki_forums` (  `forumId` int(8) NOT NULL   `name` varchar(255) default NULL,
  `description` text,
  `created` int(14) default NULL,
...
CREATE TABLE `tiki_forums_queue` (  `qId` int(14) NOT NULL   `object` varchar(32) default NULL,
  `parentId` int(14) default NULL,
  `forumId` int(14) default NULL,
  `timestamp` int(14) default NULL,
  `user` varchar(200) default '',
...
CREATE TABLE `tiki_galleries` (  `galleryId` int(14) NOT NULL   `name` varchar(80) NOT NULL default '',
  `description` text,
  `created` int(14) default NULL,
  `lastModif` int(14) default NULL,
  `visible` char(1) default NULL,
...
CREATE TABLE `tiki_group_watches` (  `watchId` int(12) NOT NULL   `group` varchar(200) NOT NULL default '',
...
CREATE TABLE `tiki_history` (  `historyId` int(12) NOT NULL   `pageName` varchar(160) NOT NULL default '',
...
CREATE TABLE `tiki_images` (  `imageId` int(14) NOT NULL   `galleryId` int(14) NOT NULL default '0',
  `name` varchar(200) NOT NULL default '',
  `description` text,
...
CREATE TABLE `tiki_link_cache` (  `cacheId` int(14) NOT NULL   `url` varchar(250) default NULL,
  `data` longblob,
...
CREATE TABLE `tiki_live_support_events` (  `eventId` int(14) NOT NULL   `reqId` varchar(32) NOT NULL default '',
...
CREATE TABLE `tiki_live_support_message_comments` (  `cId` int(12) NOT NULL   `msgId` int(12) default NULL,
  `data` text,
  `timestamp` int(14) default NULL,
  PRIMARY KEY (`cId`)
)   ;
...
CREATE TABLE `tiki_live_support_messages` (  `msgId` int(12) NOT NULL   `data` text,
  `timestamp` int(14) default NULL,
  `user` varchar(200) not null default '',
...
CREATE TABLE `tiki_live_support_modules` (  `modId` int(4) NOT NULL   `name` varchar(90) default NULL,
  PRIMARY KEY (`modId`)
)   ;
...
CREATE TABLE `tiki_logs` (  `logId` int(8) NOT NULL   `logtype` varchar(20) NOT NULL,
...
CREATE TABLE `tiki_mailin_accounts` (  `accountId` int(12) NOT NULL   `user` varchar(200) NOT NULL default '',
...
CREATE TABLE `tiki_menu_languages` (  `menuId` int(8) NOT NULL   `language` char(16) NOT NULL default '',
  PRIMARY KEY (`menuId`,`language`)
)   ;

DROP TABLE IF EXISTS `tiki_menu_options`;
CREATE TABLE `tiki_menu_options` (  `optionId` int(8) NOT NULL   `menuId` int(8) default NULL,
  `type` char(1) default NULL,
  `name` varchar(200) default NULL,
  `url` varchar(255) default NULL,
  `position` int(4) default NULL,
...
CREATE TABLE `tiki_menus` (  `menuId` int(8) NOT NULL   `name` varchar(200) NOT NULL default '',
  `description` text,
  `type` char(1) default NULL,
...
CREATE TABLE `tiki_minical_events` (
  `user` varchar(200) default '',  `eventId` int(12) NOT NULL   `title` varchar(250) default NULL,
  `description` text,
...
CREATE TABLE `tiki_minical_topics` (
  `user` varchar(200) default '',  `topicId` int(12) NOT NULL   `name` varchar(250) default NULL,
...
CREATE TABLE `tiki_modules` (  `moduleId` int(8) NOT NULL   `name` varchar(200) NOT NULL default '',
...
CREATE TABLE `tiki_newsletters` (  `nlId` int(12) NOT NULL   `name` varchar(200) default NULL,
  `description` text,
  `created` int(14) default NULL,
...
CREATE TABLE `tiki_pages` (  `page_id` int(14) NOT NULL   `pageName` varchar(160) NOT NULL default '',
  `hits` int(8) default NULL,
  `data` mediumtext,
  `description` varchar(200) default NULL,
  `lastModif` int(14) default NULL,
...
CREATE TABLE `tiki_poll_options` (
  `pollId` int(8) NOT NULL default '0',  `optionId` int(8) NOT NULL   `title` varchar(200) default NULL,
...
CREATE TABLE `tiki_polls` (  `pollId` int(8) NOT NULL   `title` varchar(200) default NULL,
  `votes` int(8) default NULL,
  `active` char(1) default NULL,
  `publishDate` int(14) default NULL,
...
CREATE TABLE `tiki_private_messages` (  `messageId` int(8) NOT NULL   `toNickname` varchar(200) NOT NULL default '',
  `poster` varchar(200) NOT NULL default 'anonymous',
  `timestamp` int(14) default NULL,
...
CREATE TABLE `tiki_programmed_content` (  `pId` int(8) NOT NULL   `contentId` int(8) NOT NULL default '0',
...
CREATE TABLE `tiki_quiz_question_options` (  `optionId` int(10) NOT NULL   `questionId` int(10) default NULL,
  `optionText` text,
...
CREATE TABLE `tiki_quiz_questions` (  `questionId` int(10) NOT NULL   `quizId` int(10) default NULL,
  `question` text,
  `position` int(4) default NULL,
  `type` char(1) default NULL,
...
CREATE TABLE `tiki_quiz_results` (  `resultId` int(10) NOT NULL   `quizId` int(10) default NULL,
...
CREATE TABLE `tiki_quizzes` (  `quizId` int(10) NOT NULL   `name` varchar(255) default NULL,
  `description` text,
...
CREATE TABLE `tiki_received_articles` (  `receivedArticleId` int(14) NOT NULL   `receivedFromSite` varchar(200) default NULL,
...
CREATE TABLE `tiki_received_pages` (  `receivedPageId` int(14) NOT NULL   `pageName` varchar(160) NOT NULL default '',
  `data` longblob,
  `description` varchar(200) default NULL,
  `comment` varchar(200) default NULL,
...
CREATE TABLE `tiki_rss_modules` (  `rssId` int(8) NOT NULL   `name` varchar(30) NOT NULL default '',
  `description` text,
  `url` varchar(255) NOT NULL default '',
...
CREATE TABLE `tiki_sent_newsletters` (  `editionId` int(12) NOT NULL   `nlId` int(12) NOT NULL default '0',
  `users` int(10) default NULL,
...
CREATE TABLE `tiki_sheets` (  `sheetId` int(8) NOT NULL   `title` varchar(200) NOT NULL default '',
  `description` text,
...
CREATE TABLE `tiki_shoutbox` (  `msgId` int(10) NOT NULL   `message` varchar(255) default NULL,
  `timestamp` int(14) default NULL,
...
CREATE TABLE `tiki_structure_versions` (  `structure_id` int(14) NOT NULL   `version` int(14) default NULL,
  PRIMARY KEY (`structure_id`)
)   ;

DROP TABLE IF EXISTS `tiki_structures`;
CREATE TABLE `tiki_structures` (  `page_ref_id` int(14) NOT NULL   `structure_id` int(14) NOT NULL,
...
CREATE TABLE `tiki_submissions` (  `subId` int(8) NOT NULL   `topline` varchar(255) default NULL,
  `title` varchar(255) default NULL,
  `subtitle` varchar(255) default NULL,
  `linkto` varchar(255) default NULL,
  `lang` varchar(16) default NULL,
...
CREATE TABLE `tiki_suggested_faq_questions` (  `sfqId` int(10) NOT NULL   `faqId` int(10) NOT NULL default '0',
  `question` text,
  `answer` text,
  `created` int(14) default NULL,
  `user` varchar(200) NOT NULL default '',
...
CREATE TABLE `tiki_survey_question_options` (  `optionId` int(12) NOT NULL   `questionId` int(12) NOT NULL default '0',
  `qoption` text,
  `votes` int(10) default NULL,
  PRIMARY KEY (`optionId`)
)   ;
...
CREATE TABLE `tiki_survey_questions` (  `questionId` int(12) NOT NULL   `surveyId` int(12) NOT NULL default '0',
  `question` text,
  `options` text,
  `type` char(1) default NULL,
...
CREATE TABLE `tiki_surveys` (  `surveyId` int(12) NOT NULL   `name` varchar(200) default NULL,
  `description` text,
  `taken` int(10) default NULL,
...
CREATE TABLE `tiki_topics` (  `topicId` int(14) NOT NULL   `name` varchar(40) default NULL,
  `image_name` varchar(80) default NULL,
  `image_type` varchar(80) default NULL,
  `image_size` int(14) default NULL,
  `image_data` longblob,
...
CREATE TABLE `tiki_tracker_fields` (  `fieldId` int(12) NOT NULL   `trackerId` int(12) NOT NULL default '0',
...
CREATE TABLE `tiki_tracker_item_attachments` (  `attId` int(12) NOT NULL   `itemId` int(12) NOT NULL default 0,
  `filename` varchar(80) default NULL,
  `filetype` varchar(80) default NULL,
  `filesize` int(14) default NULL,
...
CREATE TABLE `tiki_tracker_item_comments` (  `commentId` int(12) NOT NULL   `itemId` int(12) NOT NULL default '0',
  `user` varchar(200) default NULL,
  `data` text,
  `title` varchar(200) default NULL,
...
CREATE TABLE `tiki_tracker_items` (  `itemId` int(12) NOT NULL   `trackerId` int(12) NOT NULL default '0',
  `created` int(14) default NULL,
...
CREATE TABLE `tiki_trackers` (  `trackerId` int(12) NOT NULL   `name` varchar(255) default NULL,
  `description` text,
...
CREATE TABLE `tiki_untranslated` (  `id` int(14) NOT NULL   `source` tinyblob NOT NULL,
  `lang` char(16) NOT NULL default '',
  PRIMARY KEY (`source`(255),`lang`),
  UNIQUE KEY `id` (id),
  KEY `id_2` (id)
...
CREATE TABLE `tiki_user_answers_uploads` (  `answerUploadId` int(4) NOT NULL   `userResultId` int(11) NOT NULL default '0',
...
CREATE TABLE `tiki_user_bookmarks_folders` (  `folderId` int(12) NOT NULL   `parentId` int(12) default NULL,
  `user` varchar(200) NOT NULL default '',
...
CREATE TABLE `tiki_user_bookmarks_urls` (  `urlId` int(12) NOT NULL   `name` varchar(200) default NULL,
  `url` varchar(250) default NULL,
  `data` longblob,
  `lastUpdated` int(14) default NULL,
...
CREATE TABLE `tiki_user_mail_accounts` (  `accountId` int(12) NOT NULL   `user` varchar(200) NOT NULL default '',
  `account` varchar(50) NOT NULL default '',
  `pop` varchar(255) default NULL,
...
CREATE TABLE `tiki_user_menus` (
  `user` varchar(200) NOT NULL default '',  `menuId` int(12) NOT NULL   `url` varchar(250) default NULL,
...
CREATE TABLE `tiki_user_notes` (
  `user` varchar(200) NOT NULL default '',  `noteId` int(12) NOT NULL   `created` int(14) default NULL,
  `name` varchar(255) default NULL,
  `lastModif` int(14) default NULL,
  `data` text,
  `size` int(14) default NULL,
...
CREATE TABLE `tiki_user_quizzes` (
  ...
  `resultId` int(10) default NULL,  `userResultId` int(10) NOT NULL   PRIMARY KEY (`userResultId`)
)   ;
...
CREATE TABLE `tiki_user_watches` (  `watchId` int(12) NOT NULL   `user` varchar(200) NOT NULL default '',
  `event` varchar(40) NOT NULL default '',
  `object` varchar(200) NOT NULL default '',
  `title` varchar(250) default NULL,
  `type` varchar(200) default NULL,
...
CREATE TABLE `tiki_userfiles` (
  `user` varchar(200) NOT NULL default '',  `fileId` int(12) NOT NULL   `name` varchar(200) default NULL,
  `filename` varchar(200) default NULL,
  `filetype` varchar(200) default NULL,
  `filesize` varchar(200) default NULL,
  `data` longblob,
...
CREATE TABLE `tiki_webmail_contacts` (  `contactId` int(12) NOT NULL   `firstName` varchar(80) default NULL,
...
CREATE TABLE `tiki_wiki_attachments` (  `attId` int(12) NOT NULL   `page` varchar(200) NOT NULL default '',
  `filename` varchar(80) default NULL,
  `filetype` varchar(80) default NULL,
  `filesize` int(14) default NULL,
  `user` varchar(200) NOT NULL default '',
...
CREATE TABLE `tiki_download` (  `id` int(11) NOT NULL   `object` varchar(255) NOT NULL default '',
...
CREATE TABLE `users_groups` (  `id` int(11) NOT NULL   `groupName` varchar(255) NOT NULL default '',
...
CREATE TABLE `users_users` (  `userId` int(8) NOT NULL   `email` varchar(200) default NULL,
...
CREATE TABLE `tiki_integrator_reps` (  `repID` int(11) NOT NULL   `name` varchar(255) NOT NULL default '',
...
CREATE TABLE `tiki_integrator_rules` (  `ruleID` int(11) NOT NULL   `repID` int(11) NOT NULL default '0',
...
CREATE TABLE `tiki_translated_objects` (  `traId` int(14) NOT NULL   `type` varchar(50) NOT NULL,
...
CREATE TABLE `tiki_registration_fields` (  `id` int(11) NOT NULL   `field` varchar(255) NOT NULL default '',
  `name` varchar(255) default NULL,
...
CREATE TABLE `tiki_actionlog_conf` (  `id` int(11) NOT NULL   `action` varchar(32) NOT NULL default '',
  `objectType` varchar(32) NOT NULL default '',
...
CREATE TABLE `tiki_freetags` (  `tagId` int(10) unsigned NOT NULL   `tag` varchar(30) NOT NULL default '',
...
CREATE TABLE `tiki_freetagged_objects` (  `tagId` int(12) NOT NULL   `objectId` int(11) NOT NULL default 0,
  `user` varchar(200) default '',
  `created` int(14) NOT NULL default '0',
...
CREATE TABLE `tiki_contributions` (  `contributionId` int(12) NOT NULL   `name` varchar(100) default NULL,
  `description` varchar(250) default NULL,
...
CREATE TABLE `tiki_webmail_contacts_fields` (
  ...
  `show` char(1) NOT NULL default 'n',  `fieldId` int(10) unsigned NOT NULL   `flagsPublic` CHAR( 1 ) NOT NULL DEFAULT 'n',
  PRIMARY KEY ( `fieldId` ),
  INDEX ( `user` )
) ENGINE = MyISAM ;

DROP TABLE IF EXISTS `tiki_pages_translation_bits`;
CREATE TABLE `tiki_pages_translation_bits` (  `translation_bit_id` int(14) NOT NULL   `page_id` int(14) NOT NULL,
...
CREATE TABLE `tiki_minichat` (  `id` int(10) unsigned NOT NULL   `channel` varchar(31),
...
CREATE TABLE `tiki_feature` (  `feature_id` mediumint(9) NOT NULL   `feature_name` varchar(150) NOT NULL,
...
CREATE TABLE `tiki_sent_newsletters_files` (  `id` int(11) NOT NULL   `editionId` int(11) NOT NULL,
...
CREATE TABLE `tiki_sefurl_regex_out` (  `id` int(11) NOT NULL   `left` varchar(256) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tiki_page_list_types` (  `id` int(8) unsigned NOT NULL   `name` varchar(40) NOT NULL,
