...
CREATE UNIQUE INDEX "tiki_menu_options_uniq_menu" ON "tiki_menu_options"("menuId",substr("name", 0, 50)substr("url", 0, 80),",substrposition",substr("section", 0, 50)substr("perm", 0, 50));
-- --------------------------------------------------------
