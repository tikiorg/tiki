...
<img src="img/mytiki/mytiki.gif" alt="{tr}MyTiki{/tr}" />
</a></td>
{/if}
...
<img src="img/mytiki/prefs.gif" alt="{tr}Prefs{/tr}" />
</a></td>
{/if}
...
<img src="img/mytiki/messages.gif" alt="{tr}Messages{/tr}" /><br />
<small>({$unread})</small>
</a></div></td>
{/if}
...
<img src="img/mytiki/tasks.gif" alt="{tr}Tasks{/tr}" /><br />
</a></td>
{/if}
...
<img src="img/mytiki/bookmarks.gif" alt="{tr}Bookmarks{/tr}" /><br />
</a></td>
{/if}
...
<img src="img/mytiki/modules.gif" alt="{tr}Modules{/tr}" /><br />
</a></td>
{/if}
...
<img src="img/mytiki/news.gif" alt="{tr}Newsreader{/tr}" /><br />
</a></td>
{/if}
...
<img src="img/mytiki/webmail.gif" alt="{tr}Webmail{/tr}" /><br />
</a></td>
{/if}
...
<img src="img/mytiki/stock_contact.png" alt="{tr}Contacts Preferences{/tr}" /><br />
</a></td>
{/if}
...
<img src="img/mytiki/notes.gif" alt="{tr}Notepad{/tr}" /><br />
</a></td>
{/if}
...
<img src="img/mytiki/myfiles.gif" alt="{tr}MyFiles{/tr}" /><br />
</a></td>
{/if}
...
<img src="img/mytiki/minical.gif" alt="{tr}Mini Calendar{/tr}" /><br />
</a></td>
{/if}

{if $prefs.feature_user_watches eq 'y'}
<td valign="top"><a class="link" href="tiki-user_watches.php" title="{tr}My watches{/tr}">
<img src="img/mytiki/mywatches.gif" alt="{tr}My watches{/tr}" /><br />
</a></td>
{/if}
...
<img src="img/mytiki/gnome-vumeter.png" alt="{tr}Action Log{/tr}" width="32" height="32" /><br />
</a></td>
{/if}
