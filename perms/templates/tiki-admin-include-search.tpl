	...
	{tabset name=admin_search}
		{tab name="{tr}General Settings{/tr}"}
			...
			<fieldset><legend>{tr}Features{/tr}</legend>
				<div class="adminoptionbox">
					<div class="adminoption"><input type="checkbox" id="feature_referer_highlight" name="feature_referer_highlight" {if $prefs.feature_referer_highlight eq 'y'}checked="checked" {/if}/></div>
				...
				<div class="adminoptionbox">
					<div class="adminoption"><input type="checkbox" id="search_parsed_snippet" name="search_parsed_snippet" {if $prefs.search_parsed_snippet eq 'y'}checked="checked"{/if}/></div>
					<div class="adminoptionlabel"><label for="search_parsed_snippet">{tr}Parse the results{/tr}</label>
						<br /><em>{tr}May impact performance{/tr}.</em>
					</div>
				</div>
				<div class="adminoptionbox">
			...
			<fieldset><legend>{tr}Permissions{/tr}</legend>
				...
				<div class="adminoptionbox">
					<div class="adminoption"><input type="checkbox" id="feature_search_show_forbidden_obj" name="feature_search_show_forbidden_obj" {if $prefs.feature_search_show_forbidden_obj eq 'y'}checked="checked"{/if}/></div>
		...
		{tab name="{tr}Search Results{/tr}"}
			...
			<div class="adminoptionbox">
				<div class="adminoption"><input type="checkbox" id="feature_search_show_object_filter" name="feature_search_show_object_filter" {if $prefs.feature_search_show_object_filter eq 'y'}checked="checked"{/if}/></div>
				<div class="adminoptionlabel"><label for="feature_search_show_object_filter">{tr}Object filter{/tr}</label></div>
			</div>
			<div class="adminoptionbox">
				<div class="adminoption"><input type="checkbox" id="feature_search_show_search_box"	name="feature_search_show_search_box" {if $prefs.feature_search_show_search_box eq 'y'}checked="checked"{/if}/></div>
			...
			<div class="adminoptionbox">
				<div class="adminoption"><input type="checkbox" id="feature_search_show_visit_count" name="feature_search_show_visit_count" {if $prefs.feature_search_show_visit_count eq 'y'}checked="checked"{/if}/></div>
				<div class="adminoptionlabel"><label for="feature_search_show_visit_count">{tr}Visits{/tr} ({tr}hits{/tr})</label></div>
			</div>	  
			<div class="adminoptionbox">
				<div class="adminoption"><input type="checkbox" id="feature_search_show_pertinence" name="feature_search_show_pertinence" {if $prefs.feature_search_show_pertinence eq 'y'}checked="checked"{/if}/></div>
				<div class="adminoptionlabel"><label for="feature_search_show_pertinence">{tr}Pertinence{/tr}</label></div>
			</div>	  
			<div class="adminoptionbox">
				<div class="adminoption"><input type="checkbox" id="feature_search_show_object_type" name="feature_search_show_object_type" {if $prefs.feature_search_show_object_type eq 'y'}checked="checked"{/if}/></div>
				<div class="adminoptionlabel"><label for="feature_search_show_object_type">{tr}Object type{/tr}</label></div>
			</div>	  
			<div class="adminoptionbox">
				<div class="adminoption"><input type="checkbox" id="feature_search_show_last_modification" name="feature_search_show_last_modification" {if $prefs.feature_search_show_last_modification eq 'y'}checked="checked"{/if}/></div>
