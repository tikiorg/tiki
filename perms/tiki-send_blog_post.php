...
if (isset($_REQUEST['send'])) {
	...
	$machine = $tikilib->httpPrefix() . str_replace('tiki-send_blog_post', 'tiki-view_blog_post', $foo["path"]) . '?postId=' . $postId . '&blogId=' . $_REQUEST['blogId'];
	...
	foreach($emails as $email) {
		...
		@mail($email, tra('Post recommendation at') . ' ' . $_SERVER["SERVER_NAME"], $mail_data, 'From: ' . $prefs['sender_email'] . "\r\nContent-type: text/plain;charset=utf-8\r\n");
	}
