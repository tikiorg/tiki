 ...
 */
// $Id: twversion.class.php 44369 2012-12-20 21:40:39Z changi67 $
...
class TWVersion
{
	 ...
	 * 
	 * Lists all the valid release versions of Tiki.
	...
	private function pollVersion()
	{
		...
		// .version contains an ordered list of release numbers, one per line. 
		// All minor releases from a same major release are grouped.
